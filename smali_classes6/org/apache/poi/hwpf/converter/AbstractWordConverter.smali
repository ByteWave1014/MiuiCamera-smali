...
.method public processCharacters(Lorg/apache/poi/hwpf/HWPFDocumentCore;ILorg/apache/poi/hwpf/usermodel/Range;Lorg/w3c/dom/Element;)Z
    ...
    invoke-direct {v3, v9, v1, v2, v11}, Lorg/apache/poi/hwpf/converter/AbstractWordConverter$1;-><init>(Lorg/apache/poi/hwpf/converter/AbstractWordConverter;IILorg/apache/poi/hwpf/usermodel/Range;)V
    ...
    invoke-static {v13, v3, v2}, LA/T;->d(IILjava/lang/String;)Ljava/lang/String;
...
.method public processParagraphes(Lorg/apache/poi/hwpf/HWPFDocumentCore;Lorg/w3c/dom/Element;Lorg/apache/poi/hwpf/usermodel/Range;I)V
    ...
    invoke-virtual {p3, v1}, Lorg/apache/poi/hwpf/usermodel/Range;->getParagraph(I)Lorg/apache/poi/hwpf/usermodel/Paragraph;
    ...
    invoke-virtual {p3, v8}, Lorg/apache/poi/hwpf/usermodel/Range;->getTable(Lorg/apache/poi/hwpf/usermodel/Paragraph;)Lorg/apache/poi/hwpf/usermodel/Table;

    move-result-object v2

    invoke-virtual {p0, p1, p2, v2}, Lorg/apache/poi/hwpf/converter/AbstractWordConverter;->processTable(Lorg/apache/poi/hwpf/HWPFDocumentCore;Lorg/w3c/dom/Element;Lorg/apache/poi/hwpf/usermodel/Table;)V
    ...
    invoke-static {v3, v2, v4}, Lorg/apache/poi/hwpf/converter/AbstractWordUtils;->getBulletText(Lorg/apache/poi/hwpf/converter/AbstractWordUtils$NumberingState;Lorg/apache/poi/hwpf/usermodel/HWPFList;C)Ljava/lang/String;
    ...
    invoke-virtual/range {v2 .. v7}, Lorg/apache/poi/hwpf/converter/AbstractWordConverter;->processParagraph(Lorg/apache/poi/hwpf/HWPFDocumentCore;Lorg/w3c/dom/Element;ILorg/apache/poi/hwpf/usermodel/Paragraph;Ljava/lang/String;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    iget-object v3, p0, Lorg/apache/poi/hwpf/converter/AbstractWordConverter;->log:Lorg/apache/poi/util/POILogger;

    const/4 v4, 0x5

    const-string v5, "Can\'t process paragraph as list entry, will be processed without list information"

    invoke-virtual {v3, v4, v5, v2}, Lorg/apache/poi/util/POILogger;->log(ILjava/lang/Object;Ljava/lang/Throwable;)V
