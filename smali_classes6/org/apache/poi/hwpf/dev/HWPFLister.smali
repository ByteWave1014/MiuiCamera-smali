...
.method private dumpStyles()V
    ...
    invoke-static {v2, v5, v6}, LA3/h2;->i(ILjava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
...
.method public static main([Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v2}, Lorg/apache/poi/hwpf/dev/HWPFLister;->dumpParagraphs(Z)V
...
.method public dumpPapx(ZZ)V
    ...
    const-string v4, "binary PAP pages "
    ...
    const-class v4, Lorg/apache/poi/hwpf/HWPFDocumentCore;

    const-string v5, "_mainStream"
    ...
    iget-object v5, v0, Lorg/apache/poi/hwpf/dev/HWPFLister;->_doc:Lorg/apache/poi/hwpf/HWPFDocumentCore;
    ...
    invoke-virtual {v7}, Lorg/apache/poi/hwpf/model/FileInformationBlock;->getFcPlcfbtePapx()I
    ...
    invoke-virtual {v8}, Lorg/apache/poi/hwpf/model/FileInformationBlock;->getLcbPlcfbtePapx()I

    move-result v8

    const/4 v9, 0x4

    invoke-direct {v5, v6, v7, v8, v9}, Lorg/apache/poi/hwpf/model/PlexOfCps;-><init>([BIII)V
    ...
    invoke-virtual {v5, v8}, Lorg/apache/poi/hwpf/model/PlexOfCps;->getProperty(I)Lorg/apache/poi/hwpf/model/GenericPropertyNode;
    ...
    invoke-static {v11}, Lorg/apache/poi/util/LittleEndian;->getInt([B)I

    move-result v11

    mul-int/lit16 v11, v11, 0x200

    new-instance v12, Lorg/apache/poi/hwpf/model/PAPFormattedDiskPage;
    ...
    invoke-direct {v12, v4, v13, v11, v14}, Lorg/apache/poi/hwpf/model/PAPFormattedDiskPage;-><init>([B[BILorg/apache/poi/hwpf/model/CharIndexTranslator;)V

    sget-object v11, Ljava/lang/System;->out:Ljava/io/PrintStream;

    new-instance v13, Ljava/lang/StringBuilder;

    const-string v14, "* PFKP: "
    ...
    invoke-virtual {v12}, Lorg/apache/poi/hwpf/model/PAPFormattedDiskPage;->getPAPXs()Ljava/util/List;
    ...
    new-instance v13, Lorg/apache/poi/hwpf/sprm/SprmIterator;

    invoke-virtual {v12}, Lorg/apache/poi/hwpf/model/PAPX;->getGrpprl()[B

    move-result-object v12

    invoke-direct {v13, v12, v2}, Lorg/apache/poi/hwpf/sprm/SprmIterator;-><init>([BI)V

    invoke-virtual {p0, v13, v9}, Lorg/apache/poi/hwpf/dev/HWPFLister;->dumpSprms(Lorg/apache/poi/hwpf/sprm/SprmIterator;Ljava/lang/String;)V
    ...
    new-instance v5, Lorg/apache/poi/hwpf/sprm/SprmIterator;

    invoke-virtual {v4}, Lorg/apache/poi/hwpf/model/PAPX;->getGrpprl()[B

    move-result-object v4

    invoke-direct {v5, v4, v2}, Lorg/apache/poi/hwpf/sprm/SprmIterator;-><init>([BI)V

    invoke-virtual {p0, v5, v9}, Lorg/apache/poi/hwpf/dev/HWPFLister;->dumpSprms(Lorg/apache/poi/hwpf/sprm/SprmIterator;Ljava/lang/String;)V

    goto :goto_2

    :cond_4
    const-class v1, Lorg/apache/poi/hwpf/usermodel/Range;

    const-class v4, Lorg/apache/poi/hwpf/model/PAPX;

    filled-new-array {v1, v4}, [Ljava/lang/Class;

    move-result-object v1

    const-class v4, Lorg/apache/poi/hwpf/usermodel/Paragraph;
    ...
    iget-object v3, v0, Lorg/apache/poi/hwpf/dev/HWPFLister;->_doc:Lorg/apache/poi/hwpf/HWPFDocumentCore;
    ...
    iget-object v7, v0, Lorg/apache/poi/hwpf/dev/HWPFLister;->_doc:Lorg/apache/poi/hwpf/HWPFDocumentCore;

    invoke-virtual {v7}, Lorg/apache/poi/hwpf/HWPFDocumentCore;->getOverallRange()Lorg/apache/poi/hwpf/usermodel/Range;
    ...
    check-cast v7, Lorg/apache/poi/hwpf/usermodel/Paragraph;
    ...
    invoke-direct {v6, v5, v2}, Lorg/apache/poi/hwpf/sprm/SprmIterator;-><init>([BI)V

    const-string v5, "\t"

    invoke-virtual {p0, v6, v5}, Lorg/apache/poi/hwpf/dev/HWPFLister;->dumpSprms(Lorg/apache/poi/hwpf/sprm/SprmIterator;Ljava/lang/String;)V
...
.method public dumpParagraphLevels(Lorg/apache/poi/hwpf/model/ListTables;Lorg/apache/poi/hwpf/usermodel/ParagraphProperties;)V
    ...
    invoke-virtual {p1, v2}, Lorg/apache/poi/hwpf/model/ListTables;->getLfoData(I)Lorg/apache/poi/hwpf/model/LFOData;
    ...
    const-string v0, "PAP\'s ListLevel: "
    ...
    const-string p2, "PAP\'s ListLevel PAPX:"
    ...
    invoke-direct {p2, v3, v2}, Lorg/apache/poi/hwpf/sprm/SprmIterator;-><init>([BI)V
    ...
    const-string p2, "PAP\'s ListLevel CHPX:"
    ...
    invoke-direct {p2, p1, v2}, Lorg/apache/poi/hwpf/sprm/SprmIterator;-><init>([BI)V
