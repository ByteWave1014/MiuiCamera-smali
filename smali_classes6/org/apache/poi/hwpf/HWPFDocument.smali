...
.method public constructor <init>(Lorg/apache/poi/poifs/filesystem/DirectoryNode;)V
    ...
    iput-object v2, v6, Lorg/apache/poi/hwpf/HWPFDocument;->_endnotesTables:Lorg/apache/poi/hwpf/model/NotesTables;

    .line 12
    new-instance v3, Lorg/apache/poi/hwpf/usermodel/NotesImpl;

    invoke-direct {v3, v2}, Lorg/apache/poi/hwpf/usermodel/NotesImpl;-><init>(Lorg/apache/poi/hwpf/model/NotesTables;)V

    iput-object v3, v6, Lorg/apache/poi/hwpf/HWPFDocument;->_endnotes:Lorg/apache/poi/hwpf/usermodel/Notes;
    ...
    iput-object v2, v6, Lorg/apache/poi/hwpf/HWPFDocument;->_footnotesTables:Lorg/apache/poi/hwpf/model/NotesTables;
    ...
    iput-object v3, v6, Lorg/apache/poi/hwpf/HWPFDocument;->_footnotes:Lorg/apache/poi/hwpf/usermodel/Notes;

    .line 15
    iget-object v2, v6, Lorg/apache/poi/hwpf/HWPFDocumentCore;->_fib:Lorg/apache/poi/hwpf/model/FileInformationBlock;
    ...
    invoke-virtual {v2}, Lorg/apache/poi/hwpf/model/types/FibBaseAbstractType;->isFWhichTblStm()Z
    ...
    iput-object v3, v6, Lorg/apache/poi/hwpf/HWPFDocument;->_tableStream:[B
    ...
    iget-object v3, v6, Lorg/apache/poi/hwpf/HWPFDocument;->_tableStream:[B
    ...
    iget-object v3, v6, Lorg/apache/poi/hwpf/HWPFDocumentCore;->_mainStream:[B

    iget-object v4, v6, Lorg/apache/poi/hwpf/HWPFDocument;->_tableStream:[B
    ...
    iput-object v3, v6, Lorg/apache/poi/hwpf/HWPFDocument;->_dataStream:[B
    ...
    iget-object v1, v6, Lorg/apache/poi/hwpf/HWPFDocument;->_dataStream:[B
    ...
    iput-object v0, v6, Lorg/apache/poi/hwpf/HWPFDocument;->_dataStream:[B

    .line 27
    :goto_1
    new-instance v0, Lorg/apache/poi/hwpf/model/DocumentProperties;

    iget-object v1, v6, Lorg/apache/poi/hwpf/HWPFDocument;->_tableStream:[B

    iget-object v3, v6, Lorg/apache/poi/hwpf/HWPFDocumentCore;->_fib:Lorg/apache/poi/hwpf/model/FileInformationBlock;

    invoke-virtual {v3}, Lorg/apache/poi/hwpf/model/FileInformationBlock;->getFcDop()I

    move-result v3

    iget-object v4, v6, Lorg/apache/poi/hwpf/HWPFDocumentCore;->_fib:Lorg/apache/poi/hwpf/model/FileInformationBlock;

    invoke-virtual {v4}, Lorg/apache/poi/hwpf/model/FileInformationBlock;->getLcbDop()I

    move-result v4

    invoke-direct {v0, v1, v3, v4}, Lorg/apache/poi/hwpf/model/DocumentProperties;-><init>([BII)V

    iput-object v0, v6, Lorg/apache/poi/hwpf/HWPFDocument;->_dop:Lorg/apache/poi/hwpf/model/DocumentProperties;

    .line 28
    new-instance v0, Lorg/apache/poi/hwpf/model/ComplexFileTable;

    iget-object v1, v6, Lorg/apache/poi/hwpf/HWPFDocumentCore;->_mainStream:[B
    ...
    invoke-direct {v0, v1, v3, v4, v12}, Lorg/apache/poi/hwpf/model/ComplexFileTable;-><init>([B[BII)V

    iput-object v0, v6, Lorg/apache/poi/hwpf/HWPFDocument;->_cft:Lorg/apache/poi/hwpf/model/ComplexFileTable;
    ...
    .line 30
    new-instance v1, Lorg/apache/poi/hwpf/model/CHPBinTable;

    iget-object v14, v6, Lorg/apache/poi/hwpf/HWPFDocumentCore;->_mainStream:[B

    iget-object v15, v6, Lorg/apache/poi/hwpf/HWPFDocument;->_tableStream:[B

    iget-object v3, v6, Lorg/apache/poi/hwpf/HWPFDocumentCore;->_fib:Lorg/apache/poi/hwpf/model/FileInformationBlock;

    invoke-virtual {v3}, Lorg/apache/poi/hwpf/model/FileInformationBlock;->getFcPlcfbteChpx()I

    move-result v16

    iget-object v3, v6, Lorg/apache/poi/hwpf/HWPFDocumentCore;->_fib:Lorg/apache/poi/hwpf/model/FileInformationBlock;

    invoke-virtual {v3}, Lorg/apache/poi/hwpf/model/FileInformationBlock;->getLcbPlcfbteChpx()I
    ...
    invoke-direct/range {v13 .. v18}, Lorg/apache/poi/hwpf/model/CHPBinTable;-><init>([B[BIILorg/apache/poi/hwpf/model/CharIndexTranslator;)V

    iput-object v1, v6, Lorg/apache/poi/hwpf/HWPFDocumentCore;->_cbt:Lorg/apache/poi/hwpf/model/CHPBinTable;

    .line 31
    new-instance v1, Lorg/apache/poi/hwpf/model/PAPBinTable;

    iget-object v14, v6, Lorg/apache/poi/hwpf/HWPFDocumentCore;->_mainStream:[B

    iget-object v15, v6, Lorg/apache/poi/hwpf/HWPFDocument;->_tableStream:[B

    iget-object v3, v6, Lorg/apache/poi/hwpf/HWPFDocument;->_dataStream:[B

    iget-object v4, v6, Lorg/apache/poi/hwpf/HWPFDocumentCore;->_fib:Lorg/apache/poi/hwpf/model/FileInformationBlock;

    invoke-virtual {v4}, Lorg/apache/poi/hwpf/model/FileInformationBlock;->getFcPlcfbtePapx()I

    move-result v17

    iget-object v4, v6, Lorg/apache/poi/hwpf/HWPFDocumentCore;->_fib:Lorg/apache/poi/hwpf/model/FileInformationBlock;

    invoke-virtual {v4}, Lorg/apache/poi/hwpf/model/FileInformationBlock;->getLcbPlcfbtePapx()I
    ...
    invoke-direct/range {v13 .. v19}, Lorg/apache/poi/hwpf/model/PAPBinTable;-><init>([B[B[BIILorg/apache/poi/hwpf/model/CharIndexTranslator;)V

    iput-object v1, v6, Lorg/apache/poi/hwpf/HWPFDocumentCore;->_pbt:Lorg/apache/poi/hwpf/model/PAPBinTable;

    .line 32
    invoke-virtual {v0}, Lorg/apache/poi/hwpf/model/TextPieceTable;->getText()Ljava/lang/StringBuilder;

    move-result-object v1

    iput-object v1, v6, Lorg/apache/poi/hwpf/HWPFDocument;->_text:Ljava/lang/StringBuilder;

    .line 33
    :try_start_2
    const-string v1, "org.apache.poi.hwpf.preserveBinTables"
    ...
    .line 34
    iget-object v1, v6, Lorg/apache/poi/hwpf/HWPFDocumentCore;->_cbt:Lorg/apache/poi/hwpf/model/CHPBinTable;

    iget-object v3, v6, Lorg/apache/poi/hwpf/HWPFDocument;->_cft:Lorg/apache/poi/hwpf/model/ComplexFileTable;

    invoke-virtual {v1, v3}, Lorg/apache/poi/hwpf/model/CHPBinTable;->rebuild(Lorg/apache/poi/hwpf/model/ComplexFileTable;)V

    .line 35
    iget-object v1, v6, Lorg/apache/poi/hwpf/HWPFDocumentCore;->_pbt:Lorg/apache/poi/hwpf/model/PAPBinTable;

    iget-object v3, v6, Lorg/apache/poi/hwpf/HWPFDocument;->_text:Ljava/lang/StringBuilder;

    iget-object v4, v6, Lorg/apache/poi/hwpf/HWPFDocument;->_cft:Lorg/apache/poi/hwpf/model/ComplexFileTable;

    invoke-virtual {v1, v3, v4}, Lorg/apache/poi/hwpf/model/PAPBinTable;->rebuild(Ljava/lang/StringBuilder;Lorg/apache/poi/hwpf/model/ComplexFileTable;)V

    .line 36
    :cond_1
    :try_start_3
    const-string v1, "org.apache.poi.hwpf.preserveTextTable"
    ...
    invoke-direct {v0}, Lorg/apache/poi/hwpf/model/ComplexFileTable;-><init>()V
    ...
    .line 39
    new-instance v1, Lorg/apache/poi/hwpf/model/SinglentonTextPiece;

    iget-object v2, v6, Lorg/apache/poi/hwpf/HWPFDocument;->_text:Ljava/lang/StringBuilder;

    invoke-direct {v1, v2}, Lorg/apache/poi/hwpf/model/SinglentonTextPiece;-><init>(Ljava/lang/StringBuilder;)V

    .line 40
    invoke-virtual {v0, v1}, Lorg/apache/poi/hwpf/model/TextPieceTable;->add(Lorg/apache/poi/hwpf/model/TextPiece;)V

    .line 41
    invoke-virtual {v1}, Lorg/apache/poi/hwpf/model/TextPiece;->getStringBuilder()Ljava/lang/StringBuilder;
    ...
    .line 42
    new-instance v0, Lorg/apache/poi/hwpf/model/FSPATable;

    iget-object v1, v6, Lorg/apache/poi/hwpf/HWPFDocument;->_tableStream:[B

    iget-object v2, v6, Lorg/apache/poi/hwpf/HWPFDocumentCore;->_fib:Lorg/apache/poi/hwpf/model/FileInformationBlock;

    sget-object v3, Lorg/apache/poi/hwpf/model/FSPADocumentPart;->HEADER:Lorg/apache/poi/hwpf/model/FSPADocumentPart;

    invoke-direct {v0, v1, v2, v3}, Lorg/apache/poi/hwpf/model/FSPATable;-><init>([BLorg/apache/poi/hwpf/model/FileInformationBlock;Lorg/apache/poi/hwpf/model/FSPADocumentPart;)V

    iput-object v0, v6, Lorg/apache/poi/hwpf/HWPFDocument;->_fspaHeaders:Lorg/apache/poi/hwpf/model/FSPATable;
    ...
    sget-object v3, Lorg/apache/poi/hwpf/model/FSPADocumentPart;->MAIN:Lorg/apache/poi/hwpf/model/FSPADocumentPart;

    invoke-direct {v0, v1, v2, v3}, Lorg/apache/poi/hwpf/model/FSPATable;-><init>([BLorg/apache/poi/hwpf/model/FileInformationBlock;Lorg/apache/poi/hwpf/model/FSPADocumentPart;)V

    iput-object v0, v6, Lorg/apache/poi/hwpf/HWPFDocument;->_fspaMain:Lorg/apache/poi/hwpf/model/FSPATable;

    .line 44
    iget-object v0, v6, Lorg/apache/poi/hwpf/HWPFDocumentCore;->_fib:Lorg/apache/poi/hwpf/model/FileInformationBlock;

    invoke-virtual {v0}, Lorg/apache/poi/hwpf/model/FileInformationBlock;->getFcDggInfo()I
    ...
    .line 45
    new-instance v0, Lorg/apache/poi/hwpf/model/EscherRecordHolder;
    ...
    invoke-virtual {v3}, Lorg/apache/poi/hwpf/model/FileInformationBlock;->getLcbDggInfo()I

    move-result v3

    invoke-direct {v0, v1, v2, v3}, Lorg/apache/poi/hwpf/model/EscherRecordHolder;-><init>([BII)V

    iput-object v0, v6, Lorg/apache/poi/hwpf/HWPFDocument;->_escherRecordHolder:Lorg/apache/poi/hwpf/model/EscherRecordHolder;
    ...
    invoke-direct {v0}, Lorg/apache/poi/hwpf/model/EscherRecordHolder;-><init>()V

    iput-object v0, v6, Lorg/apache/poi/hwpf/HWPFDocument;->_escherRecordHolder:Lorg/apache/poi/hwpf/model/EscherRecordHolder;

    .line 47
    :goto_3
    new-instance v7, Lorg/apache/poi/hwpf/model/PicturesTable;

    iget-object v2, v6, Lorg/apache/poi/hwpf/HWPFDocument;->_dataStream:[B

    iget-object v3, v6, Lorg/apache/poi/hwpf/HWPFDocumentCore;->_mainStream:[B

    iget-object v4, v6, Lorg/apache/poi/hwpf/HWPFDocument;->_fspaMain:Lorg/apache/poi/hwpf/model/FSPATable;

    iget-object v5, v6, Lorg/apache/poi/hwpf/HWPFDocument;->_escherRecordHolder:Lorg/apache/poi/hwpf/model/EscherRecordHolder;
    ...
    iput-object v7, v6, Lorg/apache/poi/hwpf/HWPFDocument;->_pictures:Lorg/apache/poi/hwpf/model/PicturesTable;

    .line 48
    new-instance v0, Lorg/apache/poi/hwpf/model/ShapesTable;

    iget-object v1, v6, Lorg/apache/poi/hwpf/HWPFDocument;->_tableStream:[B

    iget-object v2, v6, Lorg/apache/poi/hwpf/HWPFDocumentCore;->_fib:Lorg/apache/poi/hwpf/model/FileInformationBlock;

    invoke-direct {v0, v1, v2}, Lorg/apache/poi/hwpf/model/ShapesTable;-><init>([BLorg/apache/poi/hwpf/model/FileInformationBlock;)V

    iput-object v0, v6, Lorg/apache/poi/hwpf/HWPFDocument;->_officeArts:Lorg/apache/poi/hwpf/model/ShapesTable;

    .line 49
    new-instance v0, Lorg/apache/poi/hwpf/usermodel/OfficeDrawingsImpl;

    iget-object v1, v6, Lorg/apache/poi/hwpf/HWPFDocument;->_fspaHeaders:Lorg/apache/poi/hwpf/model/FSPATable;

    iget-object v2, v6, Lorg/apache/poi/hwpf/HWPFDocument;->_escherRecordHolder:Lorg/apache/poi/hwpf/model/EscherRecordHolder;

    iget-object v3, v6, Lorg/apache/poi/hwpf/HWPFDocumentCore;->_mainStream:[B

    invoke-direct {v0, v1, v2, v3}, Lorg/apache/poi/hwpf/usermodel/OfficeDrawingsImpl;-><init>(Lorg/apache/poi/hwpf/model/FSPATable;Lorg/apache/poi/hwpf/model/EscherRecordHolder;[B)V

    iput-object v0, v6, Lorg/apache/poi/hwpf/HWPFDocument;->_officeDrawingsHeaders:Lorg/apache/poi/hwpf/usermodel/OfficeDrawingsImpl;

    .line 50
    new-instance v0, Lorg/apache/poi/hwpf/usermodel/OfficeDrawingsImpl;

    iget-object v1, v6, Lorg/apache/poi/hwpf/HWPFDocument;->_fspaMain:Lorg/apache/poi/hwpf/model/FSPATable;
    ...
    iput-object v0, v6, Lorg/apache/poi/hwpf/HWPFDocument;->_officeDrawingsMain:Lorg/apache/poi/hwpf/usermodel/OfficeDrawingsImpl;

    .line 51
    new-instance v0, Lorg/apache/poi/hwpf/model/SectionTable;

    iget-object v8, v6, Lorg/apache/poi/hwpf/HWPFDocumentCore;->_mainStream:[B

    iget-object v9, v6, Lorg/apache/poi/hwpf/HWPFDocument;->_tableStream:[B

    iget-object v1, v6, Lorg/apache/poi/hwpf/HWPFDocumentCore;->_fib:Lorg/apache/poi/hwpf/model/FileInformationBlock;

    invoke-virtual {v1}, Lorg/apache/poi/hwpf/model/FileInformationBlock;->getFcPlcfsed()I

    move-result v10

    iget-object v1, v6, Lorg/apache/poi/hwpf/HWPFDocumentCore;->_fib:Lorg/apache/poi/hwpf/model/FileInformationBlock;

    invoke-virtual {v1}, Lorg/apache/poi/hwpf/model/FileInformationBlock;->getLcbPlcfsed()I

    move-result v11

    iget-object v1, v6, Lorg/apache/poi/hwpf/HWPFDocumentCore;->_fib:Lorg/apache/poi/hwpf/model/FileInformationBlock;

    sget-object v2, Lorg/apache/poi/hwpf/model/SubdocumentType;->MAIN:Lorg/apache/poi/hwpf/model/SubdocumentType;
    ...
    invoke-direct/range {v7 .. v14}, Lorg/apache/poi/hwpf/model/SectionTable;-><init>([B[BIIILorg/apache/poi/hwpf/model/TextPieceTable;I)V

    iput-object v0, v6, Lorg/apache/poi/hwpf/HWPFDocumentCore;->_st:Lorg/apache/poi/hwpf/model/SectionTable;

    .line 52
    new-instance v0, Lorg/apache/poi/hwpf/model/StyleSheet;
    ...
    invoke-direct {v0, v1, v2}, Lorg/apache/poi/hwpf/model/StyleSheet;-><init>([BI)V

    iput-object v0, v6, Lorg/apache/poi/hwpf/HWPFDocumentCore;->_ss:Lorg/apache/poi/hwpf/model/StyleSheet;

    .line 53
    new-instance v0, Lorg/apache/poi/hwpf/model/FontTable;

    iget-object v1, v6, Lorg/apache/poi/hwpf/HWPFDocument;->_tableStream:[B

    iget-object v2, v6, Lorg/apache/poi/hwpf/HWPFDocumentCore;->_fib:Lorg/apache/poi/hwpf/model/FileInformationBlock;

    invoke-virtual {v2}, Lorg/apache/poi/hwpf/model/FileInformationBlock;->getFcSttbfffn()I

    move-result v2

    iget-object v3, v6, Lorg/apache/poi/hwpf/HWPFDocumentCore;->_fib:Lorg/apache/poi/hwpf/model/FileInformationBlock;

    invoke-virtual {v3}, Lorg/apache/poi/hwpf/model/FileInformationBlock;->getLcbSttbfffn()I

    move-result v3

    invoke-direct {v0, v1, v2, v3}, Lorg/apache/poi/hwpf/model/FontTable;-><init>([BII)V

    iput-object v0, v6, Lorg/apache/poi/hwpf/HWPFDocumentCore;->_ft:Lorg/apache/poi/hwpf/model/FontTable;

    .line 54
    iget-object v0, v6, Lorg/apache/poi/hwpf/HWPFDocumentCore;->_fib:Lorg/apache/poi/hwpf/model/FileInformationBlock;

    invoke-virtual {v0}, Lorg/apache/poi/hwpf/model/FileInformationBlock;->getFcPlfLst()I
    ...
    invoke-virtual {v1}, Lorg/apache/poi/hwpf/model/FileInformationBlock;->getLcbPlfLst()I
    ...
    .line 57
    new-instance v1, Lorg/apache/poi/hwpf/model/ListTables;

    iget-object v2, v6, Lorg/apache/poi/hwpf/HWPFDocument;->_tableStream:[B

    iget-object v3, v6, Lorg/apache/poi/hwpf/HWPFDocumentCore;->_fib:Lorg/apache/poi/hwpf/model/FileInformationBlock;

    invoke-virtual {v3}, Lorg/apache/poi/hwpf/model/FileInformationBlock;->getFcPlfLfo()I

    move-result v3

    iget-object v4, v6, Lorg/apache/poi/hwpf/HWPFDocumentCore;->_fib:Lorg/apache/poi/hwpf/model/FileInformationBlock;

    invoke-virtual {v4}, Lorg/apache/poi/hwpf/model/FileInformationBlock;->getLcbPlfLfo()I

    move-result v4

    invoke-direct {v1, v2, v0, v3, v4}, Lorg/apache/poi/hwpf/model/ListTables;-><init>([BIII)V

    iput-object v1, v6, Lorg/apache/poi/hwpf/HWPFDocumentCore;->_lt:Lorg/apache/poi/hwpf/model/ListTables;

    .line 58
    :cond_4
    iget-object v0, v6, Lorg/apache/poi/hwpf/HWPFDocumentCore;->_fib:Lorg/apache/poi/hwpf/model/FileInformationBlock;

    invoke-virtual {v0}, Lorg/apache/poi/hwpf/model/FileInformationBlock;->getFcSttbSavedBy()I
    ...
    invoke-direct {v2, v3, v0, v1}, Lorg/apache/poi/hwpf/model/SavedByTable;-><init>([BII)V

    iput-object v2, v6, Lorg/apache/poi/hwpf/HWPFDocument;->_sbt:Lorg/apache/poi/hwpf/model/SavedByTable;

    .line 61
    :cond_5
    iget-object v0, v6, Lorg/apache/poi/hwpf/HWPFDocumentCore;->_fib:Lorg/apache/poi/hwpf/model/FileInformationBlock;

    invoke-virtual {v0}, Lorg/apache/poi/hwpf/model/FileInformationBlock;->getFcSttbfRMark()I
    ...
    invoke-virtual {v1}, Lorg/apache/poi/hwpf/model/FileInformationBlock;->getLcbSttbfRMark()I
    ...
    invoke-direct {v2, v3, v0, v1}, Lorg/apache/poi/hwpf/model/RevisionMarkAuthorTable;-><init>([BII)V

    iput-object v2, v6, Lorg/apache/poi/hwpf/HWPFDocument;->_rmat:Lorg/apache/poi/hwpf/model/RevisionMarkAuthorTable;

    .line 64
    :cond_6
    new-instance v0, Lorg/apache/poi/hwpf/model/BookmarksTables;

    iget-object v1, v6, Lorg/apache/poi/hwpf/HWPFDocument;->_tableStream:[B

    iget-object v2, v6, Lorg/apache/poi/hwpf/HWPFDocumentCore;->_fib:Lorg/apache/poi/hwpf/model/FileInformationBlock;

    invoke-direct {v0, v1, v2}, Lorg/apache/poi/hwpf/model/BookmarksTables;-><init>([BLorg/apache/poi/hwpf/model/FileInformationBlock;)V

    iput-object v0, v6, Lorg/apache/poi/hwpf/HWPFDocument;->_bookmarksTables:Lorg/apache/poi/hwpf/model/BookmarksTables;

    .line 65
    new-instance v1, Lorg/apache/poi/hwpf/usermodel/BookmarksImpl;

    invoke-direct {v1, v0}, Lorg/apache/poi/hwpf/usermodel/BookmarksImpl;-><init>(Lorg/apache/poi/hwpf/model/BookmarksTables;)V

    iput-object v1, v6, Lorg/apache/poi/hwpf/HWPFDocument;->_bookmarks:Lorg/apache/poi/hwpf/usermodel/Bookmarks;
    ...
    invoke-direct {v0, v1, v2, v3}, Lorg/apache/poi/hwpf/model/NotesTables;-><init>(Lorg/apache/poi/hwpf/model/NoteType;[BLorg/apache/poi/hwpf/model/FileInformationBlock;)V

    iput-object v0, v6, Lorg/apache/poi/hwpf/HWPFDocument;->_endnotesTables:Lorg/apache/poi/hwpf/model/NotesTables;
    ...
    iput-object v1, v6, Lorg/apache/poi/hwpf/HWPFDocument;->_endnotes:Lorg/apache/poi/hwpf/usermodel/Notes;
    ...
    iput-object v0, v6, Lorg/apache/poi/hwpf/HWPFDocument;->_footnotesTables:Lorg/apache/poi/hwpf/model/NotesTables;
    ...
    iput-object v1, v6, Lorg/apache/poi/hwpf/HWPFDocument;->_footnotes:Lorg/apache/poi/hwpf/usermodel/Notes;

    .line 70
    new-instance v0, Lorg/apache/poi/hwpf/model/FieldsTables;

    iget-object v1, v6, Lorg/apache/poi/hwpf/HWPFDocument;->_tableStream:[B

    iget-object v2, v6, Lorg/apache/poi/hwpf/HWPFDocumentCore;->_fib:Lorg/apache/poi/hwpf/model/FileInformationBlock;

    invoke-direct {v0, v1, v2}, Lorg/apache/poi/hwpf/model/FieldsTables;-><init>([BLorg/apache/poi/hwpf/model/FileInformationBlock;)V

    iput-object v0, v6, Lorg/apache/poi/hwpf/HWPFDocument;->_fieldsTables:Lorg/apache/poi/hwpf/model/FieldsTables;

    .line 71
    new-instance v1, Lorg/apache/poi/hwpf/usermodel/FieldsImpl;

    invoke-direct {v1, v0}, Lorg/apache/poi/hwpf/usermodel/FieldsImpl;-><init>(Lorg/apache/poi/hwpf/model/FieldsTables;)V

    iput-object v1, v6, Lorg/apache/poi/hwpf/HWPFDocument;->_fields:Lorg/apache/poi/hwpf/usermodel/Fields;
    ...
    const-string v1, "Table Stream \'"

    const-string v3, "\' wasn\'t found - Either the document is corrupt, or is Word95 (or earlier)"

    .line 73
    invoke-static {v1, v2, v3}, LA/S;->h(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 75
    :cond_7
    new-instance v0, Lorg/apache/poi/hwpf/OldWordFileFormatException;

    const-string v1, "The document is too old - Word 95 or older. Try HWPFOldDocument instead?"

    invoke-direct {v0, v1}, Lorg/apache/poi/hwpf/OldWordFileFormatException;-><init>(Ljava/lang/String;)V
