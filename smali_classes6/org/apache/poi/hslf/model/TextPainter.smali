...
.method public getTextElements(FLjava/awt/font/FontRenderContext;)[Lorg/apache/poi/hslf/model/TextPainter$TextElement;
    ...
    invoke-static {v5, v1, v2}, LA3/h2;->i(ILjava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    :goto_5
    invoke-virtual {v8, v2, v6, v13}, Ljava/awt/font/LineBreakMeasurer;->nextLayout(FIZ)Ljava/awt/font/TextLayout;
    ...
    invoke-virtual {v1, v9, v11}, Ljava/text/AttributedString;->addAttribute(Ljava/text/AttributedCharacterIterator$Attribute;Ljava/lang/Object;)V
    ...
    invoke-direct {v9, v2, v11, v10}, Ljava/awt/Font;-><init>(Ljava/lang/String;II)V

    invoke-virtual {v12}, Lorg/apache/poi/hslf/usermodel/RichTextRun;->getBulletChar()C

    move-result v2

    invoke-virtual {v9, v2}, Ljava/awt/Font;->canDisplay(C)Z
