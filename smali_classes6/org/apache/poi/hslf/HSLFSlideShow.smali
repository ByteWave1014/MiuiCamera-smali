...
.method private readPictures()V
    ...
    invoke-virtual {v3, v7, v4}, Lorg/apache/poi/util/POILogger;->log(ILjava/lang/Object;)V

    iget-object v3, p0, Lorg/apache/poi/hslf/HSLFSlideShow;->logger:Lorg/apache/poi/util/POILogger;

    const-string v4, ""

    invoke-static {v4, v6, v3, v7}, LB3/d;->e(Ljava/lang/String;ILorg/apache/poi/util/POILogger;I)V
    ...
    :try_start_1
    invoke-static {v4}, Lorg/apache/poi/hslf/usermodel/PictureData;->create(I)Lorg/apache/poi/hslf/usermodel/PictureData;

    move-result-object v4

    new-array v8, v5, [B

    invoke-static {v2, v6, v8, v0, v5}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V

    invoke-virtual {v4, v8}, Lorg/apache/poi/hslf/usermodel/PictureData;->setRawData([B)V

    invoke-virtual {v4, v3}, Lorg/apache/poi/hslf/usermodel/PictureData;->setOffset(I)V
    ...
    iget-object v4, p0, Lorg/apache/poi/hslf/HSLFSlideShow;->logger:Lorg/apache/poi/util/POILogger;
...
.method public addPicture(Lorg/apache/poi/hslf/usermodel/PictureData;)I
    ...
    invoke-static {v1, v0}, LE5/a;->e(ILjava/util/List;)Ljava/lang/Object;
...
.method public write(Ljava/io/OutputStream;Z)V
    ...
    .line 41
    invoke-static {v3, p1}, LA/P;->c(ILjava/lang/String;)Ljava/lang/String;
