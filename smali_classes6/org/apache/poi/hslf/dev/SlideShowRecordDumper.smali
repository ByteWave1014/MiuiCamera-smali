...
.method public static printUsage()V
    ...
    const-string v3, "-escher\t\t: dump contents of escher records"

    const-string v4, "-verbose\t: dump binary contents of each record"

    invoke-static {v0, v1, v2, v3, v4}, LA/P;->j(Ljava/io/PrintStream;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
.method public walkTree(II[Lorg/apache/poi/hslf/record/Record;)V
    ...
    invoke-static {v3, v6}, LA/H2;->d(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v8, v13, v9, v14, v10}, LJ/b;->h(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-boolean v8, v0, Lorg/apache/poi/hslf/dev/SlideShowRecordDumper;->optEscher:Z

    if-eqz v8, :cond_4

    const-string v8, "PPDrawing"
    ...
    invoke-virtual {v7, v9}, Lorg/apache/poi/hslf/record/Record;->writeOut(Ljava/io/OutputStream;)V
    ...
    invoke-virtual {v8, v9, v10}, Lorg/apache/poi/ddf/DefaultEscherRecordFactory;->createRecord([BI)Lorg/apache/poi/ddf/EscherRecord;

    move-result-object v11

    invoke-virtual {v11, v9, v10, v8}, Lorg/apache/poi/ddf/EscherRecord;->fillFields([BILorg/apache/poi/ddf/EscherRecordFactory;)I

    invoke-virtual {v0, v11}, Lorg/apache/poi/hslf/dev/SlideShowRecordDumper;->printEscherRecord(Lorg/apache/poi/ddf/EscherRecord;)Ljava/lang/String;
    ...
    iget-boolean v8, v0, Lorg/apache/poi/hslf/dev/SlideShowRecordDumper;->optVerbose:Z
