...
.method private init()V
    ...
    const-string v6, "Warning - invalid username length "

    const-string v7, " found, treating as if there was no username set"

    invoke-static {v0, v1, v6, v7}, LE5/a;->f(JLjava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public writeOut(Ljava/io/OutputStream;)V
    ...
    iget-wide v3, p0, Lorg/apache/poi/hslf/record/CurrentUserAtom;->currentEditOffset:J

    long-to-int v3, v3

    const/16 v4, 0x10

    invoke-static {v0, v4, v3}, Lorg/apache/poi/util/LittleEndian;->putInt([BII)V
    ...
    invoke-static {v4, v3, v2}, Lorg/apache/poi/util/StringUtil;->putCompressedUnicode(Ljava/lang/String;[BI)V
    ...
    iget v5, p0, Lorg/apache/poi/hslf/record/CurrentUserAtom;->docFinalVersion:I
    ...
    iget-byte v5, p0, Lorg/apache/poi/hslf/record/CurrentUserAtom;->docMajorNo:B

    aput-byte v5, v4, v1

    const/16 v1, 0x19

    iget-byte v5, p0, Lorg/apache/poi/hslf/record/CurrentUserAtom;->docMinorNo:B
    ...
    iget-object v1, p0, Lorg/apache/poi/hslf/record/CurrentUserAtom;->_contents:[B

    add-int/lit8 v3, v0, 0x1c

    iget-wide v4, p0, Lorg/apache/poi/hslf/record/CurrentUserAtom;->releaseVersion:J
    ...
    invoke-static {v4, v3, v2}, Lorg/apache/poi/util/StringUtil;->putUnicodeLE(Ljava/lang/String;[BI)V
