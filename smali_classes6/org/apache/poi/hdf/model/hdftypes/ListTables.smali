...
.method private createLVL([BILorg/apache/poi/hdf/model/hdftypes/LVL;)I
    ...
    invoke-static {p1, v1, v3, v2, p0}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V
    ...
    iput-object v1, p3, Lorg/apache/poi/hdf/model/hdftypes/LVL;->_xst:[C

    :goto_0
    if-ge v2, p0, :cond_1

    iget-object v1, p3, Lorg/apache/poi/hdf/model/hdftypes/LVL;->_xst:[C
...
.method private initLFO([B)V
    ...
    invoke-static {v4, v7, v2, v5}, LA/y3;->b(IIII)I
...
.method private initLST([B)V
    ...
    invoke-static {v1, v7, v8, v3}, LA/y3;->b(IIII)I
