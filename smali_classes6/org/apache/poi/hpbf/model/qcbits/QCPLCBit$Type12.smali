...
.method private constructor <init>(Ljava/lang/String;Ljava/lang/String;[B)V
    ...
    .line 11
    invoke-static {p1, v1, v0, v3}, LA/c0;->a(IIII)I
    ...
    .line 14
    :goto_3
    iget-object v3, p0, Lorg/apache/poi/hpbf/model/qcbits/QCPLCBit;->plcValA:[J
    ...
    .line 18
    invoke-static {p3, v2}, Lorg/apache/poi/util/LittleEndian;->getUShort([BI)I
    ...
    .line 20
    :cond_5
    iget-object v3, p0, Lorg/apache/poi/hpbf/model/qcbits/QCPLCBit$Type12;->hyperlinks:[Ljava/lang/String;

    invoke-static {p3, v2, p1}, Lorg/apache/poi/util/StringUtil;->getFromUnicodeLE([BII)Ljava/lang/String;
    ...
    .line 21
    invoke-static {p1, v2, v1, v0}, LA/y3;->b(IIII)I
