...
.method static constructor <clinit>()V
    ...
    invoke-direct {v3, v2, v1}, Lorg/apache/xmlbeans/impl/schema/StscSimpleTypeResolver$CodeForNameEntry;-><init>(Ljavax/xml/namespace/QName;I)V
    ...
    invoke-direct {v1, v2, v0}, Lorg/apache/xmlbeans/impl/schema/StscSimpleTypeResolver$CodeForNameEntry;-><init>(Ljavax/xml/namespace/QName;I)V

    new-instance v5, Lorg/apache/xmlbeans/impl/schema/StscSimpleTypeResolver$CodeForNameEntry;

    const-string v0, "maxLength"

    invoke-static {v0, v4}, Lorg/apache/xmlbeans/impl/common/QNameHelper;->forLNS(Ljava/lang/String;Ljava/lang/String;)Ljavax/xml/namespace/QName;

    move-result-object v0

    const/4 v2, 0x2

    invoke-direct {v5, v0, v2}, Lorg/apache/xmlbeans/impl/schema/StscSimpleTypeResolver$CodeForNameEntry;-><init>(Ljavax/xml/namespace/QName;I)V
    ...
    invoke-direct {v6, v0, v2}, Lorg/apache/xmlbeans/impl/schema/StscSimpleTypeResolver$CodeForNameEntry;-><init>(Ljavax/xml/namespace/QName;I)V
    ...
    invoke-direct {v7, v0, v2}, Lorg/apache/xmlbeans/impl/schema/StscSimpleTypeResolver$CodeForNameEntry;-><init>(Ljavax/xml/namespace/QName;I)V
    ...
    invoke-direct {v8, v0, v2}, Lorg/apache/xmlbeans/impl/schema/StscSimpleTypeResolver$CodeForNameEntry;-><init>(Ljavax/xml/namespace/QName;I)V
    ...
    invoke-direct {v9, v0, v2}, Lorg/apache/xmlbeans/impl/schema/StscSimpleTypeResolver$CodeForNameEntry;-><init>(Ljavax/xml/namespace/QName;I)V

    new-instance v10, Lorg/apache/xmlbeans/impl/schema/StscSimpleTypeResolver$CodeForNameEntry;
    ...
    invoke-direct {v10, v0, v2}, Lorg/apache/xmlbeans/impl/schema/StscSimpleTypeResolver$CodeForNameEntry;-><init>(Ljavax/xml/namespace/QName;I)V
    ...
    invoke-direct {v11, v0, v2}, Lorg/apache/xmlbeans/impl/schema/StscSimpleTypeResolver$CodeForNameEntry;-><init>(Ljavax/xml/namespace/QName;I)V
    ...
    invoke-direct {v12, v0, v2}, Lorg/apache/xmlbeans/impl/schema/StscSimpleTypeResolver$CodeForNameEntry;-><init>(Ljavax/xml/namespace/QName;I)V

    new-instance v13, Lorg/apache/xmlbeans/impl/schema/StscSimpleTypeResolver$CodeForNameEntry;

    const-string/jumbo v0, "totalDigits"
    ...
    invoke-direct {v13, v0, v2}, Lorg/apache/xmlbeans/impl/schema/StscSimpleTypeResolver$CodeForNameEntry;-><init>(Ljavax/xml/namespace/QName;I)V

    new-instance v14, Lorg/apache/xmlbeans/impl/schema/StscSimpleTypeResolver$CodeForNameEntry;
    ...
    invoke-direct {v14, v0, v2}, Lorg/apache/xmlbeans/impl/schema/StscSimpleTypeResolver$CodeForNameEntry;-><init>(Ljavax/xml/namespace/QName;I)V

    move-object v4, v1

    filled-new-array/range {v3 .. v14}, [Lorg/apache/xmlbeans/impl/schema/StscSimpleTypeResolver$CodeForNameEntry;

    move-result-object v0

    sput-object v0, Lorg/apache/xmlbeans/impl/schema/StscSimpleTypeResolver;->facetCodes:[Lorg/apache/xmlbeans/impl/schema/StscSimpleTypeResolver$CodeForNameEntry;
...
.method public static resolveFacets(Lorg/apache/xmlbeans/impl/schema/SchemaTypeImpl;Lorg/apache/xmlbeans/XmlObject;Lorg/apache/xmlbeans/impl/schema/SchemaTypeImpl;)V
    ...
    check-cast v8, Lorg/apache/xmlbeans/impl/xb/xsdschema/Facet;
    ...
    const-string v14, "cos-applicable-facets"

    invoke-virtual {v3, v14, v0, v8}, Lorg/apache/xmlbeans/impl/schema/StscState;->error(Ljava/lang/String;[Ljava/lang/Object;Lorg/apache/xmlbeans/XmlObject;)V
    ...
    const-string/jumbo v0, "src-single-facet-value"

    invoke-virtual {v3, v0, v9, v8}, Lorg/apache/xmlbeans/impl/schema/StscState;->error(Ljava/lang/String;[Ljava/lang/Object;Lorg/apache/xmlbeans/XmlObject;)V
    ...
    :pswitch_0
    :try_start_0
    invoke-interface {v8}, Lorg/apache/xmlbeans/impl/xb/xsdschema/Facet;->getValue()Lorg/apache/xmlbeans/XmlAnySimpleType;
    ...
    const-string v7, "enumeration-valid-restriction"

    invoke-virtual {v3, v7, v0, v8}, Lorg/apache/xmlbeans/impl/schema/StscState;->error(Ljava/lang/String;[Ljava/lang/Object;Lorg/apache/xmlbeans/XmlObject;)V
    ...
    invoke-direct {v0, v7, v9}, Lorg/apache/xmlbeans/impl/regex/RegularExpression;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_1
    ...
    invoke-virtual {v3, v0, v7, v8}, Lorg/apache/xmlbeans/impl/schema/StscState;->error(Ljava/lang/String;[Ljava/lang/Object;Lorg/apache/xmlbeans/XmlObject;)V
    ...
    invoke-virtual {v3, v9, v11, v8}, Lorg/apache/xmlbeans/impl/schema/StscState;->error(Ljava/lang/String;ILorg/apache/xmlbeans/XmlObject;)V
    ...
    invoke-virtual {v3, v7, v9, v8}, Lorg/apache/xmlbeans/impl/schema/StscState;->error(Ljava/lang/String;[Ljava/lang/Object;Lorg/apache/xmlbeans/XmlObject;)V
    ...
    invoke-virtual {v3, v0, v11, v8}, Lorg/apache/xmlbeans/impl/schema/StscState;->error(Ljava/lang/String;ILorg/apache/xmlbeans/XmlObject;)V
    ...
    const-string/jumbo v7, "totalDigits-valid-restriction"
    ...
    invoke-virtual {v3, v0, v7, v8}, Lorg/apache/xmlbeans/impl/schema/StscState;->error(Ljava/lang/String;ILorg/apache/xmlbeans/XmlObject;)V
    ...
    invoke-interface {v9, v7}, Lorg/apache/xmlbeans/XmlObject;->compareValue(Lorg/apache/xmlbeans/XmlObject;)I
    ...
    const-string v7, "maxExclusive-valid-restriction"
    ...
    const-string v7, "maxInclusive-valid-restriction"
    ...
    const-string v7, "minInclusive-valid-restriction"
    ...
    const-string v7, "minExclusive-valid-restriction"
    ...
    invoke-virtual {v3, v9, v4, v8}, Lorg/apache/xmlbeans/impl/schema/StscState;->error(Ljava/lang/String;ILorg/apache/xmlbeans/XmlObject;)V
    ...
    invoke-interface {v7, v9}, Lorg/apache/xmlbeans/XmlObject;->compareTo(Ljava/lang/Object;)I
    ...
    invoke-virtual {v2, v4}, Lorg/apache/xmlbeans/impl/schema/SchemaTypeImpl;->getFacet(I)Lorg/apache/xmlbeans/XmlAnySimpleType;
    ...
    invoke-interface {v7, v9}, Lorg/apache/xmlbeans/XmlObject;->valueEquals(Lorg/apache/xmlbeans/XmlObject;)Z

    move-result v4

    if-eqz v4, :cond_27

    invoke-interface {v7, v11}, Lorg/apache/xmlbeans/XmlObject;->compareValue(Lorg/apache/xmlbeans/XmlObject;)I
    ...
    :goto_14
    invoke-virtual {v3, v0, v4, v8}, Lorg/apache/xmlbeans/impl/schema/StscState;->error(Ljava/lang/String;[Ljava/lang/Object;Lorg/apache/xmlbeans/XmlObject;)V
    ...
    :goto_1a
    invoke-interface {v8}, Lorg/apache/xmlbeans/impl/xb/xsdschema/Facet;->getFixed()Z
    ...
    :cond_2e
    invoke-virtual {v1, v11}, Lorg/apache/xmlbeans/impl/schema/SchemaTypeImpl;->setWhiteSpaceRule(I)V
...
.method public static resolveListType(Lorg/apache/xmlbeans/impl/schema/SchemaTypeImpl;Lorg/apache/xmlbeans/impl/xb/xsdschema/ListDocument$List;Ljava/util/List;)V
    ...
    const-string/jumbo v1, "src-redefine.5a"

    invoke-virtual {v9, v1, v0, v8}, Lorg/apache/xmlbeans/impl/schema/StscState;->error(Ljava/lang/String;[Ljava/lang/Object;Lorg/apache/xmlbeans/XmlObject;)V
    ...
    const-string/jumbo v1, "src-simple-type.3a"

    invoke-virtual {v9, v1, v13, v8}, Lorg/apache/xmlbeans/impl/schema/StscState;->error(Ljava/lang/String;[Ljava/lang/Object;Lorg/apache/xmlbeans/XmlObject;)V
    ...
    const-string/jumbo v0, "st-props-correct.4.2.1"
    ...
    :cond_b
    const-string/jumbo v0, "src-simple-type.3b"
...
.method public static resolveSimpleRestrictionType(Lorg/apache/xmlbeans/impl/schema/SchemaTypeImpl;Lorg/apache/xmlbeans/impl/xb/xsdschema/RestrictionDocument$Restriction;Ljava/util/List;)V
    ...
    const-string/jumbo v1, "src-simple-type.2a"
    ...
    invoke-virtual {v4, v6}, Ljavax/xml/namespace/QName;->equals(Ljava/lang/Object;)Z
    ...
    const-string/jumbo v5, "src-redefine.5b"
    ...
    invoke-virtual {v2, v0, v1, p2, v11}, Lorg/apache/xmlbeans/impl/schema/StscState;->notFoundError(Ljavax/xml/namespace/QName;ILorg/apache/xmlbeans/XmlObject;Z)V
    ...
    const-string/jumbo v6, "src-redefine.5a"

    filled-new-array {v5}, [Ljava/lang/Object;

    move-result-object v5

    invoke-virtual {v0, v6, v5, v4}, Lorg/apache/xmlbeans/impl/schema/StscState;->error(Ljava/lang/String;[Ljava/lang/Object;Lorg/apache/xmlbeans/XmlObject;)V
    ...
    :cond_6
    const-string/jumbo p2, "src-simple-type.2b"
...
.method public static resolveUnionType(Lorg/apache/xmlbeans/impl/schema/SchemaTypeImpl;Lorg/apache/xmlbeans/impl/xb/xsdschema/UnionDocument$Union;Ljava/util/List;)V
    ...
    :cond_1
    const-string/jumbo v1, "src-union-memberTypes-or-simpleTypes"

    invoke-virtual {v11, v1, v14, v8}, Lorg/apache/xmlbeans/impl/schema/StscState;->error(Ljava/lang/String;[Ljava/lang/Object;Lorg/apache/xmlbeans/XmlObject;)V
    ...
    invoke-virtual {v11, v1, v15, v2, v10}, Lorg/apache/xmlbeans/impl/schema/StscState;->notFoundError(Ljavax/xml/namespace/QName;ILorg/apache/xmlbeans/XmlObject;Z)V
    ...
    :goto_4
    const-string/jumbo v2, "src-simple-type.4"

    filled-new-array {v3}, [Ljava/lang/Object;

    move-result-object v3

    invoke-virtual {v11, v2, v3, v1}, Lorg/apache/xmlbeans/impl/schema/StscState;->error(Ljava/lang/String;[Ljava/lang/Object;Lorg/apache/xmlbeans/XmlObject;)V
    ...
    invoke-virtual {v11, v6, v4, v5}, Lorg/apache/xmlbeans/impl/schema/StscState;->error(Ljava/lang/String;[Ljava/lang/Object;Lorg/apache/xmlbeans/XmlObject;)V
    ...
    const-string/jumbo v0, "st-props-correct.4.2.2"

    invoke-virtual {v11, v0, v14, v8}, Lorg/apache/xmlbeans/impl/schema/StscState;->error(Ljava/lang/String;[Ljava/lang/Object;Lorg/apache/xmlbeans/XmlObject;)V
    ...
    invoke-static {v13}, Lorg/apache/xmlbeans/impl/schema/StscSimpleTypeResolver;->makeRefArray(Ljava/util/Collection;)[Lorg/apache/xmlbeans/SchemaType$Ref;
...
.method public static translateWhitespaceCode(Lorg/apache/xmlbeans/XmlAnySimpleType;)I
    ...
    invoke-static {v2, v0, v3}, LB3/d;->g(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
