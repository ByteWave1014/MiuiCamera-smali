...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lmiuix/flexible/template/StandardButtonTemplate;->NORMAL_PARAMS:Landroid/util/SparseArray;

    sget v1, Lai/a;->area_head:I
    ...
    invoke-virtual {v6, v5, v5, v4}, Lmiuix/flexible/view/HyperCellLayout$a;->a(III)V

    invoke-virtual {v0, v1, v6}, Landroid/util/SparseArray;->put(ILjava/lang/Object;)V

    sget v6, Lai/a;->view_auxiliary:I
    ...
    invoke-virtual {v11, v5, v5, v5}, Lmiuix/flexible/view/HyperCellLayout$a;->a(III)V

    invoke-virtual {v0, v9, v11}, Landroid/util/SparseArray;->put(ILjava/lang/Object;)V

    sget v11, Lai/a;->area_title_comment:I
    ...
    invoke-virtual {v12, v13, v5, v5}, Lmiuix/flexible/view/HyperCellLayout$a;->a(III)V

    iput v2, v12, Lmiuix/flexible/view/HyperCellLayout$a;->f:I

    invoke-virtual {v0, v11, v12}, Landroid/util/SparseArray;->put(ILjava/lang/Object;)V

    sget v12, Lai/a;->area_content:I
    ...
    invoke-virtual {v14, v5, v15, v5}, Lmiuix/flexible/view/HyperCellLayout$a;->a(III)V

    invoke-virtual {v0, v12, v14}, Landroid/util/SparseArray;->put(ILjava/lang/Object;)V

    sget v14, Lai/a;->area_text_button:I
    ...
    invoke-virtual {v7, v15, v5, v5}, Lmiuix/flexible/view/HyperCellLayout$a;->a(III)V

    invoke-virtual {v0, v14, v7}, Landroid/util/SparseArray;->put(ILjava/lang/Object;)V

    sget v7, Lai/a;->area_end:I
    ...
    invoke-virtual {v8, v15, v5, v5}, Lmiuix/flexible/view/HyperCellLayout$a;->a(III)V

    invoke-static {v0, v7, v8}, LA/Q;->b(Landroid/util/SparseArray;ILmiuix/flexible/view/HyperCellLayout$a;)Landroid/util/SparseArray;

    move-result-object v0

    sput-object v0, Lmiuix/flexible/template/StandardButtonTemplate;->LARGE_PARAMS:Landroid/util/SparseArray;

    invoke-static {v2, v3, v3, v5, v5}, Lmiuix/flexible/template/AbstractMarkTemplate;->generateLayoutParams(IFFII)Lmiuix/flexible/view/HyperCellLayout$a;
    ...
    invoke-static {v1, v3, v6, v4, v1}, Lmiuix/flexible/template/AbstractMarkTemplate;->generateLayoutParams(IFFII)Lmiuix/flexible/view/HyperCellLayout$a;

    move-result-object v4

    invoke-virtual {v4, v5, v5, v5}, Lmiuix/flexible/view/HyperCellLayout$a;->a(III)V

    invoke-virtual {v0, v9, v4}, Landroid/util/SparseArray;->put(ILjava/lang/Object;)V

    const/4 v4, 0x3

    invoke-static {v1, v3, v3, v5, v4}, Lmiuix/flexible/template/AbstractMarkTemplate;->generateLayoutParams(IFFII)Lmiuix/flexible/view/HyperCellLayout$a;

    move-result-object v4

    const/4 v6, 0x4

    invoke-virtual {v4, v5, v6, v5}, Lmiuix/flexible/view/HyperCellLayout$a;->a(III)V

    iput v2, v4, Lmiuix/flexible/view/HyperCellLayout$a;->f:I

    invoke-virtual {v0, v11, v4}, Landroid/util/SparseArray;->put(ILjava/lang/Object;)V

    invoke-static {v1, v3, v3, v5, v6}, Lmiuix/flexible/template/AbstractMarkTemplate;->generateLayoutParams(IFFII)Lmiuix/flexible/view/HyperCellLayout$a;

    move-result-object v4

    invoke-virtual {v4, v5, v15, v5}, Lmiuix/flexible/view/HyperCellLayout$a;->a(III)V
    ...
    invoke-virtual {v1, v5, v15, v5}, Lmiuix/flexible/view/HyperCellLayout$a;->a(III)V
    ...
    invoke-virtual {v1, v15, v5, v5}, Lmiuix/flexible/view/HyperCellLayout$a;->a(III)V
...
.method public onAddAuxiliaryViews(Landroid/view/ViewGroup;)V
    ...
    sget v0, Lai/a;->view_auxiliary:I
