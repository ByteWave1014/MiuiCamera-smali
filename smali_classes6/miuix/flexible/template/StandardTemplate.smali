...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lmiuix/flexible/template/StandardTemplate;->NORMAL_PARAMS:Landroid/util/SparseArray;
    ...
    invoke-virtual {v4, v15, v5, v5}, Lmiuix/flexible/view/HyperCellLayout$a;->a(III)V

    invoke-static {v0, v14, v4}, LA/Q;->b(Landroid/util/SparseArray;ILmiuix/flexible/view/HyperCellLayout$a;)Landroid/util/SparseArray;

    move-result-object v0

    sput-object v0, Lmiuix/flexible/template/StandardTemplate;->LARGE_PARAMS:Landroid/util/SparseArray;

    const/16 v4, 0x10

    invoke-static {v7, v3, v8, v4, v5}, Lmiuix/flexible/template/AbstractMarkTemplate;->generateLayoutParams(IFFII)Lmiuix/flexible/view/HyperCellLayout$a;
    ...
    invoke-virtual {v8, v5, v5, v4}, Lmiuix/flexible/view/HyperCellLayout$a;->a(III)V
    ...
    invoke-virtual {v1, v5, v5, v5}, Lmiuix/flexible/view/HyperCellLayout$a;->a(III)V

    invoke-virtual {v0, v9, v1}, Landroid/util/SparseArray;->put(ILjava/lang/Object;)V

    invoke-static {v7, v3, v3, v5, v6}, Lmiuix/flexible/template/AbstractMarkTemplate;->generateLayoutParams(IFFII)Lmiuix/flexible/view/HyperCellLayout$a;

    move-result-object v1

    const/4 v4, 0x4

    invoke-virtual {v1, v5, v4, v5}, Lmiuix/flexible/view/HyperCellLayout$a;->a(III)V
