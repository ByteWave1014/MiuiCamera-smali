...
# static fields
.field public static final g:LSh/c$a;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, LSh/c;->g:LSh/c$a;
...
.method public static d(LSh/c;Landroid/view/View;)Landroid/graphics/Rect;
    .locals 1
...
.method public static f(LSh/c;Landroid/view/View;ILmiuix/appcompat/app/AlertDialog$d;LSh/c$b;)V
    .locals 4
    ...
    new-instance v2, LSh/c$g;

    invoke-direct {v2, p0, p3, p4, p1}, LSh/c$g;-><init>(LSh/c;Lmiuix/appcompat/app/AlertDialog$d;LSh/c$b;Landroid/view/View;)V
    ...
    iget-object p1, p0, LSh/c;->b:Lmiuix/animation/IFolme;
    ...
    iput-object p1, p0, LSh/c;->b:Lmiuix/animation/IFolme;

    :cond_0
    iget-object p0, p0, LSh/c;->b:Lmiuix/animation/IFolme;
    ...
    sget-object p2, LSh/c;->g:LSh/c$a;
...
.method public final a(Landroid/view/View;Landroid/view/View;Lmiuix/appcompat/app/h;)V
    ...
    iput-object v5, v4, LSh/c$f;->a:Ljava/lang/ref/WeakReference;

    new-instance p3, Ljava/lang/ref/WeakReference;

    invoke-direct {p3, p1}, Ljava/lang/ref/WeakReference;-><init>(Ljava/lang/Object;)V

    iput-object p3, v4, LSh/c$f;->b:Ljava/lang/ref/WeakReference;
    ...
    new-instance p3, LSh/c$h;

    invoke-direct {p3, p0, p1}, LSh/c$h;-><init>(LSh/c;Landroid/view/View;)V
    ...
    iget-object p3, p0, LSh/c;->b:Lmiuix/animation/IFolme;
    ...
    iput-object p3, p0, LSh/c;->b:Lmiuix/animation/IFolme;
    ...
    sget-object v1, LSh/c;->g:LSh/c$a;
    ...
    invoke-static {p1}, Landroidx/core/view/r;->d(Landroid/view/View;)Landroid/view/WindowInsetsController;
    ...
    invoke-direct {v1, p0, p1, v3, v2}, LSh/f;-><init>(LSh/c;Landroid/view/View;ILmiuix/animation/base/AnimConfig;)V

    invoke-static {p3, v0, v1}, LA/a;->d(Landroid/view/WindowInsetsController;ILSh/f;)V
    ...
    :cond_3
    :goto_0
    invoke-static {p2}, LA/i4;->d(Landroid/view/View;)V
...
.method public final c(Landroid/view/View;Landroid/view/View;ZLmiuix/appcompat/app/AlertDialog$d;)V
    ...
    invoke-direct {v1, p0, p1, p2, v0}, LSh/c$b;-><init>(LSh/c;Landroid/view/View;Landroid/view/View;I)V
    ...
    invoke-direct/range {v3 .. v8}, LSh/c$c;-><init>(LSh/c;Landroid/view/View;ZLmiuix/appcompat/app/AlertDialog$d;LSh/c$b;)V
    ...
    :cond_3
    new-instance v0, LSh/c$d;

    invoke-direct {v0, p0, p3, p4, v8}, LSh/c$d;-><init>(LSh/c;ZLmiuix/appcompat/app/AlertDialog$d;LSh/c$b;)V

    invoke-virtual {p1, v0}, Landroid/view/View;->addOnLayoutChangeListener(Landroid/view/View$OnLayoutChangeListener;)V

    :goto_2
    invoke-static {p2}, LA/i4;->r(Landroid/view/View;)V
