...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "(Lokio/FileSystem;Lokio/Path;Z)LPg/h;",
        "LPg/j;",
        "fileSystem",
        "Llf/h;",
        "stack",
        "postorder",
        "collectRecursively",
        "(LPg/j;Lokio/FileSystem;Llf/h;Lokio/Path;ZZLof/e;)Ljava/lang/Object;",
        "symlinkTarget",
...
# direct methods
.method public static final collectRecursively(LPg/j;Lokio/FileSystem;Llf/h;Lokio/Path;ZZLof/e;)Ljava/lang/Object;
    .locals 16
    ...
    invoke-direct {v5, v3}, Lokio/internal/-FileSystem$collectRecursively$1;-><init>(Lof/e;)V
    ...
    invoke-static {v3}, Lkf/l;->b(Ljava/lang/Object;)V
    ...
    invoke-virtual {v0, v1, v5}, LPg/j;->b(Ljava/lang/Object;Lqf/a;)V
    ...
    invoke-virtual {v7, v13}, Llf/h;->contains(Ljava/lang/Object;)Z
    ...
    invoke-static {v1, v2}, LA/H2;->f(Lokio/Path;Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_9
    invoke-virtual {v7, v13}, Llf/h;->addLast(Ljava/lang/Object;)V
    ...
    invoke-static/range {p0 .. p6}, Lokio/internal/-FileSystem;->collectRecursively(LPg/j;Lokio/FileSystem;Llf/h;Lokio/Path;ZZLof/e;)Ljava/lang/Object;
    ...
    :cond_b
    invoke-virtual {v7}, Llf/h;->removeLast()Ljava/lang/Object;
    ...
    invoke-virtual {v11, v1, v5}, LPg/j;->b(Ljava/lang/Object;Lqf/a;)V
...
.method public static final commonCopy(Lokio/FileSystem;Lokio/Path;Lokio/Path;)V
    ...
    :try_start_4
    invoke-static {p2, p0}, LK3/a;->c(Ljava/lang/Throwable;Ljava/lang/Throwable;)V
    ...
    invoke-static {p0, p1}, LK3/a;->c(Ljava/lang/Throwable;Ljava/lang/Throwable;)V
...
.method public static final commonCreateDirectories(Lokio/FileSystem;Lokio/Path;Z)V
    ...
    invoke-virtual {v0, v1}, Llf/h;->addFirst(Ljava/lang/Object;)V
...
.method public static final commonDeleteRecursively(Lokio/FileSystem;Lokio/Path;Z)V
    ...
    invoke-direct {v0, p0, p1, v1}, Lokio/internal/-FileSystem$commonDeleteRecursively$sequence$1;-><init>(Lokio/FileSystem;Lokio/Path;Lof/e;)V

    new-instance p1, LPg/i;

    invoke-direct {p1}, LPg/j;-><init>()V

    invoke-static {p1, p1, v0}, LF2/a;->h(Lof/e;Lof/e;Lzf/p;)Lof/e;

    move-result-object v0

    iput-object v0, p1, LPg/i;->d:Lof/e;

    :goto_0
    invoke-virtual {p1}, LPg/i;->hasNext()Z

    move-result v0

    if-eqz v0, :cond_1

    invoke-virtual {p1}, LPg/i;->next()Ljava/lang/Object;
...
.method public static final commonListRecursively(Lokio/FileSystem;Lokio/Path;Z)LPg/h;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p1, p0, p2, v1}, Lokio/internal/-FileSystem$commonListRecursively$1;-><init>(Lokio/Path;Lokio/FileSystem;ZLof/e;)V
...
.method public static final commonMetadata(Lokio/FileSystem;Lokio/Path;)Lokio/FileMetadata;
    ...
    invoke-static {p1, v0}, LA/H2;->f(Lokio/Path;Ljava/lang/String;)Ljava/lang/String;
