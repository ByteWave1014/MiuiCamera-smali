...
.method public static a(Ljava/lang/Class;)Ltg/f;
    ...
    invoke-virtual {p0}, Lwg/c;->e()LMf/k;
...
.method public static b(Lhg/r$c;Ljava/lang/annotation/Annotation;)V
    .locals 3

    invoke-static {p1}, Lnc/f;->j(Ljava/lang/annotation/Annotation;)LGf/d;

    move-result-object v0

    invoke-static {v0}, Lnc/f;->l(LGf/d;)Ljava/lang/Class;
    ...
    invoke-interface {p0, v1, v2}, Lhg/r$c;->b(Log/b;LUf/b;)Lhg/r$a;

    move-result-object p0

    if-eqz p0, :cond_0

    invoke-static {p0, p1, v0}, LUf/c;->c(Lhg/r$a;Ljava/lang/annotation/Annotation;Ljava/lang/Class;)V

    :cond_0
    return-void
.end method

.method public static c(Lhg/r$a;Ljava/lang/annotation/Annotation;Ljava/lang/Class;)V
    .locals 11
    ...
    invoke-interface {p0, v3, v4}, Lhg/r$a;->c(Log/f;Ltg/f;)V

    goto/16 :goto_7

    :cond_0
    sget-object v7, LUf/g;->a:Ljava/util/Set;
    ...
    invoke-interface {p0, v3, v4}, Lhg/r$a;->f(Log/f;Ljava/lang/Object;)V
    ...
    invoke-interface {p0, v3, v5, v4}, Lhg/r$a;->b(Log/f;Log/b;Log/f;)V
    ...
    invoke-static {v5}, Llf/k;->O([Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-interface {p0, v6, v3}, Lhg/r$a;->d(Log/b;Log/f;)Lhg/r$a;
    ...
    invoke-static {v3, v4, v5}, LUf/c;->c(Lhg/r$a;Ljava/lang/annotation/Annotation;Ljava/lang/Class;)V
    ...
    invoke-interface {p0, v3}, Lhg/r$a;->e(Log/f;)Lhg/r$b;
    ...
    invoke-interface {v3, v5, v8}, Lhg/r$b;->d(Log/b;Log/f;)V
    ...
    invoke-interface {v3, v7}, Lhg/r$b;->e(Ltg/f;)V
    ...
    invoke-interface {v3, v9}, Lhg/r$b;->b(Log/b;)Lhg/r$a;
    ...
    invoke-static {v9, v8, v5}, LUf/c;->c(Lhg/r$a;Ljava/lang/annotation/Annotation;Ljava/lang/Class;)V
    ...
    invoke-interface {v3, v7}, Lhg/r$b;->c(Ljava/lang/Object;)V
    ...
    :cond_b
    invoke-interface {v3}, Lhg/r$b;->a()V
    ...
    :cond_d
    invoke-interface {p0}, Lhg/r$a;->a()V
