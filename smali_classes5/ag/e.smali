...
# static fields
.field public static final e0:Lag/e$a;

.field public static final f0:Lag/e$b;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lag/e;->e0:Lag/e$a;

    new-instance v0, Lag/e$b;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lag/e;->f0:Lag/e$b;

    return-void
.end method

.method public constructor <init>(LPf/k;LPf/S;LQf/g;Log/f;LPf/b$a;LPf/T;Z)V
    .locals 2
    ...
    invoke-direct/range {p0 .. p6}, LSf/Q;-><init>(LPf/k;LPf/S;LQf/g;Log/f;LPf/b$a;LPf/T;)V

    iput v0, p0, Lag/e;->Z:I

    iput-boolean p7, p0, Lag/e;->d0:Z
...
.method public static S0(LPf/k;Lbg/e;Log/f;Leg/a;Z)Lag/e;
    .locals 9
    ...
    invoke-direct/range {v1 .. v8}, Lag/e;-><init>(LPf/k;LPf/S;LQf/g;Log/f;LPf/b$a;LPf/T;Z)V
...
.method public final E0(LPf/b$a;LPf/k;LPf/u;LPf/T;LQf/g;Log/f;)LSf/w;
    ...
    :cond_3
    :goto_2
    invoke-static {p0}, LA3/h2;->b(I)Z

    move-result p0

    invoke-virtual {v0, p1, p0}, Lag/e;->T0(ZZ)V
...
.method public final R0(LSf/P;LPf/P;Ljava/util/List;Ljava/util/List;Ljava/util/List;LFg/G;LPf/A;LPf/r;Ljava/util/Map;)LSf/Q;
    .locals 1
    ...
    invoke-super/range {p0 .. p9}, LSf/Q;->R0(LSf/P;LPf/P;Ljava/util/List;Ljava/util/List;Ljava/util/List;LFg/G;LPf/A;LPf/r;Ljava/util/Map;)LSf/Q;
    ...
    :cond_0
    iget-object p3, p2, LLg/k;->b:LQg/f;
    ...
    invoke-virtual {p3, p4}, LQg/f;->a(Ljava/lang/String;)Z
    ...
    invoke-interface {p6, p0}, LLg/f;->a(Lag/e;)Ljava/lang/String;
...
.method public final q(LFg/G;Ljava/util/ArrayList;LFg/G;Lkf/j;)Lag/a;
    ...
    invoke-static {p2, v0, p0}, LF2/a;->g(Ljava/util/List;Ljava/util/Collection;LPf/u;)Ljava/util/ArrayList;
    ...
    invoke-static {p0, p1, v1}, Lrg/h;->h(LPf/a;LFg/G;LQf/g;)LSf/P;
    ...
    iput-object p3, p0, LSf/w$a;->k:LFg/G;

    iput-object p1, p0, LSf/w$a;->i:LSf/P;
    ...
    iget-object p1, p4, Lkf/j;->a:Ljava/lang/Object;

    check-cast p1, LPf/a$a;

    iget-object p2, p4, Lkf/j;->b:Ljava/lang/Object;

    invoke-virtual {p0, p1, p2}, LSf/w;->J0(LPf/a$a;Ljava/lang/Object;)V
