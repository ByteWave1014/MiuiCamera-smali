...
.method private static dumpImage(Lcom/xiaomi/camera/mivi/qcom/bean/ResultImageData;Laa/o;Ljava/lang/String;)V
    .locals 2
    ...
    iget-object p1, p1, Laa/o;->W:Ljava/lang/String;
    ...
    invoke-static {p0, p1, p2}, LC9/e;->d(Landroid/media/Image;Ljava/lang/String;Ljava/lang/String;)Z

    :cond_0
    return-void
.end method

.method private getParallelTaskData(Lcom/xiaomi/camera/mivi/qcom/bean/ResultImageData;ZLjava/lang/String;)Laa/o;
    .locals 11
    ...
    invoke-static {v0, v1, v2, p2}, Lcom/xiaomi/camera/mivi/MIVICaptureManager;->getParallelTaskData(Ljava/lang/String;JZ)Laa/o;
    ...
    invoke-virtual {v0, v1, v3}, Lcom/xiaomi/camera/mivi/qcom/ParallelTaskDataConverter;->readParallelTaskDataFromSmallJpeg(Landroid/content/Context;Ljava/lang/String;)Laa/o;
    ...
    iput-object p0, v0, Laa/o;->h:Landroid/hardware/camera2/TotalCaptureResult;

    invoke-virtual {p1}, Lcom/xiaomi/camera/mivi/qcom/bean/ResultImageData;->getPictureName()Ljava/lang/String;

    move-result-object p0

    iput-object p0, v0, Laa/o;->W:Ljava/lang/String;

    invoke-virtual {p1}, Lcom/xiaomi/camera/mivi/qcom/bean/ResultImageData;->getFrameNumber()J

    move-result-wide v5

    iput-wide v5, v0, Laa/o;->b0:J

    new-instance p0, Laa/p;

    invoke-direct {p0}, Laa/p;-><init>()V

    new-instance p2, LG9/f;

    invoke-direct {p2}, LG9/f;-><init>()V

    iput-object p2, p0, Laa/p;->Q:LG9/f;

    invoke-virtual {p1}, Lcom/xiaomi/camera/mivi/qcom/bean/ResultImageData;->getOutputSize()Landroid/util/Size;

    move-result-object p1

    iput-object p1, p0, Laa/p;->M:Landroid/util/Size;

    iput-object p0, v0, Laa/o;->r:Laa/p;

    iput-boolean v1, v0, Laa/o;->m0:Z
...
.method private initReprocessProxy(Laa/o;ZLjava/lang/String;)V
    .locals 2
    ...
    iget-object p2, p1, Laa/o;->r:Laa/p;

    iget-boolean p2, p2, Laa/p;->a:Z
    ...
    invoke-static {p3, p0}, LA/H2;->d(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p3, p1}, LA/H2;->d(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method private lambda$startReprocessLoop$1()V
    ...
    invoke-static {v6, v7}, Lo0/b;->I(ILjava/lang/String;)V
    ...
    :goto_2
    invoke-direct {p0, v3, v5, v4}, Lcom/xiaomi/camera/mivi/qcom/ImageReceiverExecutor;->getParallelTaskData(Lcom/xiaomi/camera/mivi/qcom/bean/ResultImageData;ZLjava/lang/String;)Laa/o;
    ...
    iput v7, v5, Laa/o;->v0:I

    invoke-virtual {v3, v5}, Lcom/xiaomi/camera/mivi/qcom/bean/ResultImageData;->setParallelTaskData(Laa/o;)V
    ...
    sget-boolean v7, LC9/e;->d:Z

    if-eqz v7, :cond_8

    const-string v7, "algo_done"

    invoke-static {v3, v5, v7}, Lcom/xiaomi/camera/mivi/qcom/ImageReceiverExecutor;->dumpImage(Lcom/xiaomi/camera/mivi/qcom/bean/ResultImageData;Laa/o;Ljava/lang/String;)V
    ...
    invoke-direct {p0, v5, v6, v4}, Lcom/xiaomi/camera/mivi/qcom/ImageReceiverExecutor;->initReprocessProxy(Laa/o;ZLjava/lang/String;)V
