...
.method public static synthetic a(Ljava/util/concurrent/atomic/AtomicInteger;Ljava/lang/Long;Laa/o;)V
    .locals 0

    invoke-static {p0, p1, p2}, Lcom/xiaomi/camera/mivi/mtk/OfflineImageDataZipper;->lambda$getParallelTaskSize$0(Ljava/util/concurrent/atomic/AtomicInteger;Ljava/lang/Long;Laa/o;)V
...
.method private doJpeg(Laa/o;Landroid/media/Image;I)V
    .locals 9
    ...
    invoke-static {v1, v2, p3}, LA/T;->k(Ljava/lang/StringBuilder;Ljava/lang/String;I)Ljava/lang/String;
    ...
    invoke-direct/range {v3 .. v8}, Lcom/xiaomi/camera/mivi/mtk/OfflineImageDataZipper;->generateReprocessData(Laa/o;Landroid/media/Image;Ljava/lang/String;IZ)Lcom/xiaomi/camera/imagecodec/ReprocessData;
...
.method private generateReprocessData(Laa/o;Landroid/media/Image;Ljava/lang/String;IZ)Lcom/xiaomi/camera/imagecodec/ReprocessData;
    .locals 18
    ...
    iget-object v13, v1, Laa/o;->r:Laa/p;

    iget-object v2, v1, Laa/o;->h:Landroid/hardware/camera2/TotalCaptureResult;

    iget-boolean v5, v1, Laa/o;->j0:Z
    ...
    invoke-static {v2, v4}, LC9/a;->a(Landroid/hardware/camera2/CaptureResult;Ljava/lang/String;)Lcom/xiaomi/protocol/ICustomCaptureResult;

    move-result-object v7

    iget-boolean v8, v13, Laa/p;->J:Z

    iget-object v2, v13, Laa/p;->M:Landroid/util/Size;
    ...
    iget-object v4, v1, Laa/o;->K:Landroid/media/Image;
    ...
    :cond_1
    iget-boolean v2, v13, Laa/p;->d0:Z

    if-eqz v2, :cond_2

    iget v2, v13, Laa/p;->y:I

    invoke-virtual {v14, v2}, Lcom/xiaomi/camera/imagecodec/ReprocessData;->setOrientation(I)V

    :cond_2
    iget-byte v2, v13, Laa/p;->e0:B

    invoke-virtual {v14, v2}, Lcom/xiaomi/camera/imagecodec/ReprocessData;->setSiqeType(B)V

    iget-object v2, v13, Laa/p;->l:Landroid/util/Size;

    invoke-virtual {v2}, Landroid/util/Size;->getWidth()I

    move-result v2

    iget-object v3, v13, Laa/p;->l:Landroid/util/Size;
...
.method private handTimeoutTask(J)V
    ...
    invoke-static {p1, p2, v1, v2}, LA/X;->g(JLjava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
...
.method private handleDataBeanIfReady(Lcom/xiaomi/camera/mivi/mtk/OfflineImageData;Z)V
    ...
    invoke-virtual {p2, v0}, LL3/n;->c(Ljava/lang/String;)J

    invoke-virtual {p1}, Lcom/xiaomi/camera/mivi/mtk/OfflineImageData;->getTimestamp()J

    move-result-wide v0

    invoke-virtual {p0, v0, v1}, Lcom/xiaomi/camera/mivi/mtk/OfflineImageDataZipper;->getParallelTaskData(J)Laa/o;
    ...
    :cond_1
    iget-wide v0, p2, Laa/o;->b0:J

    iget-object v2, p2, Laa/o;->W:Ljava/lang/String;

    iget-wide v3, p2, Laa/o;->e:J
    ...
    invoke-static {v0}, LC9/e;->h(Landroid/media/Image;)[B
    ...
    invoke-virtual {p2, v1, v0}, Laa/o;->a(I[B)V
    ...
    invoke-static {v1, v2, v3}, LA/T;->k(Ljava/lang/StringBuilder;Ljava/lang/String;I)Ljava/lang/String;
    ...
    iput-object v0, p2, Laa/o;->K:Landroid/media/Image;
    ...
    invoke-direct {p0, v2, p2, v1}, Lcom/xiaomi/camera/mivi/mtk/OfflineImageDataZipper;->postCvWaterMark(Landroid/media/Image;Laa/o;I)V
    ...
    invoke-direct {p0, p2, v1, v2}, Lcom/xiaomi/camera/mivi/mtk/OfflineImageDataZipper;->doJpeg(Laa/o;Landroid/media/Image;I)V
...
.method private handleRawImageData([BLjava/lang/String;)V
    ...
    invoke-virtual {p0, p2, p1}, Laa/o;->a(I[B)V
    ...
    invoke-static {p0, p1}, Lcom/xiaomi/camera/mivi/MIVICaptureManager;->notifyFinish(Laa/o;Ljava/lang/String;)V
...
.method private static synthetic lambda$getParallelTaskSize$0(Ljava/util/concurrent/atomic/AtomicInteger;Ljava/lang/Long;Laa/o;)V
    .locals 0

    invoke-virtual {p2}, Laa/o;->c()I
...
.method private postCvWaterMark(Landroid/media/Image;Laa/o;I)V
    .locals 4
    ...
    invoke-static {p1, v2}, LC9/e;->g(Landroid/media/Image;Z)[B

    move-result-object v2

    const-string v3, ""

    invoke-static {p3, v3}, LA/T;->e(ILjava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v0, v1, v3, p1}, LA/X;->f(JLjava/lang/String;Ljava/lang/StringBuilder;)Ljava/lang/String;
    ...
    invoke-static {p1, p2, p3}, LA/T;->k(Ljava/lang/StringBuilder;Ljava/lang/String;I)Ljava/lang/String;
...
.method public getParallelTaskData(J)Laa/o;
    .locals 3
...
.method public getParallelTaskSize()Ljava/lang/String;
    ...
    invoke-direct {v4, v1}, Lcom/xiaomi/camera/mivi/mtk/c;-><init>(Ljava/util/concurrent/atomic/AtomicInteger;)V
...
.method public putParallelTaskData(JLaa/o;)V
    .locals 5
