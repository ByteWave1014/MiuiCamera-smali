...
.method public final onImageAvailable(Landroid/media/ImageReader;)V
    ...
    iget-object v3, v0, LWa/q;->a:LWa/r;

    iget-boolean v3, v3, LWa/r;->g:Z
    ...
    iget-object v0, v0, LWa/q;->a:LWa/r;
    ...
    iget-object v1, v0, LWa/r;->B:Landroid/os/HandlerThread;

    if-eqz v1, :cond_1

    invoke-virtual {v1}, Landroid/os/HandlerThread;->quit()Z

    iput-object v4, v0, LWa/r;->B:Landroid/os/HandlerThread;

    :cond_1
    iput-object v4, v0, LWa/r;->C:Landroid/os/Handler;
    ...
    iget-object v3, v3, LWa/r;->a:Ljava/lang/ref/WeakReference;
    ...
    :cond_6
    iget-object v8, v0, LWa/q;->a:LWa/r;

    invoke-virtual {v8, v4, v3}, LWa/r;->v(Lcom/android/camera/ui/h0;Ls3/b;)V
    ...
    invoke-virtual {v3, v6, v7}, LWa/r;->j(J)I

    move-result v13

    iget-object v0, v0, LWa/q;->a:LWa/r;

    iget-object v3, v0, LWa/r;->c:LWa/b;
    ...
    iget-object v12, v0, LWa/r;->y:LQ0/e;
    ...
    iput-object v5, v0, LXa/i;->a:Landroid/media/Image;

    invoke-virtual {v5}, Landroid/media/Image;->getTimestamp()J

    move-result-wide v3

    iput-wide v3, v0, LXa/i;->b:J
    ...
    iget-object v1, v9, LXa/c;->f:Ljava/util/ArrayList;
    ...
    :try_start_3
    iget-object v2, v9, LXa/c;->f:Ljava/util/ArrayList;
    ...
    :try_start_4
    invoke-virtual {v9, v0}, LXa/d;->y(Ljava/util/ArrayList;)V
    :try_end_4
    ...
    iget-object v3, v9, LXa/d;->B:LYa/b;

    new-instance v4, LEc/a;

    new-instance v6, LXa/g;
    ...
    invoke-direct/range {v8 .. v17}, LXa/g;-><init>(LXa/e;[ZLXa/i;LQ0/e;IZLTe/b$a;ZLXa/i;)V

    invoke-direct {v4, v6}, LEc/a;-><init>(Ljava/lang/Runnable;)V

    iget-object v0, v3, LYa/b;->k:LYa/b$a;
