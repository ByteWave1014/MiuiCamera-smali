...
.method public constructor <init>(Landroid/media/MediaFormat;JJLjava/util/concurrent/LinkedBlockingQueue;)V
    ...
    iput-object v0, p0, LXa/c;->a:Ljava/lang/String;

    const/4 v1, 0x0

    iput-boolean v1, p0, LXa/c;->o:Z

    const-wide/16 v2, -0x1

    iput-wide v2, p0, LXa/c;->v:J

    iput-wide v2, p0, LXa/c;->w:J
    ...
    invoke-static {v4, v3}, LWa/g;->a(Ljava/lang/String;Z)V
    ...
    invoke-static {v4, v2}, LWa/g;->a(Ljava/lang/String;Z)V

    invoke-static {p1, v3}, LWa/t;->a(Landroid/media/MediaFormat;Ljava/lang/String;)Z
    ...
    :cond_5
    iput-object p6, p0, LXa/c;->q:Ljava/util/concurrent/LinkedBlockingQueue;

    iput-object p1, p0, LXa/c;->b:Landroid/media/MediaFormat;

    iput-wide p2, p0, LXa/c;->d:J

    sub-long p4, p2, p4

    iput-wide p4, p0, LXa/c;->e:J

    const-wide/16 p4, 0x2

    mul-long/2addr p2, p4

    iput-wide p2, p0, LXa/c;->c:J
    ...
    invoke-direct {p4, p1, p2, p3}, LXa/h;-><init>(Landroid/media/MediaFormat;J)V

    iput-object p4, p0, LXa/c;->m:LXa/h;

    new-instance p1, Landroid/media/MediaCodec$BufferInfo;

    invoke-direct {p1}, Landroid/media/MediaCodec$BufferInfo;-><init>()V

    iput-object p1, p0, LXa/c;->g:Landroid/media/MediaCodec$BufferInfo;

    new-instance p1, Ljava/util/ArrayList;

    invoke-direct {p1}, Ljava/util/ArrayList;-><init>()V

    iput-object p1, p0, LXa/c;->f:Ljava/util/ArrayList;
    ...
    iput-object p2, p0, LXa/c;->a:Ljava/lang/String;
    ...
    invoke-direct {p2, p1}, LZa/b;-><init>(Ljava/lang/String;)V

    iput-object p2, p0, LXa/c;->h:LZa/b;

    new-instance p1, LXa/c$a;

    invoke-virtual {p2}, LZa/b;->a()V

    iget-object p2, p2, LZa/b;->d:Landroid/os/Looper;

    invoke-direct {p1, p0, p2}, LXa/c$a;-><init>(LXa/c;Landroid/os/Looper;)V

    iput-object p1, p0, LXa/c;->j:LXa/c$a;

    new-instance p1, LZa/c;

    invoke-direct {p1}, LZa/c;-><init>()V

    iput-object p1, p0, LXa/c;->i:LZa/c;
    ...
    iput-object p1, p0, LXa/c;->t:Landroid/os/HandlerThread;

    invoke-virtual {p1}, Ljava/lang/Thread;->start()V

    new-instance p2, LXa/c$b;

    invoke-virtual {p1}, Landroid/os/HandlerThread;->getLooper()Landroid/os/Looper;

    move-result-object p1

    invoke-direct {p2, p0, p1}, LXa/c$b;-><init>(LXa/c;Landroid/os/Looper;)V

    iput-object p2, p0, LXa/c;->u:LXa/c$b;

    iput-boolean v1, p0, LXa/c;->n:Z
...
.method public final a(Ljava/nio/ByteBuffer;Landroid/media/MediaCodec$BufferInfo;)V
    ...
    iget-object v0, p0, LXa/c;->a:Ljava/lang/String;
    ...
    :cond_0
    invoke-virtual {p0}, LXa/c;->n()LWa/e;

    move-result-object v8

    iget-object v3, p0, LXa/c;->m:LXa/h;
    ...
    invoke-virtual/range {v3 .. v8}, LXa/h;->a(Ljava/nio/ByteBuffer;IJLWa/e;)V

    iget-wide v0, p2, Landroid/media/MediaCodec$BufferInfo;->presentationTimeUs:J

    iput-wide v0, p0, LXa/c;->p:J

    iget-object p1, p0, LXa/c;->a:Ljava/lang/String;
    ...
    :cond_1
    iget-object p1, p0, LXa/c;->u:LXa/c$b;

    const/4 p2, 0x0

    invoke-virtual {p1, p2}, Landroid/os/Handler;->removeCallbacksAndMessages(Ljava/lang/Object;)V

    iget-object p1, p0, LXa/c;->t:Landroid/os/HandlerThread;
    ...
    iget-object p0, p0, LXa/c;->u:LXa/c$b;
...
.method public final b(J)V
    ...
    iget-object v2, p0, LXa/c;->a:Ljava/lang/String;
    ...
    invoke-virtual {p0, v1, v9}, LXa/c;->a(Ljava/nio/ByteBuffer;Landroid/media/MediaCodec$BufferInfo;)V
...
.method public n()LWa/e;
    .locals 0

    iget-object p0, p0, LXa/c;->q:Ljava/util/concurrent/LinkedBlockingQueue;
...
.method public o(IZJ)LXa/k;
    ...
    iget-boolean v1, v0, LXa/c;->n:Z

    const/4 v2, 0x0

    if-nez v1, :cond_0

    iget-object v0, v0, LXa/c;->a:Ljava/lang/String;
    ...
    :goto_1
    iget-wide v5, v0, LXa/c;->e:J

    add-long v10, v12, v5

    iget-wide v5, v0, LXa/c;->d:J
    ...
    iget-wide v14, v0, LXa/c;->d:J

    iget-object v5, v0, LXa/c;->l:Landroid/media/MediaFormat;

    invoke-virtual/range {p0 .. p0}, LXa/c;->k()Z
    ...
    invoke-direct/range {v7 .. v19}, LXa/k;-><init>(JJJJILandroid/media/MediaFormat;ZZ)V

    iget-object v5, v0, LXa/c;->a:Ljava/lang/String;
    ...
    iget-object v7, v0, LXa/c;->m:LXa/h;

    iget v8, v7, LXa/h;->k:I

    iget v9, v7, LXa/h;->j:I
    ...
    invoke-static {v3, v4, v7, v6}, LA/Q;->g(JLjava/lang/String;Ljava/lang/StringBuilder;)Ljava/lang/String;
    ...
    iget-object v2, v0, LXa/c;->f:Ljava/util/ArrayList;

    monitor-enter v2

    :try_start_0
    iget-object v0, v0, LXa/c;->f:Ljava/util/ArrayList;
...
.method public final onOutputBufferAvailable(Landroid/media/MediaCodec;ILandroid/media/MediaCodec$BufferInfo;)V
    ...
    invoke-virtual {p0, v2, v3}, LXa/c;->g(J)J

    move-result-wide v2

    iput-wide v2, p3, Landroid/media/MediaCodec$BufferInfo;->presentationTimeUs:J

    invoke-virtual {p0, v1, p3}, LXa/c;->a(Ljava/nio/ByteBuffer;Landroid/media/MediaCodec$BufferInfo;)V
...
.method public onOutputFormatChanged(Landroid/media/MediaCodec;Landroid/media/MediaFormat;)V
    ...
    :try_start_0
    iput-boolean p1, p0, LXa/c;->r:Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    :try_start_1
    iget-object p1, p0, LXa/c;->k:Landroid/media/MediaCodec;
    ...
    iput-object p1, p0, LXa/c;->l:Landroid/media/MediaFormat;
    :try_end_1
    ...
    :try_start_2
    iget-object p2, p0, LXa/c;->a:Ljava/lang/String;
    ...
    :try_start_3
    iget-object p2, p0, LXa/c;->f:Ljava/util/ArrayList;
...
.method public q(Z)V
    ...
    iget-object p1, p0, LXa/c;->j:LXa/c$a;
    ...
    iget-object p1, p0, LXa/c;->i:LZa/c;
    ...
    invoke-virtual {p1, v0}, LZa/c;->b(Landroid/os/Message;)V
