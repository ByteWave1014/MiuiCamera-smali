...
.method public constructor <init>(Lmiuix/appcompat/app/AppCompatActivity;)V
    ...
    iput v0, p0, LFh/i;->k:F

    const/4 v0, 0x1

    iput-boolean v0, p0, LFh/i;->p:Z
    ...
    iput-object v1, p0, LFh/i;->r:Landroid/os/Handler;

    const/4 v1, 0x0

    iput-boolean v1, p0, LFh/i;->s:Z

    iput-boolean v0, p0, LFh/i;->t:Z

    iput-object p1, p0, LFh/i;->a:Lmiuix/appcompat/app/AppCompatActivity;
    ...
    iput-object p1, p0, LFh/i;->u:Landroid/graphics/drawable/Drawable;

    return-void
.end method

.method public static p(LFh/i;Ljava/lang/Object;)V
    .locals 2
    ...
    iget-object p1, p0, LFh/i;->c:Landroid/view/View;
    ...
    invoke-direct {v0, p0, v1}, LFh/l;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-virtual {p1}, Lmiuix/appcompat/app/AppCompatActivity;->dj()V
    ...
    invoke-direct {p1, p0, v0}, LFh/k;-><init>(Ljava/lang/Object;I)V

    iget-object v0, p0, LFh/i;->c:Landroid/view/View;
    ...
    :cond_2
    invoke-virtual {p1}, LFh/k;->run()V

    :cond_3
    :goto_0
    const/4 p1, 0x0

    iput-boolean p1, p0, LFh/i;->s:Z
...
.method public final Jb()V
    ...
    iget-boolean v0, p0, LFh/i;->t:Z

    if-eqz v0, :cond_0

    iget-object p0, p0, LFh/i;->d:Landroid/view/View;
...
.method public final a()Z
    ...
    iget-object v1, p0, LFh/i;->a:Lmiuix/appcompat/app/AppCompatActivity;
    ...
    :cond_0
    iget-boolean p0, v0, LFh/i;->s:Z

    if-nez p0, :cond_2

    invoke-virtual {v0}, LFh/i;->u()V

    iget-object p0, v0, LFh/i;->j:LEh/f;
    ...
    invoke-virtual {v0, p0, v2}, LFh/i;->r(IZ)V
    ...
    iget-object v0, p0, LFh/i;->r:Landroid/os/Handler;

    new-instance v3, LFh/i$b;
    ...
    iput-object v4, v3, LFh/i$b;->a:Ljava/lang/ref/WeakReference;

    new-instance p0, Ljava/lang/ref/WeakReference;

    invoke-direct {p0, v1}, Ljava/lang/ref/WeakReference;-><init>(Ljava/lang/Object;)V

    iput-object p0, v3, LFh/i$b;->b:Ljava/lang/ref/WeakReference;
    ...
    :cond_4
    invoke-virtual {v1}, Lmiuix/appcompat/app/AppCompatActivity;->dj()V

    invoke-virtual {p0}, LFh/i;->q()V
...
.method public final c()Landroid/view/ViewGroup$LayoutParams;
    ...
    iget-object p0, p0, LFh/i;->i:Landroid/widget/FrameLayout$LayoutParams;
...
.method public final e()V
    ...
    iget-object p0, p0, LFh/i;->c:Landroid/view/View;
...
.method public final f(Landroid/view/View;Z)V
    ...
    iput-object v0, p0, LFh/i;->b:Landroid/view/View;
    ...
    iput-object v0, p0, LFh/i;->c:Landroid/view/View;
    ...
    iput-object v3, p0, LFh/i;->d:Landroid/view/View;
    ...
    iput-object v3, p0, LFh/i;->f:Landroid/view/View;

    iput-boolean p2, p0, LFh/i;->t:Z
    ...
    new-instance v3, LFh/i$a;

    invoke-direct {v3, p0}, LFh/i$a;-><init>(LFh/i;)V
    ...
    iput-object p2, p0, LFh/i;->h:Landroid/view/GestureDetector;

    iget-object p1, p0, LFh/i;->f:Landroid/view/View;

    new-instance p2, LA/j3;

    const/4 v3, 0x4

    invoke-direct {p2, p0, v3}, LA/j3;-><init>(Ljava/lang/Object;I)V

    const-wide/16 v3, 0x1f4

    invoke-virtual {p1, p2, v3, v4}, Landroid/view/View;->postDelayed(Ljava/lang/Runnable;J)Z

    iget-object p1, p0, LFh/i;->b:Landroid/view/View;

    new-instance p2, LFh/f;

    invoke-direct {p2, p0}, LFh/f;-><init>(LFh/i;)V

    invoke-virtual {p1, p2}, Landroid/view/View;->setOnTouchListener(Landroid/view/View$OnTouchListener;)V

    iget-object p1, p0, LFh/i;->d:Landroid/view/View;

    new-instance p2, LA3/R1;

    const/4 v3, 0x2

    invoke-direct {p2, p0, v0, v3}, LA3/R1;-><init>(Ljava/lang/Object;ZI)V
    ...
    iget-object p2, p0, LFh/i;->u:Landroid/graphics/drawable/Drawable;
    ...
    iget-boolean p1, p0, LFh/i;->t:Z

    if-eqz p1, :cond_2

    iget-object p0, p0, LFh/i;->b:Landroid/view/View;
...
.method public final i()V
    ...
    :cond_0
    invoke-virtual {p0}, LFh/i;->t()Z

    move-result v0

    if-nez v0, :cond_6

    iget-object v0, p0, LFh/i;->a:Lmiuix/appcompat/app/AppCompatActivity;

    invoke-virtual {v0}, Lmiuix/appcompat/app/AppCompatActivity;->dj()V
    ...
    :cond_6
    iget-boolean v0, p0, LFh/i;->s:Z

    if-nez v0, :cond_8

    invoke-virtual {p0}, LFh/i;->u()V

    iget-object v0, p0, LFh/i;->j:LEh/f;

    if-eqz v0, :cond_7

    invoke-interface {v0}, LEh/f;->j()V
...
.method public final j(Landroid/view/View;Z)Landroid/view/ViewGroup;
    ...
    iput-object v4, p0, LFh/i;->i:Landroid/widget/FrameLayout$LayoutParams;
    ...
    iput v2, p0, LFh/i;->o:F

    new-instance v2, Lpi/n;

    invoke-direct {v2, v1}, Lpi/n;-><init>(Landroid/content/Context;)V

    iput-object v2, p0, LFh/i;->g:Lpi/n;

    iget-object v1, p0, LFh/i;->i:Landroid/widget/FrameLayout$LayoutParams;

    invoke-virtual {v2, v1}, Landroid/view/View;->setLayoutParams(Landroid/view/ViewGroup$LayoutParams;)V

    iget-object v1, p0, LFh/i;->g:Lpi/n;

    invoke-virtual {v1, p1}, Landroid/view/ViewGroup;->addView(Landroid/view/View;)V

    iget-object p1, p0, LFh/i;->g:Lpi/n;

    const/4 v1, 0x0

    if-eqz p2, :cond_4

    iget p2, p0, LFh/i;->o:F
    ...
    iget-object p2, p0, LFh/i;->g:Lpi/n;
    ...
    invoke-direct {v1, p0, p1}, LFh/g;-><init>(LFh/i;F)V
    ...
    iput-object p1, p0, LFh/i;->e:Landroid/view/View;
...
.method public final l(Z)V
    ...
    invoke-static {v1}, LE2/w;->l(Landroid/content/Intent;)Z
    ...
    invoke-static {v0}, Landroidx/core/view/F;->d(Landroid/app/Activity;)V

    :cond_0
    iget-object v1, p0, LFh/i;->c:Landroid/view/View;
    ...
    iget-object v1, p0, LFh/i;->j:LEh/f;

    invoke-interface {v1}, LEh/f;->a()Z
    ...
    iput v1, p0, LFh/i;->o:F

    iget-object v4, p0, LFh/i;->g:Lpi/n;
    ...
    :cond_4
    iget-object v1, p0, LFh/i;->d:Landroid/view/View;
    ...
    iget-object v0, p0, LFh/i;->u:Landroid/graphics/drawable/Drawable;
    ...
    iget-boolean v0, p0, LFh/i;->p:Z

    if-eqz v0, :cond_7

    iget-boolean p0, p0, LFh/i;->t:Z
...
.method public final m(LEh/f;)V
    ...
    iput-object p1, p0, LFh/i;->j:LEh/f;
...
.method public final r(IZ)V
    ...
    invoke-direct {v0, p0, p2, p1, v1}, LA3/P1;-><init>(Ljava/lang/Object;ZII)V
    ...
    new-instance v5, LFh/i$c;

    invoke-direct {v5}, Lmiuix/animation/listener/TransitionListener;-><init>()V

    iput-boolean v0, v5, LFh/i$c;->d:Z

    new-instance v6, Ljava/lang/ref/WeakReference;

    invoke-direct {v6, p0}, Ljava/lang/ref/WeakReference;-><init>(Ljava/lang/Object;)V

    iput-object v6, v5, LFh/i$c;->a:Ljava/lang/ref/WeakReference;

    iput-boolean p2, v5, LFh/i$c;->b:Z

    iput p1, v5, LFh/i$c;->c:I
    ...
    iget-object v1, p0, LFh/i;->e:Landroid/view/View;
...
.method public final s()V
    ...
    iget-boolean v1, p0, LFh/i;->p:Z

    if-eqz v1, :cond_1

    iget-object p0, p0, LFh/i;->a:Lmiuix/appcompat/app/AppCompatActivity;

    invoke-interface {v0, p0}, LEh/f;->i(Lmiuix/appcompat/app/AppCompatActivity;)V
...
.method public final u()V
    ...
    iget-object v0, p0, LFh/i;->e:Landroid/view/View;

    if-nez v0, :cond_0

    iget-object v0, p0, LFh/i;->d:Landroid/view/View;
    ...
    iget-object v2, p0, LFh/i;->f:Landroid/view/View;
