...
.field public final s:LZ5/d;

.field public t:LY5/d;

.field public final u:Landroid/os/Handler;

.field public final v:LY5/c;
...
# direct methods
.method public constructor <init>(Lcom/android/camera/module/N;ZLjava/util/List;LZ5/d;)V
    .locals 17
    ...
    iput-object v0, v1, LY5/j;->j:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0, v13}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>(Z)V

    iput-object v0, v1, LY5/j;->k:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0, v13}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>(Z)V

    iput-object v0, v1, LY5/j;->l:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0, v13}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>(Z)V

    iput-object v0, v1, LY5/j;->m:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v0, Landroid/graphics/Rect;

    invoke-direct {v0}, Landroid/graphics/Rect;-><init>()V

    iput-object v0, v1, LY5/j;->o:Landroid/graphics/Rect;

    const/high16 v0, 0x3f800000    # 1.0f

    iput v0, v1, LY5/j;->p:F

    new-instance v14, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v14, v13}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>(Z)V

    iput-object v14, v1, LY5/j;->w:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iput-object v14, v1, LY5/j;->r:Ljava/lang/ref/WeakReference;

    move-object/from16 v14, p4

    iput-object v14, v1, LY5/j;->s:LZ5/d;
    ...
    iput-object v15, v1, LY5/j;->q:Lcom/android/camera/ui/GLTextureView;

    new-instance v5, LY5/g;

    invoke-direct {v5, v1}, LY5/g;-><init>(LY5/j;)V
    ...
    iput-object v5, v1, LY5/j;->u:Landroid/os/Handler;
    ...
    :goto_4
    invoke-static {v15, v2}, LY5/j;->b(FLjava/util/List;)Landroid/util/Size;

    move-result-object v0

    iput-object v0, v1, LY5/j;->f:Landroid/util/Size;

    invoke-static {v9, v2}, LY5/j;->b(FLjava/util/List;)Landroid/util/Size;
    ...
    invoke-static {v0, v2}, LY5/j;->b(FLjava/util/List;)Landroid/util/Size;
    ...
    invoke-static {v7, v2}, LY5/j;->b(FLjava/util/List;)Landroid/util/Size;
    ...
    invoke-static/range {p4 .. p4}, LZ5/e;->v3(LZ5/d;)Z
    ...
    iput-object v7, v1, LY5/j;->f:Landroid/util/Size;
    ...
    invoke-static {v0}, Ls0/e;->A(F)I

    move-result v0

    invoke-direct {v2, v7, v0}, Landroid/util/Size;-><init>(II)V

    iput-object v2, v1, LY5/j;->g:Landroid/util/Size;

    :cond_c
    iget-object v0, v1, LY5/j;->f:Landroid/util/Size;

    if-eqz v0, :cond_d

    iget-object v0, v1, LY5/j;->g:Landroid/util/Size;
    ...
    iput-object v3, v1, LY5/j;->f:Landroid/util/Size;

    new-instance v3, Landroid/util/Size;

    invoke-direct {v3, v2, v0}, Landroid/util/Size;-><init>(II)V

    iput-object v3, v1, LY5/j;->g:Landroid/util/Size;
    ...
    iput-object v0, v1, LY5/j;->g:Landroid/util/Size;

    :cond_12
    :goto_9
    new-instance v0, LY5/c;

    iget-object v2, v1, LY5/j;->q:Lcom/android/camera/ui/GLTextureView;

    iget-object v3, v1, LY5/j;->g:Landroid/util/Size;

    move/from16 v4, p2

    invoke-direct {v0, v2, v3, v4}, LY5/c;-><init>(Landroid/view/View;Landroid/util/Size;Z)V

    iput-object v0, v1, LY5/j;->v:LY5/c;

    sget v0, LNa/b;->ic_zoom_map_eis_cv:I

    iput v0, v1, LY5/j;->h:I
    ...
    :goto_a
    iput v0, v1, LY5/j;->i:I

    invoke-virtual/range {p0 .. p0}, LY5/j;->c()V
...
.method public final a()Landroid/view/Surface;
    ...
    iget-object v0, p0, LY5/j;->e:Landroid/view/Surface;
    ...
    iget-object v1, p0, LY5/j;->f:Landroid/util/Size;
    ...
    iget-object v2, p0, LY5/j;->f:Landroid/util/Size;

    invoke-virtual {v2}, Landroid/util/Size;->getWidth()I

    move-result v2

    iget-object v3, p0, LY5/j;->f:Landroid/util/Size;
    ...
    iget-object v2, p0, LY5/j;->a:Landroid/graphics/SurfaceTexture;

    invoke-direct {v0, v2}, Landroid/view/Surface;-><init>(Landroid/graphics/SurfaceTexture;)V

    iput-object v0, p0, LY5/j;->e:Landroid/view/Surface;

    iget-object v0, p0, LY5/j;->a:Landroid/graphics/SurfaceTexture;

    new-instance v2, LY5/f;

    invoke-direct {v2, p0}, LY5/f;-><init>(LY5/j;)V
    ...
    invoke-direct {v0, p0}, LY5/j$a;-><init>(LY5/j;)V

    iget-object v2, p0, LY5/j;->q:Lcom/android/camera/ui/GLTextureView;
    ...
    :cond_0
    iget-object p0, p0, LY5/j;->e:Landroid/view/Surface;
...
.method public final c()V
    ...
    iget-object v1, p0, LY5/j;->v:LY5/c;
    ...
    iput v0, v1, LY5/c;->a:I

    iput v0, v1, LY5/c;->d:I

    iget-object v0, v1, LY5/c;->i:Landroid/view/View;
    ...
    invoke-virtual {v1}, LY5/c;->b()Landroid/graphics/Rect;

    move-result-object v0

    iget-object v1, p0, LY5/j;->q:Lcom/android/camera/ui/GLTextureView;
    ...
    invoke-direct {v2, v3, p0, v0}, LL0/O;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V

    invoke-virtual {v1, v2}, Ljava/util/Optional;->ifPresent(Ljava/util/function/Consumer;)V

    invoke-virtual {p0}, LY5/j;->f()V
...
.method public final d()V
    ...
    :cond_0
    :goto_0
    iget-object v0, p0, LY5/j;->u:Landroid/os/Handler;
...
.method public final e(F)V
    ...
    invoke-virtual {v0}, L渭渡渣湠渣渧湠渪渫游渧渭渫湠渭渡渣渣渡渠湠渍渡渣渣渡渠;->J1()F
    ...
    iget-object p1, p0, LY5/j;->v:LY5/c;

    if-eqz p1, :cond_0

    iget-object p0, p0, LY5/j;->w:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iput v1, p1, LY5/c;->a:I

    iput v1, p1, LY5/c;->d:I

    iget-object p0, p1, LY5/c;->i:Landroid/view/View;
...
.method public final g(LD3/a;Z)V
    .locals 7
    .param p1    # LD3/a;
    ...
    iget-object v0, p1, LD3/a;->a:Ljava/lang/Boolean;
    ...
    iget-object v1, p0, LY5/j;->m:Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-virtual {v1, v0}, Ljava/util/concurrent/atomic/AtomicBoolean;->set(Z)V

    :cond_0
    iget-object v0, p1, LD3/a;->b:Landroid/graphics/Rect;
    ...
    iget p1, p1, LD3/a;->c:F

    iget-object p2, p0, LY5/j;->g:Landroid/util/Size;
    ...
    :cond_3
    :goto_0
    iget-object p1, p0, LY5/j;->w:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    :cond_4
    iget-object p1, p0, LY5/j;->k:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    :cond_5
    iget-object p1, p0, LY5/j;->o:Landroid/graphics/Rect;
    ...
    :goto_1
    iget-object p2, p0, LY5/j;->j:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iget-object p2, p0, LY5/j;->u:Landroid/os/Handler;

    new-instance v4, LY5/e;

    const/4 v5, 0x0

    invoke-direct {v4, p0, p1, v5}, LY5/e;-><init>(Ljava/lang/Object;ZI)V
    ...
    iget-object p1, p0, LY5/j;->q:Lcom/android/camera/ui/GLTextureView;
    ...
    iget-object p1, p0, LY5/j;->u:Landroid/os/Handler;

    new-instance p2, LG1/c;

    const/16 v0, 0xa

    invoke-direct {p2, p0, v0}, LG1/c;-><init>(Ljava/lang/Object;I)V

    invoke-virtual {p1, p2}, Landroid/os/Handler;->post(Ljava/lang/Runnable;)Z

    :cond_8
    :goto_2
    iget-object p1, p0, LY5/j;->n:LY5/k;

    if-eqz p1, :cond_9

    iget-object p0, p0, LY5/j;->o:Landroid/graphics/Rect;

    iput-object p0, p1, LY5/k;->f:Landroid/graphics/Rect;
