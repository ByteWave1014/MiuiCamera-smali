...
# virtual methods
.method public final a(Landroidx/fragment/app/FragmentActivity;Landroid/view/ViewGroup;)Landroid/view/ViewGroup;
    .locals 3
    ...
    invoke-static {v1, v0, v2}, LA/Y;->g(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    sput-object v0, LHh/c;->a:Ljava/lang/String;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, LW2/b;->l:Ljava/util/ArrayList;
    ...
    iput-object p2, p0, LW2/b;->h:Lcom/android/camera/fragment/watermark/wmSettingV2/signature/keyboard/recyclerview/SingleChoiceRecyclerView;
...
.method public final b(Ljava/lang/Object;)V
    ...
    :cond_3
    iput-object p1, p0, LW2/b;->m:Lcom/android/camera/fragment/watermark/wmSettingV2/signature/keyboard/DialogStatusData;
...
.method public final c()V
    ...
    iget-object v0, p0, LW2/b;->i:Lcom/android/camera/fragment/watermark/wmSettingV2/signature/keyboard/typeface/TypeFaceAdapter;
    ...
    iget-object v1, p0, LW2/b;->l:Ljava/util/ArrayList;
    ...
    iget-object v2, p0, LW2/b;->j:Lcom/android/camera/fragment/watermark/wmSettingV2/signature/keyboard/typeface/TextEditStyleItemDecoration;
    ...
    iget-object v0, p0, LW2/b;->h:Lcom/android/camera/fragment/watermark/wmSettingV2/signature/keyboard/recyclerview/SingleChoiceRecyclerView;
...
.method public final d(Z)V
    ...
    invoke-super {p0, p1}, LW2/d;->d(Z)V

    if-eqz p1, :cond_0

    iget-object p1, p0, LW2/b;->h:Lcom/android/camera/fragment/watermark/wmSettingV2/signature/keyboard/recyclerview/SingleChoiceRecyclerView;
...
.method public final e()V
    ...
    :cond_1
    iget-object v1, p0, LW2/b;->f:Landroidx/fragment/app/FragmentActivity;
    ...
    iget-object v4, p0, LW2/b;->l:Ljava/util/ArrayList;
...
.method public final f()V
    ...
    invoke-direct {v2, p0}, LW2/b$a;-><init>(LW2/b;)V
    ...
    invoke-static {v1, v3, v0}, LQg/l;->I(Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    :goto_1
    sget-object v3, Lcom/android/camera/fragment/watermark/wmSettingV2/signature/keyboard/mark/a;->a:LV2/a;

    invoke-interface {v3, v1, p0}, LV2/a;->b(Ljava/lang/String;Lokhttp3/CacheControl;)LJ8/e;
    ...
    iget-object p0, p0, LJ8/e;->a:Lio/reactivex/Observable;

    new-instance v3, LJ8/c;

    invoke-direct {v3, v1, v0}, LJ8/c;-><init>(Ljava/lang/Object;I)V
    ...
    const-string v1, "defaultObservable.subscribeOn(scheduler)"
    ...
    const-string v1, "defaultObservable.observeOn(scheduler)"
    ...
    invoke-direct {v1, v3, v4, v5}, LJ8/h;-><init>(IJ)V

    invoke-virtual {p0, v1}, Lio/reactivex/Observable;->retryWhen(Lio/reactivex/functions/Function;)Lio/reactivex/Observable;

    move-result-object p0

    const-string v1, "defaultObservable.retryW\u2026yTimes, retryDelayMills))"

    invoke-static {p0, v1}, Lkotlin/jvm/internal/l;->e(Ljava/lang/Object;Ljava/lang/String;)V

    new-instance v1, LV2/c;

    invoke-direct {v1, v2, v0}, LV2/c;-><init>(Ljava/lang/Object;I)V

    new-instance v3, LI2/t;

    const/4 v4, 0x1

    invoke-direct {v3, v1, v4}, LI2/t;-><init>(Ljava/lang/Object;I)V

    new-instance v1, LI2/u;

    invoke-direct {v1, v2}, LI2/u;-><init>(LW2/b$a;)V

    new-instance v2, LJ8/d;

    invoke-direct {v2, v1, v0}, LJ8/d;-><init>(Ljava/lang/Object;I)V

    invoke-virtual {p0, v3, v2}, Lio/reactivex/Observable;->subscribe(Lio/reactivex/functions/Consumer;Lio/reactivex/functions/Consumer;)Lio/reactivex/disposables/Disposable;
...
.method public final g(I)V
    ...
    iget-object v1, p0, LW2/b;->k:Lcom/android/camera/fragment/watermark/wmSettingV2/signature/keyboard/dialog/TextEditDialog$a;
