...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lp4/a;->i:Landroid/os/ParcelFileDescriptor;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lp4/a;->j:Ljava/util/ArrayList;

    const/4 v0, 0x0

    iput v0, p0, Lp4/a;->l:I

    iput v0, p0, Lp4/a;->m:I

    iput v0, p0, Lp4/a;->n:I

    const-wide/16 v0, 0x0

    iput-wide v0, p0, Lp4/a;->o:J
...
.method public final a()V
    ...
    iget-object v1, p0, Lp4/a;->g:Ljava/lang/String;
    ...
    :cond_0
    iget-object v0, p0, Lp4/a;->b:Landroid/os/ParcelFileDescriptor;

    invoke-static {v0}, LWh/e;->a(Ljava/io/Closeable;)V

    const/4 v0, 0x0

    iput-object v0, p0, Lp4/a;->b:Landroid/os/ParcelFileDescriptor;

    iget-object v1, p0, Lp4/a;->a:Landroid/net/Uri;

    if-eqz v1, :cond_5

    iget-object v1, p0, Lp4/a;->c:Landroid/content/Context;

    invoke-virtual {v1}, Landroid/content/Context;->getContentResolver()Landroid/content/ContentResolver;

    move-result-object v2

    iget-object v3, p0, Lp4/a;->a:Landroid/net/Uri;
    ...
    iget-object v2, p0, Lp4/a;->a:Landroid/net/Uri;
    ...
    :cond_5
    :goto_3
    iput-object v0, p0, Lp4/a;->a:Landroid/net/Uri;

    iget-object p0, p0, Lp4/a;->d:Landroid/content/ContentValues;
...
.method public final b()V
    ...
    iget-object v0, p0, Lp4/a;->i:Landroid/os/ParcelFileDescriptor;
...
.method public final c()Ljava/io/FileDescriptor;
    ...
    invoke-virtual {p0}, Lp4/a;->e()Landroid/os/ParcelFileDescriptor;
...
.method public final d()Ljava/lang/String;
    ...
    iget-object v0, p0, Lp4/a;->a:Landroid/net/Uri;
    ...
    iget-object p0, p0, Lp4/a;->a:Landroid/net/Uri;

    invoke-static {v0, p0}, Lp4/a;->i(Landroid/content/ContentResolver;Landroid/net/Uri;)Ljava/lang/String;
...
.method public final e()Landroid/os/ParcelFileDescriptor;
    ...
    invoke-static {p0, v0}, Lq4/b;->b(Landroid/net/Uri;Ljava/lang/String;)Landroid/os/ParcelFileDescriptor;
...
.method public final g(Landroid/content/Intent;Z)V
    ...
    iput-object p1, p0, Lp4/a;->e:Landroid/net/Uri;
    ...
    iget-object v2, p0, Lp4/a;->e:Landroid/net/Uri;
    ...
    iput-object v1, p0, Lp4/a;->f:Landroid/os/ParcelFileDescriptor;

    new-instance v1, Ljava/lang/StringBuilder;

    invoke-direct {v1, v0}, Ljava/lang/StringBuilder;-><init>(Ljava/lang/String;)V

    iget-object p0, p0, Lp4/a;->e:Landroid/net/Uri;
...
.method public final h()Landroid/net/Uri;
    ...
    iget-object v5, p0, Lp4/a;->d:Landroid/content/ContentValues;
    ...
    iget-object v6, p0, Lp4/a;->d:Landroid/content/ContentValues;
    ...
    invoke-static {v6}, Ll4/A;->B(Ljava/lang/String;)Z
    ...
    invoke-static {v0, v6, v2}, Ll4/A;->i(Landroid/content/Context;Ljava/lang/String;Z)Landroid/net/Uri;
...
.method public final k(LHb/q;Z)V
    .locals 10
    .annotation build Landroidx/annotation/WorkerThread;
    .end annotation
    ...
    iget-object p0, p0, Lp4/a;->g:Ljava/lang/String;
    ...
    :cond_0
    iget-object v2, p0, Lp4/a;->c:Landroid/content/Context;
    ...
    iget-object v3, p0, Lp4/a;->f:Landroid/os/ParcelFileDescriptor;
    ...
    :cond_1
    iget-object v3, p0, Lp4/a;->d:Landroid/content/ContentValues;
    ...
    iget-object v2, p0, Lp4/a;->g:Ljava/lang/String;
    ...
    invoke-interface {p1, p0}, LHb/q;->x(Ljava/lang/String;)V

    return-void

    :cond_2
    iget-object p2, p0, Lp4/a;->f:Landroid/os/ParcelFileDescriptor;
    ...
    invoke-interface {p1, p0}, LHb/q;->l(Ljava/io/FileDescriptor;)V

    return-void

    :cond_3
    iget-object p2, p0, Lp4/a;->d:Landroid/content/ContentValues;
    ...
    invoke-static {p2}, Ll4/A;->B(Ljava/lang/String;)Z
    ...
    :cond_4
    invoke-static {v2, p2, v3}, Ll4/A;->i(Landroid/content/Context;Ljava/lang/String;Z)Landroid/net/Uri;
    ...
    iput-object v2, p0, Lp4/a;->a:Landroid/net/Uri;
    ...
    iput-object v2, p0, Lp4/a;->b:Landroid/os/ParcelFileDescriptor;
    ...
    invoke-static {v2, p2}, LVa/a;->g(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
