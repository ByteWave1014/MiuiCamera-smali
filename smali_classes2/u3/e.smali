...
.field public final q:Lu3/e$a;


# direct methods
.method public constructor <init>(Lu3/f;Lu3/e$a;)V
    .locals 6
    ...
    invoke-virtual {p0}, Lu3/e;->d()Ljava/lang/String;

    move-result-object v0

    iput-object v0, p0, Lu3/e;->a:Ljava/lang/String;

    new-instance v1, Ljava/lang/Object;

    invoke-direct {v1}, Ljava/lang/Object;-><init>()V

    iput-object v1, p0, Lu3/e;->b:Ljava/lang/Object;

    new-instance v2, Ljava/lang/ref/WeakReference;

    invoke-direct {v2, p1}, Ljava/lang/ref/WeakReference;-><init>(Ljava/lang/Object;)V

    iput-object v2, p0, Lu3/e;->o:Ljava/lang/ref/WeakReference;

    invoke-virtual {p1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    instance-of v2, p0, Lu3/g;

    if-eqz v2, :cond_1

    iget-object v2, p1, Lu3/f;->e:Lu3/g;
    ...
    iput-object v2, p1, Lu3/f;->e:Lu3/g;
    ...
    :cond_1
    instance-of v2, p0, Lu3/d;

    if-eqz v2, :cond_6

    iget-object v2, p1, Lu3/f;->f:Lu3/d;
    ...
    iput-object v2, p1, Lu3/f;->f:Lu3/d;
    ...
    :goto_1
    iget-object v5, p1, Lu3/f;->f:Lu3/d;
    ...
    iput v2, p1, Lu3/f;->b:I

    iput-object p2, p0, Lu3/e;->q:Lu3/e$a;
    ...
    iput-object p1, p0, Lu3/e;->p:Landroid/media/MediaCodec$BufferInfo;

    iput-boolean v3, p0, Lu3/e;->e:Z

    new-instance p1, Ljava/lang/Thread;

    invoke-direct {p1, p0, v0}, Ljava/lang/Thread;-><init>(Ljava/lang/Runnable;Ljava/lang/String;)V

    iput-object p1, p0, Lu3/e;->c:Ljava/lang/Thread;

    invoke-virtual {p1}, Ljava/lang/Thread;->start()V

    :goto_3
    iget-boolean p1, p0, Lu3/e;->e:Z
    :try_end_0
    ...
    :try_start_1
    iget-object p1, p0, Lu3/e;->b:Ljava/lang/Object;
    ...
    :try_start_2
    iget-object p2, p0, Lu3/e;->a:Ljava/lang/String;
...
.method public final a()V
    ...
    iget-object v0, p0, Lu3/e;->o:Ljava/lang/ref/WeakReference;
    ...
    iget-object p0, p0, Lu3/e;->a:Ljava/lang/String;
    ...
    :cond_0
    iget-object v2, p0, Lu3/e;->n:Landroid/media/MediaCodec;
    ...
    :cond_2
    :goto_0
    iget-boolean v4, p0, Lu3/e;->h:Z

    if-eqz v4, :cond_13

    iget-boolean v4, p0, Lu3/e;->f:Z
    ...
    :goto_1
    iput-boolean v4, p0, Lu3/e;->f:Z

    :cond_4
    :try_start_1
    iget-object v4, p0, Lu3/e;->n:Landroid/media/MediaCodec;

    iget-object v6, p0, Lu3/e;->p:Landroid/media/MediaCodec$BufferInfo;
    ...
    iget-object v4, p0, Lu3/e;->a:Ljava/lang/String;
    ...
    :try_start_2
    iget-boolean v7, v0, Lu3/f;->d:Z

    if-nez v7, :cond_a

    iget-object v7, v0, Lu3/f;->a:Landroid/media/MediaMuxer;
    ...
    iput v7, p0, Lu3/e;->m:I

    iget-object v4, p0, Lu3/e;->b:Ljava/lang/Object;

    monitor-enter v4

    :try_start_3
    iget-boolean v6, p0, Lu3/e;->j:Z
    ...
    iget-object v4, v0, Lu3/f;->a:Landroid/media/MediaMuxer;

    invoke-virtual {v4}, Landroid/media/MediaMuxer;->start()V

    iput-boolean v5, v0, Lu3/f;->d:Z
    ...
    iget-object v5, p0, Lu3/e;->a:Ljava/lang/String;
    ...
    iget-object v6, p0, Lu3/e;->a:Ljava/lang/String;
    ...
    iget-boolean v3, p0, Lu3/e;->f:Z

    if-nez v3, :cond_10

    iget-object v3, p0, Lu3/e;->p:Landroid/media/MediaCodec$BufferInfo;

    iget-wide v6, v3, Landroid/media/MediaCodec$BufferInfo;->presentationTimeUs:J

    long-to-double v6, v6

    iget v8, p0, Lu3/e;->d:F
    ...
    :cond_11
    iget-object v5, p0, Lu3/e;->n:Landroid/media/MediaCodec;

    invoke-virtual {v5, v4, v1}, Landroid/media/MediaCodec;->releaseOutputBuffer(IZ)V

    iget-object v4, p0, Lu3/e;->p:Landroid/media/MediaCodec$BufferInfo;
    ...
    invoke-static {v0, v4, v1}, LA/P2;->d(Ljava/lang/String;ILjava/lang/String;)Ljava/lang/String;
...
.method public final declared-synchronized b(Ljava/nio/ByteBuffer;IJ)V
    ...
    :try_start_0
    iget-boolean v0, p0, Lu3/e;->h:Z

    if-eqz v0, :cond_5

    iget-object v0, p0, Lu3/e;->n:Landroid/media/MediaCodec;
    ...
    :cond_1
    iget-boolean v1, p0, Lu3/e;->h:Z

    if-eqz v1, :cond_4

    iget-object v1, p0, Lu3/e;->n:Landroid/media/MediaCodec;
    ...
    iget-object p1, p0, Lu3/e;->a:Ljava/lang/String;
...
.method public final c()Z
    ...
    iget-object v1, p0, Lu3/e;->b:Ljava/lang/Object;

    monitor-enter v1

    :try_start_0
    iget-boolean v2, p0, Lu3/e;->h:Z

    if-eqz v2, :cond_1

    iget-boolean v2, p0, Lu3/e;->j:Z
...
.method public final e()V
    ...
    iget-object v0, p0, Lu3/e;->c:Ljava/lang/Thread;

    if-eqz v0, :cond_1

    :try_start_0
    iget-boolean v0, p0, Lu3/e;->j:Z
    ...
    iput-object v0, p0, Lu3/e;->c:Ljava/lang/Thread;
    :try_end_0
...
.method public f()V
    ...
    iput-object v1, p0, Lu3/e;->n:Landroid/media/MediaCodec;
    :try_end_0
    ...
    iget-object v0, p0, Lu3/e;->q:Lu3/e$a;

    if-eqz v0, :cond_2

    iget-object v0, p0, Lu3/e;->q:Lu3/e$a;

    invoke-interface {v0}, Lu3/e$a;->c()V
    ...
    :goto_2
    iput-boolean v2, p0, Lu3/e;->h:Z

    iget-object v2, p0, Lu3/e;->q:Lu3/e$a;

    if-eqz v2, :cond_4

    invoke-interface {v2, p0, v0}, Lu3/e$a;->a(Lu3/e;Z)V

    :cond_4
    iput-object v1, p0, Lu3/e;->p:Landroid/media/MediaCodec$BufferInfo;
...
.method public g()V
    ...
    invoke-virtual {p0, v3, v0, v1, v2}, Lu3/e;->b(Ljava/nio/ByteBuffer;IJ)V
...
.method public h(JZ)Z
    ...
    iget-object p3, p0, Lu3/e;->a:Ljava/lang/String;
    ...
    iget-object p3, p0, Lu3/e;->b:Ljava/lang/Object;
...
.method public final run()V
    ...
    invoke-virtual {p0}, Lu3/e;->a()V

    invoke-virtual {p0}, Lu3/e;->g()V
