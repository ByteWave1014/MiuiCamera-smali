...
# direct methods
.method public constructor <init>(Lu3/b;Landroid/view/Surface;)V
    .locals 5
    ...
    iput-object v0, p0, Lu3/b$b;->b:Landroid/opengl/EGLSurface;
    ...
    :cond_1
    :goto_0
    iput-object p1, p0, Lu3/b$b;->a:Lu3/b;
    ...
    :try_start_0
    iget-object v3, p1, Lu3/b;->c:Landroid/opengl/EGLDisplay;

    iget-object p1, p1, Lu3/b;->a:Landroid/opengl/EGLConfig;
    ...
    :goto_1
    iput-object p1, p0, Lu3/b$b;->b:Landroid/opengl/EGLSurface;

    iget-object p2, p0, Lu3/b$b;->a:Lu3/b;

    const/4 v1, 0x1

    new-array v3, v1, [I

    iget-object p2, p2, Lu3/b;->c:Landroid/opengl/EGLDisplay;
    ...
    iget-object p0, p0, Lu3/b$b;->b:Landroid/opengl/EGLSurface;
    ...
    invoke-static {p1, p0, p2, v1, v2}, LA/A2;->f(IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public final a()V
    ...
    iget-object v0, p0, Lu3/b$b;->b:Landroid/opengl/EGLSurface;

    iget-object p0, p0, Lu3/b$b;->a:Lu3/b;

    iget-object v1, p0, Lu3/b;->c:Landroid/opengl/EGLDisplay;
    ...
    iget-object p0, p0, Lu3/b;->b:Landroid/opengl/EGLContext;
