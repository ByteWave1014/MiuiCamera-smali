...
.field public final synthetic f:LEb/a;


# direct methods
.method public constructor <init>(LEb/a;Ljava/net/Socket;)V
    .locals 3
    ...
    iput-object p1, p0, LEb/a$f;->f:LEb/a;
    ...
    iput-object v0, p0, LEb/a$f;->a:Ljava/lang/String;

    iput-object p2, p0, LEb/a$f;->b:Ljava/net/Socket;
    ...
    invoke-static {p0, p1}, LFb/b;->b(Ljava/lang/String;Ljava/lang/String;)V

    return-void
.end method

.method public static a(LEb/a$f;)V
    .locals 4
    ...
    iget-object v1, p0, LEb/a$f;->c:Ljava/io/OutputStream;
...
# virtual methods
.method public final b(LEb/a$b;)LEb/a$d;
    .locals 17
    .annotation system Ldalvik/annotation/Throws;
        value = {
    ...
    new-instance v3, LEb/a$d;

    invoke-direct {v3, v1}, LEb/a$d;-><init>(LEb/a$b;)V

    iget-object v4, v0, LEb/a$f;->f:LEb/a;

    iget-object v4, v4, LEb/a;->a:Ljava/util/HashMap;

    monitor-enter v4

    :try_start_0
    iget-object v5, v0, LEb/a$f;->a:Ljava/lang/String;
    ...
    iget-object v5, v0, LEb/a$f;->f:LEb/a;

    iget-object v5, v5, LEb/a;->a:Ljava/util/HashMap;
    ...
    iget-object v10, v0, LEb/a$f;->a:Ljava/lang/String;
    ...
    invoke-static {v9}, LFb/b;->d(Ljava/lang/Object;)Ljava/lang/String;
    ...
    iget-object v10, v0, LEb/a$f;->e:Lnet/majorkernelpanic/streaming/Session;
    ...
    iput-object v1, v3, LEb/a$d;->c:Ljava/lang/String;
    ...
    iput-object v0, v3, LEb/a$d;->b:Ljava/lang/String;

    const-string v0, "400 Bad Request"

    iput-object v0, v3, LEb/a$d;->a:Ljava/lang/String;

    return-object v3

    :cond_2
    iget-object v4, v1, LEb/a$b;->c:Ljava/util/HashMap;
    ...
    sget-object v4, LEb/a;->l:Ljava/lang/String;

    iget-object v4, v0, LEb/a$f;->f:LEb/a;

    invoke-virtual {v4}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iget-object v4, v1, LEb/a$b;->a:Ljava/lang/String;
    ...
    iget-object v2, v0, LEb/a$f;->f:LEb/a;

    iget-object v1, v1, LEb/a$b;->b:Ljava/lang/String;

    iget-object v4, v0, LEb/a$f;->b:Ljava/net/Socket;
    ...
    :cond_3
    iput-object v1, v0, LEb/a$f;->e:Lnet/majorkernelpanic/streaming/Session;

    iget-object v1, v0, LEb/a$f;->a:Ljava/lang/String;
    ...
    iget-object v4, v0, LEb/a$f;->e:Lnet/majorkernelpanic/streaming/Session;
    ...
    iget-object v1, v0, LEb/a$f;->f:LEb/a;

    iget-object v4, v1, LEb/a;->a:Ljava/util/HashMap;
    ...
    iget-object v1, v1, LEb/a;->a:Ljava/util/HashMap;

    iget-object v2, v0, LEb/a$f;->e:Lnet/majorkernelpanic/streaming/Session;

    invoke-virtual {v2}, Lnet/majorkernelpanic/streaming/Session;->getDestination()Ljava/lang/String;

    move-result-object v2

    iget-object v5, v0, LEb/a$f;->e:Lnet/majorkernelpanic/streaming/Session;
    ...
    iget-object v1, v0, LEb/a$f;->e:Lnet/majorkernelpanic/streaming/Session;
    ...
    iget-object v0, v0, LEb/a$f;->b:Ljava/net/Socket;
    ...
    iput-object v0, v3, LEb/a$d;->c:Ljava/lang/String;

    iput-object v1, v3, LEb/a$d;->b:Ljava/lang/String;
    ...
    iget-object v8, v1, LEb/a$b;->b:Ljava/lang/String;
    ...
    iget-object v8, v0, LEb/a$f;->e:Lnet/majorkernelpanic/streaming/Session;
    ...
    iget-object v1, v1, LEb/a$b;->c:Ljava/util/HashMap;
    ...
    :goto_2
    iget-object v9, v0, LEb/a$f;->e:Lnet/majorkernelpanic/streaming/Session;
    ...
    iget-object v11, v0, LEb/a$f;->e:Lnet/majorkernelpanic/streaming/Session;

    invoke-virtual {v11}, Lnet/majorkernelpanic/streaming/Session;->getDestination()Ljava/lang/String;

    move-result-object v11

    iget-object v12, v0, LEb/a$f;->e:Lnet/majorkernelpanic/streaming/Session;
    ...
    iget-object v13, v0, LEb/a$f;->a:Ljava/lang/String;
    ...
    iget-object v13, v0, LEb/a$f;->f:LEb/a;
    ...
    :try_start_4
    sget-boolean v14, LEb/a;->n:Z

    if-eqz v14, :cond_c

    iget-object v14, v0, LEb/a$f;->f:LEb/a;

    iget-object v15, v14, LEb/a;->h:Landroid/media/MediaCodec;

    if-nez v15, :cond_a

    iget-object v14, v0, LEb/a$f;->a:Ljava/lang/String;
    ...
    iget-object v15, v0, LEb/a$f;->e:Lnet/majorkernelpanic/streaming/Session;
    ...
    invoke-virtual {v14, v15, v2}, LEb/a;->b(Landroid/content/SharedPreferences;Lnet/majorkernelpanic/streaming/video/VideoQuality;)V
    ...
    :cond_a
    iget-object v2, v14, LEb/a;->g:Lnet/majorkernelpanic/streaming/video/VideoQuality;

    iget-object v14, v0, LEb/a$f;->e:Lnet/majorkernelpanic/streaming/Session;
    ...
    iget-object v2, v0, LEb/a$f;->a:Ljava/lang/String;
    ...
    iget-object v13, v0, LEb/a$f;->e:Lnet/majorkernelpanic/streaming/Session;
    ...
    invoke-static {v2, v4, v5}, LEb/a;->a(LEb/a;Lnet/majorkernelpanic/streaming/Session;I)V
    ...
    iget-object v0, v0, LEb/a$f;->e:Lnet/majorkernelpanic/streaming/Session;
    ...
    :cond_11
    iget-object v2, v1, LEb/a$b;->a:Ljava/lang/String;
    ...
    iget-object v2, v0, LEb/a$f;->b:Ljava/net/Socket;
    ...
    invoke-static {v1, v2}, LA/y3;->g(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-static {v8}, LFb/b;->d(Ljava/lang/Object;)Ljava/lang/String;
    ...
    iget-object v0, v0, LEb/a$f;->f:LEb/a;

    iget-object v0, v0, LEb/a;->f:Lcom/xiaomi/camera/rcs/service/RemoteControlService;

    if-eqz v0, :cond_22

    iget-object v1, v1, LEb/a$b;->d:Ljava/lang/String;
    ...
    sget-object v3, Lzb/h;->a:Ljava/lang/String;
    ...
    invoke-static {v2, v4, v1, v0}, LFb/b;->e(ILjava/lang/String;Ljava/lang/String;Ljava/lang/Exception;)V
    ...
    iput-object v1, v2, LEb/a$d;->c:Ljava/lang/String;
    ...
    iput-object v0, v2, LEb/a$d;->b:Ljava/lang/String;
    ...
    iput-object v0, v2, LEb/a$d;->a:Ljava/lang/String;
    ...
    iget-object v0, v0, LEb/a$f;->a:Ljava/lang/String;
    ...
    invoke-static {v0, v1}, LFb/b;->b(Ljava/lang/String;Ljava/lang/String;)V
...
.method public final run()V
    ...
    :try_start_0
    iget-object v6, p0, LEb/a$f;->d:Ljava/io/BufferedReader;

    invoke-static {v6}, LEb/a$b;->a(Ljava/io/BufferedReader;)LEb/a$b;
    ...
    :catch_0
    iget-object v3, p0, LEb/a$f;->a:Ljava/lang/String;

    const-string v6, "Unknown request from client"

    sget-boolean v7, LFb/b;->a:Z

    invoke-static {v5, v3, v6}, Landroid/util/Log;->println(ILjava/lang/String;Ljava/lang/String;)I

    new-instance v3, LEb/a$d;

    invoke-direct {v3}, LEb/a$d;-><init>()V

    const-string v6, "400 Bad Request"

    iput-object v6, v3, LEb/a$d;->a:Ljava/lang/String;

    :goto_1
    if-eqz v4, :cond_1

    :try_start_1
    invoke-virtual {p0, v4}, LEb/a$f;->b(LEb/a$b;)LEb/a$d;
    ...
    iget-object v6, p0, LEb/a$f;->a:Ljava/lang/String;
    ...
    :goto_2
    invoke-static {v6, v3}, LFb/b;->b(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v3, p0, LEb/a$f;->f:LEb/a;

    invoke-virtual {v3, v0}, LEb/a;->e(I)V

    new-instance v3, LEb/a$d;

    invoke-direct {v3, v4}, LEb/a$d;-><init>(LEb/a$b;)V

    :cond_1
    :goto_3
    if-gtz v2, :cond_2

    iget-object v4, p0, LEb/a$f;->e:Lnet/majorkernelpanic/streaming/Session;
    ...
    iget-object v2, p0, LEb/a$f;->a:Ljava/lang/String;
    ...
    invoke-static {v2, v6}, LFb/b;->b(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :try_start_3
    iget-object v4, p0, LEb/a$f;->c:Ljava/io/OutputStream;

    invoke-virtual {v3, v4}, LEb/a$d;->a(Ljava/io/OutputStream;)V
    ...
    :catch_2
    iget-object v0, p0, LEb/a$f;->a:Ljava/lang/String;
    ...
    iget-object v4, p0, LEb/a$f;->a:Ljava/lang/String;
    ...
    invoke-static {v1, v3, v2}, LA/P2;->d(Ljava/lang/String;ILjava/lang/String;)Ljava/lang/String;
    ...
    :cond_5
    :goto_4
    iget-object v0, p0, LEb/a$f;->e:Lnet/majorkernelpanic/streaming/Session;

    invoke-virtual {v0}, Lnet/majorkernelpanic/streaming/Session;->isStreaming()Z

    move-result v0

    iget-object v1, p0, LEb/a$f;->e:Lnet/majorkernelpanic/streaming/Session;
    ...
    iget-object v0, p0, LEb/a$f;->f:LEb/a;

    iget-object v1, p0, LEb/a$f;->e:Lnet/majorkernelpanic/streaming/Session;

    invoke-static {v0, v1, v5}, LEb/a;->a(LEb/a;Lnet/majorkernelpanic/streaming/Session;I)V

    :cond_6
    iget-object v0, p0, LEb/a$f;->f:LEb/a;

    iget-object v0, v0, LEb/a;->a:Ljava/util/HashMap;

    monitor-enter v0

    :try_start_5
    iget-object v1, p0, LEb/a$f;->f:LEb/a;

    iget-object v1, v1, LEb/a;->a:Ljava/util/HashMap;

    iget-object v2, p0, LEb/a$f;->e:Lnet/majorkernelpanic/streaming/Session;
    ...
    :try_start_6
    iget-object v0, p0, LEb/a$f;->b:Ljava/net/Socket;
    ...
    :catch_5
    iget-object p0, p0, LEb/a$f;->a:Ljava/lang/String;
