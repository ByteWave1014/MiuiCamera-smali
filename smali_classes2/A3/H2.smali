...
.method public constructor <init>(Ljava/lang/ref/WeakReference;)V
    ...
    iput v0, p0, LA3/H2;->c:I

    iput v0, p0, LA3/H2;->m:I
    ...
    iput-object v1, p0, LA3/H2;->Q:Ljava/util/concurrent/locks/ReentrantLock;

    new-instance v1, LA3/H2$a;

    invoke-direct {v1, p0}, LA3/H2$a;-><init>(LA3/H2;)V

    iput-object v1, p0, LA3/H2;->Y:LA3/H2$a;

    iput-object p1, p0, LA3/H2;->a:Ljava/lang/ref/WeakReference;
    ...
    iget-object v1, p1, Lcom/android/camera/ActivityBase;->k0:Lo5/f;

    iput-object v1, p0, LA3/H2;->d:Lo5/f;
    ...
    invoke-virtual {p1}, L渭渡渣湠渣渧湠渪渫游渧渭渫湠渭渡渣渣渡渠湠渍渡渣渣渡渠;->t6()Z
...
.method public final c()V
    ...
    iget-object v0, p0, LA3/H2;->f:LA3/p2;
    ...
    iput-object v2, v0, LA3/p2;->d:Landroid/graphics/SurfaceTexture;

    iget-object v3, v0, LA3/p2;->a:[I
...
.method public final d(I)V
    ...
    :cond_0
    iget v0, p0, LA3/H2;->p:I

    iget v1, p0, LA3/H2;->q:I

    invoke-static {v0, v1}, Ljava/lang/Math;->min(II)I

    move-result v0

    iget v1, p0, LA3/H2;->p:I

    iget v2, p0, LA3/H2;->q:I
    ...
    iget v1, p0, LA3/H2;->n:I

    iget v2, p0, LA3/H2;->o:I
    ...
    :goto_1
    iput v0, p0, LA3/H2;->p:I

    iput v1, p0, LA3/H2;->q:I
...
.method public final f(I)V
    ...
    iget-object v0, p0, LA3/H2;->a:Ljava/lang/ref/WeakReference;
    ...
    invoke-direct {v1, p0, p1}, LA3/G2;-><init>(LA3/H2;I)V
...
.method public final g(I)V
    ...
    iget-object p1, p0, LA3/H2;->H:LA3/D2;

    if-eqz p1, :cond_7

    iget p0, p0, LA3/H2;->M:I

    iput p0, p1, LA3/D2;->j:I
    ...
    :cond_0
    iget-object p0, p1, LA3/D2;->e:Ljava/lang/String;

    iget-object v2, p1, LA3/D2;->h:Lcom/xiaomi/microfilm/vlogpro/vp/a;
    ...
    iget-object v2, p1, LA3/D2;->k:LV3/w1;
    ...
    iput-object v2, p1, LA3/D2;->k:LV3/w1;
    ...
    iput-boolean v0, p1, LA3/D2;->n:Z

    iget-object v0, p1, LA3/D2;->h:Lcom/xiaomi/microfilm/vlogpro/vp/a;
    ...
    iget-object v3, p1, LA3/D2;->h:Lcom/xiaomi/microfilm/vlogpro/vp/a;
    ...
    invoke-static {v4, v3, v5}, LA/Y;->g(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v3

    iget-object v4, p1, LA3/D2;->h:Lcom/xiaomi/microfilm/vlogpro/vp/a;
    ...
    new-instance v6, LA3/A2;

    const/4 v7, 0x0

    invoke-direct {v6, p1, v7}, LA3/A2;-><init>(Ljava/lang/Object;I)V

    invoke-virtual {v5, v6}, Lio/reactivex/Single;->map(Lio/reactivex/functions/Function;)Lio/reactivex/Single;

    move-result-object v5

    new-instance v6, LA3/B2;

    invoke-direct {v6, p1, v2, v3, v4}, LA3/B2;-><init>(LA3/D2;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    new-instance v4, LA3/C2;

    invoke-direct {v4, p1, p0, v0, v2}, LA3/C2;-><init>(LA3/D2;Ljava/lang/String;ILjava/lang/String;)V
    ...
    :cond_3
    iget-object p0, p1, LA3/D2;->a:Lcom/android/camera/ActivityBase;
    ...
    :cond_4
    iget-object p0, p1, LA3/D2;->h:Lcom/xiaomi/microfilm/vlogpro/vp/a;
    ...
    iget-object v0, p1, LA3/D2;->g:Lcom/xiaomi/microfilm/vlogpro/vp/VPItem;
    ...
    invoke-virtual {p1, p0}, LA3/D2;->n0(I)V

    :goto_2
    iget-object p0, p1, LA3/D2;->c:Landroid/os/Handler;

    new-instance v0, LA/j3;

    const/4 v1, 0x1

    invoke-direct {v0, p1, v1}, LA/j3;-><init>(Ljava/lang/Object;I)V
...
.method public final h()V
    ...
    invoke-virtual {p0, v0}, LA3/H2;->g(I)V

    const/4 v0, 0x1

    iput-boolean v0, p0, LA3/H2;->w:Z
...
.method public final i()V
    ...
    iget-object v1, p0, LA3/H2;->h:Lcom/xiaomi/milab/videosdk/XmsTimeline;
...
.method public final onDrawFrame(Landroid/graphics/Rect;IIZ)Z
    ...
    :try_start_0
    iget-object v3, v1, LA3/H2;->Q:Ljava/util/concurrent/locks/ReentrantLock;

    invoke-virtual {v3}, Ljava/util/concurrent/locks/ReentrantLock;->lock()V

    iget-object v3, v1, LA3/H2;->a:Ljava/lang/ref/WeakReference;
    ...
    iget-boolean v4, v1, LA3/H2;->b:Z

    const/4 v5, 0x0

    if-eqz v4, :cond_b

    iget-object v4, v1, LA3/H2;->e:Landroid/graphics/SurfaceTexture;
    ...
    iget-object v4, v1, LA3/H2;->l:Lcom/xiaomi/microfilm/vlogpro/vp/VPItem;
    ...
    :cond_0
    iget-object v4, v1, LA3/H2;->f:LA3/p2;
    ...
    new-instance v3, LA3/p2;

    invoke-direct {v3}, Ljava/lang/Object;-><init>()V

    new-array v4, v6, [I

    iput-object v4, v3, LA3/p2;->a:[I

    sget-object v4, LUe/a;->a:LUe/a$a;

    iput-object v4, v3, LA3/p2;->k:LUe/a;
    ...
    iput-object v7, v3, LA3/p2;->c:Ljava/nio/FloatBuffer;
    ...
    iput-object v3, v1, LA3/H2;->f:LA3/p2;

    iget-boolean v4, v1, LA3/H2;->C:Z
    ...
    :cond_1
    :goto_0
    invoke-virtual {v3}, LA3/p2;->a()V

    iget-object v3, v1, LA3/H2;->f:LA3/p2;
    ...
    iget-object v7, v3, LA3/p2;->a:[I

    aget v7, v7, v5

    invoke-virtual {v4, v7}, Landroid/graphics/SurfaceTexture;->attachToGLContext(I)V

    iput-object v4, v3, LA3/p2;->d:Landroid/graphics/SurfaceTexture;

    iget-object v3, v1, LA3/H2;->f:LA3/p2;

    iget-object v4, v3, LA3/p2;->d:Landroid/graphics/SurfaceTexture;
    ...
    iget-object v3, v3, LA3/p2;->d:Landroid/graphics/SurfaceTexture;

    invoke-virtual {v3}, Landroid/graphics/SurfaceTexture;->updateTexImage()V

    :cond_2
    iget-object v3, v1, LA3/H2;->A:[F
    :try_end_0
    ...
    :try_start_1
    iget-object v3, v1, LA3/H2;->h:Lcom/xiaomi/milab/videosdk/XmsTimeline;
    ...
    iput-object v2, v1, LA3/H2;->h:Lcom/xiaomi/milab/videosdk/XmsTimeline;

    iget v3, v1, LA3/H2;->n:I

    iget v7, v1, LA3/H2;->o:I
    ...
    iget-object v3, v1, LA3/H2;->Y:LA3/H2$a;
    ...
    iget-object v2, v1, LA3/H2;->h:Lcom/xiaomi/milab/videosdk/XmsTimeline;

    invoke-virtual {v2}, Lcom/xiaomi/milab/videosdk/XmsTimeline;->appendVideoTrack()Lcom/xiaomi/milab/videosdk/XmsVideoTrack;

    move-result-object v2

    iput-object v2, v1, LA3/H2;->i:Lcom/xiaomi/milab/videosdk/XmsVideoTrack;
    ...
    iput-object v2, v1, LA3/H2;->j:Lcom/xiaomi/milab/videosdk/XmsAudioTrack;

    iget-object v2, v1, LA3/H2;->i:Lcom/xiaomi/milab/videosdk/XmsVideoTrack;

    iget-object v3, v1, LA3/H2;->f:LA3/p2;

    iget-object v3, v3, LA3/p2;->a:[I

    aget v3, v3, v5

    iget-object v7, v1, LA3/H2;->A:[F
    ...
    iput-object v2, v1, LA3/H2;->k:Lcom/xiaomi/milab/videosdk/XmsVideoClip;

    iget-object v2, v1, LA3/H2;->j:Lcom/xiaomi/milab/videosdk/XmsAudioTrack;

    iget-object v3, v1, LA3/H2;->l:Lcom/xiaomi/microfilm/vlogpro/vp/VPItem;
    ...
    invoke-virtual {p0, v6}, LA3/H2;->g(I)V

    :cond_3
    iget-boolean v2, v1, LA3/H2;->g:Z
    ...
    iget-object v0, v1, LA3/H2;->k:Lcom/xiaomi/milab/videosdk/XmsVideoClip;

    iget-object v2, v1, LA3/H2;->A:[F

    invoke-virtual {v0, v2}, Lcom/xiaomi/milab/videosdk/XmsVideoClip;->updatePreviewMatrix([F)I

    iput-boolean v5, v1, LA3/H2;->g:Z

    iget v0, v1, LA3/H2;->t:I
    ...
    :cond_5
    iget-object v7, v1, LA3/H2;->h:Lcom/xiaomi/milab/videosdk/XmsTimeline;

    if-eqz v7, :cond_a

    iget-boolean v0, v1, LA3/H2;->g:Z
    ...
    :goto_2
    iget-boolean v14, v1, LA3/H2;->C:Z
    ...
    iget-object v0, v1, LA3/H2;->f:LA3/p2;
    ...
    invoke-virtual {v0, v3, v4, v2}, LA3/p2;->b(II[F)V
    ...
    iget-object v4, v1, LA3/H2;->A:[F

    invoke-virtual {v0, v2, v3, v4}, LA3/p2;->b(II[F)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0

    :goto_3
    iget-object v0, v1, LA3/H2;->Q:Ljava/util/concurrent/locks/ReentrantLock;
    ...
    :goto_6
    iget-object v1, v1, LA3/H2;->Q:Ljava/util/concurrent/locks/ReentrantLock;
...
.method public final onFrameAvailable(Landroid/graphics/SurfaceTexture;)V
    ...
    iget-object v1, p0, LA3/H2;->e:Landroid/graphics/SurfaceTexture;
    ...
    :cond_0
    iget-object v1, p0, LA3/H2;->d:Lo5/f;

    iget-boolean v2, p0, LA3/H2;->b:Z

    if-nez v2, :cond_1

    const/4 v2, 0x1

    iput-boolean v2, p0, LA3/H2;->b:Z
    ...
    invoke-direct {v2, p0, v3}, LA/k;-><init>(Ljava/lang/Object;I)V

    invoke-virtual {v0, v2}, Lo5/f;->t(Ljava/lang/Runnable;)V

    iget-object v0, p0, LA3/H2;->A:[F
    ...
    iget-object p0, v1, Lo5/f;->j:LA/L2;

    invoke-virtual {p0}, LA/L2;->e()V

    invoke-virtual {v1}, Lo5/f;->requestRender()V

    iget-object p0, v1, Lo5/f;->j:LA/L2;

    invoke-virtual {p0}, LA/L2;->f()V
