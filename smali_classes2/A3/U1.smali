...
.method public constructor <init>(Lcom/android/camera/ActivityBase;)V
    ...
    iput-boolean v0, p0, LA3/U1;->e:Z

    iput v0, p0, LA3/U1;->f:I

    iput v0, p0, LA3/U1;->g:I

    iput-object p1, p0, LA3/U1;->a:Lcom/android/camera/ActivityBase;
    ...
    invoke-virtual {p1}, L渭渡渣湠渣渧湠渪渫游渧渭渫湠渭渡渣渣渡渠湠渍渡渣渣渡渠;->Y()S
    ...
    :cond_0
    iput-boolean v0, p0, LA3/U1;->b:Z

    return-void
.end method

.method public static Q(Landroid/view/KeyEvent;ILcom/android/camera/module/M;IZ)V
    .locals 9
    ...
    invoke-static {p1}, LA3/U1;->d0(F)F
    ...
    invoke-direct {v3, v0, p0}, LA3/q1;-><init>(ILandroid/view/KeyEvent;)V
    ...
    invoke-direct {v3, p1}, LA3/M1;-><init>(I)V
    ...
    invoke-static {p0, p1}, LA3/U1;->n0(Landroid/view/KeyEvent;Ljava/lang/String;)V
...
.method public static R(I)Z
    ...
    invoke-direct {v0, v2}, LL0/M;-><init>(I)V
    ...
    invoke-direct {v2, p0, v3}, LA3/w1;-><init>(II)V
...
.method public static i0(Lcom/android/camera/data/data/c;IZ)V
    ...
    invoke-direct {v0, p0, v1, p2}, LA3/g1;-><init>(Lcom/android/camera/data/data/c;IZ)V
    ...
    invoke-direct {v0, p0, p2}, LA3/N1;-><init>(Lcom/android/camera/data/data/c;Z)V
    ...
    invoke-direct {v1, p0, p2, p1, v2}, LA3/K1;-><init>(Ljava/lang/Object;ZII)V
    ...
    new-instance v3, LA3/I1;

    invoke-direct {v3, p0, v0, p2, p1}, LA3/I1;-><init>(Lcom/android/camera/data/data/c;IZI)V
    ...
    invoke-direct {v1, p0, p1, p2}, LA3/L1;-><init>(Lcom/android/camera/data/data/c;IZ)V
...
.method public static l(ILcom/android/camera/module/M;)Z
    .locals 5
    ...
    invoke-direct {v1, v0, p1, v2}, LA3/O1;-><init>(Ljava/lang/Object;II)V
...
.method public static o(ILcom/android/camera/module/M;)V
    .locals 9
    .annotation build Lcom/android/camera/jacoco/JacocoForceIgnore;
    .end annotation
    ...
    :goto_2
    new-instance v5, LA3/U1$a;

    invoke-direct {v5, v4, p1}, LA3/U1$a;-><init>(ILcom/android/camera/module/M;)V

    invoke-static {}, LV3/J;->impl()Ljava/util/Optional;

    move-result-object v7

    new-instance v8, LA3/H1;
    ...
    invoke-direct/range {v0 .. v5}, LA3/H1;-><init>(FZZILA3/U1$b;)V
...
.method public final F5()V
    ...
    iput-boolean v0, p0, LA3/U1;->d:Z

    iput-boolean v0, p0, LA3/U1;->c:Z
...
.method public final W()Ljava/util/Optional;
    ...
    iget-object p0, p0, LA3/U1;->a:Lcom/android/camera/ActivityBase;
...
.method public final f0(Ljava/lang/String;ZZ)V
    ...
    :cond_0
    invoke-virtual/range {p0 .. p0}, LA3/U1;->W()Ljava/util/Optional;
    ...
    invoke-interface {v13}, Lcom/android/camera/module/M;->getModuleState()Ls3/f;
    ...
    new-instance v15, LA3/I0;

    invoke-direct {v15, v10}, LA3/I0;-><init>(I)V
    ...
    invoke-direct {v3, v11}, Lq2/a;-><init>(I)V
    ...
    invoke-direct {v3, v0, v1, v13}, LA3/E1;-><init>(Lb0/X;ZI)V
    ...
    invoke-direct {v3, v7}, LA/u1;-><init>(I)V
    ...
    invoke-interface {v0}, Lcom/android/camera/module/M;->getApertureManager()LP/f;
    ...
    invoke-direct {v3, v4, v11}, LA/r2;-><init>(IB)V
    ...
    :cond_15
    :pswitch_3
    invoke-static {v0, v13, v1}, LA3/U1;->i0(Lcom/android/camera/data/data/c;IZ)V
    ...
    invoke-static {v0, v8, v9, v13, v1}, LA3/U1;->Q(Landroid/view/KeyEvent;ILcom/android/camera/module/M;IZ)V
    ...
    invoke-direct {v4, v2, v13, v1, v0}, LA3/A1;-><init>(ZIZLf0/b0;)V
    ...
    :cond_1b
    invoke-static {v8, v9}, LA3/U1;->l(ILcom/android/camera/module/M;)Z
    ...
    :goto_2
    invoke-static {v0, v9}, LA3/U1;->l(ILcom/android/camera/module/M;)Z
    ...
    :cond_1e
    invoke-static {v8, v9}, LA3/U1;->o(ILcom/android/camera/module/M;)V
    ...
    invoke-direct {v3, v4}, LA/p1;-><init>(I)V
    ...
    invoke-direct {v3, v0, v1, v11}, LA3/v1;-><init>(Ljava/lang/Object;ZI)V
    ...
    invoke-direct {v3, v4, v0, v1, v13}, LA3/u1;-><init>(LA3/U1;Lb0/D0;ZI)V
    ...
    invoke-direct {v2, v11}, LA3/x1;-><init>(I)V
    ...
    invoke-direct {v3, v4}, LA3/o1;-><init>(I)V
    ...
    :cond_27
    invoke-static {v13}, LA3/U1;->R(I)Z
    ...
    invoke-direct {v2, v0, v11}, LA3/y1;-><init>(Ljava/lang/String;I)V
...
.method public final onGenericMotionEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-direct {v5, p1, v6}, LA3/m1;-><init>(Landroid/view/MotionEvent;I)V
    ...
    invoke-virtual {p0, p1, v0, v2}, LA3/U1;->f0(Ljava/lang/String;ZZ)V
    ...
    invoke-direct {v5, p1, v6}, LA3/r1;-><init>(Landroid/view/MotionEvent;I)V
    ...
    :cond_2
    iget p1, p0, LA3/U1;->g:I

    add-int/2addr p1, v1

    :goto_1
    iput p1, p0, LA3/U1;->g:I

    if-eqz v0, :cond_3

    iget v0, p0, LA3/U1;->f:I
    ...
    invoke-virtual {p0, v0, p1, v1}, LA3/U1;->f0(Ljava/lang/String;ZZ)V

    iput v2, p0, LA3/U1;->f:I

    iput v2, p0, LA3/U1;->g:I
...
.method public final onKeyDown(ILandroid/view/KeyEvent;)Z
    ...
    invoke-static {v0, v5}, LA/P;->c(ILjava/lang/String;)Ljava/lang/String;
    ...
    iget-object v0, v11, LA3/U1;->a:Lcom/android/camera/ActivityBase;
    ...
    invoke-interface {v1, v6, v0}, LV3/A0;->Y5(ILjava/lang/String;)V
    ...
    invoke-interface {v15}, Lcom/android/camera/module/M;->getUserEventMgr()Ls3/i;
    ...
    invoke-interface {v14}, Lcom/android/camera/module/M;->getModuleIndex()I
    ...
    new-instance v15, LA3/C1;

    invoke-direct {v15, v10, v4}, LA3/C1;-><init>(II)V
    ...
    :cond_18
    invoke-static {v14}, LA3/U1;->R(I)Z
    ...
    invoke-direct {v2, v8, v14}, LA3/W0;-><init>(ZI)V
    ...
    invoke-direct {v3, v1, v8, v14}, LA3/T0;-><init>(IZI)V
    ...
    invoke-direct {v2, v14, v7}, LA3/s1;-><init>(II)V
    ...
    invoke-direct {v2, v14, v8}, LA3/t1;-><init>(IZ)V
    ...
    invoke-static {v5, v0, v1, v2}, LA3/h2;->f(IILjava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {v2, v7}, LA3/B1;-><init>(I)V
    ...
    :cond_21
    invoke-virtual/range {p0 .. p2}, LA3/U1;->s(ILandroid/view/KeyEvent;)V
...
.method public final onKeyUp(ILandroid/view/KeyEvent;)Z
    ...
    invoke-static {v1, v14}, LA/P;->c(ILjava/lang/String;)Ljava/lang/String;
    ...
    :cond_3
    invoke-virtual {v0, v4, v2}, LA3/U1;->s(ILandroid/view/KeyEvent;)V

    return v13

    :cond_4
    invoke-virtual {v0, v3, v2}, LA3/U1;->s(ILandroid/view/KeyEvent;)V
    ...
    new-instance v8, LA3/k1;

    invoke-direct {v8, v9, v2}, LA3/k1;-><init>(ILandroid/view/KeyEvent;)V
    ...
    iget-object v1, v0, LA3/U1;->a:Lcom/android/camera/ActivityBase;
    ...
    invoke-interface {v10}, Lcom/android/camera/module/M;->getModuleIndex()I
    ...
    invoke-direct {v3, v12}, LA/B1;-><init>(I)V
    ...
    invoke-direct {v4, v7}, LA/n0;-><init>(I)V
    ...
    new-instance v7, LA3/n1;

    invoke-direct {v7, v10, v9}, LA3/n1;-><init>(II)V
    ...
    invoke-direct {v1, v10, v9}, LA3/j1;-><init>(II)V
    ...
    invoke-direct {v1, v11}, LA/H0;-><init>(I)V
    ...
    invoke-direct {v2, v9}, LA3/o1;-><init>(I)V
    ...
    :cond_28
    invoke-static {v10}, LA3/U1;->R(I)Z
    ...
    invoke-direct {v1, v10, v2}, LA/Q0;-><init>(II)V
    ...
    invoke-direct {v1, v10, v9}, LA3/l1;-><init>(II)V
    ...
    invoke-direct {v1, v3}, LA/v1;-><init>(I)V
    ...
    invoke-static {v2, v0}, LA3/U1;->n0(Landroid/view/KeyEvent;Ljava/lang/String;)V
    ...
    iget-object v2, v0, LG7/b;->e:L渭渡渣湠渣渧湠渪渫游渧渭渫湠渭渡渣渣渡渠湠渍渡渣渣渡渠;

    invoke-virtual {v2}, L渭渡渣湠渣渧湠渪渫游渧渭渫湠渭渡渣渣渡渠湠渍渡渣渣渡渠;->t7()Z
    ...
    invoke-virtual {v0}, L渭渡渣湠渣渧湠渪渫游渧渭渫湠渭渡渣渣渡渠湠渍渡渣渣渡渠;->u7()Z
    ...
    invoke-virtual {v0}, L渭渡渣湠渣渧湠渪渫游渧渭渫湠渭渡渣渣渡渠湠渍渡渣渣渡渠;->g6()Z
...
.method public final s(ILandroid/view/KeyEvent;)V
    ...
    invoke-virtual {p0}, LA3/U1;->W()Ljava/util/Optional;
    ...
    :cond_1
    iget-boolean v1, p0, LA3/U1;->c:Z

    if-nez v1, :cond_2

    iget-boolean v1, p0, LA3/U1;->d:Z
    ...
    invoke-direct {v1, p1}, LA3/M1;-><init>(I)V
    ...
    invoke-direct {v1, p2, v2}, LA/A1;-><init>(Ljava/lang/Object;I)V
    ...
    :cond_4
    iput-boolean v4, p0, LA3/U1;->d:Z

    goto :goto_0

    :cond_5
    iget-boolean v0, p0, LA3/U1;->c:Z
    ...
    :cond_8
    iput-boolean v3, p0, LA3/U1;->d:Z

    goto :goto_0

    :cond_9
    iput-boolean v3, p0, LA3/U1;->c:Z
    ...
    invoke-direct {v0, p1, p2}, LA3/p1;-><init>(ILandroid/view/KeyEvent;)V
    ...
    invoke-direct {v2, p2, v5}, LA3/a1;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-direct {v2, p2, v4}, LA3/i1;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-static {p1, v0}, LA3/U1;->l(ILcom/android/camera/module/M;)Z

    iput-boolean v3, p0, LA3/U1;->e:Z

    goto :goto_2

    :cond_f
    invoke-static {p1, v0}, LA3/U1;->o(ILcom/android/camera/module/M;)V

    const-string/jumbo p1, "zoom"

    invoke-static {p2, p1}, LA3/U1;->n0(Landroid/view/KeyEvent;Ljava/lang/String;)V
    ...
    invoke-static {p2, p1, v0, p0, v3}, LA3/U1;->Q(Landroid/view/KeyEvent;ILcom/android/camera/module/M;IZ)V
