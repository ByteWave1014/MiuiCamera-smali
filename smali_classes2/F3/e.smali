...
.method public constructor <init>()V
    ...
    iput-object v0, p0, LF3/e;->h:Ljava/util/List;

    new-instance v0, LF3/g;

    invoke-direct {v0, p0}, LF3/g;-><init>(LF3/e;)V

    iput-object v0, p0, LF3/e;->k:LF3/g;
...
.method public final A()I
    ...
    invoke-virtual {p0}, LF3/e;->isInitialized()Z
    ...
    :cond_0
    iget-object p0, p0, LF3/e;->i:Landroid/util/SparseIntArray;
...
.method public final declared-synchronized B()I
    ...
    :cond_0
    :try_start_1
    iget-object v0, p0, LF3/e;->i:Landroid/util/SparseIntArray;
...
.method public final N()Ljava/util/concurrent/ConcurrentHashMap;
    ...
    sget-object v2, LM0/i;->b:LM0/i;

    if-eqz v1, :cond_0

    invoke-virtual {p0}, LF3/e;->p()I
...
.method public final declared-synchronized S()Landroid/util/SparseArray;
    ...
    iget-object v0, p0, LF3/b;->b:Landroid/util/SparseArray;
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
...
.method public final V(LA/S;)V
    .locals 9

    iget-object p0, p0, LF3/e;->k:LF3/g;
    ...
    :try_start_0
    iput-object p1, p0, LF3/g;->c:LA/S;
    ...
    iget-boolean p1, p0, LF3/g;->d:Z

    if-eqz p1, :cond_0

    iget-object v2, p0, LF3/g;->c:LA/S;

    iget-object p1, p0, LF3/g;->b:LF3/e;

    invoke-virtual {p1}, LF3/e;->P()I
    ...
    iget-object v7, p1, LF3/e;->j:Ljava/util/ArrayList;

    iget-object p0, p0, LF3/g;->b:LF3/e;

    iget-object v8, p0, LF3/b;->c:Landroid/util/SparseArray;

    invoke-virtual/range {v2 .. v8}, LA/S;->j(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/util/ArrayList;Landroid/util/SparseArray;)V
...
.method public final declared-synchronized c()I
    ...
    iget-object v3, p0, LF3/e;->i:Landroid/util/SparseIntArray;
...
.method public final declared-synchronized h(I)Z
    ...
    iget-object v4, p0, LF3/e;->i:Landroid/util/SparseIntArray;
...
.method public final declared-synchronized k(I)Ljava/util/List;
    ...
    :goto_0
    iget-object v2, p0, LF3/e;->i:Landroid/util/SparseIntArray;
...
.method public final l(Z)V
    ...
    :try_start_0
    invoke-virtual {p0}, LF3/e;->reset()V

    new-instance v1, LL3/d;

    const-string v2, "CameraServerWatchDog"

    invoke-direct {v1, v2}, LL3/r;-><init>(Ljava/lang/String;)V

    new-instance v2, LL3/e;

    invoke-direct {v2}, Ljava/lang/Object;-><init>()V

    iput-object v2, v1, LL3/d;->g:LL3/e;

    iput-object v2, v1, LL3/r;->b:LL3/r$a;

    const/16 v2, 0x1388

    invoke-virtual {v1, v2}, LL3/r;->a(I)V
    ...
    invoke-virtual {p0, v2, p1}, LF3/b;->Q(Landroid/hardware/camera2/CameraManager;Z)[Ljava/lang/String;
    ...
    sget-object p1, LL3/n;->q:LL3/n;

    invoke-static {}, Landroid/os/SystemClock;->elapsedRealtime()J

    move-result-wide v6

    sget-wide v8, LL3/n;->v:J

    cmp-long p1, v8, v4

    if-nez p1, :cond_0

    sput-wide v6, LL3/n;->v:J
    ...
    invoke-virtual {p1, v0, v8, v9, v2}, LL3/n;->a(LL3/a;J[Ljava/lang/String;)V

    :cond_1
    :goto_0
    invoke-virtual {v1}, LL3/r;->b()V

    invoke-virtual {v1}, LL3/d;->c()V
    ...
    iput-object v0, p0, LF3/e;->j:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, LF3/b;->b:Landroid/util/SparseArray;
    ...
    iput-object v0, p0, LF3/e;->i:Landroid/util/SparseIntArray;
    ...
    iput-object v0, p0, LF3/b;->c:Landroid/util/SparseArray;
    ...
    iget-object v7, p0, LF3/b;->d:Landroid/util/SparseArray;

    invoke-virtual {v7, v5, v6}, Landroid/util/SparseArray;->put(ILjava/lang/Object;)V

    sget-object v7, Ln6/h;->A0:Ln6/K;

    const v8, 0xbabe

    invoke-static {v6, v7, v8}, Ln6/L;->g(Landroid/hardware/camera2/CameraCharacteristics;Ln6/K;I)Ljava/lang/Object;
    ...
    iget-object v11, p0, LF3/e;->i:Landroid/util/SparseIntArray;

    invoke-virtual {v11, v10, v5}, Landroid/util/SparseIntArray;->put(II)V

    if-eq v10, v9, :cond_4

    iget-object v11, p0, LF3/e;->h:Ljava/util/List;
    ...
    iget-object v10, p0, LF3/e;->j:Ljava/util/ArrayList;
    ...
    :goto_4
    iget-object v7, p0, LF3/e;->i:Landroid/util/SparseIntArray;

    invoke-virtual {v7, v6, v5}, Landroid/util/SparseIntArray;->put(II)V

    if-eq v6, v9, :cond_7

    iget-object v5, p0, LF3/e;->h:Ljava/util/List;
    ...
    iget-object v5, p0, LF3/e;->j:Ljava/util/ArrayList;
    ...
    invoke-direct {v1, v3, p1, p0, v2}, LF3/d;-><init>(ILjava/io/Serializable;Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    invoke-static {p1, v1}, LA/Q;->i(Ljava/lang/Exception;Ljava/lang/String;)Ljava/lang/String;
...
.method public final declared-synchronized reset()V
    ...
    iget-object v0, p0, LF3/b;->d:Landroid/util/SparseArray;

    invoke-virtual {v0}, Landroid/util/SparseArray;->clear()V

    iput-boolean v2, p0, LF3/b;->f:Z
...
.method public final declared-synchronized y()[I
    ...
    iget-object v1, p0, LF3/e;->i:Landroid/util/SparseIntArray;
