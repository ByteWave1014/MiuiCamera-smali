...
.method public synthetic constructor <init>(Landroid/app/Application;[BZLandroid/net/Uri;Ljava/lang/String;Landroid/location/Location;IIIJIZ)V
    ...
    iput-object p1, p0, Ll4/z;->a:Landroid/app/Application;

    iput-object p2, p0, Ll4/z;->b:[B

    iput-boolean p3, p0, Ll4/z;->c:Z

    iput-object p4, p0, Ll4/z;->d:Landroid/net/Uri;

    iput-object p5, p0, Ll4/z;->e:Ljava/lang/String;

    iput-object p6, p0, Ll4/z;->f:Landroid/location/Location;

    iput p7, p0, Ll4/z;->g:I

    iput p8, p0, Ll4/z;->h:I

    iput p9, p0, Ll4/z;->i:I

    iput-wide p10, p0, Ll4/z;->j:J

    iput p12, p0, Ll4/z;->k:I

    iput-boolean p13, p0, Ll4/z;->l:Z
...
.method public final invoke()Ljava/lang/Object;
    ...
    iget-object v9, v1, Ll4/z;->d:Landroid/net/Uri;
    ...
    iget-object v14, v1, Ll4/z;->a:Landroid/app/Application;
    ...
    :goto_0
    invoke-static/range {v17 .. v23}, Lq4/c;->a(JLjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Z)Lq4/c;
    ...
    :cond_3
    :goto_3
    iget-boolean v5, v1, Ll4/z;->c:Z

    iget-object v6, v1, Ll4/z;->e:Ljava/lang/String;

    if-eqz v0, :cond_5

    iget-object v7, v0, Lq4/c;->b:Ljava/lang/String;

    if-eqz v7, :cond_5

    iget-boolean v15, v0, Lq4/c;->d:Z
    ...
    :cond_5
    :goto_5
    invoke-static {v6, v5}, Ll4/A;->e(Ljava/lang/String;Z)Ljava/lang/String;
    ...
    :cond_6
    invoke-static {v6}, LA/c0;->e(Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    iget-object v13, v0, Lq4/c;->b:Ljava/lang/String;
    ...
    iget-object v2, v1, Ll4/z;->b:[B

    iget v8, v1, Ll4/z;->k:I
    ...
    :try_start_3
    sget-object v0, Ll4/o;->a:Ljava/io/File;
    ...
    invoke-static {v13}, LY9/d;->l(Ljava/lang/String;)Z
    ...
    sget-object v3, Ll4/o;->a:Ljava/io/File;

    invoke-direct {v0, v3, v7}, Ljava/io/File;-><init>(Ljava/io/File;Ljava/lang/String;)V

    invoke-static {v0, v2}, Ljc/y;->q(Ljava/io/File;[B)V
    :try_end_5
    .catchall {:try_start_5 .. :try_end_5} :catchall_3

    if-eqz v1, :cond_e

    invoke-static {v13}, LY9/d;->m(Ljava/lang/String;)V
    ...
    :goto_13
    :try_start_b
    invoke-static {v0, v15}, Ll4/A;->b(Ljava/lang/Exception;Ljava/lang/String;)V
    ...
    invoke-static {v0}, Ll4/A;->s(Ljava/lang/Exception;)Z

    move-result v0

    if-eqz v0, :cond_13

    sget-object v0, Ll4/A;->r:Lcom/xiaomi/camera/utils/lifecycle/FreshLiveData;
    ...
    invoke-static {v14, v9, v3}, Lq4/d;->g(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;)Z
    ...
    invoke-static {v4, v0}, LA3/E2;->e(Ljava/io/File;Ljava/lang/StringBuilder;)Ljava/lang/String;
    ...
    iget-object v7, v3, Ll4/z;->f:Landroid/location/Location;
    ...
    invoke-static/range {v3 .. v8}, Ll4/A;->z(Landroid/app/Application;Landroid/net/Uri;Landroid/content/ContentValues;Ljava/lang/String;[BI)I
    ...
    invoke-static/range {v13 .. v24}, Ll4/A;->y(IJJJLandroid/content/Context;Landroid/location/Location;Ljava/lang/String;ZZ)V
