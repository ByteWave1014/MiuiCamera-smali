...
.method public final run()V
    ...
    iget-object v9, v8, Laa/o;->r:Laa/p;

    iget v10, v9, Laa/p;->q:I

    iget v11, v9, Laa/p;->r:I

    iget v12, v9, Laa/p;->s:I

    sget-boolean v13, LG7/b;->i:Z

    sget-object v13, LG7/b$b;->a:LG7/b;

    iget-object v14, v13, LG7/b;->e:L渭渡渣湠渣渧湠渪渫游渧渭渫湠渭渡渣渣渡渠湠渍渡渣渣渡渠;

    invoke-virtual {v14}, L渭渡渣湠渣渧湠渪渫游渧渭渫湠渭渡渣渣渡渠湠渍渡渣渣渡渠;->D4()Z

    move-result v14

    if-eqz v14, :cond_0

    iget-object v14, v8, Laa/o;->n:[B

    goto :goto_0

    :cond_0
    iget-object v14, v8, Laa/o;->j:[B

    :goto_0
    iget v15, v9, Laa/p;->n:I

    move-object/from16 v47, v1

    iget v1, v9, Laa/p;->p:I

    move-object/from16 v48, v2

    iget-boolean v2, v9, Laa/p;->b0:Z
    ...
    iget-object v10, v9, Laa/p;->M:Landroid/util/Size;

    invoke-virtual {v10}, Landroid/util/Size;->getHeight()I

    move-result v10

    iget-object v11, v9, Laa/p;->D:Landroid/location/Location;

    iget-object v12, v9, Laa/p;->P:Ljava/lang/String;

    iget-object v15, v9, Laa/p;->Q:LG9/f;

    iget v6, v9, Laa/p;->x:I
    ...
    invoke-static {v6, v4, v15, v7, v12}, LA/N;->f(IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    iget-boolean v12, v8, Laa/o;->h0:Z
    ...
    iget-object v15, v8, Laa/o;->q:Ljava/lang/String;
    ...
    invoke-static {v7}, Ljc/y;->h(Ljava/io/File;)Ljava/lang/String;

    move-result-object v4

    iget-boolean v7, v8, Laa/o;->h0:Z
    ...
    iget-object v1, v9, Laa/p;->k:Landroid/util/Size;
    ...
    iget v1, v9, Laa/p;->n:I

    iget v4, v9, Laa/p;->o:I

    iget v7, v9, Laa/p;->p:I

    move/from16 v56, v6

    iget v6, v9, Laa/p;->q:I

    move/from16 v57, v2

    iget v2, v9, Laa/p;->r:I
    ...
    iget v12, v9, Laa/p;->t:I

    move/from16 v60, v10

    iget v10, v9, Laa/p;->u:I

    move/from16 v61, v5

    iget v5, v9, Laa/p;->v:I

    iget-object v15, v9, Laa/p;->M:Landroid/util/Size;
    ...
    iget v15, v9, Laa/p;->x:I

    move-object/from16 v62, v13

    iget v13, v9, Laa/p;->y:I

    iget v0, v9, Laa/p;->A:I

    move/from16 v31, v0

    iget-object v0, v9, Laa/p;->I:Ljava/lang/String;

    move-object/from16 v33, v0

    iget-boolean v0, v9, Laa/p;->c:Z
    ...
    iget-boolean v0, v9, Laa/p;->f:Z

    move/from16 v36, v0

    iget-object v0, v9, Laa/p;->T:Lrc/b;

    move-object/from16 v37, v0

    iget-object v0, v9, Laa/p;->Q:LG9/f;

    move-object/from16 v38, v0

    iget-object v0, v9, Laa/p;->S:Ljava/lang/String;
    ...
    iget-object v15, v8, Laa/o;->t0:Lcom/xiaomi/camera/core/EffectData;

    invoke-virtual {v15}, Lcom/xiaomi/camera/core/EffectData;->getEffectRectAttribute()LP0/c;

    move-result-object v42

    iget-object v15, v9, Laa/p;->o0:Ljava/util/ArrayList;

    move-object/from16 v63, v8

    iget-object v8, v9, Laa/p;->p0:Landroid/graphics/Rect;

    move-object/from16 v44, v8

    iget-object v8, v9, Laa/p;->q0:Ljava/util/ArrayList;
    ...
    invoke-static/range {v15 .. v46}, Ll4/a;->e([BIIIIIIIIIIIIIIIIZLjava/lang/String;ZZZLrc/b;LG9/f;Ljava/lang/String;IZLP0/c;Ljava/util/ArrayList;Landroid/graphics/Rect;Ljava/util/ArrayList;Z)LJ9/f;

    move-result-object v0

    invoke-static {v14}, Lp8/a;->c([B)Lp8/b;

    move-result-object v1

    iget-object v2, v9, Laa/p;->P:Ljava/lang/String;
    ...
    iget-object v3, v2, Ll4/b;->b:Ll4/t;
    ...
    invoke-virtual {v3, v0, v1, v4}, Ll4/j;->v(LJ9/f;Lp8/b;LV0/g;)V
    ...
    iget-boolean v7, v3, Laa/p;->i:Z

    iget v4, v3, Laa/p;->x:I

    int-to-float v8, v4

    iget-boolean v9, v1, Laa/o;->Y:Z

    iget-object v4, v3, Laa/p;->T:Lrc/b;

    iget-boolean v10, v4, Lrc/b;->b:Z

    iget-boolean v11, v3, Laa/p;->b0:Z
    ...
    invoke-static {v4, v3}, Ljc/e;->f(ILandroid/graphics/Bitmap;)[B
    ...
    :goto_4
    iget-boolean v0, v1, Laa/o;->h0:Z

    if-nez v0, :cond_10

    iget-object v0, v1, Laa/o;->r:Laa/p;
    ...
    iget-object v0, v2, Ll4/b;->d:Laa/o;

    invoke-virtual {v0, v14}, Laa/o;->j([B)V

    iget-object v0, v2, Ll4/b;->d:Laa/o;

    iget-object v5, v0, Laa/o;->r:Laa/p;

    iget-boolean v6, v5, Laa/p;->a:Z
    ...
    :cond_7
    iget-object v6, v0, Laa/o;->h:Landroid/hardware/camera2/TotalCaptureResult;

    iget-object v7, v0, Laa/o;->i:Landroid/hardware/camera2/CaptureResult;

    iget-object v5, v5, Laa/p;->D:Landroid/location/Location;

    iget-boolean v8, v0, Laa/o;->v:Z
    ...
    iget v5, v5, Laa/p;->w:I

    new-instance v6, Lua/a;

    invoke-direct {v6, v10, v12, v5}, Lua/a;-><init>(Landroid/graphics/Bitmap;LIc/b;I)V
    ...
    invoke-virtual/range {v62 .. v62}, LG7/b;->n()Ljava/lang/String;

    invoke-static {}, Lcom/android/camera/data/data/s;->p0()Z

    move-result v5

    iput-boolean v5, v6, Lua/a;->t:Z
    ...
    :cond_d
    invoke-static {v7}, LD5/c;->b(Landroid/hardware/camera2/CaptureResult;)Lua/b;
    ...
    iget-object v13, v0, Laa/o;->W:Ljava/lang/String;
    ...
    invoke-virtual {v6}, Lua/b;->toString()Ljava/lang/String;
    ...
    iget-object v7, v0, Laa/o;->r:Laa/p;

    iget-boolean v7, v7, Laa/p;->h0:Z
    ...
    invoke-virtual {v7, v11, v13}, Lea/a;->g(Ljava/lang/String;Z)Z
    ...
    :cond_e
    iget-object v11, v0, Laa/o;->r:Laa/p;

    iget-wide v13, v11, Laa/p;->K:J
    ...
    iget-wide v13, v6, Lua/b;->a:J

    :cond_f
    iget-object v15, v11, Laa/p;->F:Ljava/lang/String;

    iget-boolean v3, v11, Laa/p;->G:Z

    iget v4, v11, Laa/p;->w:I

    move-object/from16 v63, v1

    new-instance v1, Lua/a;

    invoke-direct {v1, v10, v12, v4}, Lua/a;-><init>(Landroid/graphics/Bitmap;LIc/b;I)V

    iget-object v4, v11, Laa/p;->E:Ljava/lang/String;

    iput-object v4, v1, Lua/a;->a:Ljava/lang/String;

    iput-object v5, v1, Lua/a;->k:Landroid/location/Location;

    iput-object v15, v1, Lua/a;->l:Ljava/lang/String;

    iget-object v4, v11, Laa/p;->H:Ljava/lang/String;

    iput-object v4, v1, Lua/a;->m:Ljava/lang/String;

    iput-boolean v3, v1, Lua/a;->n:Z

    iget-short v3, v6, Lua/b;->c:S

    iput-short v3, v1, Lua/a;->f:S

    iget v3, v6, Lua/b;->d:F

    iput v3, v1, Lua/a;->g:F

    iput-wide v13, v1, Lua/a;->h:J

    invoke-virtual/range {v62 .. v62}, LG7/b;->n()Ljava/lang/String;

    iget v3, v6, Lua/b;->b:I
    ...
    iput-object v9, v1, Lua/a;->o:[B

    invoke-static {}, Lcom/android/camera/data/data/s;->A()Ljava/lang/String;

    iput-boolean v7, v1, Lua/a;->t:Z
    ...
    invoke-virtual {v1, v6}, LD5/b;->g(Lua/a;)Landroid/graphics/Bitmap;
    ...
    iput-object v6, v4, Laa/p;->M:Landroid/util/Size;

    invoke-virtual {v0, v3}, Laa/o;->j([B)V

    iget-object v0, v0, Laa/o;->r0:Laa/g;

    iput-boolean v8, v0, Laa/g;->a:Z

    :goto_c
    iget-object v0, v2, Ll4/b;->d:Laa/o;

    iget-object v14, v0, Laa/o;->j:[B

    iget-object v0, v0, Laa/o;->r:Laa/p;

    iget-object v0, v0, Laa/p;->M:Landroid/util/Size;
    ...
    iget-boolean v1, v0, Laa/o;->C:Z

    iput-boolean v1, v2, Ll4/b;->f:Z

    iget-object v1, v0, Laa/o;->q:Ljava/lang/String;

    iput-object v1, v2, Ll4/a;->C:Ljava/lang/String;
    ...
    iget-object v0, v2, Ll4/b;->b:Ll4/t;
    ...
    iget-object v3, v5, LG7/b;->e:L渭渡渣湠渣渧湠渪渫游渧渭渫湠渭渡渣渣渡渠湠渍渡渣渣渡渠;

    invoke-virtual {v3}, L渭渡渣湠渣渧湠渪渫游渧渭渫湠渭渡渣渣渡渠湠渍渡渣渣渡渠;->Z6()Z
    ...
    invoke-direct {v4, v2}, Ll4/p;-><init>(Ll4/q;)V
    ...
    invoke-static {v4, v3}, Laa/D;->q(Lio/reactivex/Scheduler;Ljava/lang/Runnable;)Lio/reactivex/disposables/Disposable;
    ...
    iget-object v4, v2, Ll4/b;->b:Ll4/t;
    ...
    iget-object v7, v2, Ll4/q;->d0:Landroid/util/Size;
    ...
    iget-object v5, v2, Ll4/b;->d:Laa/o;

    iget-boolean v5, v5, Laa/o;->l0:Z

    iget-object v5, v2, Ll4/b;->b:Ll4/t;

    check-cast v5, Ll4/j;

    invoke-virtual {v5, v0, v4}, Ll4/j;->u(LA/a4;Z)V
    ...
    iget-object v8, v2, Ll4/b;->d:Laa/o;
    ...
    iget-object v5, v5, Laa/o;->r0:Laa/g;
    ...
    invoke-direct {v5, v2, v0, v3}, LA/z;-><init>(Ll4/q;LA/a4;Landroid/net/Uri;)V
