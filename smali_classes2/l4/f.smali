...
.method public static d(Landroid/media/Image;Landroid/util/Size;)[B
    ...
    sget-object v4, LC9/e;->a:Ljava/lang/String;
    ...
    invoke-static {v4, v2}, LVa/a;->j(Ljava/lang/StringBuilder;[I)Ljava/lang/String;
    ...
    invoke-static {v12, v13, v14}, LA3/h2;->i(ILjava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
...
.method public final e(Landroid/media/Image;[BZLjava/lang/String;JILjava/lang/String;IILandroid/location/Location;I)Landroid/net/Uri;
    ...
    invoke-static {v3, v15}, LVa/a;->g(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v15, v4}, LA/H2;->d(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static/range {v3 .. v19}, Ll4/A;->m(Landroid/app/Application;Ljava/lang/String;Ljava/lang/String;JLjava/lang/String;ILjava/lang/String;JIILandroid/location/Location;ZZJ)Landroid/net/Uri;
    ...
    :try_start_3
    invoke-direct/range {v12 .. v17}, LTa/g$a;-><init>(Ljava/lang/String;Ljava/io/FileDescriptor;III)V
    ...
    invoke-direct/range {v10 .. v15}, LTa/g$a;-><init>(Ljava/lang/String;Ljava/io/FileDescriptor;III)V

    move-object/from16 v11, v16

    :goto_4
    iget-object v10, v3, Ll4/b;->d:Laa/o;

    iget-object v10, v10, Laa/o;->r:Laa/p;

    iget v10, v10, Laa/p;->y:I

    iput-object v1, v11, LTa/g$a;->j:Landroid/os/Handler;

    move/from16 v1, p12

    invoke-virtual {v11, v1}, LTa/g$a;->b(I)V

    invoke-virtual {v11, v10}, LTa/g$a;->c(I)V

    invoke-virtual {v11}, LTa/g$a;->a()LTa/g;

    move-result-object v1

    const/4 v10, 0x0

    invoke-virtual {v1, v10}, LTa/i;->b(Z)V

    iget v10, v1, LTa/i;->a:I

    const/4 v11, 0x1

    if-ne v10, v11, :cond_5

    iget-object v10, v1, LTa/i;->h:LTa/f;

    iget v12, v10, LTa/d;->j:I

    if-ne v12, v11, :cond_4

    iget-object v10, v10, LTa/d;->Y:Landroid/view/Surface;
    ...
    invoke-virtual {v1, v9}, LTa/i;->b(Z)V

    iput-boolean v11, v1, LTa/i;->l:Z

    iget-object v9, v1, LTa/i;->h:LTa/f;

    iget-object v9, v9, LTa/d;->f:Landroid/media/MediaCodec;
    ...
    invoke-virtual {v1, v0, v2}, LTa/i;->a(I[B)V
    ...
    invoke-virtual {v1}, LTa/i;->close()V
    ...
    iget-object v12, v3, Ll4/b;->d:Laa/o;

    iget-object v12, v12, Laa/o;->r:Laa/p;

    iget-object v12, v12, Laa/p;->M:Landroid/util/Size;
    ...
    :goto_a
    iget-object v3, v3, Ll4/b;->d:Laa/o;

    iget-object v3, v3, Laa/o;->r:Laa/p;

    iget v3, v3, Laa/p;->y:I

    iput-object v9, v11, LTa/g$a;->j:Landroid/os/Handler;

    invoke-virtual {v11, v1}, LTa/g$a;->b(I)V

    invoke-virtual {v11, v3}, LTa/g$a;->c(I)V
    ...
    invoke-virtual {v1, v3}, LTa/i;->b(Z)V

    const/4 v3, 0x1

    iput-boolean v3, v1, LTa/i;->l:Z

    iget-object v3, v1, LTa/i;->h:LTa/f;

    iget-object v3, v3, LTa/d;->f:Landroid/media/MediaCodec;
    ...
    iget v12, v10, LTa/d;->k:I

    iget v13, v10, LTa/d;->l:I
    ...
    invoke-virtual {v10, v0}, LTa/d;->a([B)V
...
.method public final run()V
    ...
    iget-object v0, v14, Ll4/b;->d:Laa/o;

    iget-object v12, v0, Laa/o;->q:Ljava/lang/String;
    ...
    iget-wide v6, v0, Laa/o;->I:J

    iget-object v0, v0, Laa/o;->r:Laa/p;

    iget v10, v0, Laa/p;->U:I

    iget v9, v0, Laa/p;->y:I

    iget-object v8, v0, Laa/p;->D:Landroid/location/Location;

    iget v5, v0, Laa/p;->s0:I
    ...
    iget-object v0, v14, Ll4/f;->u:Landroid/hardware/camera2/TotalCaptureResult;

    iget v3, v14, Ll4/b;->i:I

    iget v4, v14, Ll4/b;->j:I

    sget-object v16, Lp8/a;->a:Ljava/nio/charset/Charset;

    new-instance v15, Lp8/b;

    invoke-direct {v15}, Lp8/b;-><init>()V

    move/from16 v17, v5

    if-eqz v0, :cond_0

    invoke-static {v15}, Ll4/d;->g(Lp8/b;)Ll4/d$a;

    move-result-object v5

    invoke-virtual {v5, v9, v3, v4}, Ll4/d$a;->b(III)V

    iput-wide v6, v5, Ll4/d$a;->c:J

    iput-object v8, v5, Ll4/d$a;->j:Landroid/location/Location;

    const-wide/16 v3, 0x0

    iput-wide v3, v5, Ll4/d$a;->d:J

    invoke-virtual {v5, v0}, Ll4/d$a;->a(Landroid/hardware/camera2/CaptureResult;)V

    sget-object v0, Ljava/lang/Boolean;->FALSE:Ljava/lang/Boolean;

    sget-object v3, Ljava/lang/Boolean;->TRUE:Ljava/lang/Boolean;

    iput-object v0, v5, Ll4/d$a;->o:Ljava/lang/Boolean;

    iput-object v3, v5, Ll4/d$a;->p:Ljava/lang/Boolean;

    invoke-virtual {v5}, Ll4/d$a;->c()Lp8/b;
    ...
    iget-object v0, v15, Lp8/b;->m:Ljava/nio/ByteOrder;

    invoke-direct {v4, v3, v0}, Lp8/b$c;-><init>(Ljava/io/OutputStream;Ljava/nio/ByteOrder;)V
    :try_end_1
    ...
    iput-object v0, v4, Lp8/b$c;->b:Ljava/nio/ByteOrder;

    sget-object v0, Lp8/b;->l0:[B

    invoke-virtual {v4, v0}, Lp8/b$c;->write([B)V

    const/16 v0, -0x1f

    invoke-virtual {v4, v0}, Lp8/b$c;->c(S)V

    invoke-virtual {v15, v4}, Lp8/b;->b0(Lp8/b$c;)V
    ...
    invoke-static {v1, v2, v0}, LA/l2;->b(JLjava/lang/StringBuilder;)Ljava/lang/String;
    ...
    invoke-static {v12}, Lo0/b;->H(Ljava/lang/String;)Lm0/b;
    ...
    :cond_2
    invoke-static {v11}, Ll4/A;->n(Ljava/lang/String;)Z
    ...
    invoke-static {v11}, Ll4/A;->o(Ljava/lang/String;)Z
    ...
    invoke-static {v0, v2, v11, v1}, Landroidx/appcompat/app/h;->k(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v1, v5, Lm0/b;->c:Ljava/lang/Long;
    ...
    invoke-static {v4, v12, v15}, Ll4/A;->i(Landroid/content/Context;Ljava/lang/String;Z)Landroid/net/Uri;
    ...
    invoke-static {v12}, Ll4/A;->B(Ljava/lang/String;)Z
    ...
    :try_start_9
    invoke-static {v0, v15}, Lq4/a;->c(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_9
    ...
    invoke-static {v15}, Ll4/A;->B(Ljava/lang/String;)Z
    ...
    invoke-static {v8, v15, v2}, Ll4/A;->i(Landroid/content/Context;Ljava/lang/String;Z)Landroid/net/Uri;
    ...
    invoke-static/range {v1 .. v12}, Ll4/A;->y(IJJJLandroid/content/Context;Landroid/location/Location;Ljava/lang/String;ZZ)V
    ...
    invoke-static {v0, v15}, LVa/a;->g(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v1, v15, Ll4/b;->d:Laa/o;

    iget-boolean v1, v1, Laa/o;->C:Z

    if-eqz v1, :cond_10

    iget-object v1, v15, Ll4/b;->a:Landroid/app/Application;
    ...
    iget-object v2, v15, Ll4/b;->b:Ll4/t;

    const/4 v3, 0x1

    check-cast v2, Ll4/j;

    invoke-virtual {v2, v1, v3}, Ll4/j;->u(LA/a4;Z)V

    goto :goto_11

    :cond_f
    iget-object v1, v15, Ll4/b;->b:Ll4/t;
    ...
    invoke-virtual/range {v1 .. v6}, Ll4/j;->o(Landroid/net/Uri;ZLjava/lang/String;IZ)V
    ...
    :goto_13
    iget-object v0, v15, Ll4/b;->s:Laa/s;

    iget-object v1, v15, Ll4/b;->g:Landroid/media/Image;

    iget-object v3, v15, Ll4/b;->d:Laa/o;
    ...
    iget-object v4, v0, Laa/r;->C:Laa/r$c;

    invoke-virtual {v4, v1}, Laa/r$c;->b(Landroid/media/Image;)V
    ...
    iget-object v1, v3, Laa/o;->K:Landroid/media/Image;

    invoke-static {v0, v1}, Laa/r;->b(Laa/r;Landroid/media/Image;)V

    invoke-virtual {v3}, Laa/o;->k()V

    invoke-static {v0, v3}, Laa/r;->d(Laa/r;Laa/o;)Z

    move-result v1

    if-eqz v1, :cond_13

    iget-object v1, v0, Laa/r;->h:Lcom/android/camera/b$a;

    if-eqz v1, :cond_13

    invoke-virtual {v1, v3}, Lcom/android/camera/b$a;->a(Laa/o;)V

    :cond_13
    iget-wide v3, v3, Laa/o;->e:J

    invoke-virtual {v0, v3, v4}, Laa/r;->y(J)Laa/o;
    ...
    iget-object v0, v15, Ll4/b;->d:Laa/o;
    ...
    iget-object v4, v15, Ll4/b;->d:Laa/o;
    ...
    invoke-static {v0, v1, v4}, LA/H2;->b(JLjava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v2, v0}, LL3/n;->d([Ljava/lang/String;)V

    const/4 v1, 0x0

    iput-object v1, v15, Ll4/b;->g:Landroid/media/Image;

    iput-object v1, v15, Ll4/b;->d:Laa/o;

    iput-object v1, v15, Ll4/b;->s:Laa/s;

    iput-object v1, v15, Ll4/f;->u:Landroid/hardware/camera2/TotalCaptureResult;

    iput-object v1, v15, Ll4/b;->m:Landroid/os/Handler;

    iget-object v0, v15, Ll4/b;->b:Ll4/t;

    iget v1, v15, Ll4/b;->h:I
