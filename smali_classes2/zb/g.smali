...
.field public d:Lzb/g$b;

.field public e:Lzb/g$d;

.field public f:Lzb/b;


# direct methods
.method public constructor <init>(Landroid/content/Context;LA/W3;LA/W3;LA/W3;Landroid/os/Bundle;)V
    .locals 3
    ...
    iput-object v0, p0, Lzb/g;->a:Ljava/lang/String;
    ...
    invoke-static {p1}, Lzb/g;->b(Landroid/content/Context;)I
    ...
    iput-object p1, p0, Lzb/g;->b:Landroid/content/Context;
    ...
    iput-object v0, p1, Lzb/g$b;->a:Landroid/os/Bundle;

    iput-object p1, p0, Lzb/g;->d:Lzb/g$b;

    iput-object p2, p1, Lzb/g$b;->b:LA/W3;

    iput-object p3, p1, Lzb/g$b;->c:LA/W3;

    iput-object p4, p1, Lzb/g$b;->d:LA/W3;
    ...
    invoke-static {v2, p1}, LA/P;->c(ILjava/lang/String;)Ljava/lang/String;
...
.method public static a(Landroid/content/Context;LA/W3;LA/W3;LA/W3;Landroid/os/Bundle;)Lzb/g;
    .locals 7
    ...
    invoke-direct/range {v0 .. v5}, Lzb/g;-><init>(Landroid/content/Context;LA/W3;LA/W3;LA/W3;Landroid/os/Bundle;)V

    const-string p0, "Binding to service found in package: "

    iget-object p1, v6, Lzb/g;->a:Ljava/lang/String;

    const-string p2, "bind: E"

    sget-boolean p3, LFb/b;->a:Z
    ...
    iget-object p2, v6, Lzb/g;->b:Landroid/content/Context;
    ...
    :try_start_0
    iput-boolean p4, v6, Lzb/g;->c:Z

    iget-object v1, v6, Lzb/g;->e:Lzb/g$d;

    const/4 v2, 0x5

    if-nez v1, :cond_2

    new-instance v1, Lzb/g$d;

    invoke-direct {v1, v6}, Lzb/g$d;-><init>(Lzb/g;)V
    ...
    iget-object v3, v6, Lzb/g;->a:Ljava/lang/String;
    ...
    iget-object p0, v6, Lzb/g;->b:Landroid/content/Context;
    ...
    iget-object p0, v6, Lzb/g;->a:Ljava/lang/String;
    ...
    :goto_4
    iget-object p0, v6, Lzb/g;->d:Lzb/g$b;
    ...
    invoke-virtual {p0, p4}, Lzb/g$b;->w0(I)V
...
.method public final c()Lzb/b;
    ...
    iget-object p0, p0, Lzb/g;->f:Lzb/b;
...
.method public final d(Z)V
    ...
    iget-object v1, p0, Lzb/g;->a:Ljava/lang/String;
    ...
    :try_start_0
    iget-object v1, p0, Lzb/g;->e:Lzb/g$d;

    if-nez v1, :cond_0

    const/4 p1, 0x1

    iput-boolean p1, p0, Lzb/g;->c:Z

    iget-object p1, p0, Lzb/g;->a:Ljava/lang/String;
    ...
    :cond_0
    iget-object v1, p0, Lzb/g;->d:Lzb/g$b;
    ...
    iput-object v2, v1, Lzb/g$b;->b:LA/W3;

    iput-object v2, v1, Lzb/g$b;->c:LA/W3;

    iput-object v2, v1, Lzb/g$b;->d:LA/W3;

    :cond_1
    iget-object v4, p0, Lzb/g;->f:Lzb/b;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    :try_start_1
    invoke-interface {v4, v1}, Lzb/b;->Y(Lzb/c;)V
    :try_end_1
    ...
    iput-object v2, v1, Lzb/g$b;->a:Landroid/os/Bundle;

    iput-object v2, p0, Lzb/g;->d:Lzb/g$b;
    ...
    iget-object v1, p0, Lzb/g;->f:Lzb/b;
    :try_end_2
    ...
    iget-object v4, p0, Lzb/g;->e:Lzb/g$d;
    ...
    :cond_4
    :try_start_4
    iget-object v1, p0, Lzb/g;->b:Landroid/content/Context;
    ...
    :catch_2
    :try_start_5
    iput-object v2, p0, Lzb/g;->e:Lzb/g$d;

    :cond_5
    iput-object v2, p0, Lzb/g;->f:Lzb/b;
...
.method public final e(Landroid/os/Bundle;)V
    ...
    sget-boolean v0, LFb/b;->a:Z

    iget-object v0, p0, Lzb/g;->a:Ljava/lang/String;
    ...
    invoke-interface {v0, p0, p1}, Lzb/b;->c(Lzb/c;Landroid/os/Bundle;)V
...
.method public final f(Landroid/os/Bundle;)V
    ...
    invoke-interface {v0, p0, p1}, Lzb/b;->P(Lzb/c;Landroid/os/Bundle;)V
...
.method public final finalize()V
    ...
    :try_start_0
    invoke-virtual {p0, v2}, Lzb/g;->d(Z)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
