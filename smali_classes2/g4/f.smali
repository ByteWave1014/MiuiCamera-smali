...
.method public constructor <init>(Ljava/lang/ref/WeakReference;)V
    ...
    iput-object p1, p0, Lg4/f;->a:Ljava/lang/ref/WeakReference;
...
.method public final a(Ljava/lang/Object;)V
    ...
    invoke-static {v0}, Lg4/a;->a(Ljava/lang/String;)V
    ...
    invoke-virtual {v3}, Lo6/i$a;->toString()Ljava/lang/String;
    ...
    invoke-static {v4}, Lg4/a;->a(Ljava/lang/String;)V

    iget v4, v3, Lo6/i$a;->a:I

    iget v5, v3, Lo6/i$a;->b:I
    ...
    :cond_0
    sget-object v6, Lg4/c;->a:Ljava/util/ArrayList;
    ...
    iget v9, v8, Lg4/d;->a:I

    if-ne v9, v4, :cond_1

    int-to-float v4, v5

    iget v6, v8, Lg4/d;->b:F
    ...
    invoke-static {v3}, Lg4/a;->a(Ljava/lang/String;)V

    goto/16 :goto_7

    :cond_4
    filled-new-array {v3}, [Lo6/i$a;

    move-result-object v3

    iget-object v4, p0, Lg4/f;->a:Ljava/lang/ref/WeakReference;
    ...
    new-instance v6, Lcom/android/camera/module/t;

    const/16 v8, 0x13

    invoke-direct {v6, v8}, Lcom/android/camera/module/t;-><init>(I)V
    ...
    invoke-virtual {v3, v6}, LS3/g;->d(Ljava/lang/Class;)Ljava/util/Optional;
    ...
    invoke-interface {v3}, LV3/f;->isShowing()Z
    ...
    invoke-virtual {v8, v9, v7}, Lea/a;->g(Ljava/lang/String;Z)Z
    ...
    invoke-interface {v6, v9, v7, v8, v3}, LV3/o;->V5(IZZ[Ljava/lang/Object;)V
    ...
    invoke-virtual {v6, v3}, Lcom/android/camera/module/Camera2Module;->setAsdScenes([Lo6/i$a;)V
    ...
    invoke-virtual {v6, v3}, Lcom/android/camera/module/AmbilightModule;->setAsdScenes([Lo6/i$a;)V
    ...
    iget-object v3, v4, Lcom/android/camera/module/VideoBase;->mUserRecordSetting:Lcom/android/camera/module/video/A;

    invoke-virtual {v4}, Lcom/android/camera/module/BaseModule;->getActualCameraId()I

    move-result v6

    invoke-virtual {v3, v6}, Lcom/android/camera/module/video/A;->g(I)Z
