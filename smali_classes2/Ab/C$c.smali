...
# direct methods
.method public constructor <init>(LAb/C;Ljava/net/InetAddress;)V
    .locals 0

    iput-object p1, p0, LAb/C$c;->h:LAb/C;

    invoke-direct {p0, p1}, LAb/C$a;-><init>(LAb/C;)V

    iput-object p2, p0, LAb/C$c;->f:Ljava/net/InetAddress;

    const/16 p1, 0x22b8

    iput p1, p0, LAb/C$c;->g:I
...
.method public final a()Ljava/net/Socket;
    ...
    iget-object v2, p0, LAb/C$c;->f:Ljava/net/InetAddress;
    ...
    :goto_1
    sget-object v5, LAb/C;->d:Ljava/lang/String;
    ...
    invoke-static {v3, v6}, LA/Y;->e(Ljava/io/IOException;Ljava/lang/StringBuilder;)Ljava/lang/String;
    ...
    iget-object p0, p0, LAb/C$c;->h:LAb/C;
    ...
    :try_start_3
    iget-object v2, p0, LAb/C$c;->e:Ljava/net/ServerSocket;
    ...
    :cond_2
    :goto_4
    iput-object v3, p0, LAb/C$c;->e:Ljava/net/ServerSocket;
...
.method public final b()V
    ...
    :try_start_1
    iget-object v1, p0, LAb/C$c;->e:Ljava/net/ServerSocket;
    ...
    iput-object v1, p0, LAb/C$c;->e:Ljava/net/ServerSocket;
    ...
    iget-object v1, p0, LAb/C$c;->h:LAb/C;
