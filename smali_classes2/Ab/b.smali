...
.method public final run()V
    ...
    iget v7, v0, LAb/b;->a:I

    packed-switch v7, :pswitch_data_0

    iget-object v1, v0, LAb/b;->c:Ljava/lang/Object;
    ...
    iget-object v0, v0, LAb/b;->b:Ljava/lang/Object;
    ...
    iget-object v0, v1, Lcom/xiaomi/mimoji/gif/FragmentGifEdit;->e:Ltd/f;

    if-eqz v0, :cond_0

    invoke-virtual {v0, v3}, Ltd/f;->k(Z)V
    ...
    iget-object v1, v1, Lo3/o;->h:LA/Y1;
    ...
    invoke-direct {v4, v2, v3}, LA/P0;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-direct {v14}, LU0/c;-><init>()V
    ...
    invoke-virtual {v14, v9}, LU0/c;->a(Ljava/lang/String;)V
    ...
    invoke-static {v15, v3, v6, v7, v6}, Landroid/opengl/Matrix;->scaleM([FIFFF)V

    invoke-static {v8, v3}, Landroid/opengl/Matrix;->setIdentityM([FI)V

    new-instance v6, LQe/b;

    iget-object v7, v0, LAb/b;->c:Ljava/lang/Object;
    ...
    invoke-direct {v6, v9, v10}, LQe/b;-><init>(II)V

    iget-object v9, v6, LQe/b;->c:[I
    ...
    const-string v9, "HDR10-OpenGlUtils loadTexture"
    ...
    invoke-static {v10, v11, v12}, Landroid/opengl/GLES20;->glTexParameterf(IIF)V

    const/16 v13, 0x2801

    invoke-static {v10, v13, v12}, Landroid/opengl/GLES20;->glTexParameterf(IIF)V

    const/16 v12, 0x2802

    const v14, 0x47012f00    # 33071.0f

    invoke-static {v10, v12, v14}, Landroid/opengl/GLES20;->glTexParameterf(IIF)V

    const/16 v11, 0x2803

    invoke-static {v10, v11, v14}, Landroid/opengl/GLES20;->glTexParameterf(IIF)V

    invoke-static {v10, v3, v7, v3}, Landroid/opengl/GLUtils;->texImage2D(IILandroid/graphics/Bitmap;I)V
    ...
    const-string v11, "loadTexture1d"

    invoke-static {v11}, Lcom/xiaomi/gl/MIGL;->checkGlErrorAndExit(Ljava/lang/String;)V

    iget v11, v4, LU0/c;->a:I

    invoke-static {v11}, Landroid/opengl/GLES20;->glUseProgram(I)V

    const-string v11, "mainTexture"

    invoke-virtual {v4, v11}, LU0/c;->b(Ljava/lang/String;)I

    move-result v11

    const-string v12, "LutTexture"

    invoke-virtual {v4, v12}, LU0/c;->b(Ljava/lang/String;)I
    ...
    const-string/jumbo v10, "uOrientationM"

    invoke-virtual {v4, v10}, LU0/c;->b(Ljava/lang/String;)I
    ...
    invoke-static {v10, v5, v3, v15, v3}, Landroid/opengl/GLES20;->glUniformMatrix4fv(IIZ[FI)V

    invoke-static {v11, v5, v3, v8, v3}, Landroid/opengl/GLES20;->glUniformMatrix4fv(IIZ[FI)V

    const-string v5, "aPosition"

    invoke-virtual {v4, v5}, LU0/c;->b(Ljava/lang/String;)I
    ...
    invoke-static {v9, v2}, Lcom/xiaomi/gl/MIGL;->glDeleteTexture(ILjava/lang/String;)V
    ...
    invoke-static {v1, v5}, LFg/y;->i(II)Landroid/graphics/Rect;

    move-result-object v1

    const/4 v5, -0x1

    invoke-static {v5, v1}, LEc/f;->a(ILandroid/graphics/Rect;)Landroid/graphics/Bitmap;
    ...
    :pswitch_2
    iget-object v1, v0, LAb/b;->b:Ljava/lang/Object;

    check-cast v1, Landroidx/fragment/app/FragmentActivity;

    iget-object v0, v0, LAb/b;->c:Ljava/lang/Object;

    check-cast v0, Lcom/android/camera/module/FriendModule;

    invoke-static {v0, v1}, Lcom/android/camera/module/FriendModule;->i8(Lcom/android/camera/module/FriendModule;Landroidx/fragment/app/FragmentActivity;)V
    ...
    invoke-static {v1, v0}, Landroidx/room/MultiInstanceInvalidationClient$callback$1;->v0(Landroidx/room/MultiInstanceInvalidationClient;[Ljava/lang/String;)V
    ...
    invoke-virtual {v1, v0}, LZ5/b0;->L(Lcom/xiaomi/camera/mivi/qcom/bean/ResultOutputData;)V
    ...
    iget-object v4, v1, Laf/s;->m:Landroid/graphics/Rect;
    ...
    iget v5, v1, Laf/s;->i:I

    invoke-virtual {v4, v3, v3, v2, v5}, Landroid/graphics/Rect;->set(IIII)V
    ...
    iget-object v2, v0, LAb/b;->c:Ljava/lang/Object;
    ...
    iget-object v1, v1, LB2/b;->i:Lcom/android/camera/fragment/subtitle/FragmentSubtitle$b;
    ...
    iget-object v3, v0, LAb/b;->b:Ljava/lang/Object;

    check-cast v3, Ljava/lang/String;

    invoke-interface {v2, v3}, LAb/l;->onClientRejectAck(Ljava/lang/String;)V
    ...
    invoke-virtual {v1, v0}, LAb/c;->d(Ljava/lang/String;)V
    ...
    iget-object v0, v1, LAb/C$a;->d:LAb/C;

    const-string v1, "Sending data on closed socket."

    invoke-virtual {v0, v1}, LAb/C;->a(Ljava/lang/String;)V
    ...
    iget-object v0, v1, LAb/C$a;->b:Ljava/io/PrintWriter;
