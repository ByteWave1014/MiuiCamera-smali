...
.method private static trackMiShotStopRecord(I)V
    .locals 3
    ...
    invoke-direct {v1, p0}, LR4/a;-><init>(I)V
...
.method public getDeviceList()Ljava/util/Set;
    ...
    invoke-direct {v4, v2, v3}, LI0/c;-><init>(Ljava/lang/String;Ljava/lang/String;)V
...
.method public release()V
    ...
    invoke-virtual {v0}, Lcom/android/camera2/compat/theme/custom/mm/cinemaster/view/StreamTextureView;->getPlayer()LJ9/b;

    move-result-object v0

    if-eqz v0, :cond_0

    invoke-virtual {v0}, LJ9/b;->e()V
...
.method public startOrStopRecording(ILjava/lang/String;)V
    ...
    const-string/jumbo v0, "startOrStopRecording: mode = "

    const-string v1, ", ip = "

    invoke-static {p1, v0, v1, p2}, LA/Q;->e(ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {p2, p0, v1}, LZb/b;-><init>(II)V
    ...
    invoke-static {p0}, Lcom/android/camera2/compat/theme/custom/mm/cinemaster/view/MagicAdapter;->trackMiShotStopRecord(I)V
    ...
    invoke-static {v2}, Lcom/android/camera2/compat/theme/custom/mm/cinemaster/view/MagicAdapter;->trackMiShotStopRecord(I)V
    ...
    invoke-direct {p1, v2, v1}, LZb/b;-><init>(II)V
