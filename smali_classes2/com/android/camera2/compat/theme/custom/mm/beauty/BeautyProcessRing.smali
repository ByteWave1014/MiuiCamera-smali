...
.super Lcom/android/camera/ui/O;
.source "SourceFile"
...
.field public static NO_SELECTION:I = 0x2
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 1
    invoke-direct {p0, p1}, Lcom/android/camera/ui/O;-><init>(Landroid/content/Context;)V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .line 3
    invoke-direct {p0, p1, p2}, Lcom/android/camera/ui/O;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 5
    invoke-direct {p0, p1, p2, p3}, Lcom/android/camera/ui/O;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
...
.method private init(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/android/camera/ui/O;->mArcRectF:Landroid/graphics/RectF;
    ...
    iput p1, p0, Lcom/android/camera/ui/O;->mOffset:I
...
.method public onDraw(Landroid/graphics/Canvas;)V
    ...
    :cond_0
    iget v1, v0, Lcom/android/camera/ui/O;->mProgress:I
    ...
    iget-object v4, v0, Lcom/android/camera/ui/O;->mArcRectF:Landroid/graphics/RectF;

    iget v5, v0, Lcom/android/camera/ui/O;->mOffset:I

    int-to-float v6, v5

    int-to-float v7, v5

    iget v8, v0, Lcom/android/camera/ui/O;->mWidth:I

    sub-int/2addr v8, v5

    int-to-float v8, v8

    iget v9, v0, Lcom/android/camera/ui/O;->mHeight:I
    ...
    iget-object v8, v0, Lcom/android/camera/ui/O;->mArcRectF:Landroid/graphics/RectF;
    ...
    sget v6, Lcom/android/camera2/compat/theme/custom/mm/beauty/BeautyProcessRing;->NO_SELECTION:I
    ...
    iget-object v12, v0, Lcom/android/camera2/compat/theme/custom/mm/beauty/BeautyProcessRing;->mProcessPaint:Landroid/graphics/Paint;
    ...
    iget-object v1, v0, Lcom/android/camera/ui/O;->mArcRectF:Landroid/graphics/RectF;

    const/4 v4, 0x1

    iget-object v5, v0, Lcom/android/camera2/compat/theme/custom/mm/beauty/BeautyProcessRing;->mBackgroundPaint:Landroid/graphics/Paint;
    ...
    iget-object v3, v0, Lcom/android/camera/ui/O;->mArcRectF:Landroid/graphics/RectF;
    ...
    iget-object v7, v0, Lcom/android/camera/ui/O;->mArcRectF:Landroid/graphics/RectF;
    ...
    iget-object v13, v0, Lcom/android/camera/ui/O;->mArcRectF:Landroid/graphics/RectF;
    ...
    iget-object v6, v0, Lcom/android/camera/ui/O;->mArcRectF:Landroid/graphics/RectF;
...
.method public setColor(I)V
    ...
    invoke-virtual {v1, p1, v2}, LY/d;->a(IZ)I
...
.method public setProgress(I)V
    ...
    iput p1, p0, Lcom/android/camera/ui/O;->mProgress:I
