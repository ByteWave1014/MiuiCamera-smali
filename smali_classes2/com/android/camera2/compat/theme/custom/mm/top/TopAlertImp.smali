...
.method public static synthetic Q(LV3/B;)V
    ...
    invoke-static {p0}, Lcom/android/camera2/compat/theme/custom/mm/top/TopAlertImp;->lambda$alertFlashFrontAdjustSwitchLayout$3(LV3/B;)V

    return-void
.end method

.method public static synthetic R(LV3/B;LV3/h1;)V
    .locals 0

    invoke-static {p0, p1}, Lcom/android/camera2/compat/theme/custom/mm/top/TopAlertImp;->lambda$reInitAlertAction$6(LV3/B;LV3/h1;)V

    return-void
.end method

.method public static synthetic W(Lcom/android/camera2/compat/theme/custom/mm/top/TopAlertImp;Lcom/android/camera/fragment/top/FragmentTopAlert;)V
    .locals 0
...
.method public static synthetic d0(Landroid/view/View;IILcom/android/camera/fragment/top/FragmentTopAlert;)V
    .locals 0
...
.method public static synthetic f0(Lcom/android/camera/fragment/top/FragmentTopAlert;)Z
    .locals 0
...
.method private static synthetic lambda$alertFlashFrontAdjustSwitchLayout$2(LX3/f;)V
    .locals 2
...
.method private static synthetic lambda$alertFlashFrontAdjustSwitchLayout$3(LV3/B;)V
    .locals 1
...
.method private static synthetic lambda$reInitAlertAction$6(LV3/B;LV3/h1;)V
    .locals 1

    const/4 v0, 0x1

    invoke-interface {p1, p0, v0}, LV3/h1;->showTips(LV3/B;Z)V

    return-void
.end method

.method public static synthetic o(LX3/f;)V
    .locals 0

    invoke-static {p0}, Lcom/android/camera2/compat/theme/custom/mm/top/TopAlertImp;->lambda$alertFlashFrontAdjustSwitchLayout$2(LX3/f;)V
...
.method private reInitAlertAction(Z)V
    ...
    invoke-direct {v2, p0, v3}, LA/h;-><init>(Ljava/lang/Object;I)V

    invoke-virtual {p1, v2}, Ljava/util/Optional;->ifPresent(Ljava/util/function/Consumer;)V

    invoke-interface {p0}, LV3/B;->u8()V

    invoke-interface {p0}, LV3/B;->z9()V

    invoke-interface {p0}, LV3/B;->hd()V

    invoke-interface {p0}, LV3/B;->p1()V

    invoke-interface {p0}, LV3/B;->m8()V

    invoke-interface {p0}, LV3/B;->A3()V

    invoke-interface {p0, v1}, LV3/B;->vi(Z)V

    invoke-interface {p0}, LV3/B;->Jf()V

    invoke-interface {p0}, LV3/B;->C0()V

    new-array p1, v0, [Z

    invoke-interface {p0, p1}, LV3/B;->Ag([Z)V

    invoke-interface {p0}, LV3/B;->z4()V

    invoke-interface {p0}, LV3/B;->ke()V

    invoke-interface {p0}, LV3/B;->cb()V
    ...
    invoke-virtual {p1}, Lf0/b0;->H()Z

    move-result p1

    invoke-interface {p0, p1}, LV3/B;->C2(Z)V

    invoke-interface {p0}, LV3/B;->si()V

    invoke-interface {p0}, LV3/B;->Pe()V

    invoke-interface {p0}, LV3/B;->gf()V

    invoke-interface {p0}, LV3/B;->Yb()V

    invoke-interface {p0}, LV3/B;->N6()V

    invoke-interface {p0}, LV3/B;->qd()V

    invoke-interface {p0}, LV3/B;->P9()V

    invoke-interface {p0}, LV3/B;->E4()V
...
.method public alertFlashFrontAdjustSwitchLayout(ZZ)V
    ...
    invoke-direct {p1, p2}, LV1/z;-><init>(I)V
...
.method public alertSmartCompositionTip(II)V
    ...
    invoke-direct {v0, p1, p2}, Lcom/android/camera2/compat/theme/custom/mm/top/j;-><init>(II)V
...
.method public bridge synthetic getVideoTag()LV3/e0;
    .locals 0

    .line 1
    invoke-virtual {p0}, Lcom/android/camera2/compat/theme/custom/mm/top/TopAlertImp;->getVideoTag()Lcom/android/camera/ui/D0;
...
.method public initLandscapeTopTipLayout(Landroid/view/View;II)V
    ...
    invoke-direct {v0, p1, p2, p3}, Lcom/android/camera2/compat/theme/custom/mm/top/k;-><init>(Landroid/view/View;II)V
...
.method public registerProtocol()V
    ...
    invoke-virtual {v0, v1, v2}, LS3/g;->b(Ljava/lang/Class;LS3/a;)V
...
.method public showRecordingTime(Z)V
    ...
    invoke-virtual {p0, p1}, Lcom/android/camera/fragment/top/FragmentTopAlert;->showRecordingTime(Z)V
...
.method public updateLyingDirectHint(ZZ)V
    ...
    invoke-interface {v0, p1}, LV3/h1;->setIsShowTopLyingDirectHint(Z)V
    ...
    invoke-interface {v0}, LV3/h1;->isShowTopLyingDirectHint()Z
