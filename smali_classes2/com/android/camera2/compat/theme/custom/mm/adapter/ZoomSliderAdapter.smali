...
.field private mStopPointValueListener:Li2/l;
...
.method public constructor <init>(Landroid/content/Context;ILi2/l;Landroid/util/Range;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p3, p0, Lcom/android/camera2/compat/theme/custom/mm/adapter/ZoomSliderAdapter;->mStopPointValueListener:Li2/l;
...
.method private final getSupportedZoomInnerValues()V
    ...
    sget-object v2, Lic/g;->b:[Ljava/lang/Float;
...
.method private final indexAndZoomRangeFilter()V
    ...
    invoke-static {v0}, Llf/t;->q0(Ljava/lang/Iterable;)Ljava/util/Set;
...
.method private final initValue()V
    ...
    invoke-virtual {v4}, LG7/b;->c()Ljava/util/List;
...
.method public draw(Lcom/android/camera/ui/c$a$a;ILandroid/graphics/Canvas;ZIFI)V
    ...
    iget p5, p0, Lcom/android/camera/ui/c$a;->mLineSelectWidth:F
    ...
    iget p5, p0, Lcom/android/camera/ui/c$a;->mLineStopPointWidth:F

    goto :goto_0

    :cond_1
    iget p5, p0, Lcom/android/camera/ui/c$a;->mLineWidth:F
    ...
    invoke-virtual/range {v0 .. v5}, Lcom/android/camera/ui/c$a;->drawLineLite(Lcom/android/camera/ui/c$a$a;ILandroid/graphics/Canvas;ZF)V
...
.method public mapPositionToValue(F)Ljava/lang/String;
    ...
    invoke-static {p1, p0, v1, v0}, LA/y3;->a(FFFF)F
...
.method public onPositionSelect(Landroid/view/View;FIII)V
    ...
    .line 2
    invoke-interface {p0, p1, p2, p3, p4}, Lcom/android/camera/ui/c$c;->onPositionSelect(Landroid/view/View;FII)V
