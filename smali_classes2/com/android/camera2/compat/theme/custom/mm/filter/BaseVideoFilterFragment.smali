...
.field protected mDataItemConfig:Lb0/a1;

.field protected mDataItemRunning:Lf0/q0;
...
.method public static synthetic Ki(LV3/h1;)V
    .locals 0
...
.method private updateFilterStatus()V
    ...
    :try_start_0
    invoke-interface {v1, v0}, LV3/B;->J4(I)V
    :try_end_0
...
.method public getFilterNone()I
    ...
    invoke-static {p0, v0}, LA8/b;->g(II)I
...
.method public isSupportCloudFilter()Z
    ...
    invoke-virtual {p0}, L渭渡渣湠渣渧湠渪渫游渧渭渫湠渭渡渣渣渡渠湠渍渡渣渣渡渠;->t8()Z
...
.method public onViewCreatedAndVisibleToUser(Z)V
    ...
    iget-boolean p1, p1, Lf0/b0;->d0:Z
    ...
    iput-object v3, p0, Lcom/android/camera2/compat/theme/custom/mm/filter/BaseVideoFilterFragment;->mDataItemConfig:Lb0/a1;

    invoke-static {}, LZ/a;->j()Lf0/q0;

    move-result-object v3

    iput-object v3, p0, Lcom/android/camera2/compat/theme/custom/mm/filter/BaseVideoFilterFragment;->mDataItemRunning:Lf0/q0;
    ...
    iget-object v1, p0, Lcom/android/camera2/compat/theme/custom/mm/filter/BaseVideoFilterFragment;->mDataItemConfig:Lb0/a1;

    invoke-virtual {v1, v3, v4}, Lea/a;->l(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v1

    iget-object v3, p0, Lcom/android/camera2/compat/theme/custom/mm/filter/BaseVideoFilterFragment;->mDataItemConfig:Lb0/a1;
    ...
    :cond_3
    iget-object v1, p0, Lcom/android/camera2/compat/theme/custom/mm/filter/BaseVideoFilterFragment;->mDataItemRunning:Lf0/q0;

    invoke-virtual {v1, v3, v4}, Lea/a;->l(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v1

    iget-object v3, p0, Lcom/android/camera2/compat/theme/custom/mm/filter/BaseVideoFilterFragment;->mDataItemRunning:Lf0/q0;
    ...
    invoke-interface {p1, v1}, LV3/B;->J4(I)V
    :try_end_0
    .catch Ljava/lang/NumberFormatException; {:try_start_0 .. :try_end_0} :catch_0
    .catch Ljava/lang/IndexOutOfBoundsException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public setFilter(Ljava/lang/String;IZ)V
    ...
    invoke-interface {p2}, LV3/B;->yd()Z
