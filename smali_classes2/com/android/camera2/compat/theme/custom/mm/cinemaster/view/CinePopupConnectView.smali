...
.method private initView()V
    ...
    invoke-virtual {v5, v6}, Lea/b;->t(Ljava/lang/Class;)Ljava/util/Optional;

    move-result-object v5

    new-instance v6, LA3/B;

    invoke-direct {v6, v3, v1}, LA3/B;-><init>(II)V
    ...
    invoke-static {v5, v3}, LY/e;->b(ILandroid/view/View;)V
    ...
    invoke-static {v3}, Lq6/a;->h(Landroid/widget/TextView;)V
    ...
    invoke-static {v3, v4}, LM/i;->g(I[Landroid/view/View;)V
    ...
    invoke-static {v3}, LY/e;->a(I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v4}, L渭渡渣湠渣渧湠渪渫游渧渭渫湠渭渡渣渣渡渠湠渍渡渣渣渡渠;->Q1()Z
...
.method private lambda$initListener$4(Landroid/widget/CompoundButton;Z)V
    ...
    invoke-direct {p2, v0, p0}, LZb/c;-><init>(Ljava/lang/String;Ljava/lang/String;)V
...
.method private lambda$initListener$5(Landroid/widget/CompoundButton;Z)V
    ...
    invoke-virtual {p1, v0, p2}, Lea/a;->m(Ljava/lang/String;Z)Lea/a;
...
.method private static trackSelectMiShotRole(Ljava/lang/String;)V
    ...
    invoke-direct {v1, v2, p0}, LZb/c;-><init>(Ljava/lang/String;Ljava/lang/String;)V
...
.method private updateSwitchTrackDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-static {v2, v4}, LY/a;->e(IZ)Landroid/graphics/ColorFilter;
...
.method public toggleStarted(Z)V
    ...
    invoke-static {p1, v1}, LM/i;->g(I[Landroid/view/View;)V
    ...
    invoke-static {p1, v0}, LM/i;->g(I[Landroid/view/View;)V

    iget-object p1, p0, Lcom/android/camera2/compat/theme/custom/mm/cinemaster/view/CinePopupConnectView;->btnConnectStart:Landroid/widget/Button;

    const v0, 0x7f080d43

    invoke-static {v0, p1}, LY/e;->b(ILandroid/view/View;)V
...
.method public updateColor()V
    ...
    invoke-static {v1, v0}, LY/e;->b(ILandroid/view/View;)V
