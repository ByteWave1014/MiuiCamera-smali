...
.method private static initFilterComponent(ILjava/util/ArrayList;)V
    ...
    invoke-virtual {v1, p1, p0, v0}, Lf0/K;->m(Ljava/util/ArrayList;II)V

    const/4 p0, 0x0

    invoke-virtual {v1, v0, p0}, Lf0/K;->n(IZ)V
...
.method private static synthetic lambda$setWidgetCameraFilter$2(ILV3/B;)V
    ...
    invoke-interface {p1, p0}, LV3/B;->Q8(I)V
...
.method private static synthetic lambda$setWidgetCameraMasterFilter$0(ILjava/util/concurrent/atomic/AtomicBoolean;LV3/B;)V
    ...
    invoke-interface {p2, p0}, LV3/B;->J4(I)V
...
.method private static mutexByCclockWidget(I)V
    ...
    invoke-virtual {v1, p0}, Lf0/S;->isSwitchOn(I)Z

    move-result v2

    if-eqz v2, :cond_3

    invoke-virtual {v1, p0}, Lf0/S;->i(I)V
...
.method private static mutexByMasterFilterWidget(I)V
    ...
    invoke-virtual {v0, p0}, Lf0/S;->i(I)V
    ...
    invoke-virtual {p0, v0}, Lb0/H;->q(I)Z
    ...
    invoke-virtual {p0, v0, v1}, Lb0/H;->setComponentValue(ILjava/lang/String;)V

    const/4 v1, 0x1

    invoke-virtual {p0, v0, v1}, Lb0/H;->u(IZ)V
...
.method public static setCameraWidget(Landroid/content/pm/PackageManager;Landroid/content/Context;)V
    ...
    invoke-virtual {v1}, L渭渡渣湠渣渧湠渪渫游渧渭渫湠渭渡渣渣渡渠湠渍渡渣渣渡渠;->X5()Z
...
.method private static setWidgetCameraCcLock(Landroid/content/Intent;)V
    ...
    invoke-virtual {v0, v1}, Lc0/d;->o(Z)V
...
.method private static setWidgetCameraFilter(Ljava/lang/String;Landroid/content/Intent;)V
    ...
    invoke-direct {v3, p0, v0}, LW5/c;-><init>(II)V
    ...
    invoke-direct {v0, v2}, LA/h1;-><init>(I)V
...
.method private static setWidgetCameraMasterFilter(Ljava/lang/String;Landroid/content/Intent;)V
    ...
    invoke-direct {v2, p0, v1}, Lcom/android/camera2/compat/theme/custom/cv/widget/a;-><init>(ILjava/util/concurrent/atomic/AtomicBoolean;)V
    ...
    invoke-direct {v0, v2, v1, p1}, LV1/v;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V
...
.method private static updateDefaultWidget(Landroid/content/Context;Landroid/content/pm/PackageManager;)V
    ...
    invoke-virtual {v1}, L渭渡渣湠渣渧湠渪渫游渧渭渫湠渭渡渣渣渡渠湠渍渡渣渣渡渠;->l5()Z
    ...
    invoke-virtual {v0}, L渭渡渣湠渣渧湠渪渫游渧渭渫湠渭渡渣渣渡渠湠渍渡渣渣渡渠;->X5()Z
