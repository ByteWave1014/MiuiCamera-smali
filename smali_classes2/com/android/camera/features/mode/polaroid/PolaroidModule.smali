...
.method public notifyFirstFrameArrived(I)V
    ...
    sget-object p0, Lcom/android/camera/features/mode/polaroid/ImagePrinterManger;->d:LUa/b;

    if-eqz p0, :cond_0

    sget p1, Lcom/android/camera/features/mode/polaroid/ImagePrinterManger;->m:I

    invoke-virtual {p0, p1}, LUa/b;->b(I)V
    ...
    invoke-direct {p1, v0}, LVa/a;-><init>(I)V
...
.method public onNewUriArrived(Landroid/net/Uri;ZLjava/lang/String;Z)V
    ...
    invoke-interface {p0}, Lcom/android/camera/module/N;->j9()Z
    ...
    iget-object p0, p0, LF1/w;->g:LF1/u;

    iget-boolean p0, p0, LF1/u;->d:Z
    ...
    iget-object p0, p0, LF1/w;->i:LF1/u;

    iput-object p1, p0, LF1/u;->b:Landroid/net/Uri;
    ...
    invoke-direct {p2, p1, v0}, LA/o1;-><init>(Ljava/lang/Object;I)V
...
.method public onOriginJpegReceived([B)V
    ...
    invoke-static {v2, p0}, LA/y3;->e(Ljava/lang/String;Landroid/util/Size;)Ljava/lang/String;
    ...
    iget-object v2, v0, LF1/w;->g:LF1/u;

    iget-boolean v2, v2, LF1/u;->d:Z
    ...
    :goto_1
    invoke-virtual {v0, p0}, LF1/w;->g(Landroid/graphics/Bitmap;)V
    ...
    :goto_2
    iget-object v1, v0, LF1/w;->c:LF1/u;

    if-eqz p0, :cond_6

    iget v2, v1, LF1/u;->a:I

    invoke-static {v2}, Ls0/e;->k(I)I

    move-result v2

    invoke-static {v2, p0}, Ljc/e;->h(ILandroid/graphics/Bitmap;)Landroid/graphics/Bitmap;
    ...
    :goto_3
    iput-object p0, v1, LF1/u;->g:Landroid/graphics/Bitmap;

    iget-boolean v1, v1, LF1/u;->i:Z
    ...
    invoke-static {p0, v1}, Ljc/e;->m(Landroid/graphics/Bitmap;Landroid/graphics/ColorSpace;)V
    ...
    iget-object p1, v0, LF1/w;->m:LF1/q;

    iput-object p0, p1, LF1/q;->g:Lp8/b;
    ...
    invoke-direct {p1, v0, v4}, Lqf/i;-><init>(ILof/e;)V

    const/4 v0, 0x3

    invoke-static {p0, v4, v4, p1, v0}, LSg/f;->a(LSg/E;Lof/f;LSg/G;Lzf/p;I)LSg/C0;
...
.method public prepareNormalCapture(Landroid/hardware/camera2/CaptureResult;LZ5/a1$a;)V
    ...
    iget-object p1, p1, LF1/w;->c:LF1/u;

    iput p0, p1, LF1/u;->a:I

    const/4 p0, 0x1

    iput-boolean p0, p1, LF1/u;->d:Z
