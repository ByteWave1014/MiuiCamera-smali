...
# direct methods
.method public static a(Lcom/android/camera/features/mode/capture/q;ILjava/lang/String;Ljava/lang/String;)I
    .locals 16
    ...
    iget-object v6, v6, Lf0/b0;->h:Lc6/b;
    ...
    invoke-static {v7, v12}, LE5/a;->e(ILjava/util/List;)Ljava/lang/Object;
    ...
    invoke-static {v11, v6}, Lcom/android/camera/data/data/j;->w(Ljava/lang/String;Lc6/b;)I

    move-result v12

    invoke-static {v11, v6}, Lcom/android/camera/data/data/j;->r(Ljava/lang/String;Lc6/b;)I
    ...
    invoke-virtual {v2, v12, v11}, Lea/a;->o(ILjava/lang/String;)Lea/a;
    ...
    invoke-interface {v0}, LV3/k;->d3()V
    ...
    invoke-static {v0, v6}, Lcom/android/camera/data/data/j;->r(Ljava/lang/String;Lc6/b;)I
    ...
    invoke-interface {v1, v0}, LV3/l;->K8(I)V
    ...
    invoke-static {v3, v0, v1, v2}, Lcom/android/camera/features/mode/capture/p;->a(Lcom/android/camera/features/mode/capture/q;ILjava/lang/String;Ljava/lang/String;)I
...
.method public static b(Lf0/o0;ILjava/lang/String;Ljava/lang/String;)I
    .locals 11
    ...
    iget-object v8, v8, Lf0/O;->a:Landroid/util/SparseArray;
    ...
    invoke-virtual {v8}, Lf0/i0;->isEmpty()Z
    ...
    invoke-direct {v9, v10}, LA/l;-><init>(I)V
    ...
    invoke-virtual {v0}, Lf0/i0;->isEmpty()Z
    ...
    invoke-virtual {v0, p1, p3}, Lf0/i0;->getComponentValueJudgeSelect(ILjava/lang/String;)Landroid/util/Pair;
    ...
    :cond_8
    invoke-virtual {v0, p1, p2}, Lf0/i0;->getComponentValueJudgeSelect(ILjava/lang/String;)Landroid/util/Pair;
    ...
    iget-object v8, p0, Lf0/o0;->e:Landroid/util/Range;
    ...
    invoke-virtual {p0, v8, v3, p1, p3}, Lf0/o0;->i(Landroid/util/Range;[FILjava/lang/String;)Landroid/util/Pair;
    ...
    :cond_c
    invoke-virtual {p0, v8, v3, p1, p2}, Lf0/o0;->i(Landroid/util/Range;[FILjava/lang/String;)Landroid/util/Pair;
    ...
    new-instance p3, Lcom/android/camera/features/mode/capture/m;

    invoke-direct {p3, p0}, Lcom/android/camera/features/mode/capture/m;-><init>(F)V
    ...
    invoke-static {p1, v1}, Lcom/android/camera/data/data/A;->t0(IZ)V
    ...
    invoke-virtual {p0}, Lb0/B0;->getItems()Ljava/util/List;

    move-result-object v5

    iget-object v6, p0, Lb0/B0;->b:Lb0/B0$c;

    invoke-static {v6}, Ljava/util/Objects;->requireNonNull(Ljava/lang/Object;)Ljava/lang/Object;

    invoke-virtual {v6}, Lb0/B0$c;->a()Ljava/util/HashMap;
    ...
    check-cast v7, Lb0/B0$a;

    if-eqz v7, :cond_12

    iget-object v7, v7, Lb0/B0$a;->d:Landroid/util/Range;
    ...
    invoke-static {v8, p1}, LW5/g;->o(II)Landroid/util/Range;
    ...
    :cond_19
    iget-object v0, p0, Lb0/B0;->b:Lb0/B0$c;
    ...
    iput-object v5, v7, Lb0/B0$a;->d:Landroid/util/Range;
    ...
    invoke-virtual {p0, v3, p1, p3, v0}, Lb0/B0;->h([FILjava/lang/String;F)Lb0/B0$b;
    ...
    :cond_1c
    invoke-virtual {p0, v3, p1, p2, v0}, Lb0/B0;->h([FILjava/lang/String;F)Lb0/B0$b;

    move-result-object p0

    :goto_d
    iget p2, p0, Lb0/B0$b;->c:I

    if-eq p2, v1, :cond_1e

    iget p2, p0, Lb0/B0$b;->b:F

    iget-object p3, p0, Lb0/B0$b;->a:Ljava/lang/String;

    invoke-static {p2, p1}, Lcom/android/camera/data/data/A;->s0(FI)V
    ...
    invoke-direct {v0, p2, p1}, Lcom/android/camera/features/mode/capture/l;-><init>(Lb0/B0;I)V
