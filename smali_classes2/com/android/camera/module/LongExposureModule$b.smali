...
.method public final onShutterButtonClick(I)Z
    ...
    :cond_2
    invoke-static {v1}, Lcom/android/camera/module/LongExposureModule;->lj(Lcom/android/camera/module/LongExposureModule;)I
    ...
    invoke-interface {v2, p1}, LV3/d1;->Ae(I)Z
    ...
    invoke-interface {p0, p1}, LV3/d1;->Ae(I)Z
    ...
    :cond_7
    invoke-static {v1}, Lcom/android/camera/module/LongExposureModule;->sj(Lcom/android/camera/module/LongExposureModule;)V
    ...
    :cond_9
    iget-object p0, v1, Lcom/android/camera/module/BaseModule;->mCameraManager:Ls3/j;

    invoke-interface {p0}, Ls3/j;->v0()LZ5/a;

    move-result-object p0

    invoke-virtual {p0}, LZ5/a;->j1()V
