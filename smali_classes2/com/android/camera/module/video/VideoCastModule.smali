...
.method public static synthetic Sj(Lcom/android/camera/module/video/VideoCastModule;Landroid/os/Bundle;)V
    .locals 0
...
.method private onStopTimer()V
    ...
    iput-boolean v1, v0, Lcom/android/camera/module/video/s;->a:Z
    ...
    invoke-interface {v0, v2}, LV3/p1;->Ze(Z)V

    iget-object v2, p0, Lcom/android/camera/module/VideoBase;->mRecordRuntimeInfo:Lcom/android/camera/module/video/s;

    iget-boolean v2, v2, Lcom/android/camera/module/video/s;->a:Z

    invoke-interface {v0, v2}, LV3/p1;->ud(Z)V
...
.method private pauseVideoCastRecording()V
    ...
    iget-wide v6, v5, Lcom/android/camera/module/video/s;->c:J

    sub-long/2addr v3, v6

    iput-wide v3, v2, Lcom/android/camera/module/video/s;->b:J

    iget-wide v2, v5, Lcom/android/camera/module/video/s;->b:J

    invoke-interface {v0, v2, v3}, LV3/p1;->c1(J)V

    iget-object v2, p0, Lcom/android/camera/module/VideoBase;->mRecordRuntimeInfo:Lcom/android/camera/module/video/s;

    const/4 v3, 0x1

    iput-boolean v3, v2, Lcom/android/camera/module/video/s;->a:Z
    ...
    invoke-static {v3, v2, v4}, LG4/a;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V

    invoke-interface {v1}, LV3/P0;->onPause()V

    iget-object v1, p0, Lcom/android/camera/module/VideoBase;->mRecordRuntimeInfo:Lcom/android/camera/module/video/s;

    iget-boolean v1, v1, Lcom/android/camera/module/video/s;->a:Z

    invoke-interface {v0, v1}, LV3/p1;->ud(Z)V
...
.method private resumeVideoCastRecording()V
    ...
    iput-boolean v6, v5, Lcom/android/camera/module/video/s;->f:Z

    iget-object v5, p0, Lcom/android/camera/module/VideoBase;->mRecordRuntimeInfo:Lcom/android/camera/module/video/s;

    iget-boolean v5, v5, Lcom/android/camera/module/video/s;->f:Z

    invoke-interface {v0, v5}, LV3/p1;->Ze(Z)V
    ...
    iget-wide v6, v5, Lcom/android/camera/module/video/s;->e:J
    ...
    :cond_0
    iput-wide v2, v5, Lcom/android/camera/module/video/s;->e:J

    :try_start_0
    invoke-interface {v0}, LV3/p1;->F4()J

    move-result-wide v2

    iput-wide v2, v5, Lcom/android/camera/module/video/s;->b:J
    ...
    iget-wide v6, v5, Lcom/android/camera/module/video/s;->b:J

    sub-long/2addr v2, v6

    iput-wide v2, v0, Lcom/android/camera/module/video/s;->c:J

    const-wide/16 v2, 0x0

    iput-wide v2, v5, Lcom/android/camera/module/video/s;->b:J

    iput-boolean v4, v5, Lcom/android/camera/module/video/s;->a:Z
    ...
    invoke-interface {v1}, LV3/P0;->onResume()V
    :try_end_0
...
.method public onRemoteControlRequest(Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    invoke-direct {v0, v1, p0, p2}, LA/E1;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V
...
.method public onStartRecorderSucceed()V
    ...
    invoke-interface {v0, v1}, LV3/p1;->Ze(Z)V
...
.method public registerProtocol()V
    ...
    const-class v0, LV3/p1;

    filled-new-array {v0}, [Ljava/lang/Class;

    move-result-object v0

    invoke-virtual {p0, v0}, Lz3/b;->f([Ljava/lang/Class;)V
