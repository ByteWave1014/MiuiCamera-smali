...
.method public final onDown(Landroid/view/MotionEvent;)Z
    ...
    invoke-interface {v0}, La4/a;->R3()Z
...
.method public final onScroll(Landroid/view/MotionEvent;Landroid/view/MotionEvent;FF)Z
    ...
    invoke-virtual {p2}, L渭渡渣湠渣渧湠渪渫游渧渭渫湠渭渡渣渣渡渠湠渍渡渣渣渡渠;->h2()Z
    ...
    invoke-static {p2}, Lcom/android/camera/ui/z0;->b(Landroid/app/Activity;)Lcom/android/camera/ui/z0;

    move-result-object p2

    iget p2, p2, Lcom/android/camera/ui/z0;->a:I
    ...
    :cond_6
    iput v7, p0, Lcom/android/camera/ui/FocusView;->M:I
    ...
    const-string v3, "mSimpleOnGestureListener.onScroll() \u91cd\u65b0\u8bbe\u7f6emBeingAdjustType\u503c\u4e3a"
    ...
    iget v3, p0, Lcom/android/camera/ui/FocusView;->s0:I
    ...
    invoke-static {v3, p3, p4}, Landroidx/core/math/MathUtils;->clamp(III)I
    ...
    sget v3, Lcom/android/camera/ui/FocusView;->M0:I
    ...
    :cond_f
    :goto_5
    iput-boolean v7, p0, Lcom/android/camera/ui/FocusView;->n0:Z
    ...
    invoke-virtual {p2, p3, v3, v4}, Landroid/os/Handler;->sendEmptyMessageDelayed(IJ)Z
    ...
    iget-object v3, p0, Lcom/android/camera/ui/FocusView;->j0:Lcom/android/camera/ui/z;

    iget v3, v3, Lcom/android/camera/ui/z;->d:I
    ...
    iget-object p4, p0, Lcom/android/camera/ui/FocusView;->j0:Lcom/android/camera/ui/z;

    iget p4, p4, Lcom/android/camera/ui/z;->d:I
    ...
    iget-object p3, p0, Lcom/android/camera/ui/FocusView;->j0:Lcom/android/camera/ui/z;

    if-eqz p3, :cond_12

    sget-object p3, LS3/g$a;->a:LS3/g;

    const-class p4, LV3/I;

    invoke-virtual {p3, p4}, LS3/g;->d(Ljava/lang/Class;)Ljava/util/Optional;

    move-result-object p3

    new-instance p4, LA3/s0;

    invoke-direct {p4, p0, p2, p1}, LA3/s0;-><init>(Ljava/lang/Object;II)V
    ...
    iget-object p1, p0, Lcom/android/camera/ui/FocusView;->y0:Li5/f;
    ...
    iget-object p4, p1, Li5/h;->d:Li5/q;

    invoke-virtual {p4, p1, v7}, Li5/q;->o(Landroid/graphics/drawable/Drawable;Z)V

    iput p2, p4, Li5/q;->I:F

    iget-object p2, p1, Li5/h;->e:Li5/r;

    iput p3, p2, Li5/r;->I:F
    ...
    iget-object p3, p1, Li5/h;->g:Li5/v;

    invoke-virtual {p3, p1, v7}, Li5/v;->o(Landroid/graphics/drawable/Drawable;Z)V

    iput p2, p3, Li5/v;->I:F
    ...
    :cond_16
    iget p1, p0, Lcom/android/camera/ui/FocusView;->M:I
    ...
    :cond_18
    iput v7, p0, Lcom/android/camera/ui/FocusView;->b:I
