...
.method public final handleMessage(Landroid/os/Message;)V
    ...
    :cond_1
    invoke-interface {v0}, Lcom/android/camera/ui/m0;->onSnapForceUp()V

    goto :goto_0

    :cond_2
    iput-boolean v1, p0, Lcom/android/camera/ui/CameraSnapView;->j0:Z

    invoke-interface {v0}, Lcom/android/camera/ui/m0;->onSnapCancelOut()V

    goto :goto_0

    :cond_3
    invoke-interface {v0}, Lcom/android/camera/ui/m0;->onSnapLongPressCancelIn()V
    ...
    iget-object p1, p1, Lcom/android/camera/fragment/bottom/action/FragmentBottomAction;->h0:Lq5/c;
    ...
    invoke-interface {p0}, Lcom/android/camera/ui/m0;->onSnapLongPress()V

    goto :goto_0

    :cond_7
    invoke-interface {v0}, Lcom/android/camera/ui/m0;->onSnapClick()V
