...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput v0, p2, Lk5/h;->n:F

    iput v0, p2, Lk5/h;->o:F

    const/4 v0, 0x0

    iput-boolean v0, p2, Lk5/h;->q:Z

    new-instance v0, Lk5/j;

    invoke-direct {v0, p1}, Lh5/c;-><init>(Landroid/content/Context;)V

    iput-object v0, p2, Lk5/h;->a:Lk5/j;

    new-instance v0, Lk5/i;

    invoke-direct {v0, p1}, Lh5/c;-><init>(Landroid/content/Context;)V

    iput-object v0, p2, Lk5/h;->b:Lk5/i;
    ...
    iput p1, p2, Lk5/h;->i:I

    iput-object p2, p0, Lcom/android/camera/ui/LightingView;->c:Lk5/h;
...
.method public final a()V
    ...
    iget-object p0, p0, Lcom/android/camera/ui/LightingView;->c:Lk5/h;

    invoke-virtual {p0}, Lk5/h;->a()V

    const/4 v0, -0x1

    iput v0, p0, Lk5/h;->p:I
    ...
    iput-object v0, p0, Lk5/h;->j:Landroid/animation/ValueAnimator;

    const-wide/16 v2, 0x17c

    invoke-virtual {v0, v2, v3}, Landroid/animation/ValueAnimator;->setDuration(J)Landroid/animation/ValueAnimator;

    iget-object v0, p0, Lk5/h;->j:Landroid/animation/ValueAnimator;
    ...
    invoke-direct {v1, p0}, Lk5/a;-><init>(Lk5/h;)V
    ...
    invoke-direct {v1, p0}, Lk5/b;-><init>(Lk5/h;)V

    invoke-virtual {v0, v1}, Landroid/animation/ValueAnimator;->addListener(Landroid/animation/Animator$AnimatorListener;)V

    iget-object p0, p0, Lk5/h;->j:Landroid/animation/ValueAnimator;
...
.method public final onDetachedFromWindow()V
    ...
    iget-object v0, p0, Lcom/android/camera/ui/LightingView;->c:Lk5/h;
...
.method public final onDraw(Landroid/graphics/Canvas;)V
    ...
    invoke-virtual {p0, p1}, Lk5/h;->draw(Landroid/graphics/Canvas;)V
...
.method public final onMeasure(II)V
    ...
    iget-object p1, p0, Lcom/android/camera/ui/LightingView;->c:Lk5/h;
    ...
    iput p2, p1, Lk5/h;->g:I

    iput v1, p1, Lk5/h;->h:I
    ...
    iput p2, p1, Lk5/h;->e:F

    iget p2, p1, Lk5/h;->g:I

    iget v4, p1, Lk5/h;->h:I
    ...
    iget v4, p1, Lk5/h;->e:F

    iget v5, p1, Lk5/h;->o:F

    mul-float/2addr v4, v5

    iput v4, p1, Lk5/h;->e:F

    mul-float/2addr p2, v5

    iput p2, p1, Lk5/h;->f:F
    ...
    iget p2, p1, Lk5/h;->e:F

    iget v4, p1, Lk5/h;->i:I
    ...
    iget-object v5, p1, Lk5/h;->a:Lk5/j;

    iput p2, v5, Lk5/j;->I:I

    iput v4, v5, Lk5/j;->J:I

    const/16 v6, 0x5a

    iget-object v7, p1, Lk5/h;->b:Lk5/i;
    ...
    :cond_4
    iget v2, p1, Lk5/h;->d:F

    iget v6, p1, Lk5/h;->e:F
    ...
    invoke-virtual {v5, v2, v6, p2}, Lh5/c;->g(FFF)V

    iget p2, p1, Lk5/h;->d:F

    iget v2, p1, Lk5/h;->e:F

    iget v4, p1, Lk5/h;->g:I

    iget v5, p1, Lk5/h;->h:I
    ...
    invoke-virtual {v7, p2, v2, v4}, Lh5/c;->g(FFF)V
    ...
    iget v2, p1, Lk5/h;->f:F

    iget v5, p1, Lk5/h;->g:I

    iget v6, p1, Lk5/h;->h:I
    ...
    invoke-virtual {v7, p2, v2, v5}, Lh5/c;->g(FFF)V
