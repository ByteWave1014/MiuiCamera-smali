...
.method public final Wc()V
    ...
    invoke-virtual {p0, v0, v1, v3, v2}, Lcom/android/camera/fragment/settings/BasePreferenceFragment;->Rc(Landroidx/preference/PreferenceCategory;Landroidx/preference/PreferenceScreen;Ljava/lang/String;Ljava/lang/String;)V

    const-string v0, "pref_camera_handle_ring"

    invoke-static {v0}, Lu2/g;->a(Ljava/lang/String;)Lu2/h;

    move-result-object v0

    iput-object v0, p0, Lcom/android/camera/fragment/settings/CameraHandleRingFragment;->d0:Lu2/h;

    iget-object v2, p0, Lcom/android/camera/fragment/settings/BasePreferenceFragment;->w:Landroidx/preference/PreferenceScreen;

    iget-object v3, v0, Lu2/h;->a:Ljava/lang/String;

    iget-object v5, v0, Lu2/h;->c:[Ljava/lang/String;

    iget-boolean v6, v0, Lu2/h;->f:Z

    iget-object v4, v0, Lu2/h;->b:[Ljava/lang/String;

    move-object v1, p0

    invoke-virtual/range {v1 .. v6}, Lcom/android/camera/fragment/settings/BasePreferenceFragment;->oe(Landroidx/preference/PreferenceGroup;Ljava/lang/String;[Ljava/lang/CharSequence;[Ljava/lang/CharSequence;Z)Lmiuix/preference/SingleChoicePreferenceCategory;
...
.method public final onPreferenceClick(Landroidx/preference/Preference;)Z
    ...
    iget-object v0, p0, Lcom/android/camera/fragment/settings/CameraHandleRingFragment;->d0:Lu2/h;
    ...
    iget-object p0, p0, Lcom/android/camera/fragment/settings/CameraHandleRingFragment;->d0:Lu2/h;

    iget-object p0, p0, Lu2/h;->i:Lu2/i;

    if-eqz p0, :cond_0

    check-cast p1, Lmiuix/preference/SingleChoicePreferenceCategory;

    invoke-interface {p0, p1}, Lu2/i;->a(Lmiuix/preference/SingleChoicePreferenceCategory;)V
...
.method public final onResume()V
    ...
    iget-object v0, v0, Lu2/h;->e:Ljava/lang/String;
    ...
    :goto_0
    iget-object v2, p0, Lcom/android/camera/fragment/settings/CameraHandleRingFragment;->d0:Lu2/h;
    ...
    iget-object v4, p0, Lcom/android/camera/fragment/settings/CameraHandleRingFragment;->d0:Lu2/h;

    iget-object v4, v4, Lu2/h;->c:[Ljava/lang/String;
    ...
    iget-object v3, p0, Lcom/android/camera/fragment/settings/CameraHandleRingFragment;->d0:Lu2/h;

    iget-object v3, v3, Lu2/h;->c:[Ljava/lang/String;
    ...
    invoke-virtual {v3, v2}, Lmiuix/preference/SingleChoicePreferenceCategory;->i(Landroidx/preference/Preference;)V
