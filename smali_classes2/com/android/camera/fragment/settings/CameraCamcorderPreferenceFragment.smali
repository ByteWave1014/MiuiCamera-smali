...
.method public final Mi(Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, v1, p1}, Lcom/android/camera/fragment/settings/BasePreferenceFragment;->Cf(Ljava/lang/Class;Ljava/lang/String;)V
    ...
    :pswitch_1
    invoke-virtual {p0, p1}, Lcom/android/camera/fragment/settings/BasePreferenceFragment;->Df(Ljava/lang/String;)V
...
.method public final Ni(Landroidx/preference/CheckBoxPreference;Ljava/lang/String;ZLandroid/content/SharedPreferences;)V
    ...
    invoke-virtual {p3, p4}, Lc0/b;->l(I)Z
    ...
    invoke-virtual {v0, p3, v1}, Lea/a;->g(Ljava/lang/String;Z)Z
    ...
    invoke-virtual {p3, p0, v1}, Lea/a;->g(Ljava/lang/String;Z)Z
    ...
    invoke-virtual {p0, p3}, Lea/b;->v(Ljava/lang/Class;)Ljava/lang/Object;

    move-result-object p0

    check-cast p0, Lc0/d;

    iget p3, p0, Lc0/d;->b:I
...
.method public final Pi(Ljava/lang/String;)V
    ...
    invoke-virtual {v9, v1}, Lc0/c;->m(Z)V

    invoke-static {}, Lcom/android/camera/fragment/settings/BasePreferenceFragment;->Ce()Lb0/a1;
    ...
    invoke-virtual {v0, v2}, Lc0/b;->s(Z)V
    ...
    invoke-virtual {v0, v5}, Lc0/d;->o(Z)V
    ...
    invoke-virtual {p0, v1, v8}, Lcom/android/camera/fragment/settings/BasePreferenceFragment;->sh(Ljava/lang/Object;Ljava/lang/String;)V
...
.method public final Wc()V
    ...
    iget-object v4, p0, Lcom/android/camera/fragment/settings/BasePreferenceFragment;->x:Lu2/f;
    ...
    invoke-virtual {v6, v1}, Lc0/b;->l(I)Z

    move-result v7

    if-nez v7, :cond_4

    invoke-virtual {v6, v0}, Lc0/b;->l(I)Z
    ...
    invoke-virtual {p0, v2, v4, v5}, Lcom/android/camera/fragment/settings/BasePreferenceFragment;->re(Landroidx/preference/PreferenceCategory;Ljava/lang/String;I)V
    ...
    iget-object v5, p0, Lcom/android/camera/fragment/settings/BasePreferenceFragment;->x:Lu2/f;
    ...
    iget-object v5, v11, LG7/b;->e:L渭渡渣湠渣渧湠渪渫游渧渭渫湠渭渡渣渣渡渠湠渍渡渣渣渡渠;

    invoke-virtual {v5}, L渭渡渣湠渣渧湠渪渫游渧渭渫湠渭渡渣渣渡渠湠渍渡渣渣渡渠;->F3()Z
    ...
    iget-object v4, v11, LG7/b;->e:L渭渡渣湠渣渧湠渪渫游渧渭渫湠渭渡渣渣渡渠湠渍渡渣渣渡渠;

    invoke-virtual {v4}, L渭渡渣湠渣渧湠渪渫游渧渭渫湠渭渡渣渣渡渠湠渍渡渣渣渡渠;->w5()Z
    ...
    invoke-virtual {p0, v2, v4, v5, v3}, Lcom/android/camera/fragment/settings/BasePreferenceFragment;->Pd(Landroidx/preference/PreferenceCategory;Ljava/lang/String;II)V
    ...
    invoke-virtual/range {v4 .. v9}, Lcom/android/camera/fragment/settings/BasePreferenceFragment;->Nb(Landroidx/preference/PreferenceGroup;Ljava/lang/String;ZII)Landroidx/preference/CheckBoxPreference;
    ...
    invoke-virtual {v4}, L渭渡渣湠渣渧湠渪渫游渧渭渫湠渭渡渣渣渡渠湠渍渡渣渣渡渠;->F3()Z
    ...
    invoke-virtual {v4}, L渭渡渣湠渣渧湠渪渫游渧渭渫湠渭渡渣渣渡渠湠渍渡渣渣渡渠;->P5()Z
    ...
    invoke-virtual {v4, v5}, LF3/f;->Q(I)LZ5/d;

    move-result-object v4

    invoke-static {v4}, LZ5/e;->V2(LZ5/d;)Z
    ...
    invoke-static {v5}, Lu2/f;->b(Ljava/lang/String;)I

    move-result v4

    invoke-virtual {v11}, LG7/b;->B1()Z
    ...
    invoke-virtual {v5}, L渭渡渣湠渣渧湠渪渫游渧渭渫湠渭渡渣渣渡渠湠渍渡渣渣渡渠;->g5()Z
    ...
    invoke-virtual {v6}, LF3/f;->a0()LZ5/d;

    move-result-object v6

    invoke-static {v6}, LZ5/e;->k3(LZ5/d;)Z

    move-result v7

    if-nez v7, :cond_11

    invoke-static {v6}, LZ5/e;->g3(LZ5/d;)Z
    ...
    invoke-static {v7}, Lb0/f1;->c(I)Ljava/lang/String;
    ...
    invoke-virtual {v5, v4}, LF3/f;->Q(I)LZ5/d;

    move-result-object v4

    invoke-static {v4}, LZ5/e;->H3(LZ5/d;)Z
    ...
    invoke-virtual {v4}, L渭渡渣湠渣渧湠渪渫游渧渭渫湠渭渡渣渣渡渠湠渍渡渣渣渡渠;->q6()Z
    ...
    invoke-static {v4, v10}, Lic/f;->c(Ljava/lang/String;Z)Z
    ...
    invoke-virtual {v4}, Lu2/f;->a()LA/Q3;

    move-result-object v4

    iget-boolean v4, v4, LA/Q3;->a:Z

    if-eqz v4, :cond_21

    iget-object v4, v11, LG7/b;->e:L渭渡渣湠渣渧湠渪渫游渧渭渫湠渭渡渣渣渡渠湠渍渡渣渣渡渠;

    invoke-virtual {v4}, L渭渡渣湠渣渧湠渪渫游渧渭渫湠渭渡渣渣渡渠湠渍渡渣渣渡渠;->h6()Z
    ...
    invoke-virtual {v4}, Lu2/f;->c()LA/Q3;
    ...
    invoke-static {v4}, LZ5/e;->s3(LZ5/d;)Z
    ...
    invoke-static {v4}, LZ5/e;->j0(LZ5/d;)I
    ...
    invoke-virtual {v4}, LF3/f;->W()LZ5/d;

    move-result-object v4

    invoke-static {v4}, LZ5/e;->V3(LZ5/d;)Z
    ...
    :cond_26
    iget-object v3, p0, Lcom/android/camera/fragment/settings/BasePreferenceFragment;->x:Lu2/f;
    ...
    invoke-virtual {v3}, LF3/f;->a0()LZ5/d;

    move-result-object v3

    :cond_27
    invoke-static {v3}, LZ5/e;->r0(LZ5/d;)Z

    move-result v4

    if-nez v4, :cond_28

    invoke-static {v3}, LZ5/e;->t0(LZ5/d;)Z
    ...
    invoke-virtual {v4}, Le0/o;->M()Z

    move-result v4

    iget v3, v3, Lu2/f;->a:I
    ...
    invoke-static {v5, v6, v3, v4}, LA/N;->e(Ljava/lang/String;Ljava/lang/String;ZZ)Ljava/lang/String;
    ...
    invoke-virtual {v4}, L渭渡渣湠渣渧湠渪渫游渧渭渫湠渭渡渣渣渡渠湠渍渡渣渣渡渠;->a4()Z

    move-result v5

    if-eqz v5, :cond_33

    invoke-virtual {v4}, L渭渡渣湠渣渧湠渪渫游渧渭渫湠渭渡渣渣渡渠湠渍渡渣渣渡渠;->b4()Z

    move-result v5

    if-nez v5, :cond_33

    invoke-virtual {v4}, L渭渡渣湠渣渧湠渪渫游渧渭渫湠渭渡渣渣渡渠湠渍渡渣渣渡渠;->c4()Z
    ...
    invoke-virtual/range {v4 .. v11}, Lcom/android/camera/fragment/settings/BasePreferenceFragment;->me(Landroidx/preference/PreferenceCategory;Ljava/lang/String;Ljava/lang/String;II[Ljava/lang/CharSequence;[Ljava/lang/CharSequence;)V
...
.method public final onPreferenceChange(Landroidx/preference/Preference;Ljava/lang/Object;)Z
    ...
    invoke-virtual {p0, v3}, Lcom/android/camera/fragment/settings/CameraCamcorderPreferenceFragment;->Pi(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v2}, Lc0/c;->m(Z)V
    ...
    iget-object p1, p0, Lcom/android/camera/fragment/settings/BasePreferenceFragment;->x:Lu2/f;
    ...
    invoke-virtual {p0, v0, v4}, Lcom/android/camera/fragment/settings/BasePreferenceFragment;->sh(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    invoke-virtual {v0}, L渭渡渣湠渣渧湠渪渫游渧渭渫湠渭渡渣渣渡渠湠渍渡渣渣渡渠;->h6()Z
    ...
    invoke-virtual {p0, v0, v2}, Lea/a;->m(Ljava/lang/String;Z)Lea/a;
    ...
    invoke-virtual {v0}, LF3/f;->a0()LZ5/d;
    ...
    invoke-virtual {p0, v4, v2}, Lea/a;->m(Ljava/lang/String;Z)Lea/a;

    :cond_e
    invoke-virtual {p1}, LG7/b;->B1()Z

    move-result v4

    if-nez v4, :cond_f

    invoke-virtual {p1}, LG7/b;->A1()Z
    ...
    invoke-virtual {p0, p1, v2}, Lea/a;->m(Ljava/lang/String;Z)Lea/a;
    ...
    invoke-virtual {p0, v2}, Lc0/b;->s(Z)V
    ...
    iget-object v1, p0, Lcom/android/camera/fragment/settings/BasePreferenceFragment;->x:Lu2/f;

    iget v1, v1, Lu2/f;->a:I
    ...
    invoke-virtual {p0, v2}, Lb0/i;->n(Z)V
    ...
    invoke-direct {v4, p0, v0}, LJ8/d;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-virtual {p0, p1, v4}, Lcom/android/camera/fragment/settings/BasePreferenceFragment;->sh(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v2}, Lc0/d;->o(Z)V
...
.method public final onRequestPermissionsResult(I[Ljava/lang/String;[I)V
    ...
    invoke-virtual {p0, p1}, Lcom/android/camera/fragment/settings/CameraPreferenceFragment;->E6(Ljava/lang/String;)V
