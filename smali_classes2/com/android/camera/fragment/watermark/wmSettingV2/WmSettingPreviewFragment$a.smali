...
.method public final surfaceChanged(Landroid/view/SurfaceHolder;III)V
    ...
    iget-object p4, p2, Lcom/android/camera/fragment/watermark/wmSettingV2/WmSettingPreviewFragment;->c:LJ5/e;
    ...
    iput-object v0, p4, LJ5/e;->b:LM5/b$b;
    ...
    invoke-direct {v0, p2, p1}, LM5/b;-><init>(Landroid/content/Context;Landroid/view/Surface;)V

    iput-object v0, p4, LJ5/e;->c:LM5/b;

    invoke-virtual {v0}, Ljava/lang/Thread;->start()V

    iget-object p1, p4, LJ5/e;->c:LM5/b;

    iget-object p2, p1, LM5/b;->a:Ljava/lang/Object;

    monitor-enter p2

    :goto_0
    :try_start_0
    iget-boolean p4, p1, LM5/b;->e:Z
    :try_end_0
    ...
    :try_start_1
    iget-object p4, p1, LM5/b;->a:Ljava/lang/Object;
    ...
    invoke-virtual {p3, p4}, Lof/a;->plus(Lof/h;)Lof/h;
    ...
    invoke-direct {p4, p0, p1, p2}, LI2/H;-><init>(Lcom/android/camera/fragment/watermark/wmSettingV2/WmSettingPreviewFragment;Landroid/graphics/Bitmap;Lof/e;)V

    const/4 p1, 0x3

    invoke-static {p3, p2, p2, p4, p1}, LSg/f;->a(LSg/E;Lof/f;LSg/G;Lzf/p;I)LSg/C0;

    move-result-object p1

    iput-object p1, p0, Lcom/android/camera/fragment/watermark/wmSettingV2/WmSettingPreviewFragment;->o:LSg/C0;
...
.method public final surfaceDestroyed(Landroid/view/SurfaceHolder;)V
    ...
    :goto_0
    iget-object p0, p0, Lcom/android/camera/fragment/watermark/wmSettingV2/WmSettingPreviewFragment;->c:LJ5/e;

    if-eqz p0, :cond_2

    iget-object p1, p0, LJ5/e;->c:LM5/b;
    ...
    invoke-virtual {p1, v0}, LM5/b;->b(Ljava/lang/Runnable;)V
