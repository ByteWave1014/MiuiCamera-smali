...
# virtual methods
.method public final J9(Landroid/graphics/Bitmap;)V
    .locals 8
    ...
    invoke-static {v4, v5}, LA/H2;->d(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    :try_start_4
    invoke-static {v0, p1}, LA/O2;->i(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    ...
    invoke-static {v0, v4, v2, v5}, LQg/p;->T(Ljava/lang/String;CII)I
    ...
    const-string/jumbo v7, "userData/current/icon/"
    ...
    invoke-virtual {v5, v0, v2}, Lcom/xiaomi/cam/watermark/b;->R(Ljava/lang/String;Z)V
    ...
    invoke-virtual {v0, v3}, Lcom/xiaomi/cam/watermark/b;->e(Z)V
    ...
    iget-object v2, v0, LK2/m;->a:LK2/m$a;

    if-eqz v2, :cond_7

    invoke-interface {v2, p1}, LK2/m$a;->a(Landroid/net/Uri;)V

    iput-object v1, v0, LK2/m;->a:LK2/m$a;

    :cond_7
    invoke-virtual {p0}, Lcom/android/camera/fragment/watermark/wmSettingV2/imageCrop/WmFragmentIconCrop;->X9()V
...
.method public final X9()V
    ...
    :cond_0
    iget-object v0, p0, Lcom/android/camera/fragment/watermark/wmSettingV2/imageCrop/WmFragmentIconCrop;->m:LJ0/b;
...
.method public final o8(Landroid/view/View;)V
    ...
    invoke-direct {v2, p0, v0}, LK2/a;-><init>(Landroidx/fragment/app/Fragment;I)V
    ...
    invoke-static {v2, p1}, LK2/m;->a(Landroid/content/Context;Landroid/net/Uri;)I
    ...
    :try_start_3
    invoke-static {v1, v3}, LA/O2;->i(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    :try_end_3
