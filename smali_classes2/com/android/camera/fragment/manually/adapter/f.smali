...
.field public final e:Lb0/X0;

.field public final f:I


# direct methods
.method public constructor <init>(Landroid/content/Context;Lb0/X0;ILi2/k;)V
    .locals 1
    ...
    sget-object v0, Lb0/X0;->i:Ljava/util/HashMap;

    iput-object v0, p0, Lcom/android/camera/fragment/manually/adapter/f;->a:Ljava/util/HashMap;

    iput-object p2, p0, Lcom/android/camera/fragment/manually/adapter/f;->e:Lb0/X0;

    iput p3, p0, Lcom/android/camera/fragment/manually/adapter/f;->f:I

    iput-object p4, p0, Lcom/android/camera/fragment/manually/adapter/f;->d:Li2/k;

    invoke-virtual {p0, p1}, Lcom/android/camera/ui/c$a;->initStyle(Landroid/content/Context;)V

    iget-object p1, p0, Lcom/android/camera/ui/c$a;->mTextPaint:Landroid/graphics/Paint;
    ...
    invoke-virtual {p1}, L渭渡渣湠渣渧湠渪渫游渧渭渫湠渭渡渣渣渡渠湠渍渡渣渣渡渠;->F0()I
    ...
    iput-object p2, p1, Ls5/d;->a:Ljava/lang/String;

    const/4 p3, 0x0

    iput p3, p1, Ls5/d;->b:I

    iput-object p2, p1, Ls5/d;->c:Ljava/lang/String;

    const/4 p3, 0x2

    iput p3, p1, Ls5/d;->d:I

    iput-object p2, p1, Ls5/d;->f:Lcom/android/camera/ui/c$a$b;

    iput p3, p1, Ls5/d;->e:I

    invoke-virtual {p0, p1, p2, p2}, Lcom/android/camera/ui/c$a;->initDataList(Ls5/d;Ljava/util/List;Ljava/lang/String;)V
...
.method public d(I)V
    ...
    :cond_0
    invoke-virtual {p0, v0, p1}, Lcom/android/camera/ui/c$a;->performValueChangedVibrator(II)V
    ...
    iget-object v0, p0, Lcom/android/camera/fragment/manually/adapter/f;->e:Lb0/X0;

    iget v1, p0, Lcom/android/camera/fragment/manually/adapter/f;->f:I

    invoke-virtual {v0, v1}, Lb0/X0;->h(I)I

    move-result v2

    if-eq p1, v2, :cond_2

    invoke-virtual {v0, v1, p1}, Lb0/X0;->k(II)V

    invoke-static {p1}, Ljava/lang/String;->valueOf(I)Ljava/lang/String;

    move-result-object v3

    invoke-virtual {v0, v1, v3}, Lb0/X0;->d(ILjava/lang/String;)V

    iget-object v4, p0, Lcom/android/camera/fragment/manually/adapter/f;->d:Li2/k;
    ...
    iget-object v5, p0, Lcom/android/camera/fragment/manually/adapter/f;->e:Lb0/X0;

    const/4 v8, 0x1

    invoke-interface/range {v4 .. v10}, Li2/k;->onManuallyDataChanged(Lcom/android/camera/data/data/c;Ljava/lang/String;Ljava/lang/String;ZII)V
...
.method public final draw(ILandroid/graphics/Canvas;ZIFI)V
    ...
    invoke-super/range {p0 .. p6}, Lcom/android/camera/ui/c$a;->draw(ILandroid/graphics/Canvas;ZIFI)V
    ...
    invoke-virtual {p0, p2, p4, p5}, Lcom/android/camera/ui/c$a;->drawText(Landroid/graphics/Canvas;ZLjava/lang/String;)V
    ...
    :goto_0
    invoke-virtual {p0, p1, p2, p3, p4}, Lcom/android/camera/ui/c$a;->drawLine(ILandroid/graphics/Canvas;ZF)V
...
.method public e(IZ)Ljava/lang/String;
    ...
    invoke-virtual {p0}, Lcom/android/camera/ui/c$a;->needSample()Z

    move-result v0

    if-eqz v0, :cond_0

    iget v0, p0, Lcom/android/camera/ui/c$a;->mSampleInterval:I
    ...
    iget-object p1, p0, Lcom/android/camera/ui/c$a;->mCurrentValue:Ljava/lang/String;
