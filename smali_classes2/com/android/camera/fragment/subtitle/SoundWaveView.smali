...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-boolean v2, p0, Lcom/android/camera/fragment/subtitle/SoundWaveView;->d:Z
    ...
    iput-object v0, p0, Lcom/android/camera/fragment/subtitle/SoundWaveView;->i:[Z

    new-instance v0, Lcom/android/camera/fragment/subtitle/SoundWaveView$a;

    invoke-static {}, Landroid/os/Looper;->getMainLooper()Landroid/os/Looper;

    move-result-object v4

    invoke-direct {v0, p0, v4}, Lcom/android/camera/fragment/subtitle/SoundWaveView$a;-><init>(Lcom/android/camera/fragment/subtitle/SoundWaveView;Landroid/os/Looper;)V

    iput-object v0, p0, Lcom/android/camera/fragment/subtitle/SoundWaveView;->l:Lcom/android/camera/fragment/subtitle/SoundWaveView$a;

    sget-object v0, Lza/f;->SoundWaveView:[I
    ...
    :try_start_0
    sget p2, Lza/f;->SoundWaveView_degree:I
    ...
    iput p1, p0, Lcom/android/camera/fragment/subtitle/SoundWaveView;->b:F

    const p1, 0x406851ec    # 3.63f
    ...
    iput p1, p0, Lcom/android/camera/fragment/subtitle/SoundWaveView;->c:F

    new-instance p1, Landroid/graphics/Paint;

    invoke-direct {p1, v3}, Landroid/graphics/Paint;-><init>(I)V

    iput-object p1, p0, Lcom/android/camera/fragment/subtitle/SoundWaveView;->a:Landroid/graphics/Paint;

    invoke-virtual {p1, v1}, Landroid/graphics/Paint;->setColor(I)V

    iget-object p1, p0, Lcom/android/camera/fragment/subtitle/SoundWaveView;->a:Landroid/graphics/Paint;

    iget p2, p0, Lcom/android/camera/fragment/subtitle/SoundWaveView;->b:F
    ...
    iput-object p1, p0, Lcom/android/camera/fragment/subtitle/SoundWaveView;->k:Landroid/graphics/RectF;

    iget-object p1, p0, Lcom/android/camera/fragment/subtitle/SoundWaveView;->e:[F

    invoke-static {p1}, Lcom/android/camera/fragment/subtitle/SoundWaveView;->b([F)[F

    move-result-object p1

    iput-object p1, p0, Lcom/android/camera/fragment/subtitle/SoundWaveView;->e:[F

    iget-object p1, p0, Lcom/android/camera/fragment/subtitle/SoundWaveView;->f:[F

    invoke-static {p1}, Lcom/android/camera/fragment/subtitle/SoundWaveView;->b([F)[F

    move-result-object p1

    iput-object p1, p0, Lcom/android/camera/fragment/subtitle/SoundWaveView;->f:[F

    iget-object p1, p0, Lcom/android/camera/fragment/subtitle/SoundWaveView;->g:[F

    invoke-static {p1}, Lcom/android/camera/fragment/subtitle/SoundWaveView;->b([F)[F

    move-result-object p1

    iput-object p1, p0, Lcom/android/camera/fragment/subtitle/SoundWaveView;->g:[F
    ...
    iput-object p1, p0, Lcom/android/camera/fragment/subtitle/SoundWaveView;->h:[F
