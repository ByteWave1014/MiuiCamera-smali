...
.method public final K4()Landroid/util/Range;
    ...
    invoke-super {p0}, LX5/H;->K4()Landroid/util/Range;
...
.method public final e6(FFI)Z
    ...
    iget v1, v1, Lb0/c0;->a:I

    const/4 v4, 0x3

    if-gt v1, v4, :cond_2

    invoke-super {p0, p1, p2, p3}, LX5/H;->e6(FFI)Z
    ...
    invoke-virtual {p0, p3}, Lb0/c0;->k(Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, v5}, Lb0/c0;->k(Ljava/lang/String;)Z

    move-result v6

    const-string/jumbo v7, "ultra_tele"

    invoke-virtual {p0, v7}, Lb0/c0;->k(Ljava/lang/String;)Z
    ...
    invoke-static {p0, v2}, LW5/g;->L6(Lcom/android/camera/module/M;Z)V
...
.method public final f0()Landroid/util/Range;
    ...
    invoke-static {p0}, LZ5/e;->W(LZ5/d;)F
