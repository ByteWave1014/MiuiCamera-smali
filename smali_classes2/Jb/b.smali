...
.field public m:LIb/a;

.field public n:I

.field public o:F

.field public p:LI2/o;
...
.method public constructor <init>()V
    ...
    iput-boolean v0, p0, LJb/b;->c:Z

    iput-boolean v0, p0, LJb/b;->d:Z
    ...
    iput-object v2, v1, LJb/a;->a:Ljava/util/concurrent/ArrayBlockingQueue;

    iput-object v1, p0, LJb/b;->i:LJb/a;

    new-instance v1, Ljava/lang/Object;

    invoke-direct {v1}, Ljava/lang/Object;-><init>()V

    iput-object v1, p0, LJb/b;->j:Ljava/lang/Object;

    new-instance v1, Landroid/media/AudioTimestamp;

    invoke-direct {v1}, Landroid/media/AudioTimestamp;-><init>()V

    iput-object v1, p0, LJb/b;->k:Landroid/media/AudioTimestamp;

    iput-boolean v0, p0, LJb/b;->l:Z

    iput v0, p0, LJb/b;->n:I

    const-wide/16 v0, 0x0

    iput-wide v0, p0, LJb/b;->q:J

    return-void
.end method

.method public static a(LJb/b;Ljava/lang/String;I)V
    .locals 4
    ...
    invoke-static {p1, v0, p2}, LA/P2;->e(Ljava/lang/String;Ljava/lang/String;I)Ljava/lang/String;
    ...
    iput-wide p1, p0, LJb/b;->q:J

    :cond_0
    return-void
.end method

.method public static b(LJb/b;)V
    .locals 5
    ...
    iget-object v3, p0, LJb/b;->a:Landroid/media/AudioRecord;
    ...
    iget-object v1, p0, LJb/b;->j:Ljava/lang/Object;

    monitor-enter v1

    :try_start_0
    iget-object v2, p0, LJb/b;->a:Landroid/media/AudioRecord;
...
.method public final c()V
    ...
    iget-object v0, p0, LJb/b;->b:Ljava/lang/Thread;

    if-nez v0, :cond_2

    iget-boolean v0, p0, LJb/b;->l:Z
    ...
    :cond_0
    const-string v5, "setDSPAACBitrate E audioBitRate = "
    ...
    iget-object v5, p0, LJb/b;->a:Landroid/media/AudioRecord;

    const-string v6, "setAudioRecordParameters err =  "

    new-instance v7, Ljava/lang/StringBuilder;

    const-string v8, "setAudioRecordParameters audioRecord =  "
    ...
    :goto_3
    iget-object v0, p0, LJb/b;->a:Landroid/media/AudioRecord;
    ...
    invoke-direct {v0, p0}, LJb/d;-><init>(LJb/b;)V

    iput-object v0, p0, LJb/b;->b:Ljava/lang/Thread;
    ...
    invoke-direct {v0, p0}, LJb/c;-><init>(LJb/b;)V
...
.method public final d(Landroid/media/AudioFormat;IIII)V
    ...
    iput-object p1, p0, LJb/b;->e:Landroid/media/AudioFormat;

    iput p2, p0, LJb/b;->g:I

    iput p3, p0, LJb/b;->f:I

    iput p4, p0, LJb/b;->h:I
    ...
    iput-object p4, p3, LIb/a;->c:Ljava/nio/ByteBuffer;

    const-wide/16 v0, -0x1

    iput-wide v0, p3, LIb/a;->d:J

    const-wide/16 v0, 0x0

    iput-wide v0, p3, LIb/a;->e:J

    iput-boolean p5, p3, LIb/a;->f:Z

    iput p1, p3, LIb/a;->a:I

    iput-object p4, p3, LIb/a;->b:Ljava/nio/ByteBuffer;
    ...
    iput-object p1, p3, LIb/a;->c:Ljava/nio/ByteBuffer;

    iput-object p3, p0, LJb/b;->m:LIb/a;

    new-instance p1, LJb/b$a;

    invoke-direct {p1, p0}, LJb/b$a;-><init>(LJb/b;)V

    iput-object p1, p3, LIb/a;->g:LJb/b$a;

    goto :goto_0

    :cond_0
    iput-boolean p5, p0, LJb/b;->l:Z
    ...
    invoke-static {p2, p1, p3}, LA3/h2;->i(ILjava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object p1

    iget-boolean p2, p0, LJb/b;->l:Z
    ...
    iget-object p2, p0, LJb/b;->e:Landroid/media/AudioFormat;
    ...
    iput-object p1, p0, LJb/b;->a:Landroid/media/AudioRecord;
    :try_end_0
...
.method public final e()V
    ...
    iput-boolean v2, p0, LJb/b;->c:Z

    iget-object v0, p0, LJb/b;->j:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, LJb/b;->a:Landroid/media/AudioRecord;
    ...
    iput-object v1, p0, LJb/b;->a:Landroid/media/AudioRecord;

    iget-object v3, p0, LJb/b;->i:LJb/a;

    invoke-virtual {v3}, LJb/a;->a()V

    monitor-exit v0
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    iget-object v0, p0, LJb/b;->m:LIb/a;

    if-eqz v0, :cond_3

    iput-object v1, v0, LIb/a;->b:Ljava/nio/ByteBuffer;

    iput-object v1, v0, LIb/a;->c:Ljava/nio/ByteBuffer;

    iput-object v1, v0, LIb/a;->g:LJb/b$a;

    const-wide/16 v3, -0x1

    iput-wide v3, v0, LIb/a;->d:J

    const-wide/16 v3, 0x0

    iput-wide v3, v0, LIb/a;->e:J

    :cond_3
    iput-object v1, p0, LJb/b;->m:LIb/a;

    iput-object v1, p0, LJb/b;->b:Ljava/lang/Thread;

    iput-boolean v2, p0, LJb/b;->l:Z
...
.method public final f()V
    ...
    iput-boolean v1, p0, LJb/b;->c:Z

    iget-object v1, p0, LJb/b;->i:LJb/a;

    invoke-virtual {v1}, LJb/a;->a()V

    iget-object v1, p0, LJb/b;->b:Ljava/lang/Thread;
    ...
    :cond_0
    iget-object p0, p0, LJb/b;->b:Ljava/lang/Thread;
...
.method public final g()V
    ...
    :try_start_1
    iget-object v3, p0, LJb/b;->m:LIb/a;

    iget-object v4, v3, LIb/a;->b:Ljava/nio/ByteBuffer;
    ...
    :cond_1
    iput-object v1, v3, LIb/a;->b:Ljava/nio/ByteBuffer;

    iget-object v4, v3, LIb/a;->c:Ljava/nio/ByteBuffer;
