...
.field public v:Lb0/G0;

.field public final w:LA/d3;

.field public x:I


# direct methods
.method public constructor <init>(ZLA/d3;)V
    .locals 1
    ...
    iput-object v0, p0, LC3/w0;->r:Landroid/graphics/RectF;

    new-instance v0, Landroid/graphics/Matrix;

    invoke-direct {v0}, Landroid/graphics/Matrix;-><init>()V

    iput-object v0, p0, LC3/w0;->s:Landroid/graphics/Matrix;

    new-instance v0, Landroid/graphics/Matrix;

    invoke-direct {v0}, Landroid/graphics/Matrix;-><init>()V

    iput-object v0, p0, LC3/w0;->t:Landroid/graphics/Matrix;

    const/4 v0, 0x0

    iput v0, p0, LC3/w0;->x:I

    iput-boolean p1, p0, LC3/w0;->q:Z

    iput-object p2, p0, LC3/w0;->w:LA/d3;
...
.method public final a()V
    ...
    sget-object v0, Ld5/m;->f:Ld5/m;

    goto/16 :goto_4

    :cond_0
    iget v1, p0, LC3/w0;->u:I
    ...
    :cond_1
    iget-object v1, p0, LC3/w0;->v:Lb0/G0;

    invoke-virtual {v1}, Lb0/G0;->a()Z
    ...
    invoke-static {v1, v2}, Lcom/android/camera/data/data/s;->P(IZ)Z
    ...
    :cond_3
    iget-object v1, p0, LC3/w0;->k:LB3/h;
    ...
    iget-object v4, p0, LC3/w0;->n:LB3/h;

    iget-object v4, v4, LB3/h;->a:Ljava/lang/Object;

    if-eqz v4, :cond_d

    :cond_4
    iget-object v4, p0, LC3/w0;->l:LB3/h;

    iget-object v4, v4, LB3/h;->a:Ljava/lang/Object;

    if-eqz v4, :cond_d

    iget-object v4, p0, LC3/w0;->m:LB3/h;
    ...
    invoke-virtual {p0, v0, v1}, LC3/w0;->t(Lcom/android/camera/module/BaseModule;Landroid/graphics/Rect;)Landroid/graphics/Rect;
    ...
    invoke-virtual {p0, v0, v5}, LC3/w0;->t(Lcom/android/camera/module/BaseModule;Landroid/graphics/Rect;)Landroid/graphics/Rect;
    ...
    :cond_6
    new-instance v13, Ld5/m;

    iget-object v5, p0, LC3/w0;->l:LB3/h;

    iget-object v5, v5, LB3/h;->a:Ljava/lang/Object;
    ...
    iget-object v5, p0, LC3/w0;->m:LB3/h;
    ...
    iget v8, p0, LC3/w0;->i:F

    iget-boolean v5, p0, LC3/w0;->o:Z
    ...
    invoke-direct/range {v4 .. v9}, Ld5/m;-><init>(Landroid/graphics/Rect;IIF[I)V
    ...
    :cond_8
    iget-object v4, p0, LC3/w0;->j:LB3/h;
    ...
    iget-object v4, p0, LC3/w0;->p:LZ5/d;

    invoke-static {v4}, LZ5/e;->W3(LZ5/d;)Z
    ...
    sget-object v1, Ld5/m;->f:Ld5/m;

    iget-object v2, v1, Ld5/m;->a:Landroid/graphics/Rect;
    ...
    iget-boolean v4, p0, LC3/w0;->q:Z

    if-eqz v4, :cond_c

    iget v4, p0, LC3/w0;->u:I
    ...
    iget-object v3, p0, LC3/w0;->m:LB3/h;
    ...
    :cond_d
    :goto_3
    iget-object v0, p0, LC3/w0;->l:LB3/h;
    ...
    :goto_4
    iput-object v0, p0, LC3/w0;->g:Ld5/m;
    ...
    invoke-direct {v1, p0, v2}, LC3/u0;-><init>(Ljava/lang/Object;I)V
...
.method public final b()V
    ...
    iget-object v1, p0, LC3/w0;->g:Ld5/m;

    invoke-static {}, LV3/o0;->impl()Ljava/util/Optional;

    move-result-object v2

    new-instance v3, LC3/v0;

    const/4 v4, 0x0

    invoke-direct {v3, v4, p0, v0, v1}, LC3/v0;-><init>(ILjava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)V
...
.method public final g()Z
    ...
    iput-object v0, p0, LC3/w0;->h:Landroid/graphics/Rect;

    iget v0, p0, LC3/w0;->u:I
    ...
    :goto_1
    iput-boolean v0, p0, LC3/w0;->o:Z

    iget-object v0, p0, LB3/i;->b:LZ5/d;

    iput-object v0, p0, LC3/w0;->p:LZ5/d;
    ...
    iput-object v0, p0, LC3/w0;->v:Lb0/G0;
...
.method public final j(Landroid/hardware/camera2/CaptureResult;)V
    ...
    invoke-static {v0, p1}, Laa/D;->x(Landroid/graphics/Rect;Landroid/graphics/Rect;)F

    move-result p1

    iput p1, p0, LC3/w0;->i:F
    ...
    invoke-static {v0, p1}, Lic/g;->h(Landroid/graphics/Rect;Landroid/hardware/camera2/CaptureResult;)F
...
.method public final q()V
    ...
    iput-object v0, p0, LC3/w0;->j:LB3/h;

    sget-object v0, Ld5/l;->a:Ln6/K;
    ...
    iput-object v0, p0, LC3/w0;->k:LB3/h;

    sget-object v0, Ld5/l;->e:Ln6/K;
    ...
    iput-object v0, p0, LC3/w0;->l:LB3/h;

    sget-object v0, Ld5/l;->i:Ln6/K;
    ...
    iput-object v0, p0, LC3/w0;->m:LB3/h;

    sget-object v0, Ld5/l;->k:Ln6/K;
    ...
    iput-object v0, p0, LC3/w0;->n:LB3/h;
...
.method public final t(Lcom/android/camera/module/BaseModule;Landroid/graphics/Rect;)Landroid/graphics/Rect;
    ...
    :cond_0
    iget-object v1, p0, LC3/w0;->w:LA/d3;
    ...
    :cond_1
    iget-object v2, p0, LC3/w0;->s:Landroid/graphics/Matrix;

    invoke-virtual {v2}, Landroid/graphics/Matrix;->reset()V

    iget-object v12, p0, LC3/w0;->t:Landroid/graphics/Matrix;

    invoke-virtual {v12}, Landroid/graphics/Matrix;->reset()V

    invoke-interface {v1}, LA/d3;->a()I

    move-result v7

    invoke-interface {v1}, LA/d3;->b()I
    ...
    iget-object p1, p0, LC3/w0;->h:Landroid/graphics/Rect;

    iget v1, p0, LC3/w0;->i:F

    invoke-static {v2, p1, v1}, Laa/D;->o(Landroid/graphics/Matrix;Landroid/graphics/Rect;F)V
    ...
    invoke-static/range {v3 .. v11}, LFg/C;->w(Landroid/graphics/Matrix;ZIIIIIII)V
    ...
    :cond_2
    iget-object p0, p0, LC3/w0;->r:Landroid/graphics/RectF;
