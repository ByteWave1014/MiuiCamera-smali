...
.method public final a()V
    ...
    iget-object v0, p0, LC3/r0;->l:Ljava/lang/Integer;

    const-string v1, "SuperMoonMultipleASD"

    sget-boolean v2, LC3/r0;->q:Z
    ...
    new-instance v6, LA3/I0;

    const/4 v7, 0x6

    invoke-direct {v6, v7}, LA3/I0;-><init>(I)V
    ...
    iget-object v6, p0, LC3/r0;->l:Ljava/lang/Integer;
    ...
    iget-object v5, p0, LC3/r0;->l:Ljava/lang/Integer;
    ...
    iput-boolean v3, v1, Lf0/h0;->a:Z

    :cond_9
    iget-boolean v1, p0, LC3/r0;->g:Z

    if-ne v0, v1, :cond_a

    iget-boolean v1, p0, LC3/r0;->j:Z
    ...
    iget-boolean v0, p0, LC3/r0;->j:Z

    if-eqz v0, :cond_b

    iput-boolean v4, p0, LC3/r0;->i:Z

    :cond_b
    iput-boolean v3, p0, LC3/r0;->j:Z

    iput-boolean v4, p0, LC3/r0;->h:Z
...
.method public final b()V
    ...
    :goto_0
    iget-boolean v5, p0, LC3/r0;->k:Z

    iget-boolean v6, p0, LC3/r0;->j:Z

    if-eq v5, v6, :cond_3

    iget v5, p0, LC3/r0;->o:I
    ...
    invoke-direct {v2, v5}, LA/I;-><init>(I)V

    invoke-virtual {v1, v2}, Ljava/util/Optional;->ifPresent(Ljava/util/function/Consumer;)V

    iput-boolean v3, p0, LC3/r0;->p:Z

    goto :goto_1

    :cond_3
    iget-boolean v2, p0, LC3/r0;->p:Z
    ...
    invoke-direct {v2, v5}, LA/H0;-><init>(I)V

    invoke-virtual {v1, v2}, Ljava/util/Optional;->ifPresent(Ljava/util/function/Consumer;)V

    iput-boolean v4, p0, LC3/r0;->p:Z

    :cond_4
    :goto_1
    iput v0, p0, LC3/r0;->o:I

    iget-boolean v0, p0, LC3/r0;->j:Z

    iput-boolean v0, p0, LC3/r0;->k:Z
    ...
    invoke-direct {v2, v0, v5}, LA3/p;-><init>(ZI)V

    invoke-virtual {v1, v2}, Ljava/util/Optional;->ifPresent(Ljava/util/function/Consumer;)V

    iget-boolean v0, p0, LC3/r0;->h:Z
    ...
    invoke-direct {v6, v1, v7}, LA/y;-><init>(ZI)V

    invoke-virtual {v5, v6}, Ljava/util/Optional;->ifPresent(Ljava/util/function/Consumer;)V

    :cond_8
    :goto_4
    iget-boolean v1, p0, LC3/r0;->m:Z
    ...
    iput-boolean v4, p0, LC3/r0;->m:Z

    iput-boolean v3, p0, LC3/r0;->n:Z
    ...
    invoke-virtual {v1, v3, v4}, Lea/a;->m(Ljava/lang/String;Z)Lea/a;
    ...
    invoke-direct {v3, v5, v6}, LA/Q1;-><init>(IB)V
    ...
    invoke-direct {v3, v0, v5}, LA3/y0;-><init>(ZI)V
    ...
    invoke-direct {v3, v0, v5}, LA3/Y;-><init>(ZI)V
...
.method public final s()V
    ...
    iput-object v0, p0, LC3/r0;->l:Ljava/lang/Integer;
