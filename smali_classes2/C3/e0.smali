...
.method public final b()V
    ...
    iget-object v1, p0, LC3/e0;->n:Ljava/lang/String;
    ...
    :goto_0
    invoke-interface {v0, v1}, Lcom/android/camera/module/N;->Ha(Ljava/lang/String;)V
    ...
    :goto_1
    invoke-interface {v0, p0}, Lcom/android/camera/module/N;->K5([F)V
...
.method public final g()Z
    ...
    iput-object v0, p0, LC3/e0;->l:Ljava/util/ArrayList;

    new-instance v1, LB3/m;

    const-string v2, "camera.preview.debug.xp_content"

    invoke-direct {v1, v2}, LB3/m;-><init>(Ljava/lang/String;)V

    invoke-virtual {v0, v1}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    iget-object v0, p0, LC3/e0;->l:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, LC3/e0;->g:LA/d3;

    iget-object v0, p0, LB3/i;->b:LZ5/d;

    invoke-static {v0}, LZ5/e;->K3(LZ5/d;)Z

    move-result v0

    iput-boolean v0, p0, LC3/e0;->h:Z

    iget-object v0, p0, LB3/i;->b:LZ5/d;

    invoke-static {v0}, LZ5/e;->j(LZ5/d;)I

    move-result v0

    iput v0, p0, LC3/e0;->i:I

    iget-object v0, p0, LB3/i;->b:LZ5/d;

    invoke-static {v0}, LZ5/e;->k(LZ5/d;)I

    move-result v0

    iput v0, p0, LC3/e0;->j:I
    ...
    iput-object v0, p0, LC3/e0;->k:Landroid/graphics/Rect;
...
.method public final j(Landroid/hardware/camera2/CaptureResult;)V
    ...
    iget-object v5, v0, LB3/i;->a:Lcom/android/camera/module/BaseModule;

    iget-object v6, v0, LC3/e0;->l:Ljava/util/ArrayList;
    ...
    :cond_0
    iput-object v7, v6, LB3/m;->b:Ljava/lang/String;

    iget-object v6, v0, LC3/e0;->g:LA/d3;
    ...
    invoke-interface {v6}, Ls3/j;->r0()I

    move-result v13

    iget-object v6, v0, LC3/e0;->k:Landroid/graphics/Rect;

    iget-object v12, v0, LC3/e0;->g:LA/d3;

    invoke-interface {v12}, LA/d3;->b()I

    move-result v14

    iget-object v12, v0, LC3/e0;->g:LA/d3;

    invoke-interface {v12}, LA/d3;->a()I
    ...
    sget-object v3, Ld5/l;->a:Ln6/K;

    invoke-static {v1, v3, v7}, Ln6/L;->j(Landroid/hardware/camera2/CaptureResult;Ln6/K;I)Ljava/lang/Object;

    move-result-object v3

    check-cast v3, Landroid/graphics/Rect;

    sget-object v4, Ld5/l;->k:Ln6/K;

    invoke-static {v1, v4, v7}, Ln6/L;->j(Landroid/hardware/camera2/CaptureResult;Ln6/K;I)Ljava/lang/Object;

    move-result-object v4

    check-cast v4, [I

    sget-object v2, Ld5/l;->e:Ln6/K;

    invoke-static {v1, v2, v7}, Ln6/L;->j(Landroid/hardware/camera2/CaptureResult;Ln6/K;I)Ljava/lang/Object;
    ...
    sget-object v3, Ld5/l;->b:Ln6/K;

    const v4, 0xdead

    invoke-static {v1, v3, v4}, Ln6/L;->j(Landroid/hardware/camera2/CaptureResult;Ln6/K;I)Ljava/lang/Object;
    ...
    invoke-static {v6, v3}, Laa/D;->x(Landroid/graphics/Rect;Landroid/graphics/Rect;)F
    ...
    :cond_3
    invoke-static {v6, v1}, Lic/g;->h(Landroid/graphics/Rect;Landroid/hardware/camera2/CaptureResult;)F

    move-result v3

    :goto_1
    invoke-static {v10, v6, v3}, Ljc/c;->D(Landroid/graphics/Matrix;Landroid/graphics/Rect;F)V
    ...
    invoke-static/range {v12 .. v19}, Ljc/c;->C(Landroid/graphics/Matrix;IIIIIII)V
    ...
    :goto_3
    iget-object v3, v0, LC3/e0;->l:Ljava/util/ArrayList;
    ...
    :cond_6
    iput-object v2, v3, LB3/m;->b:Ljava/lang/String;

    iget-object v2, v0, LC3/e0;->g:LA/d3;
    ...
    invoke-interface {v2}, Ls3/j;->r0()I

    move-result v4

    iget-object v2, v0, LC3/e0;->k:Landroid/graphics/Rect;

    iget-object v3, v0, LC3/e0;->g:LA/d3;

    invoke-interface {v3}, LA/d3;->b()I

    move-result v5

    iget-object v3, v0, LC3/e0;->g:LA/d3;

    invoke-interface {v3}, LA/d3;->a()I

    move-result v6

    sget-boolean v3, LZ5/M;->a:Z

    sget-object v3, Ld5/l;->g:Ln6/K;
    ...
    invoke-static {v2, v3}, Laa/D;->x(Landroid/graphics/Rect;Landroid/graphics/Rect;)F
    ...
    :cond_8
    invoke-static {v2, v1}, Lic/g;->h(Landroid/graphics/Rect;Landroid/hardware/camera2/CaptureResult;)F

    move-result v3

    :goto_4
    invoke-static {v14, v2, v3}, Ljc/c;->D(Landroid/graphics/Matrix;Landroid/graphics/Rect;F)V
    ...
    invoke-static/range {v3 .. v10}, Ljc/c;->C(Landroid/graphics/Matrix;IIIIIII)V
    ...
    invoke-static {v3, v2, v4, v5, v6}, LA/N;->f(IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    iget-object v2, v0, LC3/e0;->l:Ljava/util/ArrayList;

    iget v3, v0, LC3/e0;->i:I

    iget v4, v0, LC3/e0;->j:I
    ...
    invoke-static {v1, v3, v4}, LZ5/N;->a(Landroid/hardware/camera2/CaptureResult;II)Lo6/a;

    move-result-object v3

    sget-object v4, Ln6/J;->W:Ln6/K;
    ...
    invoke-direct {v7}, Lo6/b$a;-><init>()V
    ...
    invoke-direct {v11, v10, v4, v7}, Lo6/b;-><init>(IILo6/b$a;)V
    ...
    iget-object v14, v7, Lo6/b$a;->b:[F
    ...
    iget-object v15, v7, Lo6/b$a;->d:[F
    ...
    iget-object v11, v7, Lo6/b$a;->e:[J
    ...
    invoke-direct {v4, v10, v12, v7}, Lo6/b;-><init>(IILo6/b$a;)V
    ...
    invoke-static {v4}, Lic/f;->a(Ljava/lang/String;)Ljava/lang/String;
    ...
    sget-object v8, LZ5/N;->a:Ljava/util/List;

    sget-object v8, Ln6/J;->b2:Ln6/K;

    const v10, 0xbabe

    invoke-static {v1, v8, v10}, Ln6/L;->j(Landroid/hardware/camera2/CaptureResult;Ln6/K;I)Ljava/lang/Object;
    ...
    invoke-direct/range {v21 .. v28}, Lo6/n;-><init>(IF[F[FJF)V
    ...
    invoke-static {v8, v9}, LA/P;->c(ILjava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v4, v6}, LA/A3;->a(Ljava/lang/String;Ljava/lang/StringBuilder;)V
    ...
    iget-object v4, v3, Lo6/a;->a:[Lo6/a$a;
    ...
    iget v10, v12, Lo6/a$a;->c:F

    const/4 v12, 0x0

    aget-object v4, v4, v12

    iget v4, v4, Lo6/a$a;->c:F
    ...
    iget-object v3, v3, Lo6/a;->a:[Lo6/a$a;

    const/4 v4, 0x0

    aget-object v3, v3, v4

    iget-wide v3, v3, Lo6/a$a;->a:J
    ...
    invoke-static {v3, v6}, LA/A3;->a(Ljava/lang/String;Ljava/lang/StringBuilder;)V
    ...
    :goto_17
    sget-object v9, Ln6/J;->U1:Ln6/K;

    invoke-static {v1, v9, v4}, Ln6/L;->j(Landroid/hardware/camera2/CaptureResult;Ln6/K;I)Ljava/lang/Object;
    ...
    :goto_18
    sget-object v9, Ln6/J;->W1:Ln6/K;

    const v10, 0xbabe

    invoke-static {v1, v9, v10}, Ln6/L;->j(Landroid/hardware/camera2/CaptureResult;Ln6/K;I)Ljava/lang/Object;
    ...
    iget v3, v11, Lo6/b;->b:I

    if-nez v3, :cond_2a

    iget v3, v11, Lo6/b;->a:I
    ...
    :goto_1b
    iget-object v4, v11, Lo6/b;->c:Lo6/b$a;

    iget v9, v4, Lo6/b$a;->a:I
    ...
    iget-object v10, v4, Lo6/b$a;->b:[F
    ...
    iget-object v10, v4, Lo6/b$a;->c:[F
    ...
    iget-wide v9, v5, LZ5/I;->I2:J

    iget-wide v11, v5, LZ5/I;->J2:J
    ...
    sget-object v3, Ln6/J;->H0:Ln6/K;

    const v5, 0xbabe

    invoke-static {v1, v3, v5}, Ln6/L;->j(Landroid/hardware/camera2/CaptureResult;Ln6/K;I)Ljava/lang/Object;
    ...
    invoke-static {v5, v6}, LA/A3;->a(Ljava/lang/String;Ljava/lang/StringBuilder;)V
    ...
    sget-object v3, Ln6/J;->u1:Ln6/K;

    const v10, 0xdead

    invoke-static {v1, v3, v10}, Ln6/L;->j(Landroid/hardware/camera2/CaptureResult;Ln6/K;I)Ljava/lang/Object;
    ...
    new-instance v15, Lo6/m;

    invoke-direct {v15}, Ljava/lang/Object;-><init>()V

    iput v10, v15, Lo6/m;->a:F

    iput v11, v15, Lo6/m;->b:F

    iput v12, v15, Lo6/m;->c:F

    iput v13, v15, Lo6/m;->d:F

    iput v14, v15, Lo6/m;->e:F

    iput v3, v15, Lo6/m;->f:F
    ...
    invoke-static {v3, v10}, LA/P;->c(ILjava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v15}, Lo6/m;->toString()Ljava/lang/String;
    ...
    invoke-static/range {p1 .. p1}, LZ5/N;->b(Landroid/hardware/camera2/CaptureResult;)Lo6/c;
    ...
    invoke-static {v10, v3}, LA/T;->h(Ljava/lang/String;F)Ljava/lang/String;
    ...
    invoke-static {v3, v8}, LA/T;->h(Ljava/lang/String;F)Ljava/lang/String;
    ...
    sget-object v3, Ln6/J;->g2:Ln6/K;

    const v8, 0xbabe

    invoke-static {v1, v3, v8}, Ln6/L;->j(Landroid/hardware/camera2/CaptureResult;Ln6/K;I)Ljava/lang/Object;
    ...
    iget-boolean v3, v3, Lb0/F0;->h:Z

    if-eqz v3, :cond_43

    sget-object v3, LZ5/N;->a:Ljava/util/List;

    sget-object v3, Ln6/J;->i2:Ln6/K;
    ...
    invoke-static {v5, v10, v13, v11}, LA/O;->f(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-static/range {p1 .. p1}, LZ5/N;->h(Landroid/hardware/camera2/CaptureResult;)I

    move-result v3

    invoke-static/range {p1 .. p1}, LZ5/N;->g(Landroid/hardware/camera2/CaptureResult;)[B
    ...
    invoke-virtual {v9}, L渭渡渣湠渣渧湠渪渫游渧渭渫湠渭渡渣渣渡渠湠渍渡渣渣渡渠;->W()[I
    ...
    invoke-virtual {v8}, L渭渡渣湠渣渧湠渪渫游渧渭渫湠渭渡渣渣渡渠湠渍渡渣渣渡渠;->W()[I
    ...
    invoke-virtual {v8}, L渭渡渣湠渣渧湠渪渫游渧渭渫湠渭渡渣渣渡渠湠渍渡渣渣渡渠;->K()[I

    move-result-object v8

    :goto_27
    new-instance v9, Lo6/h;

    invoke-direct {v9, v4, v8}, Lo6/h;-><init>([B[I)V
    ...
    invoke-static/range {p1 .. p1}, Lo6/i;->a(Landroid/hardware/camera2/CaptureResult;)[Lo6/i$a;
    ...
    sget-object v4, LZ5/N;->a:Ljava/util/List;

    sget-object v4, Ln6/J;->O0:Ln6/K;

    const v8, 0xdead

    invoke-static {v1, v4, v8}, Ln6/L;->j(Landroid/hardware/camera2/CaptureResult;Ln6/K;I)Ljava/lang/Object;
    ...
    invoke-static {v3}, Lo6/k;->a([B)Lo6/k$a;
    ...
    iget-object v4, v3, LB3/m;->a:Ljava/lang/String;

    iget-object v3, v3, LB3/m;->b:Ljava/lang/String;
    ...
    sget-object v4, Ln6/J;->i0:Ln6/K;

    const v9, 0xdead

    invoke-static {v1, v4, v9}, Ln6/L;->j(Landroid/hardware/camera2/CaptureResult;Ln6/K;I)Ljava/lang/Object;
    ...
    invoke-static {v10, v6}, LA/A3;->a(Ljava/lang/String;Ljava/lang/StringBuilder;)V
    ...
    sget-object v2, LZ5/N;->a:Ljava/util/List;

    sget-object v2, Ln6/J;->C2:Ln6/K;
    ...
    invoke-static {v2, v6}, LA/A3;->a(Ljava/lang/String;Ljava/lang/StringBuilder;)V
    ...
    iput-object v2, v0, LC3/e0;->n:Ljava/lang/String;
    ...
    invoke-static {v1, v11}, LA/P;->g(Ljava/lang/StringBuilder;[F)Ljava/lang/String;
...
.method public final s()V
    ...
    iput-object v0, p0, LC3/e0;->m:[Landroid/hardware/camera2/params/MeteringRectangle;
