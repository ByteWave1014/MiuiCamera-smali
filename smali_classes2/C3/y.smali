...
.method public constructor <init>()V
    ...
    iput-object v0, p0, LC3/y;->h:Landroid/graphics/RectF;

    new-instance v0, Landroid/graphics/Matrix;

    invoke-direct {v0}, Landroid/graphics/Matrix;-><init>()V

    iput-object v0, p0, LC3/y;->i:Landroid/graphics/Matrix;

    new-instance v0, Landroid/graphics/Matrix;

    invoke-direct {v0}, Landroid/graphics/Matrix;-><init>()V

    iput-object v0, p0, LC3/y;->j:Landroid/graphics/Matrix;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, LC3/y;->o:Ljava/util/HashMap;
...
.method public final b()V
    ...
    iget-object v2, v0, LC3/y;->g:LB3/h;

    iget-object v2, v2, LB3/h;->a:Ljava/lang/Object;
    ...
    invoke-static {v5, v9}, LA/P;->d(Landroid/graphics/Rect;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v9, v0, LC3/y;->i:Landroid/graphics/Matrix;

    invoke-virtual {v9}, Landroid/graphics/Matrix;->reset()V

    iget-object v10, v0, LC3/y;->j:Landroid/graphics/Matrix;
    ...
    invoke-interface {v12}, Lcom/android/camera/module/N;->R()LA/L2;

    move-result-object v12

    iget v15, v12, LA/L2;->t:I

    iget v13, v12, LA/L2;->s:I

    iget-object v12, v0, LC3/y;->k:Landroid/graphics/Rect;

    iget v7, v0, LC3/y;->l:F

    invoke-static {v9, v12, v7}, Laa/D;->o(Landroid/graphics/Matrix;Landroid/graphics/Rect;F)V

    div-int/lit8 v17, v13, 0x2

    div-int/lit8 v18, v15, 0x2

    iget-object v7, v0, LC3/y;->k:Landroid/graphics/Rect;
    ...
    invoke-static/range {v12 .. v20}, LFg/C;->w(Landroid/graphics/Matrix;ZIIIIIII)V

    iget-object v7, v0, LC3/y;->h:Landroid/graphics/RectF;
    ...
    iget-object v5, v0, LC3/y;->o:Ljava/util/HashMap;
    ...
    invoke-direct {v7, v4, v9, v8, v2}, LV/g;-><init>(Landroid/graphics/Rect;III)V
    ...
    invoke-direct {v10, v4, v9, v8, v2}, LV/g;-><init>(Landroid/graphics/Rect;III)V

    iget-object v9, v7, LV/g;->d:Landroid/graphics/Rect;

    iput-object v9, v10, LV/g;->g:Landroid/graphics/Rect;

    iget v9, v7, LV/g;->c:I

    iput v9, v10, LV/g;->f:I

    iget v9, v7, LV/g;->b:I

    iput v9, v10, LV/g;->e:I
    ...
    invoke-direct {v9, v3, v10}, LA/U0;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-static {v4, v5, v1, v3}, LA/N;->e(Ljava/lang/String;Ljava/lang/String;ZZ)Ljava/lang/String;
    ...
    invoke-virtual {v3, v4, v1}, Lea/a;->m(Ljava/lang/String;Z)Lea/a;
    ...
    invoke-virtual {v1, v3, v6}, Lea/a;->g(Ljava/lang/String;Z)Z
    ...
    const v12, 0x7f140423

    const-wide/16 v13, -0x1

    invoke-interface/range {v9 .. v14}, LV3/f1;->alertRecommendDescTip(Ljava/lang/String;IIJ)V
    ...
    invoke-interface {v1, v2}, LV3/f1;->hideRecommendDescTip(Ljava/lang/String;)V

    :goto_5
    iget-boolean v1, v0, LC3/y;->n:Z

    if-eqz v1, :cond_9

    iput-boolean v6, v0, LC3/y;->n:Z
    ...
    invoke-virtual {v0, v3, v8}, Lea/a;->m(Ljava/lang/String;Z)Lea/a;
...
.method public final g()Z
    ...
    iput-object v0, p0, LC3/y;->k:Landroid/graphics/Rect;
    ...
    iget v0, v0, LA/L2;->s:I

    iput v0, p0, LC3/y;->m:I
...
.method public final j(Landroid/hardware/camera2/CaptureResult;)V
    ...
    iget-object v0, p0, LC3/y;->k:Landroid/graphics/Rect;
...
.method public final q()V
    ...
    iput-object v0, p0, LC3/y;->g:LB3/h;
