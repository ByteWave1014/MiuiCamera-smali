...
.method public E()La6/a$d;
    ...
    iget-object v2, v1, LZ5/a1;->g:LZ5/a1$a;

    iget-boolean v2, v2, LZ5/a1$a;->h:Z

    if-nez v2, :cond_0

    iget v1, v1, LZ5/a1;->d:I
...
.method public final G(Laa/o;)V
    ...
    iput-boolean p0, p1, Laa/o;->e0:Z

    return-void
.end method

.method public H(La6/a$c;)V
    .locals 6
    ...
    iget-object v5, v2, LZ5/a1;->g:LZ5/a1$a;

    iget-object v5, v5, LZ5/a1$a;->f:LG9/d;

    invoke-virtual {v5}, LG9/d;->d()I
    ...
    invoke-static {p1, v1, v0}, LZ5/L;->x0(LZ5/d;Landroid/hardware/camera2/CaptureRequest$Builder;Z)V

    iget-object p1, p0, LZ5/a0;->E:LZ5/d;

    invoke-static {p1, v1, v0}, LZ5/L;->q0(LZ5/d;Landroid/hardware/camera2/CaptureRequest$Builder;Z)V

    :cond_2
    iget-object p1, v2, LZ5/a1;->g:LZ5/a1$a;
    ...
    iget-boolean v2, v2, LZ5/a1$a;->e:Z
    ...
    invoke-static {v1, p1, v2, v0}, Ln6/L;->b(Landroid/hardware/camera2/CaptureRequest$Builder;Landroid/hardware/camera2/CaptureRequest$Key;Ljava/lang/Object;Z)V
    ...
    invoke-static {v1, p1, p0}, LZ5/L;->i(Landroid/hardware/camera2/CaptureRequest$Builder;ILZ5/I;)V
    ...
    invoke-static {v1, p0, p1, v0}, Ln6/L;->b(Landroid/hardware/camera2/CaptureRequest$Builder;Landroid/hardware/camera2/CaptureRequest$Key;Ljava/lang/Object;Z)V
...
.method public final J()La6/a$d;
    ...
    iget-boolean v7, v1, La6/a$d;->b:Z
    ...
    iget-object v7, v4, LZ5/a0;->D:LZ5/H0;
    ...
    invoke-virtual {v7, v3, v8}, LZ5/H0;->h(IZ)Landroid/view/Surface;
    ...
    iput-object v8, p0, La6/a;->F:Landroid/util/Size;

    iget v8, p0, LZ5/j0;->t:I

    invoke-virtual {v7}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    invoke-static {v8}, LZ5/H0;->i(I)I

    move-result v8

    iput v8, p0, La6/a;->E:I

    goto :goto_2

    :cond_3
    invoke-virtual {v7, v3, v8}, LZ5/H0;->k(IZ)Landroid/view/Surface;
    ...
    iget-object v8, p0, La6/a;->F:Landroid/util/Size;
    ...
    invoke-virtual {v7, v2}, LZ5/H0;->n(I)Landroid/view/Surface;
    ...
    invoke-virtual {v7}, LZ5/H0;->m()Landroid/util/SparseArray;
    ...
    invoke-virtual {v7, v8}, LZ5/H0;->n(I)Landroid/view/Surface;
    ...
    :cond_7
    iget-object v0, v4, LZ5/a0;->F:LZ5/H;
...
.method public y(La6/a$c;)V
    ...
    iget-object p1, v1, LZ5/a0;->D:LZ5/H0;

    const/16 v4, 0xb

    invoke-virtual {p1, v4}, LZ5/H0;->n(I)Landroid/view/Surface;
    ...
    :cond_3
    invoke-virtual {p0}, La6/d;->K()Z

    move-result p1

    if-eqz p1, :cond_5

    iget-object p1, v1, LZ5/a0;->E:LZ5/d;
    ...
    invoke-static {p1}, LZ5/e;->U0(LZ5/d;)Z
    ...
    iget-object p1, v0, LZ5/a1;->g:LZ5/a1$a;

    iget-boolean p1, p1, LZ5/a1$a;->o:Z
    ...
    invoke-virtual {p0, v1, p1, v4, v0}, LZ5/o0;->o(ILandroid/util/Size;II)Lcom/xiaomi/engine/BufferFormat;
    ...
    invoke-virtual {p0, p1, v4, v0}, LZ5/o0;->q(Landroid/util/Size;II)Lcom/xiaomi/engine/BufferFormat;
