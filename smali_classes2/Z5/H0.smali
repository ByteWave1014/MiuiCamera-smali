...
.method public constructor <init>()V
    ...
    iput-object v0, p0, LZ5/H0;->i:Ljava/util/concurrent/ConcurrentHashMap;

    new-instance v0, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {v0}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    iput-object v0, p0, LZ5/H0;->j:Ljava/util/concurrent/ConcurrentHashMap;

    new-instance v0, Ljava/util/concurrent/CopyOnWriteArrayList;

    invoke-direct {v0}, Ljava/util/concurrent/CopyOnWriteArrayList;-><init>()V

    iput-object v0, p0, LZ5/H0;->k:Ljava/util/concurrent/CopyOnWriteArrayList;
...
.method public static j(LZ5/I;I)Landroid/util/Size;
    .locals 2
    ...
    iget-object p0, p0, LZ5/I;->p:Landroid/util/Size;
    ...
    iget-object p0, p0, LZ5/I;->q:Landroid/util/Size;
    ...
    iget-object p0, p0, LZ5/I;->r:Landroid/util/Size;
    ...
    iget-object p0, p0, LZ5/I;->u:Landroid/util/Size;
    ...
    iget-object p0, p0, LZ5/I;->v:Landroid/util/Size;
...
.method public static l(I)I
    ...
    invoke-static {p0, v2}, LA/P;->c(ILjava/lang/String;)Ljava/lang/String;
...
.method public final a()V
    ...
    invoke-virtual {p0}, LZ5/H0;->e()V

    iget-object v0, p0, LZ5/H0;->f:Landroid/media/ImageReader;
    ...
    iput-object v1, p0, LZ5/H0;->f:Landroid/media/ImageReader;

    :cond_0
    invoke-virtual {p0}, LZ5/H0;->f()V

    iget-object v0, p0, LZ5/H0;->o:Landroid/media/ImageReader;

    if-eqz v0, :cond_1

    invoke-virtual {v0}, Landroid/media/ImageReader;->close()V

    iput-object v1, p0, LZ5/H0;->o:Landroid/media/ImageReader;

    :cond_1
    invoke-virtual {p0}, LZ5/H0;->c()V

    invoke-virtual {p0}, LZ5/H0;->g()V

    iget-object v0, p0, LZ5/H0;->q:Landroid/media/ImageReader;

    if-eqz v0, :cond_2

    invoke-virtual {v0}, Landroid/media/ImageReader;->close()V

    iput-object v1, p0, LZ5/H0;->q:Landroid/media/ImageReader;

    :cond_2
    iget-object v0, p0, LZ5/H0;->g:Landroid/media/ImageReader;

    if-eqz v0, :cond_3

    invoke-virtual {v0}, Landroid/media/ImageReader;->close()V

    iput-object v1, p0, LZ5/H0;->g:Landroid/media/ImageReader;

    :cond_3
    invoke-virtual {p0}, LZ5/H0;->b()V

    invoke-virtual {p0}, LZ5/H0;->d()V

    iget-object v0, p0, LZ5/H0;->i:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object v0, p0, LZ5/H0;->j:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    :goto_2
    iget-object v1, p0, LZ5/H0;->k:Ljava/util/concurrent/CopyOnWriteArrayList;
...
.method public final b()V
    ...
    iget-object v0, p0, LZ5/H0;->d:Landroid/media/ImageReader;

    if-eqz v0, :cond_1

    iget-boolean v1, p0, LZ5/H0;->x:Z
    ...
    invoke-static {v0}, LZ5/H0;->s(Landroid/media/ImageReader;)V

    const/4 v0, 0x0

    iput-object v0, p0, LZ5/H0;->d:Landroid/media/ImageReader;
    ...
    iget-object p0, p0, LZ5/H0;->d:Landroid/media/ImageReader;

    invoke-static {p0}, LZ5/H0;->r(Landroid/media/ImageReader;)V
...
.method public final c()V
    ...
    iget-object v0, p0, LZ5/H0;->p:Landroid/media/ImageReader;
    ...
    iput-object v0, p0, LZ5/H0;->p:Landroid/media/ImageReader;
    ...
    iget-object p0, p0, LZ5/H0;->p:Landroid/media/ImageReader;
...
.method public final d()V
    ...
    iget-object v0, p0, LZ5/H0;->c:Landroid/media/ImageReader;
    ...
    iput-object v0, p0, LZ5/H0;->c:Landroid/media/ImageReader;
    ...
    iget-object p0, p0, LZ5/H0;->c:Landroid/media/ImageReader;
...
.method public final e()V
    ...
    iget-object v0, p0, LZ5/H0;->a:Landroid/media/ImageReader;
    ...
    iput-object v0, p0, LZ5/H0;->a:Landroid/media/ImageReader;
    ...
    iget-object p0, p0, LZ5/H0;->a:Landroid/media/ImageReader;
...
.method public final f()V
    ...
    iget-object v0, p0, LZ5/H0;->l:Landroid/media/ImageReader;
    ...
    iput-object v0, p0, LZ5/H0;->l:Landroid/media/ImageReader;
    ...
    iget-object p0, p0, LZ5/H0;->l:Landroid/media/ImageReader;
...
.method public final g()V
    ...
    iget-object v0, p0, LZ5/H0;->e:Landroid/media/ImageReader;
    ...
    iput-object v0, p0, LZ5/H0;->e:Landroid/media/ImageReader;
    ...
    iget-object p0, p0, LZ5/H0;->e:Landroid/media/ImageReader;
...
.method public final h(IZ)Landroid/view/Surface;
    ...
    invoke-virtual {p0, p1}, LZ5/H0;->n(I)Landroid/view/Surface;
...
.method public final k(IZ)Landroid/view/Surface;
    ...
    invoke-virtual {p0, v1}, LZ5/H0;->n(I)Landroid/view/Surface;
    ...
    :cond_0
    invoke-virtual {p0, v3}, LZ5/H0;->n(I)Landroid/view/Surface;
    ...
    :cond_1
    invoke-virtual {p0, p2}, LZ5/H0;->n(I)Landroid/view/Surface;
    ...
    :cond_3
    invoke-virtual {p0, v2}, LZ5/H0;->n(I)Landroid/view/Surface;
...
.method public final m()Landroid/util/SparseArray;
    ...
    iget-object p0, p0, LZ5/H0;->v:Landroid/util/SparseArray;
...
.method public final n(I)Landroid/view/Surface;
    ...
    iget-object p0, p0, Li6/e;->e:Landroid/media/ImageReader;
...
.method public final u(Landroid/util/Size;LZ5/a0$g;Landroid/os/Handler;)V
    .locals 5
    ...
    iput-object p1, p0, LZ5/H0;->p:Landroid/media/ImageReader;
    ...
    :goto_0
    iget-object p1, p0, LZ5/H0;->p:Landroid/media/ImageReader;
    ...
    invoke-static {p0}, LZ5/H0;->t(Landroid/media/ImageReader;)V

    return-void
.end method

.method public final v(LZ5/I;LZ5/a0$a;Landroid/os/Handler;)V
    .locals 3

    invoke-virtual {p0}, LZ5/H0;->e()V

    iget-object v0, p1, LZ5/I;->i:Landroid/util/Size;
...
.method public final w(LZ5/I;Landroid/media/ImageReader$OnImageAvailableListener;Landroid/os/Handler;)V
    .locals 4
    ...
    iput-object v0, p0, LZ5/H0;->f:Landroid/media/ImageReader;

    :cond_0
    iget-object v0, p1, LZ5/I;->h:Landroid/util/Size;
    ...
    iget v2, p1, LZ5/I;->U:I

    iget p1, p1, LZ5/I;->X:I

    invoke-static {v1, v0, v2, p1}, Landroid/media/ImageReader;->newInstance(IIII)Landroid/media/ImageReader;

    move-result-object p1

    iput-object p1, p0, LZ5/H0;->f:Landroid/media/ImageReader;
