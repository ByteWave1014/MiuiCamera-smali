...
# direct methods
.method public static a(ILZ5/a1$a;Landroid/hardware/camera2/CaptureResult;Z)LZ5/a1;
    .locals 6

    const/4 v0, 0x1

    new-instance v1, LZ5/a1;

    invoke-direct {v1, p1}, LZ5/a1;-><init>(LZ5/a1$a;)V

    iput v0, v1, LZ5/a1;->h:I
    ...
    :cond_1
    invoke-virtual {v1}, LZ5/a1;->b()LZ5/a1$a;
    ...
    iget-boolean p0, p0, LZ5/a1$a;->C:Z

    if-nez p0, :cond_3

    iget-boolean p0, p1, LZ5/a1$a;->H:Z

    if-nez p0, :cond_3

    iget-boolean p0, p1, LZ5/a1$a;->a:Z

    if-eqz p0, :cond_2

    iget-boolean p0, p1, LZ5/a1$a;->t:Z
    ...
    iget-object p0, p0, Le0/o;->v:Lo6/x;

    if-eqz p0, :cond_6

    iget-object p0, v1, LZ5/a1;->g:LZ5/a1$a;

    invoke-static {}, LZ/a;->g()Le0/o;

    move-result-object p1

    iget-object p1, p1, Le0/o;->v:Lo6/x;
    ...
    invoke-static {p2, v3, v5}, Ln6/L;->j(Landroid/hardware/camera2/CaptureResult;Ln6/K;I)Ljava/lang/Object;
    ...
    :goto_3
    iput-object p1, p0, LZ5/a1$a;->W:Ljava/util/ArrayList;

    :cond_6
    return-object v1
.end method

.method public static b(LZ5/a1$a;)V
    .locals 6
    ...
    iget-object v3, p0, LZ5/a1$a;->f:LG9/d;
    ...
    iget-object v0, p0, LZ5/a1$a;->f:LG9/d;

    invoke-virtual {v0}, LG9/d;->b()I

    move-result v0

    iget-object v1, p0, LZ5/a1$a;->f:LG9/d;
    ...
    iput v1, p0, LZ5/a1$a;->c:I

    iput v1, p0, LZ5/a1$a;->d:I
    ...
    iput v0, p0, LZ5/a1$a;->c:I

    iput v0, p0, LZ5/a1$a;->d:I
    ...
    iget-object p0, p0, LZ5/a1$a;->f:LG9/d;
...
.method public static final d(Ls3/j;LZ5/a1$a;Landroid/hardware/camera2/CaptureResult;LZ5/I;)I
    .locals 10
    ...
    :goto_1
    iput-boolean v2, p1, LZ5/a1$a;->n:Z
    ...
    invoke-virtual {v5}, L渭渡渣湠渣渧湠渪渫游渧渭渫湠渭渡渣渣渡渠湠渍渡渣渣渡渠;->h()Z
    ...
    invoke-virtual {v5}, LZ5/a;->p()LZ5/d;

    move-result-object v5

    invoke-static {v5}, LZ5/e;->e0(LZ5/d;)Ljava/util/HashMap;
    ...
    :cond_7
    sget-object v5, Ln6/J;->R:Ln6/K;

    invoke-static {p2, v5, v6}, Ln6/L;->j(Landroid/hardware/camera2/CaptureResult;Ln6/K;I)Ljava/lang/Object;
    ...
    invoke-static {v5, v8}, LA/P;->c(ILjava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p0}, LZ5/a;->p()LZ5/d;
    ...
    iput-boolean p3, p1, LZ5/a1$a;->o:Z

    if-eqz p0, :cond_d

    iget-object p3, p0, LZ5/d;->S3:Ljava/lang/Boolean;

    if-nez p3, :cond_c

    sget-object p3, Ln6/h;->J2:Ln6/K;
    ...
    invoke-static {v4, p3, v2}, Ln6/L;->g(Landroid/hardware/camera2/CameraCharacteristics;Ln6/K;I)Ljava/lang/Object;
    ...
    invoke-static {v2, p3}, LB3/d;->b(Ljava/lang/String;Ljava/lang/Integer;)Ljava/lang/String;
    ...
    iput-object p3, p0, LZ5/d;->S3:Ljava/lang/Boolean;

    :cond_c
    iget-object p0, p0, LZ5/d;->S3:Ljava/lang/Boolean;
    ...
    :goto_8
    iput-boolean p0, p1, LZ5/a1$a;->p:Z

    iget-boolean p0, p1, LZ5/a1$a;->o:Z
    ...
    invoke-static {p3, p0}, LVa/a;->j(Ljava/lang/StringBuilder;[I)Ljava/lang/String;
    ...
    invoke-static {p2, v2, v6}, Ln6/L;->j(Landroid/hardware/camera2/CaptureResult;Ln6/K;I)Ljava/lang/Object;
    ...
    iput p2, p1, LZ5/a1$a;->c:I

    iget-object p2, v4, Lo6/h;->c:[I

    iput-object p2, p1, LZ5/a1$a;->q:[I
    ...
    :cond_10
    iput-object p0, p1, LZ5/a1$a;->u:[I
    ...
    iput-object v9, p1, LZ5/a1$a;->u:[I

    :goto_c
    iget-object p0, p1, LZ5/a1$a;->q:[I
    ...
    iput p2, p1, LZ5/a1$a;->v:I

    invoke-static {p0}, Ljava/util/Arrays;->stream([I)Ljava/util/stream/IntStream;

    move-result-object p0

    new-instance p2, LZ5/b1;

    invoke-direct {p2, p1, v1}, LZ5/b1;-><init>(Ljava/lang/Object;I)V
    ...
    iput p0, p1, LZ5/a1$a;->w:I

    :cond_12
    iget p0, p1, LZ5/a1$a;->w:I

    add-int/2addr p0, v3

    iput p0, p1, LZ5/a1$a;->d:I

    goto :goto_d

    :cond_13
    invoke-static {p1}, LZ5/c1;->b(LZ5/a1$a;)V
    ...
    invoke-virtual {v5, v2}, LZ5/a;->t1(LZ5/d;)Z

    move-result v5

    iput-boolean v5, p1, LZ5/a1$a;->x:Z
    ...
    invoke-virtual {v6}, L渭渡渣湠渣渧湠渪渫游渧渭渫湠渭渡渣渣渡渠湠渍渡渣渣渡渠;->h()Z
    ...
    iput-boolean v3, p1, LZ5/a1$a;->x:Z
    ...
    iget-boolean v6, p1, LZ5/a1$a;->x:Z
    ...
    iput-boolean p0, p1, LZ5/a1$a;->t:Z
    ...
    iget-boolean v6, p1, LZ5/a1$a;->t:Z
    ...
    invoke-static {v6, p0}, LVa/a;->j(Ljava/lang/StringBuilder;[I)Ljava/lang/String;
    ...
    iput v3, p1, LZ5/a1$a;->c:I

    iput v3, p1, LZ5/a1$a;->d:I

    iget-object p0, v4, LG7/b;->e:L渭渡渣湠渣渧湠渪渫游渧渭渫湠渭渡渣渣渡渠湠渍渡渣渣渡渠;

    invoke-virtual {p0}, L渭渡渣湠渣渧湠渪渫游渧渭渫湠渭渡渣渣渡渠湠渍渡渣渣渡渠;->h()Z
    ...
    iput-object p0, p1, LZ5/a1$a;->q:[I
    ...
    iput p3, p1, LZ5/a1$a;->y:I

    iget p3, v5, Lo6/h;->b:I

    iput p3, p1, LZ5/a1$a;->c:I

    iput p3, p1, LZ5/a1$a;->d:I

    iget-object p3, v5, Lo6/h;->c:[I

    iput-object p3, p1, LZ5/a1$a;->q:[I
    ...
    iget-object p3, p1, LZ5/a1$a;->q:[I
    ...
    invoke-static {v2, p2}, LZ5/M;->e(LZ5/d;Landroid/hardware/camera2/CaptureResult;)[B

    move-result-object p0

    iput-object p0, p1, LZ5/a1$a;->A:[B

    :cond_1e
    invoke-static {v2, p2}, LZ5/M;->g(LZ5/d;Landroid/hardware/camera2/CaptureResult;)Z

    move-result p0

    iput-boolean p0, p1, LZ5/a1$a;->B:Z

    :goto_11
    return v3
.end method

.method public static e(LZ5/a1;Landroid/hardware/camera2/CaptureResult;)Lo6/t;
    .locals 2
    ...
    iget-object p0, p0, LZ5/a1$a;->I:[B
    ...
    invoke-virtual {v0, v1}, L渭渡渣湠渣渧湠渪渫游渧渭渫湠渭渡渣渣渡渠湠渍渡渣渣渡渠;->f1(Z)[I
