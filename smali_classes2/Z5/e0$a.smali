...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = LZ5/e0;->onCaptureStarted(Landroid/hardware/camera2/CameraCaptureSession;Landroid/hardware/camera2/CaptureRequest;JJ)V
.end annotation
...
.field public final synthetic b:LZ5/e0;


# direct methods
.method public constructor <init>(LZ5/e0;Laa/o;)V
    .locals 0
    ...
    iput-object p1, p0, LZ5/e0$a;->b:LZ5/e0;

    iput-object p2, p0, LZ5/e0$a;->a:Laa/o;
...
.method public final onCaptureCompleted()V
    ...
    iget-object p0, p0, LZ5/e0$a;->b:LZ5/e0;
...
.method public final onImageReceived(Lcom/xiaomi/camera/mivi/qcom/bean/ResultOutputData;)V
    ...
    iget-object v0, p0, LZ5/e0$a;->b:LZ5/e0;

    iget-object v0, v0, LZ5/e0;->a:LZ5/f0;

    invoke-virtual {v0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iget-object v2, p0, LZ5/e0$a;->a:Laa/o;

    iget-object p0, v2, Laa/o;->W:Ljava/lang/String;
    ...
    iget-object v1, v0, LZ5/j0;->g:LZ5/a$i;

    instance-of v3, v1, Lv3/r$b;

    if-eqz v3, :cond_2

    check-cast v1, Lv3/r$b;

    iget-boolean v3, v2, Laa/o;->C:Z

    iget-object v1, v1, Lv3/r$b;->e:Lv3/r;

    iget-boolean v4, v1, Lv3/r;->g:Z
    ...
    :cond_0
    iput-boolean v3, v1, Lv3/r;->g:Z

    invoke-virtual {v1}, Lv3/r;->b()Lv3/r$c;
    ...
    iput-object v1, v2, Laa/o;->h:Landroid/hardware/camera2/TotalCaptureResult;

    invoke-virtual {v0, p1, v2}, LZ5/b0;->Q(Lcom/xiaomi/camera/mivi/qcom/bean/ResultOutputData;Laa/o;)V
    ...
    invoke-static {v7, v3}, LA/y3;->g(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-virtual {v2, v1}, Laa/o;->j([B)V

    iget-object v1, v0, LZ5/j0;->h:Ll4/j;

    if-nez v1, :cond_4

    const-string p0, "notifyResultData: null parallel callback"

    invoke-static {v7, p0}, LA/H2;->d(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object p0, v2, Laa/o;->q:Ljava/lang/String;
    ...
    iget-object v3, v2, Laa/o;->h:Landroid/hardware/camera2/TotalCaptureResult;
