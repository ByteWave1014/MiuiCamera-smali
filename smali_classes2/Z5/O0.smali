...
# direct methods
.method public constructor <init>(LZ5/a0;ZLandroid/view/Surface;)V
    .locals 1

    const/4 v0, 0x0

    invoke-direct {p0, p1, v0}, LZ5/K0;-><init>(LZ5/a0;LG9/a;)V

    iput-object p3, p0, LZ5/O0;->S:Landroid/view/Surface;

    iput-boolean p2, p0, LZ5/O0;->U:Z

    return-void
.end method

.method public static J(LZ5/O0;ZI)V
    .locals 4
    ...
    invoke-virtual {v2, v3}, LZ5/H;->i(Z)V
...
.method public final K()Landroid/hardware/camera2/CaptureRequest$Builder;
    ...
    iget-object v8, v4, LZ5/H0;->j:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iput-object v8, p0, LZ5/o0;->u:Landroid/util/Size;

    iget-object v9, v0, LZ5/a0;->F:LZ5/H;

    iget-object v9, v9, LZ5/H;->a:LZ5/I;

    invoke-virtual {v9, v8}, LZ5/I;->e(Landroid/util/Size;)V

    goto :goto_0

    :cond_0
    iget-object v2, v4, LZ5/H0;->c:Landroid/media/ImageReader;
    ...
    invoke-static {v2}, Ljc/K;->a(Landroid/view/Surface;)Ljava/lang/String;
    ...
    iget-object v8, v4, LZ5/H0;->i:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object v2, v4, LZ5/H0;->e:Landroid/media/ImageReader;
    ...
    :goto_2
    iget-object v2, v4, LZ5/H0;->n:Landroid/view/Surface;
    ...
    iget-boolean v4, v2, LZ5/I;->z1:Z

    if-eqz v4, :cond_4

    iput-boolean v7, v2, LZ5/I;->z1:Z
    ...
    sget-object v5, Lic/a;->a:Ljava/util/Map;

    iget-object v0, v0, LZ5/a0;->E:LZ5/d;

    iget-object v8, v0, LZ5/d;->f:Ljava/util/HashSet;
    ...
    :cond_5
    iget-object v2, p0, LZ5/j0;->g:LZ5/a$i;

    iget-object v4, p0, LZ5/O0;->T:Ljava/lang/String;
    ...
    iput-object v2, p0, LZ5/O0;->T:Ljava/lang/String;

    invoke-static {v1, v0, v2}, LZ5/L;->n0(Landroid/hardware/camera2/CaptureRequest$Builder;LZ5/d;Ljava/lang/String;)V
    ...
    iget-object p0, p0, LZ5/O0;->T:Ljava/lang/String;
...
.method public final L(Laa/o;)V
    ...
    invoke-virtual {p0, v0, p1}, LZ5/K0;->I(Landroid/hardware/camera2/TotalCaptureResult;Laa/o;)V
    ...
    invoke-virtual {p1, v0}, Laa/o;->j([B)V
    ...
    :cond_1
    iget-object v6, p1, Laa/o;->h:Landroid/hardware/camera2/TotalCaptureResult;
    ...
    iget-object p0, p1, Laa/o;->W:Ljava/lang/String;
...
.method public final j(Landroid/media/Image;I)V
    ...
    iget-boolean v0, p0, LZ5/O0;->V:Z

    if-nez v0, :cond_0

    invoke-super {p0, p1, p2}, LZ5/K0;->j(Landroid/media/Image;I)V
    ...
    invoke-virtual {v0, v2, v3}, Lcom/xiaomi/camera/mivi/mtk/OfflineImageDataZipper;->getParallelTaskData(J)Laa/o;
    ...
    invoke-virtual {v0, p2, v4}, Laa/o;->a(I[B)V

    iget-boolean p1, v0, Laa/o;->G:Z
    ...
    :cond_3
    invoke-virtual {p0, v0}, LZ5/O0;->L(Laa/o;)V
...
.method public final k()V
    ...
    iget-boolean v2, v1, LZ5/I;->H0:Z

    const/4 v3, 0x1

    if-eq v2, v3, :cond_0

    iput-boolean v3, v1, LZ5/I;->H0:Z
...
.method public final m()V
    ...
    invoke-virtual {v3}, LZ5/a0;->i0()V

    :try_start_0
    new-instance v4, LZ5/N0;

    invoke-direct {v4, p0}, LZ5/N0;-><init>(LZ5/O0;)V

    invoke-virtual {p0}, LZ5/O0;->K()Landroid/hardware/camera2/CaptureRequest$Builder;

    move-result-object v6

    iget-object v7, p0, LZ5/O0;->S:Landroid/view/Surface;
    ...
    :cond_0
    :goto_0
    iget-object v7, v3, LZ5/a0;->v:LI9/b;

    invoke-virtual {v7}, LI9/b;->c()Ljava/lang/String;
    ...
    invoke-virtual {v2, v0}, LL3/n;->c(Ljava/lang/String;)J
    ...
    invoke-virtual {v3}, LZ5/a0;->q()Landroid/hardware/camera2/CameraCaptureSession;
