...
.method public final onCaptureCompleted(Landroid/hardware/camera2/CameraCaptureSession;Landroid/hardware/camera2/CaptureRequest;Landroid/hardware/camera2/TotalCaptureResult;)V
    ...
    iget v0, p1, LZ5/r0;->E:I

    const/4 v1, 0x1

    add-int/2addr v0, v1

    iput v0, p1, LZ5/r0;->E:I

    iget-boolean v0, p1, LZ5/j0;->p:Z
    ...
    iget v3, v0, LZ5/r0;->E:I

    iget v4, v0, LZ5/r0;->C:I
    ...
    :goto_1
    iput-boolean v0, p1, LZ5/j0;->q:Z

    iget-object p1, p0, LZ5/q0;->a:LZ5/r0;

    invoke-virtual {p1, p3, v2}, LZ5/j0;->l(Landroid/hardware/camera2/CaptureResult;Z)V
    ...
    iget-object v3, p0, LZ5/q0;->a:LZ5/r0;

    iget v3, v3, LZ5/r0;->E:I
    ...
    invoke-static {v3}, LC9/a;->b(Landroid/hardware/camera2/CaptureResult;)Landroid/os/Parcelable;
    ...
    iget v0, p1, LZ5/r0;->C:I

    iget p1, p1, LZ5/r0;->E:I

    if-ne v0, p1, :cond_5

    invoke-virtual {p0}, LZ5/q0;->a()V
    ...
    :cond_5
    sget-object p1, LZ5/N;->a:Ljava/util/List;
    ...
    iget-object p2, p2, LZ5/j0;->a:Ljava/lang/String;
    ...
    invoke-static {p2, v1}, LA/P;->f(Ljava/lang/String;Z)Ljava/lang/String;
    ...
    iget-object p3, p0, LZ5/q0;->a:LZ5/r0;

    iget-boolean p3, p3, LZ5/r0;->R:Z
...
.method public final onCaptureFailed(Landroid/hardware/camera2/CameraCaptureSession;Landroid/hardware/camera2/CaptureRequest;Landroid/hardware/camera2/CaptureFailure;)V
    ...
    invoke-virtual {p0, p1, p2}, LZ5/a0;->y2(LZ5/j0;Z)V
...
.method public final onCaptureStarted(Landroid/hardware/camera2/CameraCaptureSession;Landroid/hardware/camera2/CaptureRequest;JJ)V
    ...
    invoke-static {p3, p4, p2, v0}, LA/X;->g(JLjava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    iget p1, p0, LZ5/r0;->F:I

    const/4 p2, 0x1

    add-int/2addr p1, p2

    iput p1, p0, LZ5/r0;->F:I

    iget-object p5, p0, LZ5/j0;->g:LZ5/a$i;

    iget p6, p0, LZ5/r0;->C:I
    ...
    :cond_0
    iget-boolean p1, p0, LZ5/o0;->y:Z

    if-eqz p1, :cond_10

    const/4 p1, 0x0

    iput-boolean p1, p0, LZ5/o0;->y:Z
    ...
    iput p3, v8, Laa/o;->B:I

    invoke-static {}, Lcom/android/camera/data/data/A;->D()Z

    move-result p3

    iput-boolean p3, v8, Laa/o;->e0:Z

    invoke-static {}, LA3/o2;->b()Laa/v;

    move-result-object p3

    iput-object p3, v8, Laa/o;->s0:Laa/v;
    ...
    invoke-virtual {v8, p3}, Laa/o;->l(LP0/c;)V
    ...
    invoke-virtual {v8, p3}, Laa/o;->m(Z)V

    iget-object p3, p0, LZ5/o0;->w:Landroid/hardware/camera2/CaptureResult;

    iput-object p3, v8, Laa/o;->i:Landroid/hardware/camera2/CaptureResult;
    ...
    iput-object p4, v8, Laa/o;->p0:[Ljava/lang/String;
    ...
    iput-object p3, v8, Laa/o;->i0:LG9/a;
    ...
    invoke-static {p3}, LZ5/e;->t2(LZ5/d;)Z
    ...
    iput-object p3, v8, Laa/o;->W:Ljava/lang/String;
    ...
    :goto_0
    iget-object p3, p0, LZ5/o0;->u:Landroid/util/Size;

    new-instance p4, LZ5/O;

    invoke-direct {p4}, Ljava/lang/Object;-><init>()V

    iput-object p3, p4, LZ5/O;->b:Landroid/util/Size;

    new-instance p3, LZ5/W0;

    iget-boolean v1, p0, LZ5/j0;->f:Z

    const/4 v4, 0x0

    iget-object v5, p0, LZ5/j0;->r:LG9/a;

    move-object v0, p3

    invoke-direct/range {v0 .. v5}, LZ5/W0;-><init>(ZZZZLG9/a;)V

    iput-object p3, p4, LZ5/O;->a:LZ5/W0;

    iget p3, p0, LZ5/j0;->t:I

    iput p3, p4, LZ5/O;->c:I

    invoke-interface {p5, v8, p4}, LZ5/a$i;->onCaptureStart(Laa/o;LZ5/O;)Laa/o;
    ...
    iput-object p4, p3, Laa/o;->a0:Ljava/lang/String;

    iget-boolean p4, p0, LZ5/r0;->R:Z

    if-eqz p4, :cond_5

    iget-object p4, p0, LZ5/r0;->Q:LG9/d;
    ...
    :goto_1
    iput-object p4, p3, Laa/o;->L:LG9/d;

    iget p4, p0, LZ5/r0;->J:I

    iput p4, p3, Laa/o;->A:I

    iget-boolean p4, p0, LZ5/r0;->I:Z

    iput-boolean p4, p3, Laa/o;->O:Z

    iget-object p4, p0, LZ5/j0;->b:LZ5/a0;

    iget-object p5, p4, LZ5/a0;->F:LZ5/H;

    iget-object p5, p5, LZ5/H;->a:LZ5/I;

    iget-object p5, p5, LZ5/I;->n:Landroid/util/Size;

    if-nez p5, :cond_6

    iget-object p4, p4, LZ5/a0;->E:LZ5/d;

    iget p5, p4, LZ5/d;->b:I

    const/16 v0, 0x20

    invoke-virtual {p4, v0, p5}, LZ5/d;->b0(II)Ljava/util/List;
    ...
    iget v0, p5, Le0/o;->s:I

    invoke-virtual {p5, v0}, Le0/o;->B(I)I

    move-result p5

    invoke-static {p5, p4}, LA/z3;->f(ILjava/util/List;)Landroid/util/Size;

    move-result-object p5

    const-string p4, "onCaptureStarted, sensor raw size is null then get it again, size: "

    invoke-static {p4, p5}, LA/y3;->e(Ljava/lang/String;Landroid/util/Size;)Ljava/lang/String;
    ...
    iput p4, p3, Laa/o;->R:I

    iput p5, p3, Laa/o;->S:I
    ...
    invoke-static {p4}, LZ5/e;->d(LZ5/d;)Landroid/graphics/Rect;

    move-result-object p4

    iput-object p4, p3, Laa/o;->T:Landroid/graphics/Rect;
    ...
    iget p4, p4, LZ5/I;->b0:F

    iput p4, p3, Laa/o;->U:F

    :cond_9
    :goto_3
    iget-object p4, p3, Laa/o;->r:Laa/p;

    if-eqz p4, :cond_d

    iget p5, p0, LZ5/r0;->J:I

    if-eq p5, p2, :cond_a

    invoke-static {p5}, LC9/c;->b(I)Z
    ...
    iget p5, p0, LZ5/r0;->X:I

    iput p5, p3, Laa/o;->k0:I

    :cond_b
    iget-object p4, p4, Laa/p;->Q:LG9/f;
    ...
    :goto_4
    iput-boolean p2, p4, LG9/f;->F:Z

    iget-object p0, p0, LZ5/r0;->K:[I

    iput-object p0, p4, LG9/f;->E:[I
    ...
    invoke-virtual {p0, p3}, Lcom/android/camera/b$b;->n(Laa/o;)V
