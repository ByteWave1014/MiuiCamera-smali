...
.method public static b(Ljava/lang/String;)I
    ...
    :cond_6
    iget-object p0, v3, LZ5/d;->D3:Ljava/util/ArrayList;

    if-nez p0, :cond_7

    sget-object p0, Ln6/h;->i4:Ln6/K;

    invoke-virtual {v3, p0}, LZ5/d;->G0(Ln6/K;)Ljava/util/ArrayList;

    move-result-object p0

    iput-object p0, v3, LZ5/d;->D3:Ljava/util/ArrayList;

    :cond_7
    iget-object v5, v3, LZ5/d;->D3:Ljava/util/ArrayList;
    ...
    :cond_8
    iget-object p0, v3, LZ5/d;->r6:Ljava/util/ArrayList;
    ...
    iput-object p0, v3, LZ5/d;->r6:Ljava/util/ArrayList;

    :cond_9
    iget-object v5, v3, LZ5/d;->r6:Ljava/util/ArrayList;
    ...
    invoke-virtual {v3, p0}, LZ5/d;->B0(Ljava/lang/String;)Z
    ...
    :cond_b
    invoke-virtual {v3}, LZ5/d;->j()[Ljava/lang/Integer;
    ...
    invoke-static {v3, v6}, Lb0/f1;->g(II)I
...
.method public static e()Z
    ...
    invoke-virtual {v0}, L渭渡渣湠渣渧湠渪渫游渧渭渫湠渭渡渣渣渡渠湠渍渡渣渣渡渠;->E5()Z
...
.method public static f(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v3, p0}, Lea/a;->q(Ljava/lang/String;Ljava/lang/String;)Lea/a;

    invoke-static {}, LZ/a;->g()Le0/o;

    move-result-object p0

    invoke-virtual {p0, v2, v1}, Lea/a;->q(Ljava/lang/String;Ljava/lang/String;)Lea/a;
    ...
    invoke-virtual {v0, v2, p0}, Lea/a;->q(Ljava/lang/String;Ljava/lang/String;)Lea/a;

    invoke-static {}, LZ/a;->g()Le0/o;

    move-result-object p0

    invoke-virtual {p0, v3, v1}, Lea/a;->q(Ljava/lang/String;Ljava/lang/String;)Lea/a;
...
.method public final a()LA/Q3;
    ...
    :cond_2
    invoke-virtual {p0, v2}, Lc0/b;->o(I)Z
    ...
    invoke-virtual {p0, v1}, Lc0/b;->o(I)Z
    ...
    invoke-virtual {v3, v1}, LF3/f;->Q(I)LZ5/d;
    ...
    invoke-virtual {p0, v4}, Lc0/b;->n(I)Z

    move-result v5

    if-nez v5, :cond_7

    iget-object v5, p0, Lc0/b;->d:Landroid/util/SparseBooleanArray;
    ...
    invoke-virtual {p0, v3}, Lc0/b;->n(I)Z
...
.method public final c()LA/Q3;
    ...
    invoke-virtual {v2}, L渭渡渣湠渣渧湠渪渫游渧渭渫湠渭渡渣渣渡渠湠渍渡渣渣渡渠;->q6()Z

    move-result v2

    if-eqz v2, :cond_6

    invoke-virtual {v1}, LG7/b;->O()V
    ...
    iget-boolean v1, p0, Lc0/d;->a:Z

    if-eqz v1, :cond_2

    iget-boolean v1, p0, Lc0/d;->e:Z

    if-eqz v1, :cond_2

    iget-boolean v1, p0, Lc0/d;->d:Z
