...
.method public constructor <init>(LJ9/f;)V
    ...
    iput-object v0, p0, LJ9/i;->i:Ljava/lang/StringBuilder;

    iput-object p1, p0, LJ9/i;->g:LJ9/f;
    ...
    iget-object p1, p1, LJ9/f;->b:Ljava/lang/Object;
    ...
    iput-object p1, p0, LJ9/i;->e:Ljava/lang/String;
...
.method public final b()Ljava/lang/String;
    ...
    iget-object v0, p0, LJ9/i;->f:Ltv/danmaku/ijk/media/player/IjkMediaPlayer;

    invoke-virtual {v0}, Ltv/danmaku/ijk/media/player/IjkMediaPlayer;->getBitRate()J

    move-result-wide v0

    iget-object v2, p0, LJ9/i;->f:Ltv/danmaku/ijk/media/player/IjkMediaPlayer;

    invoke-virtual {v2}, Ltv/danmaku/ijk/media/player/IjkMediaPlayer;->getVideoCachedBytes()J

    move-result-wide v2

    iget-object v4, p0, LJ9/i;->f:Ltv/danmaku/ijk/media/player/IjkMediaPlayer;

    invoke-virtual {v4}, Ltv/danmaku/ijk/media/player/IjkMediaPlayer;->getVideoCachedPackets()J

    move-result-wide v4

    iget-object v6, p0, LJ9/i;->f:Ltv/danmaku/ijk/media/player/IjkMediaPlayer;

    invoke-virtual {v6}, Ltv/danmaku/ijk/media/player/IjkMediaPlayer;->getVideoCachedDuration()J

    move-result-wide v6

    iget-object v8, p0, LJ9/i;->i:Ljava/lang/StringBuilder;

    const/4 v9, 0x0

    invoke-virtual {v8, v9}, Ljava/lang/StringBuilder;->setLength(I)V

    iget-object v10, p0, LJ9/i;->f:Ltv/danmaku/ijk/media/player/IjkMediaPlayer;
    ...
    invoke-static {v8, v12, v10, v11}, LA3/E2;->i(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v9, p0, LJ9/i;->f:Ltv/danmaku/ijk/media/player/IjkMediaPlayer;
...
.method public c()V
    ...
    iget-wide v3, p0, LJ9/i;->h:J

    invoke-static {v1, v2, v3, v4, v0}, LA/S;->f(JJLjava/lang/StringBuilder;)Ljava/lang/String;
    ...
    iget-object p0, p0, LJ9/i;->e:Ljava/lang/String;
...
.method public final d()V
    ...
    iget-object v0, p0, LJ9/i;->g:LJ9/f;
    ...
    iput-wide v1, p0, LJ9/i;->h:J

    invoke-virtual {p0}, LJ9/i;->e()V
    ...
    iput-object v1, p0, LJ9/e;->a:Landroid/os/HandlerThread;

    invoke-virtual {v1}, Ljava/lang/Thread;->start()V

    new-instance v1, Landroid/os/Handler;

    iget-object v2, p0, LJ9/e;->a:Landroid/os/HandlerThread;
    ...
    iput-object v1, p0, LJ9/e;->b:Landroid/os/Handler;
    ...
    iput-object v1, p0, LJ9/e;->c:Landroid/os/Handler;

    iget-object v1, p0, LJ9/e;->b:Landroid/os/Handler;
...
.method public e()V
    ...
    iget-object v0, p0, LJ9/e;->c:Landroid/os/Handler;

    if-eqz v0, :cond_0

    iget-object v0, p0, LJ9/e;->a:Landroid/os/HandlerThread;

    if-eqz v0, :cond_0

    iget-object v1, p0, LJ9/i;->f:Ltv/danmaku/ijk/media/player/IjkMediaPlayer;

    if-eqz v1, :cond_0

    iget-object v2, p0, LJ9/e;->b:Landroid/os/Handler;

    new-instance v3, LJ9/h;

    const/4 v4, 0x0

    invoke-direct {v3, v4, p0, v1, v0}, LJ9/h;-><init>(ILjava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)V

    invoke-virtual {v2, v3}, Landroid/os/Handler;->post(Ljava/lang/Runnable;)Z

    const/4 v0, 0x0

    iput-object v0, p0, LJ9/i;->f:Ltv/danmaku/ijk/media/player/IjkMediaPlayer;
...
.method public final f(Landroid/view/Surface;)V
    ...
    :cond_0
    iput-object p1, p0, LJ9/e;->d:Landroid/view/Surface;
...
.method public final onInfo(Ltv/danmaku/ijk/media/player/IMediaPlayer;II)Z
    ...
    iget-wide v2, p0, LJ9/i;->h:J

    invoke-static {p2, p3, v2, v3, p1}, LA/S;->f(JJLjava/lang/StringBuilder;)Ljava/lang/String;
    ...
    :cond_2
    iget-object p1, p0, LJ9/e;->c:Landroid/os/Handler;

    new-instance p2, LA/S1;

    const/4 p3, 0x7

    invoke-direct {p2, p0, p3}, LA/S1;-><init>(Ljava/lang/Object;I)V
...
.method public onPrepared(Ltv/danmaku/ijk/media/player/IMediaPlayer;)V
    ...
    invoke-static {v0, v1, v2, v3, p1}, LA/S;->f(JJLjava/lang/StringBuilder;)Ljava/lang/String;
