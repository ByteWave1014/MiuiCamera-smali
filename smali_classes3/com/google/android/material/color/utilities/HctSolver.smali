...
.method public static bisectToLimit(DD)[D
    ...
    invoke-static {v2, v7, v8, v0, v6}, Lcom/google/android/material/color/utilities/HctSolver;->setCoordinate([DD[DI)[D
...
.method public static findResultByJ(DDD)I
    ...
    sget-object v14, Lcom/google/android/material/color/utilities/ViewingConditions;->DEFAULT:Lcom/google/android/material/color/utilities/ViewingConditions;

    invoke-virtual {v14}, Lcom/google/android/material/color/utilities/ViewingConditions;->getN()D
    ...
    div-double v17, v15, v4

    const-wide/high16 v19, 0x4000000000000000L    # 2.0

    add-double v4, p0, v19
    ...
    invoke-virtual {v14}, Lcom/google/android/material/color/utilities/ViewingConditions;->getNc()D

    move-result-wide v6

    mul-double/2addr v6, v4

    invoke-virtual {v14}, Lcom/google/android/material/color/utilities/ViewingConditions;->getNcb()D
    ...
    cmpl-double v6, p2, v28

    if-eqz v6, :cond_1

    cmpl-double v6, v2, v28
    ...
    invoke-virtual {v14}, Lcom/google/android/material/color/utilities/ViewingConditions;->getAw()D

    move-result-wide v6

    invoke-virtual {v14}, Lcom/google/android/material/color/utilities/ViewingConditions;->getC()D

    move-result-wide v8

    div-double v8, v15, v8

    invoke-virtual {v14}, Lcom/google/android/material/color/utilities/ViewingConditions;->getZ()D
    ...
    invoke-virtual {v14}, Lcom/google/android/material/color/utilities/ViewingConditions;->getNbb()D
    ...
    mul-double v34, v4, v30

    mul-double v36, v21, v6
    ...
    invoke-static/range {v4 .. v11}, LA/O;->b(DDDD)D
    ...
    const-wide v6, 0x407c300000000000L    # 451.0
    ...
    const-wide v6, 0x4095ec0000000000L    # 1403.0
    ...
    invoke-static {v8, v9}, Lcom/google/android/material/color/utilities/HctSolver;->inverseChromaticAdaptation(D)D

    move-result-wide v4

    invoke-static {v10, v11}, Lcom/google/android/material/color/utilities/HctSolver;->inverseChromaticAdaptation(D)D
    ...
    invoke-static {v10, v4}, Lcom/google/android/material/color/utilities/MathUtils;->matrixMultiply([D[[D)[D
    ...
    cmpg-double v9, v7, v28

    if-ltz v9, :cond_7

    aget-wide v9, v4, v0

    cmpg-double v11, v9, v28
    ...
    aget-wide v30, v11, v27

    aget-wide v32, v11, v1

    aget-wide v34, v11, v0
...
.method public static lerpPoint([DD[D)[D
    ...
    invoke-static/range {v1 .. v8}, LA/N;->a(DDDD)D
    ...
    invoke-static/range {v4 .. v11}, LA/N;->a(DDDD)D
    ...
    invoke-static/range {v7 .. v14}, LA/N;->a(DDDD)D
