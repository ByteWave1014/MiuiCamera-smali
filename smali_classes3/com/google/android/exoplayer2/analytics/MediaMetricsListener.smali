...
.method public static create(Landroid/content/Context;)Lcom/google/android/exoplayer2/analytics/MediaMetricsListener;
    ...
    invoke-static {v0}, Landroidx/core/view/d;->b(Ljava/lang/Object;)Landroid/media/metrics/MediaMetricsManager;
    ...
    invoke-static {v0}, Landroidx/core/view/e;->a(Landroid/media/metrics/MediaMetricsManager;)Landroid/media/metrics/PlaybackSession;
...
.method private finishCurrentSession()V
    ...
    invoke-static {v0, v2}, Lcom/google/android/exoplayer2/analytics/L;->b(Landroid/media/metrics/PlaybackMetrics$Builder;I)V

    iget-object v0, p0, Lcom/google/android/exoplayer2/analytics/MediaMetricsListener;->metricsBuilder:Landroid/media/metrics/PlaybackMetrics$Builder;

    iget v2, p0, Lcom/google/android/exoplayer2/analytics/MediaMetricsListener;->droppedFrames:I

    invoke-static {v0, v2}, Lcom/google/android/exoplayer2/analytics/M;->c(Landroid/media/metrics/PlaybackMetrics$Builder;I)V

    iget-object v0, p0, Lcom/google/android/exoplayer2/analytics/MediaMetricsListener;->metricsBuilder:Landroid/media/metrics/PlaybackMetrics$Builder;

    iget v2, p0, Lcom/google/android/exoplayer2/analytics/MediaMetricsListener;->playedFrames:I

    invoke-static {v0, v2}, Lcom/google/android/exoplayer2/analytics/N;->c(Landroid/media/metrics/PlaybackMetrics$Builder;I)V
    ...
    :goto_0
    invoke-static {v2, v5, v6}, Lcom/google/android/exoplayer2/analytics/O;->d(Landroid/media/metrics/PlaybackMetrics$Builder;J)V
    ...
    :goto_1
    invoke-static {v2, v5, v6}, Landroidx/core/view/h;->c(Landroid/media/metrics/PlaybackMetrics$Builder;J)V
    ...
    :goto_2
    invoke-static {v2, v0}, Landroidx/core/view/i;->d(Landroid/media/metrics/PlaybackMetrics$Builder;I)V
    ...
    invoke-static {v2}, Landroidx/core/view/j;->d(Landroid/media/metrics/PlaybackMetrics$Builder;)Landroid/media/metrics/PlaybackMetrics;

    move-result-object v2

    invoke-static {v0, v2}, Landroidx/core/app/b;->c(Landroid/media/metrics/PlaybackSession;Landroid/media/metrics/PlaybackMetrics;)V
...
.method private maybeReportNetworkChange(J)V
    ...
    invoke-static {}, Landroidx/core/view/j;->c()Landroid/media/metrics/NetworkEvent$Builder;

    move-result-object v2

    invoke-static {v2, v0}, Lcom/google/android/exoplayer2/analytics/N;->a(Landroid/media/metrics/NetworkEvent$Builder;I)Landroid/media/metrics/NetworkEvent$Builder;
    ...
    invoke-static {v0, p1, p2}, Lcom/google/android/exoplayer2/analytics/O;->a(Landroid/media/metrics/NetworkEvent$Builder;J)Landroid/media/metrics/NetworkEvent$Builder;

    move-result-object p0

    invoke-static {p0}, Landroidx/core/view/a;->a(Landroid/media/metrics/NetworkEvent$Builder;)Landroid/media/metrics/NetworkEvent;

    move-result-object p0

    invoke-static {v1, p0}, LBh/a;->d(Landroid/media/metrics/PlaybackSession;Landroid/media/metrics/NetworkEvent;)V
...
.method private maybeReportPlaybackError(J)V
    ...
    invoke-static {}, Landroidx/core/view/h;->a()Landroid/media/metrics/PlaybackErrorEvent$Builder;
    ...
    invoke-static {v3, p1, p2}, Lcom/google/android/exoplayer2/analytics/K;->a(Landroid/media/metrics/PlaybackErrorEvent$Builder;J)Landroid/media/metrics/PlaybackErrorEvent$Builder;

    move-result-object p1

    iget p2, v1, Lcom/google/android/exoplayer2/analytics/MediaMetricsListener$ErrorInfo;->errorCode:I

    invoke-static {p1, p2}, Lcom/google/android/exoplayer2/analytics/L;->a(Landroid/media/metrics/PlaybackErrorEvent$Builder;I)Landroid/media/metrics/PlaybackErrorEvent$Builder;

    move-result-object p1

    iget p2, v1, Lcom/google/android/exoplayer2/analytics/MediaMetricsListener$ErrorInfo;->subErrorCode:I

    invoke-static {p1, p2}, Lcom/google/android/exoplayer2/analytics/M;->a(Landroid/media/metrics/PlaybackErrorEvent$Builder;I)Landroid/media/metrics/PlaybackErrorEvent$Builder;

    move-result-object p1

    invoke-static {p1, v0}, Lcom/google/android/exoplayer2/analytics/N;->b(Landroid/media/metrics/PlaybackErrorEvent$Builder;Ljava/lang/Exception;)Landroid/media/metrics/PlaybackErrorEvent$Builder;

    move-result-object p1

    invoke-static {p1}, Lcom/google/android/exoplayer2/analytics/O;->b(Landroid/media/metrics/PlaybackErrorEvent$Builder;)Landroid/media/metrics/PlaybackErrorEvent;

    move-result-object p1

    invoke-static {v2, p1}, Landroidx/core/view/a;->c(Landroid/media/metrics/PlaybackSession;Landroid/media/metrics/PlaybackErrorEvent;)V
...
.method private maybeReportPlaybackStateChange(Lcom/google/android/exoplayer2/Player;Lcom/google/android/exoplayer2/analytics/AnalyticsListener$Events;J)V
    ...
    invoke-static {}, Landroidx/core/view/f;->b()Landroid/media/metrics/PlaybackStateEvent$Builder;

    move-result-object p2

    iget v0, p0, Lcom/google/android/exoplayer2/analytics/MediaMetricsListener;->currentPlaybackState:I

    invoke-static {p2, v0}, Landroidx/core/view/g;->c(Landroid/media/metrics/PlaybackStateEvent$Builder;I)Landroid/media/metrics/PlaybackStateEvent$Builder;
    ...
    invoke-static {p2, p3, p4}, Lcom/google/android/exoplayer2/analytics/P;->a(Landroid/media/metrics/PlaybackStateEvent$Builder;J)Landroid/media/metrics/PlaybackStateEvent$Builder;

    move-result-object p0

    invoke-static {p0}, Landroidx/core/view/g;->d(Landroid/media/metrics/PlaybackStateEvent$Builder;)Landroid/media/metrics/PlaybackStateEvent;

    move-result-object p0

    invoke-static {p1, p0}, Lcom/google/android/exoplayer2/analytics/P;->c(Landroid/media/metrics/PlaybackSession;Landroid/media/metrics/PlaybackStateEvent;)V
...
.method private maybeUpdateMetricsBuilderValues(Lcom/google/android/exoplayer2/Player;Lcom/google/android/exoplayer2/analytics/AnalyticsListener$Events;)V
    ...
    invoke-static {v0}, Landroidx/core/view/g;->b(Ljava/lang/Object;)Landroid/media/metrics/PlaybackMetrics$Builder;
    ...
    invoke-static {v0, p1}, Lcom/google/android/exoplayer2/analytics/K;->b(Landroid/media/metrics/PlaybackMetrics$Builder;I)V
...
.method private maybeUpdateTimelineMetadata(Lcom/google/android/exoplayer2/Timeline;Lcom/google/android/exoplayer2/source/MediaSource$MediaPeriodId;)V
    ...
    invoke-static {v0, p1}, Landroidx/core/view/b;->a(Landroid/media/metrics/PlaybackMetrics$Builder;I)V
    ...
    invoke-static {v0, p1, p2}, Landroidx/core/location/t;->b(Landroid/media/metrics/PlaybackMetrics$Builder;J)V
    ...
    :goto_0
    invoke-static {v0, p1}, Landroidx/core/os/a;->c(Landroid/media/metrics/PlaybackMetrics$Builder;I)V
...
.method private reportTrackChangeEvent(IJLcom/google/android/exoplayer2/Format;I)V
    ...
    invoke-static {p1}, Landroidx/core/view/i;->b(I)Landroid/media/metrics/TrackChangeEvent$Builder;
    ...
    invoke-static {p1, p2, p3}, LBh/a;->a(Landroid/media/metrics/TrackChangeEvent$Builder;J)Landroid/media/metrics/TrackChangeEvent$Builder;

    move-result-object p1

    if-eqz p4, :cond_9

    invoke-static {p1}, Landroidx/core/view/e;->d(Landroid/media/metrics/TrackChangeEvent$Builder;)V

    invoke-static {p5}, Lcom/google/android/exoplayer2/analytics/MediaMetricsListener;->getTrackChangeReason(I)I

    move-result p2

    invoke-static {p1, p2}, Landroidx/core/view/f;->c(Landroid/media/metrics/TrackChangeEvent$Builder;I)V

    iget-object p2, p4, Lcom/google/android/exoplayer2/Format;->containerMimeType:Ljava/lang/String;

    if-eqz p2, :cond_0

    invoke-static {p1, p2}, Landroidx/core/view/h;->d(Landroid/media/metrics/TrackChangeEvent$Builder;Ljava/lang/String;)V
    ...
    invoke-static {p1, p2}, Landroidx/core/view/i;->e(Landroid/media/metrics/TrackChangeEvent$Builder;Ljava/lang/String;)V

    :cond_1
    iget-object p2, p4, Lcom/google/android/exoplayer2/Format;->codecs:Ljava/lang/String;

    if-eqz p2, :cond_2

    invoke-static {p1, p2}, Landroidx/core/view/j;->f(Landroid/media/metrics/TrackChangeEvent$Builder;Ljava/lang/String;)V

    :cond_2
    iget p2, p4, Lcom/google/android/exoplayer2/Format;->bitrate:I

    const/4 p3, -0x1

    if-eq p2, p3, :cond_3

    invoke-static {p1, p2}, Landroidx/core/app/b;->d(Landroid/media/metrics/TrackChangeEvent$Builder;I)V
    ...
    invoke-static {p1, p2}, Lcom/google/android/exoplayer2/analytics/K;->c(Landroid/media/metrics/TrackChangeEvent$Builder;I)V
    ...
    invoke-static {p1, p2}, Lcom/google/android/exoplayer2/analytics/L;->c(Landroid/media/metrics/TrackChangeEvent$Builder;I)V
    ...
    invoke-static {p1, p2}, Lcom/google/android/exoplayer2/analytics/M;->d(Landroid/media/metrics/TrackChangeEvent$Builder;I)V
    ...
    invoke-static {p1, p2}, LBh/b;->e(Landroid/media/metrics/TrackChangeEvent$Builder;I)V

    :cond_7
    iget-object p2, p4, Lcom/google/android/exoplayer2/Format;->language:Ljava/lang/String;

    if-eqz p2, :cond_8

    invoke-static {p2}, Lcom/google/android/exoplayer2/analytics/MediaMetricsListener;->getLanguageAndRegion(Ljava/lang/String;)Landroid/util/Pair;
    ...
    invoke-static {p1, p3}, LBh/c;->c(Landroid/media/metrics/TrackChangeEvent$Builder;Ljava/lang/String;)V
    ...
    invoke-static {p1, p2}, Landroidx/core/view/b;->b(Landroid/media/metrics/TrackChangeEvent$Builder;Ljava/lang/String;)V

    :cond_8
    iget p2, p4, Lcom/google/android/exoplayer2/Format;->frameRate:F
    ...
    invoke-static {p1, p2}, Landroidx/core/location/t;->c(Landroid/media/metrics/TrackChangeEvent$Builder;F)V

    goto :goto_0

    :cond_9
    invoke-static {p1}, Landroidx/core/os/a;->d(Landroid/media/metrics/TrackChangeEvent$Builder;)V
    ...
    invoke-static {p0, p1}, Landroidx/core/view/d;->d(Landroid/media/metrics/PlaybackSession;Landroid/media/metrics/TrackChangeEvent;)V
...
.method public getLogSessionId()Landroid/media/metrics/LogSessionId;
    ...
    invoke-static {p0}, Landroidx/core/view/c;->a(Landroid/media/metrics/PlaybackSession;)Landroid/media/metrics/LogSessionId;
...
.method public onSessionActive(Lcom/google/android/exoplayer2/analytics/AnalyticsListener$EventTime;Ljava/lang/String;)V
    ...
    invoke-static {}, Landroidx/core/app/b;->a()Landroid/media/metrics/PlaybackMetrics$Builder;

    move-result-object p2

    invoke-static {p2}, LBh/b;->b(Landroid/media/metrics/PlaybackMetrics$Builder;)Landroid/media/metrics/PlaybackMetrics$Builder;

    move-result-object p2

    invoke-static {p2}, LBh/c;->a(Landroid/media/metrics/PlaybackMetrics$Builder;)Landroid/media/metrics/PlaybackMetrics$Builder;
