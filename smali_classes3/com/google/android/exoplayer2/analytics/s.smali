...
.method public onMenuItemClick(Landroid/view/MenuItem;)V
    ...
    iget-object v4, v0, Lcom/google/android/exoplayer2/analytics/s;->b:Ljava/lang/Object;
    ...
    iget v0, v0, Lcom/google/android/exoplayer2/analytics/s;->a:I

    const-string v7, ", itemId: "

    invoke-static {v6, v0, v5, v7}, LA/P2;->f(Ljava/lang/StringBuilder;IILjava/lang/String;)Ljava/lang/String;
    ...
    iput-object v8, v6, LUb/f;->a:Ljava/util/LinkedHashMap;

    new-instance v8, Ljava/util/LinkedHashMap;

    invoke-direct {v8}, Ljava/util/LinkedHashMap;-><init>()V

    iput-object v8, v6, LUb/f;->b:Ljava/util/LinkedHashMap;

    new-instance v8, Ljava/util/LinkedHashMap;

    invoke-direct {v8}, Ljava/util/LinkedHashMap;-><init>()V

    iput-object v8, v6, LUb/f;->e:Ljava/util/LinkedHashMap;

    iput-object v6, v5, LUb/h;->b:LUb/f;

    const-string v6, "draft_rename"

    invoke-virtual {v5, v6, v7}, LUb/h;->c(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    invoke-direct {v8, v9}, LA/M2;-><init>(I)V
    ...
    invoke-direct {v7, v2, v3}, LE2/n;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-static {v6}, Lnc/d;->b(Landroid/widget/TextView;)Lnc/h;
    ...
    invoke-direct {v6, v4, v3}, LJ2/a;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-direct {v3, v4, v1}, LG3/a;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-direct {v2, v4, v0}, Lfd/m;-><init>(Lcom/xiaomi/milive/ui/LiveWorkspaceAdapter;I)V
    ...
    invoke-direct {v2, v4, v0}, Lfd/n;-><init>(Lcom/xiaomi/milive/ui/LiveWorkspaceAdapter;I)V
    ...
    invoke-virtual {v6, v0}, Lcom/xiaomi/milive/ui/LiveWorkspaceActivity;->ej(Lcom/xiaomi/milive/data/LiveWorkspaceItem;)V
    ...
    iput-object v8, v4, LUb/h;->a:Ljava/lang/String;
    ...
    iput-object v8, v5, LUb/f;->a:Ljava/util/LinkedHashMap;

    new-instance v8, Ljava/util/LinkedHashMap;

    invoke-direct {v8}, Ljava/util/LinkedHashMap;-><init>()V

    iput-object v8, v5, LUb/f;->b:Ljava/util/LinkedHashMap;

    new-instance v8, Ljava/util/LinkedHashMap;

    invoke-direct {v8}, Ljava/util/LinkedHashMap;-><init>()V

    iput-object v8, v5, LUb/f;->e:Ljava/util/LinkedHashMap;

    iput-object v5, v4, LUb/h;->b:LUb/f;

    const-string v5, "draft_delete"

    invoke-virtual {v4, v5, v7}, LUb/h;->c(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    invoke-direct {v1, v3}, LA/z2;-><init>(I)V
    ...
    invoke-static/range {v8 .. v16}, Ljc/u;->b(Landroid/content/Context;Ljava/lang/String;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/Runnable;Ljava/lang/CharSequence;Ljava/lang/Runnable;Ljava/lang/CharSequence;Ljava/lang/Runnable;)Lmiuix/appcompat/app/AlertDialog;
    ...
    invoke-direct {v3, v6, v2}, Lfd/k;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-virtual {v0, v2}, Le0/o;->Z(Z)V
