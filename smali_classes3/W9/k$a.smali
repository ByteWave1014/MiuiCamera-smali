...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = LW9/k;->g(Landroid/content/Context;I)V
.end annotation
...
.method public constructor <init>(Landroid/content/Context;I)V
    ...
    iput-object p1, p0, LW9/k$a;->a:Landroid/content/Context;

    iput p2, p0, LW9/k$a;->b:I
...
.method public final a(Ljava/io/Serializable;)V
    ...
    iget-object v2, p0, LW9/k$a;->a:Landroid/content/Context;
    ...
    invoke-static {v2, p0, v1}, LW9/k;->d(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Z
    ...
    :try_start_0
    sget-object p0, LW9/k;->h:Ljava/lang/Boolean;
    ...
    :goto_0
    sget-object p1, Lx9/H;->k:Ljava/nio/file/Path;

    invoke-interface {p1}, Ljava/nio/file/Path;->toFile()Ljava/io/File;

    move-result-object p1

    invoke-static {p0, p1}, LW9/k;->a(Ljava/io/File;Ljava/io/File;)V

    invoke-static {p0}, LW9/k;->b(Ljava/io/File;)V
    :try_end_1
    ...
    invoke-static {p1}, Lx9/H;->m(Ljava/util/ArrayList;)V
    ...
    iget p0, p0, LW9/k$a;->b:I

    if-ge p0, p1, :cond_3

    add-int/2addr p0, v3

    invoke-static {v2, p0}, LW9/k;->g(Landroid/content/Context;I)V
