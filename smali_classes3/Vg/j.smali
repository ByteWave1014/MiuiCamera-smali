...
.method public constructor <init>(Landroidx/datastore/core/DataStoreImpl$data$1$invokeSuspend$$inlined$map$1;Lzf/q;)V
    ...
    iput-object p1, p0, LVg/j;->a:Landroidx/datastore/core/DataStoreImpl$data$1$invokeSuspend$$inlined$map$1;

    iput-object p2, p0, LVg/j;->b:Lzf/q;
...
.method public final collect(LVg/f;Lof/e;)Ljava/lang/Object;
    ...
    invoke-direct {v0, p0, p2}, LVg/j$a;-><init>(LVg/j;Lof/e;)V
    ...
    iget-object p0, v0, LVg/j$a;->d:Ljava/lang/Object;
    ...
    :try_start_2
    iget-object p2, p0, LVg/j;->a:Landroidx/datastore/core/DataStoreImpl$data$1$invokeSuspend$$inlined$map$1;

    iput-object p0, v0, LVg/j$a;->d:Ljava/lang/Object;

    iput-object p1, v0, LVg/j$a;->e:LVg/f;

    iput v5, v0, LVg/j$a;->b:I

    invoke-interface {p2, p1, v0}, LVg/e;->collect(LVg/f;Lof/e;)Ljava/lang/Object;
    ...
    :try_start_3
    iget-object p0, p0, LVg/j;->b:Lzf/q;

    iput-object p2, v0, LVg/j$a;->d:Ljava/lang/Object;

    iput-object v6, v0, LVg/j$a;->e:LVg/f;
    ...
    :goto_4
    new-instance p2, LVg/H;

    invoke-direct {p2, p0}, LVg/H;-><init>(Ljava/lang/Throwable;)V

    iget-object p1, p1, LVg/j;->b:Lzf/q;
    ...
    invoke-static {p2, p1, p0, v0}, Ljc/c;->j(LVg/H;Lzf/q;Ljava/lang/Throwable;Lqf/c;)Ljava/lang/Object;
