...
# direct methods
.method public synthetic constructor <init>(Lcom/android/camera/effect/EffectController;LWe/c;Ljava/lang/String;Ljava/lang/String;)V
    .locals 0
    ...
    iput-object p2, p0, LP0/b;->b:LWe/c;
...
.method public final run()V
    ...
    iget-object v4, v0, LP0/b;->b:LWe/c;

    invoke-virtual {v4, v3}, LWe/c;->b(LRe/d;)Ljava/util/Optional;
    ...
    :cond_0
    iget-object v5, v4, LWe/c;->e:Laf/u;
    ...
    iget-object v6, v4, LWe/c;->d:Ljava/util/ArrayList;

    monitor-enter v6

    :try_start_0
    iget-object v9, v4, LWe/c;->d:Ljava/util/ArrayList;
    ...
    iget-object v10, v4, LWe/c;->a:Landroid/content/Context;

    iput-object v10, v9, Laf/g;->d:Landroid/content/Context;

    :cond_2
    invoke-virtual {v5, v8}, Laf/t;->b(LPe/g;)V
    ...
    invoke-virtual {v4, v6}, LWe/c;->b(LRe/d;)Ljava/util/Optional;
    ...
    invoke-direct {v9, v5, v10}, LA/m0;-><init>(Ljava/lang/Object;I)V
    ...
    iget-object v6, v4, LWe/c;->f:LWe/a;
    ...
    invoke-static {v12, v13, v0, v8, v7}, LA/N;->f(IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-static {v0, v9, v7, v5, v8}, LA/y3;->i(Ljava/lang/StringBuilder;ILjava/lang/String;ILjava/lang/String;)V
    ...
    iget-object v5, v4, LWe/c;->d:Ljava/util/ArrayList;

    monitor-enter v5

    :try_start_1
    iget-object v0, v4, LWe/c;->d:Ljava/util/ArrayList;
    ...
    iget-object v8, v4, LWe/c;->f:LWe/a;
    ...
    iget-object v10, v4, LWe/c;->f:LWe/a;
    ...
    iget-object v9, v4, LWe/c;->f:LWe/a;
    ...
    iget-object v12, v4, LWe/c;->f:LWe/a;
    ...
    iget-object v9, v4, LWe/c;->g:LWe/d;
    ...
    iget-object v11, v4, LWe/c;->h:LUe/h;

    iput-object v7, v9, LPe/h;->c:LQe/b;

    iput-object v8, v9, LPe/h;->d:LQe/b;

    iget-object v7, v9, LPe/h;->f:Landroid/graphics/Rect;

    invoke-virtual {v7, v10}, Landroid/graphics/Rect;->set(Landroid/graphics/Rect;)V

    const/4 v7, 0x0

    iput-object v7, v9, LPe/h;->g:Landroid/util/Size;

    iput-object v11, v9, LPe/h;->j:LUe/h;

    invoke-virtual {v6, v9}, Laf/t;->e(LPe/h;)I
    ...
    iget-object v5, v4, LWe/c;->f:LWe/a;
    ...
    :goto_5
    iget-object v5, v4, LWe/c;->c:LQe/c;
    ...
    iput-object v5, v4, LWe/c;->c:LQe/c;
    ...
    iget-object v8, v4, LWe/c;->c:LQe/c;
    ...
    iget-object v0, v4, LWe/c;->c:LQe/c;
    ...
    iget-object v7, v4, LWe/c;->d:Ljava/util/ArrayList;
    ...
    iget-object v11, v4, LWe/c;->f:LWe/a;
    ...
    iget-object v9, v4, LWe/c;->c:LQe/c;
    ...
    iget-object v12, v4, LWe/c;->g:LWe/d;

    iget-object v13, v4, LWe/c;->f:LWe/a;

    invoke-virtual {v13}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iget-object v13, v13, LWe/a;->a:Landroid/graphics/Rect;

    iget-object v14, v4, LWe/c;->h:LUe/h;

    iput-object v8, v12, LPe/h;->c:LQe/b;

    iput-object v9, v12, LPe/h;->d:LQe/b;

    iget-object v8, v12, LPe/h;->f:Landroid/graphics/Rect;

    invoke-virtual {v8, v13}, Landroid/graphics/Rect;->set(Landroid/graphics/Rect;)V

    const/4 v8, 0x0

    iput-object v8, v12, LPe/h;->g:Landroid/util/Size;

    iput-object v14, v12, LPe/h;->j:LUe/h;

    invoke-virtual {v6, v12}, Laf/t;->e(LPe/h;)I

    move-result v8

    sget-boolean v12, LWe/c;->i:Z
    ...
    invoke-static {v13, v9, v14, v15}, LEc/f;->c(IILjava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v14

    invoke-static {v12, v13, v9, v14}, LEc/f;->b(IIILjava/lang/String;)V

    :cond_12
    sget-boolean v9, LG7/c;->d:Z
    ...
    iget-object v8, v4, LWe/c;->d:Ljava/util/ArrayList;
    ...
    iget-object v7, v4, LWe/c;->c:LQe/c;
    ...
    :goto_c
    iget-object v0, v4, LWe/c;->f:LWe/a;
    ...
    :goto_d
    invoke-static {v3, v3, v6, v7}, LEc/f;->e(IIII)Ljava/nio/ByteBuffer;
    ...
    iget-object v0, v4, LWe/c;->h:LUe/h;
