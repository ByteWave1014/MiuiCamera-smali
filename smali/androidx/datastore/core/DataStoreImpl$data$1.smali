...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Landroidx/datastore/core/DataStoreImpl;-><init>(Landroidx/datastore/core/Storage;Ljava/util/List;Landroidx/datastore/core/CorruptionHandler;LSg/E;)V
.end annotation
...
.method public final create(Ljava/lang/Object;Lof/e;)Lof/e;
    ...
    invoke-direct {v0, p0, p2}, Landroidx/datastore/core/DataStoreImpl$data$1;-><init>(Landroidx/datastore/core/DataStoreImpl;Lof/e;)V
...
.method public final invoke(LVg/f;Lof/e;)Ljava/lang/Object;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 1
    invoke-virtual {p0, p1, p2}, Landroidx/datastore/core/DataStoreImpl$data$1;->create(Ljava/lang/Object;Lof/e;)Lof/e;
...
.method public bridge synthetic invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2}, Landroidx/datastore/core/DataStoreImpl$data$1;->invoke(LVg/f;Lof/e;)Ljava/lang/Object;
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {v1, v4, p0}, Landroidx/datastore/core/DataStoreImpl;->access$readState(Landroidx/datastore/core/DataStoreImpl;ZLof/e;)Ljava/lang/Object;
    ...
    invoke-interface {v1, v4, p0}, LVg/f;->emit(Ljava/lang/Object;Lof/e;)Ljava/lang/Object;
    ...
    invoke-direct {v4, v5, v6}, Landroidx/datastore/core/DataStoreImpl$data$1$1;-><init>(Landroidx/datastore/core/DataStoreImpl;Lof/e;)V

    new-instance v5, LVg/k;

    invoke-direct {v5, v3, v4}, LVg/k;-><init>(LVg/e;Lzf/p;)V

    new-instance v3, Landroidx/datastore/core/DataStoreImpl$data$1$2;

    invoke-direct {v3, v6}, Landroidx/datastore/core/DataStoreImpl$data$1$2;-><init>(Lof/e;)V

    new-instance v4, LVg/r;

    invoke-direct {v4, v5, v3}, LVg/r;-><init>(LVg/k;Lzf/p;)V

    new-instance v3, Landroidx/datastore/core/DataStoreImpl$data$1$3;

    invoke-direct {v3, p1, v6}, Landroidx/datastore/core/DataStoreImpl$data$1$3;-><init>(Landroidx/datastore/core/State;Lof/e;)V

    new-instance p1, LVg/p;

    invoke-direct {p1, v4, v3}, LVg/p;-><init>(LVg/r;Lzf/p;)V
    ...
    invoke-direct {p1, v4, v6}, Landroidx/datastore/core/DataStoreImpl$data$1$5;-><init>(Landroidx/datastore/core/DataStoreImpl;Lof/e;)V

    new-instance v4, LVg/j;

    invoke-direct {v4, v3, p1}, LVg/j;-><init>(Landroidx/datastore/core/DataStoreImpl$data$1$invokeSuspend$$inlined$map$1;Lzf/q;)V
    ...
    instance-of p1, v1, LVg/H;

    if-nez p1, :cond_a

    invoke-virtual {v4, v1, p0}, LVg/j;->collect(LVg/f;Lof/e;)Ljava/lang/Object;
    ...
    iget-object p0, v1, LVg/H;->a:Ljava/lang/Throwable;
