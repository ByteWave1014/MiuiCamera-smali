...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "onDone",
        "<init>",
        "(Landroidx/lifecycle/CoroutineLiveData;Lzf/p;JLSg/E;Lzf/a;)V",
        "maybeRun",
        "()V",
        "cancel",
        "Landroidx/lifecycle/CoroutineLiveData;",
...
.field private cancellationJob:LSg/n0;
...
.field private runningJob:LSg/n0;
...
# direct methods
.method public constructor <init>(Landroidx/lifecycle/CoroutineLiveData;Lzf/p;JLSg/E;Lzf/a;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p5, p0, Landroidx/lifecycle/BlockRunner;->scope:LSg/E;
...
.method public static final synthetic access$getRunningJob$p(Landroidx/lifecycle/BlockRunner;)LSg/n0;
    .locals 0

    iget-object p0, p0, Landroidx/lifecycle/BlockRunner;->runningJob:LSg/n0;
...
.method public static final synthetic access$setRunningJob$p(Landroidx/lifecycle/BlockRunner;LSg/n0;)V
    .locals 0

    iput-object p1, p0, Landroidx/lifecycle/BlockRunner;->runningJob:LSg/n0;
...
.method public final cancel()V
    ...
    iget-object v0, p0, Landroidx/lifecycle/BlockRunner;->cancellationJob:LSg/n0;

    if-nez v0, :cond_0

    iget-object v0, p0, Landroidx/lifecycle/BlockRunner;->scope:LSg/E;
    ...
    invoke-direct {v2, p0, v3}, Landroidx/lifecycle/BlockRunner$cancel$1;-><init>(Landroidx/lifecycle/BlockRunner;Lof/e;)V

    const/4 v4, 0x2

    invoke-static {v0, v1, v3, v2, v4}, LSg/f;->a(LSg/E;Lof/f;LSg/G;Lzf/p;I)LSg/C0;

    move-result-object v0

    iput-object v0, p0, Landroidx/lifecycle/BlockRunner;->cancellationJob:LSg/n0;
...
.method public final maybeRun()V
    ...
    :cond_0
    iput-object v1, p0, Landroidx/lifecycle/BlockRunner;->cancellationJob:LSg/n0;

    iget-object v0, p0, Landroidx/lifecycle/BlockRunner;->runningJob:LSg/n0;
    ...
    invoke-direct {v2, p0, v1}, Landroidx/lifecycle/BlockRunner$maybeRun$1;-><init>(Landroidx/lifecycle/BlockRunner;Lof/e;)V

    const/4 v3, 0x3

    invoke-static {v0, v1, v1, v2, v3}, LSg/f;->a(LSg/E;Lof/f;LSg/G;Lzf/p;I)LSg/C0;

    move-result-object v0

    iput-object v0, p0, Landroidx/lifecycle/BlockRunner;->runningJob:LSg/n0;
