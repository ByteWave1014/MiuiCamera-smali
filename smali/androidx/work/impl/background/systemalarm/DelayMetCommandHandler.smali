...
.field private final mCoroutineDispatcher:LSg/B;
...
.field private volatile mJob:LSg/n0;
...
.method public constructor <init>(Landroid/content/Context;ILandroidx/work/impl/background/systemalarm/SystemAlarmDispatcher;Landroidx/work/impl/StartStopToken;)V
    ...
    invoke-interface {p2}, Landroidx/work/impl/utils/taskexecutor/TaskExecutor;->getTaskCoroutineDispatcher()LSg/B;

    move-result-object p2

    iput-object p2, p0, Landroidx/work/impl/background/systemalarm/DelayMetCommandHandler;->mCoroutineDispatcher:LSg/B;
...
.method private cleanUp()V
    ...
    :try_start_0
    iget-object v2, p0, Landroidx/work/impl/background/systemalarm/DelayMetCommandHandler;->mJob:LSg/n0;
    ...
    invoke-interface {v2, v3}, LSg/n0;->a(Ljava/util/concurrent/CancellationException;)V
...
.method public handleProcessWork()V
    ...
    invoke-static {v0, v2}, LA/y3;->g(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    iget-object v2, p0, Landroidx/work/impl/background/systemalarm/DelayMetCommandHandler;->mCoroutineDispatcher:LSg/B;

    invoke-static {v0, v1, v2, p0}, Landroidx/work/impl/constraints/WorkConstraintsTrackerKt;->listen(Landroidx/work/impl/constraints/WorkConstraintsTracker;Landroidx/work/impl/model/WorkSpec;LSg/B;Landroidx/work/impl/constraints/OnConstraintsStateChangedListener;)LSg/n0;

    move-result-object v0

    iput-object v0, p0, Landroidx/work/impl/background/systemalarm/DelayMetCommandHandler;->mJob:LSg/n0;
