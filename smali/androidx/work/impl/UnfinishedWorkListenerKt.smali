...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "(LSg/E;Landroid/content/Context;Landroidx/work/Configuration;Landroidx/work/impl/WorkDatabase;)V",
        "",
        "TAG",
        "Ljava/lang/String;",
        "",
...
.method public static final maybeLaunchUnfinishedWorkListener(LSg/E;Landroid/content/Context;Landroidx/work/Configuration;Landroidx/work/impl/WorkDatabase;)V
    .locals 2
    ...
    invoke-interface {p2}, Landroidx/work/impl/model/WorkSpecDao;->hasUnfinishedWorkFlow()LVg/e;
    ...
    invoke-direct {v1, p2, p3}, LVg/o;-><init>(LVg/e;Lzf/r;)V

    invoke-static {v1}, LHh/c;->h(LVg/e;)LVg/e;

    move-result-object p2

    invoke-static {p2}, LHh/c;->j(LVg/e;)LVg/e;
    ...
    invoke-direct {p1, p2, p3}, LVg/x;-><init>(LVg/e;Lzf/p;)V

    new-instance p2, LVg/h;

    invoke-direct {p2, p1, v0}, LVg/h;-><init>(LVg/x;Lof/e;)V

    const/4 p1, 0x3

    invoke-static {p0, v0, v0, p2, p1}, LSg/f;->a(LSg/E;Lof/f;LSg/G;Lzf/p;I)LSg/C0;
