...
.field private final workerJob:LSg/s;
...
.method public constructor <init>(Landroidx/work/impl/WorkerWrapper$Builder;)V
    ...
    iput-object p1, p0, Landroidx/work/impl/WorkerWrapper;->workerJob:LSg/s;
...
.method public static final synthetic access$getWorkerJob$p(Landroidx/work/impl/WorkerWrapper;)LSg/s;
    .locals 0

    iget-object p0, p0, Landroidx/work/impl/WorkerWrapper;->workerJob:LSg/s;
...
.method public static final synthetic access$runWorker(Landroidx/work/impl/WorkerWrapper;Lof/e;)Ljava/lang/Object;
    .locals 0

    invoke-direct {p0, p1}, Landroidx/work/impl/WorkerWrapper;->runWorker(Lof/e;)Ljava/lang/Object;
...
.method private final createWorkDescription(Ljava/util/List;)Ljava/lang/String;
    ...
    invoke-static {v0, p0, p1}, LA/Y;->g(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method private final iterativelyFailWorkAndDependents(Ljava/lang/String;)V
    ...
    invoke-static {p1}, Llf/n;->x([Ljava/lang/Object;)Ljava/util/ArrayList;
    ...
    invoke-static {p1}, Llf/r;->F(Ljava/util/List;)Ljava/lang/Object;
...
.method private final runWorker(Lof/e;)Ljava/lang/Object;
    .locals 23
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v2, v1, v0}, Landroidx/work/impl/WorkerWrapper$runWorker$1;-><init>(Landroidx/work/impl/WorkerWrapper;Lof/e;)V
    ...
    invoke-direct {v8, v1, v9}, Landroidx/work/impl/e;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-static {v9}, LAe/b;->m(Ljava/lang/Object;)Ljava/util/List;
    ...
    invoke-static {v9, v10}, Llf/t;->c0(Ljava/util/Collection;Ljava/lang/Iterable;)Ljava/util/ArrayList;
    ...
    invoke-virtual {v9}, Landroidx/work/Configuration;->getWorkerCoroutineContext()Lof/h;
    ...
    invoke-direct/range {v9 .. v21}, Landroidx/work/WorkerParameters;-><init>(Ljava/util/UUID;Landroidx/work/Data;Ljava/util/Collection;Landroidx/work/WorkerParameters$RuntimeExtras;IILjava/util/concurrent/Executor;Lof/h;Landroidx/work/impl/utils/taskexecutor/TaskExecutor;Landroidx/work/WorkerFactory;Landroidx/work/ProgressUpdater;Landroidx/work/ForegroundUpdater;)V
    ...
    invoke-interface {v2}, Lof/e;->getContext()Lof/h;

    move-result-object v5

    sget-object v6, LSg/n0$a;->a:LSg/n0$a;

    invoke-interface {v5, v6}, Lof/h;->get(Lof/h$b;)Lof/h$a;

    move-result-object v5

    invoke-static {v5}, Lkotlin/jvm/internal/l;->c(Ljava/lang/Object;)V

    check-cast v5, LSg/n0;
    ...
    invoke-interface {v5, v6}, LSg/n0;->B(Lzf/l;)LSg/X;
    ...
    invoke-interface {v5}, LSg/n0;->isCancelled()Z
    ...
    invoke-static {v4}, LA3/o2;->c(Ljava/util/concurrent/Executor;)LSg/B;
    ...
    invoke-direct {v5, v1, v3, v0, v6}, Landroidx/work/impl/WorkerWrapper$runWorker$result$1;-><init>(Landroidx/work/impl/WorkerWrapper;Landroidx/work/ListenableWorker;Landroidx/work/ForegroundUpdater;Lof/e;)V
    ...
    invoke-static {v5, v4, v2}, LSg/f;->d(Lzf/p;Lof/h;Lof/e;)Ljava/lang/Object;
    ...
    invoke-static {v4, v1, v5}, LA/Y;->g(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method private final trySetRunning()Z
    ...
    invoke-direct {v1, p0, v2}, LK2/f;-><init>(Ljava/lang/Object;I)V
...
.method public final launch()Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    invoke-interface {v0}, Landroidx/work/impl/utils/taskexecutor/TaskExecutor;->getTaskCoroutineDispatcher()LSg/B;
    ...
    invoke-virtual {v0, v1}, Lof/a;->plus(Lof/h;)Lof/h;
    ...
    invoke-direct {v1, p0, v2}, Landroidx/work/impl/WorkerWrapper$launch$1;-><init>(Landroidx/work/impl/WorkerWrapper;Lof/e;)V

    const/4 p0, 0x2

    invoke-static {v0, v2, v1, p0, v2}, Landroidx/work/ListenableFutureKt;->launchFuture$default(Lof/h;LSg/G;Lzf/p;ILjava/lang/Object;)Lcom/google/common/util/concurrent/ListenableFuture;
