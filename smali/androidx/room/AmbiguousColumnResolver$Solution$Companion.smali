...
.method public final build(Ljava/util/List;)Landroidx/room/AmbiguousColumnResolver$Solution;
    ...
    invoke-virtual {v3}, Landroidx/room/AmbiguousColumnResolver$Match;->getResultRange()LFf/d;
    ...
    invoke-virtual {v5}, Landroidx/room/AmbiguousColumnResolver$Match;->getResultRange()LFf/d;

    move-result-object v5

    iget v5, v5, LFf/b;->a:I
    ...
    invoke-virtual {v6}, Landroidx/room/AmbiguousColumnResolver$Match;->getResultRange()LFf/d;

    move-result-object v6

    iget v6, v6, LFf/b;->b:I
    ...
    invoke-direct {v0, v3, v5, v4}, LFf/b;-><init>(III)V
    ...
    invoke-virtual {v5}, Llf/A;->nextInt()I
    ...
    invoke-virtual {v8}, Landroidx/room/AmbiguousColumnResolver$Match;->getResultRange()LFf/d;

    move-result-object v8

    iget v9, v8, LFf/b;->a:I

    if-gt v9, v5, :cond_8

    iget v8, v8, LFf/b;->b:I
