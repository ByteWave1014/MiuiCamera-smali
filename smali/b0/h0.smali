...
.method public static i(Ljava/util/ArrayList;)V
    ...
    invoke-interface {v3, v4, v5}, Lc4/i;->x(Ljava/lang/String;Z)I
    ...
    invoke-interface {v3, v4, v2}, Lc4/i;->x(Ljava/lang/String;Z)I
...
.method public final A(I)Z
    ...
    invoke-static {p1}, LZ5/e;->h0(LZ5/d;)Landroid/util/Size;

    move-result-object v0

    invoke-static {p1, v0}, LZ5/e;->A3(LZ5/d;Landroid/util/Size;)Z

    move-result p1

    iget-object v0, p0, Lcom/android/camera/data/data/c;->mCapabilities:LZ5/d;

    invoke-static {v0}, LZ5/e;->h0(LZ5/d;)Landroid/util/Size;

    move-result-object v0

    iget-object p0, p0, Lcom/android/camera/data/data/c;->mCapabilities:LZ5/d;

    invoke-static {p0, v0}, LZ5/e;->A3(LZ5/d;Landroid/util/Size;)Z
...
.method public final B()Z
    ...
    invoke-virtual {p0, v0}, Lb0/h0;->getComponentValue(I)Ljava/lang/String;
...
.method public final D()Z
    ...
    :cond_1
    invoke-virtual {p0}, Lb0/h0;->B()Z

    move-result v0

    if-nez v0, :cond_3

    invoke-virtual {p0}, Lb0/h0;->E()Z
...
.method public final F()Z
    ...
    iget-object v0, p0, Lb0/h0;->l:Ljava/lang/Boolean;

    if-nez v0, :cond_3

    invoke-virtual {p0}, Lb0/h0;->z()Z
    ...
    invoke-virtual {v2, v0}, LF3/f;->Q(I)LZ5/d;
    ...
    invoke-virtual {v0, v2}, LF3/f;->Q(I)LZ5/d;
    ...
    iput-object v0, p0, Lb0/h0;->l:Ljava/lang/Boolean;

    :cond_3
    iget-object p0, p0, Lb0/h0;->l:Ljava/lang/Boolean;
...
.method public final H(IILZ5/d;)V
    .locals 12

    invoke-static {p3}, LZ5/e;->q0(LZ5/d;)Z

    move-result v0

    iput-boolean v0, p0, Lb0/h0;->m:Z
    ...
    invoke-virtual {p2}, L渭渡渣湠渣渧湠渪渫游渧渭渫湠渭渡渣渣渡渠湠渍渡渣渣渡渠;->J0()Ljava/lang/String;
    ...
    :cond_4
    invoke-virtual {p0, v0}, Lb0/h0;->l(Ljava/util/ArrayList;)V

    goto/16 :goto_1

    :cond_5
    invoke-virtual {p0, v0}, Lb0/h0;->n(Ljava/util/ArrayList;)V

    goto/16 :goto_1

    :cond_6
    invoke-virtual {p0, v0}, Lb0/h0;->h(Ljava/util/ArrayList;)V

    goto/16 :goto_1

    :cond_7
    invoke-virtual {p0, v0}, Lb0/h0;->o(Ljava/util/ArrayList;)V

    goto/16 :goto_1

    :cond_8
    invoke-virtual {p0, v0}, Lb0/h0;->m(Ljava/util/ArrayList;)V

    goto/16 :goto_1

    :cond_9
    invoke-static {p3}, LZ5/e;->R(LZ5/d;)I

    move-result p2

    invoke-static {p3}, LZ5/e;->h0(LZ5/d;)Landroid/util/Size;

    move-result-object v4

    invoke-static {p3, v4}, LZ5/e;->A3(LZ5/d;Landroid/util/Size;)Z
    ...
    invoke-virtual {v10, p1}, Lf0/S;->isSwitchOn(I)Z
    ...
    invoke-virtual {v9, v10}, LF3/f;->Q(I)LZ5/d;

    move-result-object v9

    invoke-static {v9, v4}, LZ5/e;->A3(LZ5/d;Landroid/util/Size;)Z
    ...
    invoke-static {v0}, Lb0/h0;->p(Ljava/util/ArrayList;)V
    ...
    invoke-interface {v5, v3, v2}, Lc4/i;->x(Ljava/lang/String;Z)I

    move-result v6

    iput v6, v4, Lcom/android/camera/data/data/d;->c:I

    invoke-interface {v5, v3, v1}, Lc4/i;->x(Ljava/lang/String;Z)I
    ...
    invoke-virtual {p0, v3}, Lb0/h0;->v(Ljava/lang/String;)V
    ...
    invoke-static {v0}, Lb0/h0;->i(Ljava/util/ArrayList;)V
    ...
    invoke-interface {v6, v5, v1}, Lc4/i;->x(Ljava/lang/String;Z)I
    ...
    invoke-interface {v6, v5, v2}, Lc4/i;->x(Ljava/lang/String;Z)I
    ...
    invoke-static {v0, v4}, LA/N;->c(Ljava/util/ArrayList;Lcom/android/camera/data/data/d;)Lcom/android/camera/data/data/d;
    ...
    invoke-interface {v6, v3, v1}, Lc4/i;->x(Ljava/lang/String;Z)I
    ...
    invoke-interface {v6, v3, v2}, Lc4/i;->x(Ljava/lang/String;Z)I
    ...
    invoke-virtual {p0, v5}, Lb0/h0;->v(Ljava/lang/String;)V
    ...
    :cond_12
    invoke-virtual {p0, p1}, Lb0/h0;->A(I)Z
    ...
    invoke-virtual {v9, p2}, LF3/f;->Q(I)LZ5/d;

    move-result-object p2

    invoke-static {p2}, LZ5/e;->R(LZ5/d;)I

    move-result v9

    invoke-static {p2}, LZ5/e;->h0(LZ5/d;)Landroid/util/Size;

    move-result-object v10

    invoke-static {p2, v10}, LZ5/e;->A3(LZ5/d;Landroid/util/Size;)Z
    ...
    :cond_15
    invoke-static {v0}, Lb0/h0;->k(Ljava/util/ArrayList;)V

    goto :goto_1

    :cond_16
    invoke-static {v0}, Lb0/h0;->j(Ljava/util/ArrayList;)V
    ...
    :goto_2
    iput-boolean p2, p0, Lb0/h0;->f:Z

    :cond_1a
    iget-boolean p2, p0, Lb0/h0;->f:Z
    ...
    iget-object v4, p3, LZ5/d;->w:Lo6/y;
    ...
    sget-object v4, Ln6/h;->P3:Ln6/K;

    sget v5, Ln6/L;->a:I

    iget-object v6, p3, LZ5/d;->d:Landroid/hardware/camera2/CameraCharacteristics;
    ...
    :cond_1f
    iput-object v3, p3, LZ5/d;->w:Lo6/y;

    goto :goto_3

    :cond_20
    iget-object v1, p3, LZ5/d;->E6:Lo6/y;
    ...
    iput-object v1, p3, LZ5/d;->E6:Lo6/y;
    ...
    iput-object v1, p3, LZ5/d;->w:Lo6/y;
    ...
    :cond_24
    :goto_3
    iget-object v3, p3, LZ5/d;->w:Lo6/y;
    ...
    iput-object v3, p0, Lb0/h0;->n:Lo6/y;
...
.method public final I(I)V
    ...
    invoke-virtual {p0}, Lb0/h0;->r()Ljava/lang/String;
    ...
    invoke-virtual {v1, v2}, Lf0/q0;->G(Z)V
...
.method public final L(ILZ5/d;)V
    .locals 3
    ...
    :cond_0
    invoke-virtual {p0, v1, p1, p2}, Lb0/h0;->H(IILZ5/d;)V
...
.method public final b(Ljava/lang/Object;)V
    ...
    iput-object v1, p0, Lcom/android/camera/data/data/c;->mCapabilities:LZ5/d;

    invoke-static {v1}, LZ5/e;->Q0(LZ5/d;)Z

    move-result v1

    iput-boolean v1, p0, Lb0/h0;->g:Z

    const/4 v1, 0x0

    iput-object v1, p0, Lb0/h0;->h:Ljava/lang/Boolean;

    iput-object v1, p0, Lb0/h0;->i:Ljava/lang/Boolean;

    iput-object v1, p0, Lb0/h0;->k:Ljava/lang/Boolean;

    iput-object v1, p0, Lb0/h0;->l:Ljava/lang/Boolean;
    ...
    iput-boolean v0, p0, Lb0/h0;->f:Z

    iput-object v1, p0, Lb0/h0;->n:Lo6/y;

    iget v0, p1, Lcom/android/camera/data/data/x;->b:I

    if-nez v0, :cond_0

    iget-object v0, p1, Lcom/android/camera/data/data/x;->c:LZ5/d;

    iput-object v0, p0, Lb0/h0;->e:LZ5/d;

    :cond_0
    iget v0, p1, Lcom/android/camera/data/data/x;->a:I

    invoke-virtual {p0, v0}, Lb0/h0;->isSupportMode(I)Z
    ...
    invoke-virtual {p0, v0, v1, p1}, Lb0/h0;->H(IILZ5/d;)V
...
.method public final h(Ljava/util/ArrayList;)V
    ...
    invoke-static {p1}, Lb0/h0;->j(Ljava/util/ArrayList;)V
    ...
    invoke-interface {v4, v3, v5}, Lc4/i;->x(Ljava/lang/String;Z)I
    ...
    invoke-interface {v4, v3, v2}, Lc4/i;->x(Ljava/lang/String;Z)I
...
.method public final isSwitchOn(I)Z
    ...
    invoke-virtual {p0, p1}, Lb0/h0;->getComponentValue(I)Ljava/lang/String;
...
.method public final l(Ljava/util/ArrayList;)V
    ...
    invoke-static {p1}, Lb0/h0;->i(Ljava/util/ArrayList;)V
...
.method public final o(Ljava/util/ArrayList;)V
    ...
    invoke-static {p1}, Lb0/h0;->k(Ljava/util/ArrayList;)V
...
.method public final s()Ljava/lang/String;
    ...
    iget-object v0, p0, Lb0/h0;->e:LZ5/d;

    invoke-static {v0}, LZ5/e;->R(LZ5/d;)I

    move-result v0

    iget-object v1, p0, Lb0/h0;->e:LZ5/d;
...
.method public final t()[I
    ...
    invoke-interface {v1, v2, v3}, Lc4/i;->x(Ljava/lang/String;Z)I
    ...
    invoke-interface {v1, v0, p0}, Lc4/i;->x(Ljava/lang/String;Z)I
    ...
    invoke-interface {v1, v0, v3}, Lc4/i;->x(Ljava/lang/String;Z)I
    ...
    invoke-interface {v1, p0, v3}, Lc4/i;->x(Ljava/lang/String;Z)I
...
.method public final u()Z
    ...
    iget-object v0, p0, Lb0/h0;->h:Ljava/lang/Boolean;
    ...
    iput-object v0, p0, Lb0/h0;->h:Ljava/lang/Boolean;

    :cond_2
    iget-boolean v0, p0, Lb0/h0;->g:Z

    if-eqz v0, :cond_3

    iget-object p0, p0, Lb0/h0;->h:Ljava/lang/Boolean;
...
.method public final v(Ljava/lang/String;)V
    ...
    :pswitch_0
    sget-object p1, Lc4/h;->a:Lc4/i;

    const-string v0, "PIXEL_12_5"

    invoke-interface {p1, v0, v8}, Lc4/i;->x(Ljava/lang/String;Z)I

    const-string p1, ""

    iput-object p1, p0, Lb0/h0;->a:Ljava/lang/String;

    iput-object p1, p0, Lb0/h0;->b:Ljava/lang/String;
    ...
    invoke-interface {p1, v0, v7}, Lc4/i;->x(Ljava/lang/String;Z)I
    ...
    invoke-interface {p1, v1, v8}, Lc4/i;->x(Ljava/lang/String;Z)I
    ...
    invoke-interface {p1, v2, v8}, Lc4/i;->x(Ljava/lang/String;Z)I
    ...
    invoke-interface {p1, v3, v8}, Lc4/i;->x(Ljava/lang/String;Z)I
    ...
    invoke-interface {p1, v4, v8}, Lc4/i;->x(Ljava/lang/String;Z)I
    ...
    invoke-interface {p1, v5, v7}, Lc4/i;->x(Ljava/lang/String;Z)I
...
.method public final x()Z
    ...
    iget-object v0, p0, Lb0/h0;->j:Ljava/lang/Boolean;

    if-nez v0, :cond_0

    sget-object v0, Ljava/lang/Boolean;->FALSE:Ljava/lang/Boolean;

    iput-object v0, p0, Lb0/h0;->j:Ljava/lang/Boolean;
    ...
    :cond_0
    iget-object p0, p0, Lb0/h0;->j:Ljava/lang/Boolean;
...
.method public final y()Z
    ...
    iget-object v0, p0, Lb0/h0;->k:Ljava/lang/Boolean;

    if-nez v0, :cond_0

    sget-object v0, Ljava/lang/Boolean;->FALSE:Ljava/lang/Boolean;

    iput-object v0, p0, Lb0/h0;->k:Ljava/lang/Boolean;
    ...
    :cond_0
    iget-object p0, p0, Lb0/h0;->k:Ljava/lang/Boolean;
...
.method public final z()Z
    ...
    iget-object v0, p0, Lb0/h0;->i:Ljava/lang/Boolean;

    if-nez v0, :cond_0

    sget-object v0, Ljava/lang/Boolean;->FALSE:Ljava/lang/Boolean;

    iput-object v0, p0, Lb0/h0;->i:Ljava/lang/Boolean;
    ...
    :cond_0
    iget-object p0, p0, Lb0/h0;->i:Ljava/lang/Boolean;
