...
.method public final checkCloudDataByWorkspace(Ljava/lang/String;I)Ljava/lang/String;
    ...
    :cond_0
    invoke-virtual {p0, p2, p1}, Lb0/a;->checkValueValidByWorkspace(ILjava/lang/String;)Ljava/lang/String;
...
.method public final checkValueValidByWorkspace(ILjava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p0}, Lb0/a;->getItems()Ljava/util/List;

    move-result-object p1

    invoke-virtual {p0, p2}, Lb0/a;->h(Ljava/lang/String;)I
...
.method public final h(Ljava/lang/String;)I
    ...
    :pswitch_0
    sget v2, LZ9/f;->cinematic_lut_color_effect_tc:I

    goto/16 :goto_2

    :pswitch_1
    sget v2, LZ9/f;->cinematic_lut_color_effect_rh:I

    goto/16 :goto_2

    :pswitch_2
    sget v2, LZ9/f;->color_effect_entry_slack:I

    goto/16 :goto_2

    :pswitch_3
    sget v2, LZ9/f;->color_effect_entry_old_roadway:I

    goto/16 :goto_2

    :pswitch_4
    sget v2, LZ9/f;->color_effect_entry_jingdu:I

    goto/16 :goto_2

    :pswitch_5
    sget v2, LZ9/f;->color_effect_entry_monsoon:I

    goto/16 :goto_2

    :pswitch_6
    sget v2, LZ9/f;->color_effect_entry_reversal:I

    goto/16 :goto_2

    :pswitch_7
    sget v2, LZ9/f;->color_effect_entry_blackgold:I

    goto/16 :goto_2

    :pswitch_8
    sget v2, LZ9/f;->color_effect_entry_vivid:I

    goto/16 :goto_2

    :pswitch_9
    sget v2, LZ9/f;->cinematic_lut_color_effect_fbld:I
    ...
    sget v2, LZ9/f;->color_effect_entry_lc_blue:I

    goto/16 :goto_2

    :cond_1f
    sget v2, LZ9/f;->color_effect_entry_l_blue_new:I

    goto/16 :goto_2

    :pswitch_b
    sget v2, LZ9/f;->color_effect_entry_l_brown_new:I
    ...
    sget v2, LZ9/f;->color_effect_entry_lc_bw_hc:I

    goto/16 :goto_2

    :cond_20
    sget v2, LZ9/f;->color_effect_entry_monochrom_high_contrast_new:I
    ...
    sget v2, LZ9/f;->color_effect_entry_lc_bw_nat:I

    goto :goto_2

    :cond_21
    sget v2, LZ9/f;->color_effect_entry_monochrom_new:I
    ...
    sget v2, LZ9/f;->color_effect_entry_lc_nat:I

    goto :goto_2

    :cond_22
    sget v2, LZ9/f;->color_effect_entry_l_natrural_new:I

    goto :goto_2

    :cond_23
    sget v2, LZ9/f;->portait_effect_entry_nature:I
    ...
    sget v2, LZ9/f;->color_effect_entry_lc_viv:I

    goto :goto_2

    :cond_24
    sget v2, LZ9/f;->color_effect_entry_l_vivid_new:I

    goto :goto_2

    :pswitch_10
    sget v2, LZ9/f;->color_effect_entry_clearness:I

    goto :goto_2

    :pswitch_11
    sget v2, LZ9/f;->color_effect_entry_freshness:I

    goto :goto_2

    :pswitch_12
    sget v2, LZ9/f;->color_effect_entry_bright_shining:I

    goto :goto_2

    :pswitch_13
    sget v2, LZ9/f;->color_effect_entry_whitening:I

    goto :goto_2

    :pswitch_14
    sget v2, LZ9/f;->color_effect_entry_butter:I

    goto :goto_2

    :pswitch_15
    sget v2, LZ9/f;->color_effect_entry_freehand_brushwork:I

    goto :goto_2

    :pswitch_16
    sget v2, LZ9/f;->color_effect_entry_besson:I

    goto :goto_2

    :pswitch_17
    sget v2, LZ9/f;->color_effect_entry_hanjiao:I

    goto :goto_2

    :pswitch_18
    sget v2, LZ9/f;->color_effect_entry_classic:I
    ...
    :pswitch_1a
    sget v2, LZ9/f;->portait_effect_entry_cold_white:I

    goto :goto_2

    :pswitch_1b
    sget v2, LZ9/f;->portait_effect_entry_essence:I

    goto :goto_2

    :pswitch_1c
    sget v2, LZ9/f;->coloreffect_cloud_entry_none:I

    goto :goto_2

    :pswitch_1d
    sget v2, LZ9/f;->color_effect_entry_cc:I

    goto :goto_2

    :pswitch_1e
    sget v2, LZ9/f;->color_effect_entry_nc:I
