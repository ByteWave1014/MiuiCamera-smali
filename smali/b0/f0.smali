...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lb0/f0;->f:Ljava/util/ArrayList;
...
.method public static h(F)Landroid/util/Range;
    ...
    iget v5, v0, Lb0/f0;->b:I

    invoke-virtual {v2, v5}, LF3/f;->Q(I)LZ5/d;
    ...
    invoke-virtual {v1, v2}, Lf0/j;->v(I)F
    ...
    invoke-virtual {v1}, Lf0/j;->t()Ljava/lang/Float;
    ...
    iget-object v1, v0, Lb0/f0;->d:Ljava/util/HashMap;

    if-nez v1, :cond_6

    :cond_5
    invoke-virtual {v0}, Lb0/f0;->j()V
...
.method public final b(Ljava/lang/Object;)V
    ...
    :cond_1
    invoke-virtual {p0}, Lb0/f0;->getItems()Ljava/util/List;
...
.method public final getItems()Ljava/util/List;
    ...
    sget v6, LZ9/f;->street_auto_desc:I
    ...
    sget-object v3, LZ5/P;->r:LZ5/P$i;

    invoke-virtual {v3}, LC9/f;->d()Ljava/lang/Object;
    ...
    sget v3, LZ9/f;->street_near_desc:I
    ...
    sget v3, LZ9/f;->street_middle_desc:I
    ...
    sget v3, LZ9/f;->street_far_desc:I
...
.method public final j()V
    ...
    iget v3, p0, Lb0/f0;->b:I

    invoke-virtual {v2, v3}, LF3/f;->Q(I)LZ5/d;
    ...
    :cond_1
    iget-object v5, v2, LZ5/d;->S5:[F

    if-nez v5, :cond_5

    sget-object v5, Ln6/h;->R3:Ln6/K;

    const v6, 0xbabe

    iget-object v7, v2, LZ5/d;->d:Landroid/hardware/camera2/CameraCharacteristics;
    ...
    :cond_6
    iput-object v2, p0, Lb0/f0;->c:[F

    array-length v5, v2

    if-le v5, v0, :cond_b

    iget-object v5, p0, Lb0/f0;->d:Ljava/util/HashMap;
    ...
    iput-object v5, p0, Lb0/f0;->d:Ljava/util/HashMap;
    ...
    iget-object v8, p0, Lb0/f0;->d:Ljava/util/HashMap;
    ...
    invoke-virtual {v0}, L渭渡渣湠渣渧湠渪渫游渧渭渫湠渭渡渣渣渡渠湠渍渡渣渣渡渠;->b1()Landroid/util/SparseArray;
