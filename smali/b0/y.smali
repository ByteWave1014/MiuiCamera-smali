...
.method public final b(Ljava/lang/Object;)V
    ...
    iput-object v2, p0, Lb0/y;->b:LZ5/d;

    iget-object v3, v2, LZ5/d;->V1:Ljava/lang/Boolean;
    ...
    iput-object v3, v2, LZ5/d;->V1:Ljava/lang/Boolean;
    ...
    :cond_3
    iget-object v3, v2, LZ5/d;->W1:Ljava/lang/Boolean;
    ...
    iget-object v4, v2, LZ5/d;->d:Landroid/hardware/camera2/CameraCharacteristics;
    ...
    iput-object v3, v2, LZ5/d;->W1:Ljava/lang/Boolean;

    :cond_6
    iget-object v2, v2, LZ5/d;->W1:Ljava/lang/Boolean;
    ...
    invoke-interface {v0, v6}, Lc4/i;->J(Ljava/lang/String;)I
    ...
    invoke-interface {v0, v6}, Lc4/i;->M(Ljava/lang/String;)I

    move-result v1

    iput v1, p1, Lcom/android/camera/data/data/d;->g:I

    sget v1, LZ9/f;->portrait_mode_item_title1:I

    iput v1, p1, Lcom/android/camera/data/data/d;->k:I

    invoke-static {v2, p1}, LA/N;->c(Ljava/util/ArrayList;Lcom/android/camera/data/data/d;)Lcom/android/camera/data/data/d;
    ...
    invoke-interface {v0, v5}, Lc4/i;->J(Ljava/lang/String;)I
    ...
    invoke-interface {v0, v5}, Lc4/i;->M(Ljava/lang/String;)I

    move-result v0

    iput v0, p1, Lcom/android/camera/data/data/d;->g:I

    sget v0, LZ9/f;->portrait_mode_item_title2:I
    ...
    invoke-virtual {p1}, L渭渡渣湠渣渧湠渪渫游渧渭渫湠渭渡渣渣渡渠湠渍渡渣渣渡渠;->P3()Z
    ...
    invoke-interface {v0, v6}, Lc4/i;->e0(Ljava/lang/String;)I
    ...
    invoke-interface {v0, v6}, Lc4/i;->c(Ljava/lang/String;)I

    move-result v1

    iput v1, p1, Lcom/android/camera/data/data/d;->g:I

    sget v1, LZ9/f;->cvtype_item_btn_title2:I
    ...
    invoke-interface {v0, v5}, Lc4/i;->e0(Ljava/lang/String;)I
    ...
    invoke-interface {v0, v5}, Lc4/i;->c(Ljava/lang/String;)I

    move-result v0

    iput v0, p1, Lcom/android/camera/data/data/d;->g:I

    sget v0, LZ9/f;->cvtype_item_btn_title1:I
...
.method public final getContentDescriptionString()I
    ...
    sget p0, LZ9/f;->config_name_photography_style:I
...
.method public final getDisableReasonString(Landroid/content/Context;)Ljava/lang/String;
    ...
    :cond_1
    iget-object v1, p0, Lb0/y;->b:LZ5/d;

    iget v2, p0, Lcom/android/camera/data/data/c;->mCurrentMode:I

    invoke-static {v2, v1}, Lcom/android/camera/data/data/l;->e0(ILZ5/d;)Z

    move-result v1

    if-eqz v1, :cond_2

    sget p0, LZ9/f;->pref_camera_picture_format_ultra_raw:I
    ...
    sget p0, LZ9/f;->pref_camera_picture_format_raw:I
    ...
    :cond_4
    sget v0, LZ9/f;->cv_type_switch_diabled_tip_content:I
...
.method public final getDisplayTitleString()I
    ...
    sget p0, LZ9/f;->manual_picture_style_new:I
...
.method public final getKey(I)Ljava/lang/String;
    ...
    const-string p0, "pref_camera_cv_type_key_"
...
.method public final j(Ljava/lang/String;)I
    ...
    sget p0, LZ9/f;->portrait_cvtype_item_title2:I

    goto :goto_0

    :cond_0
    sget p0, LZ9/f;->portrait_cvtype_item_title1:I
    ...
    sget p0, LZ9/f;->tip_cvtype_title2:I

    return p0

    :cond_2
    sget p0, LZ9/f;->tip_cvtype_title1:I
