...
.method public final b(Ljava/lang/Object;)V
    ...
    iget-object v4, p1, Lcom/android/camera/data/data/x;->c:LZ5/d;

    const/16 v5, 0xa2

    if-ne v3, v5, :cond_0

    sget-object v3, Ln6/h;->Z3:Ln6/K;

    invoke-virtual {v3}, Ln6/K;->b()Ljava/lang/String;

    move-result-object v3

    invoke-virtual {v4, v3}, LZ5/d;->B0(Ljava/lang/String;)Z
    ...
    invoke-static {v5, v1}, Lic/f;->c(Ljava/lang/String;Z)Z
    ...
    invoke-static {v4}, LZ5/e;->Q3(LZ5/d;)Ljava/util/ArrayList;
    ...
    :goto_5
    iput-boolean v3, p0, Lf0/u;->b:Z

    iget-object v3, v4, LZ5/d;->G6:[F

    if-nez v3, :cond_9

    new-array v3, v1, [F

    iput-object v3, v4, LZ5/d;->G6:[F

    invoke-virtual {v4}, LZ5/d;->r()[Ljava/lang/Float;
    ...
    iput v0, p0, Lf0/u;->d:F

    aget v0, p1, v2

    iput v0, p0, Lf0/u;->c:F

    iput-object p1, p0, Lf0/u;->e:[F

    goto :goto_8

    :cond_a
    iput-boolean v1, p0, Lf0/u;->b:Z
...
.method public final getDisplayTitleString()I
    ...
    sget p0, LZ9/f;->pref_camera_close_focus_preferred_title:I
