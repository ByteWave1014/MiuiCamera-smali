...
.method public constructor <init>(Lf0/q0;)V
    ...
    iput-object p1, p0, Lf0/i0;->e:[F

    new-instance p1, Ljava/util/concurrent/CopyOnWriteArrayList;

    invoke-direct {p1}, Ljava/util/concurrent/CopyOnWriteArrayList;-><init>()V

    iput-object p1, p0, Lf0/i0;->g:Ljava/util/concurrent/CopyOnWriteArrayList;

    new-instance p1, Landroid/util/SparseArray;

    invoke-direct {p1}, Landroid/util/SparseArray;-><init>()V

    iput-object p1, p0, Lf0/i0;->h:Landroid/util/SparseArray;

    new-instance p1, Landroid/util/SparseArray;

    invoke-direct {p1}, Landroid/util/SparseArray;-><init>()V

    iput-object p1, p0, Lf0/i0;->i:Landroid/util/SparseArray;
...
.method public static j(I)F
    ...
    invoke-static {p0}, LZ5/e;->o(LZ5/d;)F
...
.method public final b(Ljava/lang/Object;)V
    ...
    iput v2, v6, Lf0/i0;->a:I

    iget-object v0, v0, Lcom/android/camera/data/data/x;->c:LZ5/d;

    iput-object v0, v6, Lcom/android/camera/data/data/c;->mCapabilities:LZ5/d;

    const/4 v0, 0x0

    iput-object v0, v6, Lf0/i0;->c:[F

    iput-object v0, v6, Lf0/i0;->d:[F

    invoke-virtual {v6, v1}, Lf0/i0;->isSupportMode(I)Z

    move-result v0

    if-eqz v0, :cond_17

    iget v0, v6, Lf0/i0;->a:I

    if-nez v0, :cond_17

    iget-object v9, v6, Lf0/i0;->h:Landroid/util/SparseArray;
    ...
    invoke-virtual {v6, v0}, Lf0/i0;->p(I)V
    ...
    iget-object v11, v6, Lf0/i0;->e:[F

    aput v1, v11, v7

    const/4 v1, 0x3

    invoke-static {v0}, Lf0/i0;->j(I)F
    ...
    invoke-virtual {v0}, L渭渡渣湠渣渧湠渪渫游渧渭渫湠渭渡渣渣渡渠湠渍渡渣渣渡渠;->t1()Ljava/util/Map;
    ...
    :cond_c
    iget-object v13, v6, Lf0/i0;->g:Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    invoke-virtual {v8, v1}, Lf0/Z;->p(F)F
    ...
    invoke-virtual/range {v0 .. v5}, Lf0/i0;->h(IIFFZ)V
    ...
    iget-object v0, v6, Lf0/i0;->i:Landroid/util/SparseArray;
...
.method public final getComponentValueJudgeSelect(ILjava/lang/String;)Landroid/util/Pair;
    ...
    iget-object v9, p0, Lf0/i0;->c:[F

    invoke-static {p1}, Ljava/lang/Float;->parseFloat(Ljava/lang/String;)F

    move-result v10

    invoke-static {v9, v10, v4}, Lf0/o0;->j([FFZ)F
    ...
    invoke-static {v9, v10, v6}, Lf0/o0;->j([FFZ)F
    ...
    :pswitch_5
    invoke-virtual {p0, p1}, Lf0/i0;->getDefaultValue(I)Ljava/lang/String;
...
.method public final getDefaultValue(I)Ljava/lang/String;
    ...
    invoke-virtual {v1, v3, v4}, Lea/a;->q(Ljava/lang/String;Ljava/lang/String;)Lea/a;
    ...
    :cond_4
    invoke-virtual {p0}, Lf0/i0;->isEmpty()Z

    move-result v1

    if-nez v1, :cond_5

    invoke-virtual {p0, v0}, Lf0/i0;->l(Ljava/lang/String;)F
...
.method public final getItems()Ljava/util/List;
    ...
    iget-object v0, p0, Lf0/i0;->h:Landroid/util/SparseArray;
...
.method public final h(IIFFZ)V
    ...
    iget-object v0, p0, Lf0/i0;->g:Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    :cond_1
    iget-object p5, p0, Lf0/i0;->d:[F

    const v1, 0x3dcccccd    # 0.1f

    if-eqz p5, :cond_3

    iget-object v4, p0, Lf0/i0;->c:[F
    ...
    iget-object v4, p0, Lf0/i0;->d:[F

    aget v4, v4, p5

    iget-object v5, p0, Lf0/i0;->e:[F
...
.method public final i(F)Ljava/lang/String;
    ...
    invoke-virtual {p0}, Lf0/i0;->getItems()Ljava/util/List;
...
.method public final isSupportMode(I)Z
    ...
    invoke-virtual {v3, p1}, LG7/b;->Z0(I)Z
    ...
    iget-boolean p1, p0, Lf0/i0;->f:Z

    if-nez p1, :cond_6

    iget p0, p0, Lf0/i0;->a:I
...
.method public final k(FIZ)I
    ...
    iget-object v0, p0, Lf0/i0;->i:Landroid/util/SparseArray;
    ...
    invoke-static {v3, v2}, Landroidx/appcompat/app/h;->h(ILjava/util/ArrayList;)Ljava/lang/Object;
...
.method public final p(I)V
    ...
    iget-object p1, p1, Lf0/c0;->f:[F

    iput-object p1, p0, Lf0/i0;->d:[F
