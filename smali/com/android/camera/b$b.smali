...
.method public static j(Landroid/util/SparseArray;Landroid/util/SparseArray;)Z
    ...
    invoke-virtual {v4, v3}, Li6/e;->equals(Ljava/lang/Object;)Z
...
.method public final a(Landroid/util/SparseArray;II)Landroid/util/SparseArray;
    ...
    iget-object v0, p0, Lcom/android/camera/b$b;->b:Laa/r;

    if-eqz v0, :cond_1

    invoke-virtual {v0}, Laa/r;->k()Z
    ...
    iget-object v3, p0, Lcom/android/camera/b$b;->b:Laa/r;
    ...
    iget-object p1, p0, Lcom/android/camera/b$b;->b:Laa/r;

    iget-object v0, p1, Laa/r;->j:Ljava/lang/Object;
    ...
    iget-object p2, p1, Laa/r;->j:Ljava/lang/Object;
    ...
    :try_start_8
    iget-object p1, p1, Laa/r;->e:Landroid/util/SparseArray;
    ...
    :try_start_9
    invoke-static {p1}, Li6/d;->b(Landroid/util/SparseArray;)Landroid/util/SparseArray;
    ...
    :cond_2
    iget-object v4, v3, Laa/r;->j:Ljava/lang/Object;
    ...
    :try_start_10
    iget-object v5, v3, Laa/r;->e:Landroid/util/SparseArray;
    ...
    iget-object v0, v3, Laa/r;->j:Ljava/lang/Object;
    ...
    iput-object v3, p0, Lcom/android/camera/b$b;->b:Laa/r;
    ...
    :try_start_16
    iget-object v3, v3, Laa/r;->e:Landroid/util/SparseArray;
    ...
    :try_start_17
    invoke-static {v3}, Li6/d;->b(Landroid/util/SparseArray;)Landroid/util/SparseArray;
    ...
    invoke-virtual {p0}, Lcom/android/camera/b$b;->f()Laa/r;

    move-result-object v1

    iget-object v3, v1, Laa/r;->j:Ljava/lang/Object;
    ...
    :try_start_21
    iget-object p2, v1, Laa/r;->j:Ljava/lang/Object;
    ...
    iget-object p2, p0, Lcom/android/camera/b$b;->b:Laa/r;
    ...
    iput-object v1, p0, Lcom/android/camera/b$b;->b:Laa/r;

    invoke-virtual {v1, p1}, Laa/r;->n(Landroid/util/SparseArray;)Landroid/util/SparseArray;
...
.method public final b(Lcom/xiaomi/engine/BufferFormat;)V
    ...
    invoke-virtual {p0}, Lcom/android/camera/b$b;->c()Laa/r;
    ...
    iget-object v5, p0, Laa/r;->j:Ljava/lang/Object;

    monitor-enter v5

    :try_start_0
    iget-object v6, p0, Laa/r;->c:Ljava/util/HashMap;
    ...
    invoke-virtual {v6}, Laa/k;->n()Z

    move-result v7

    if-nez v7, :cond_3

    invoke-virtual {v6}, Laa/k;->x()Z

    move-result v7

    if-eqz v7, :cond_3

    iget-object p1, p0, Laa/r;->b:Laa/k;

    if-eq p1, v6, :cond_2

    if-eqz p1, :cond_1

    invoke-virtual {p1}, Laa/k;->w()V
    ...
    :cond_1
    :goto_0
    iput-object v6, p0, Laa/r;->b:Laa/k;
    ...
    :cond_3
    iget-object v4, p0, Laa/r;->b:Laa/k;

    if-eqz v4, :cond_4

    invoke-virtual {v4}, Laa/k;->w()V
    ...
    iget-object v6, p0, Laa/r;->E:Laa/r$e;

    invoke-direct {v4, v6, p1}, Laa/f;-><init>(Laa/r$e;Lcom/xiaomi/engine/BufferFormat;)V
    ...
    invoke-direct {v4, v6, p1}, Laa/a;-><init>(Laa/r$e;Lcom/xiaomi/engine/BufferFormat;)V

    :goto_1
    iget v6, p0, Laa/r;->a:I

    if-lez v6, :cond_7

    iput v6, v4, Laa/k;->a:I

    :cond_7
    iput v6, v4, Laa/k;->e:I

    invoke-virtual {v4}, Laa/a;->J()V

    invoke-virtual {v4, p1}, Laa/k;->b(Lcom/xiaomi/engine/BufferFormat;)Ljava/util/ArrayList;

    move-result-object v6

    iget-object v7, p0, Laa/r;->A:Laa/r$a;
    ...
    invoke-virtual {p0, v3}, Laa/b;->i(I)V
...
.method public final f()Laa/r;
    ...
    invoke-direct {v0, v1}, Laa/r;-><init>(Lcom/android/camera/b$a;)V
...
.method public final k()Z
    ...
    iget-object v2, p0, Laa/r;->b:Laa/k;

    iget-object v3, p0, Laa/r;->m:Ljava/lang/Object;

    monitor-enter v3

    :try_start_0
    iget-object v4, p0, Laa/r;->k:Ljava/util/HashMap;
    ...
    iget-object v7, v6, Laa/o;->P:Ljava/lang/Object;
    ...
    invoke-virtual {p0, v5}, Laa/k;->o(I)Z
...
.method public final l(Lcom/xiaomi/protocol/ICustomCaptureResult;Z)V
    ...
    invoke-virtual {p0, p1, p2}, Laa/m;->e(Lcom/xiaomi/protocol/ICustomCaptureResult;Z)V
...
.method public final m(IJ)V
    ...
    iget-object p0, p0, Laa/r;->B:Laa/r$b;

    const/4 v2, 0x1

    invoke-direct {v1, p2, p3, p0, v2}, Laa/u;-><init>(JLaa/r$b;Z)V
    ...
    iget-object p0, p1, Laa/m;->a:Landroid/os/HandlerThread;
    ...
    iget-object p0, p1, Laa/m;->b:Laa/m$a;
    ...
    iget-object p2, p1, Laa/m;->b:Laa/m$a;
    ...
    invoke-virtual {p1, v1}, Laa/m;->h(Laa/u;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final n(Laa/o;)V
    .locals 17

    move-object/from16 v0, p1

    invoke-virtual/range {p0 .. p0}, Lcom/android/camera/b$b;->c()Laa/r;
    ...
    iget-object v1, v1, Laa/r;->o:Laa/r$g;

    iget-object v3, v1, Laa/r$g;->a:Laa/r;
    ...
    invoke-virtual {v4, v5, v6}, Laa/b;->f(II)I

    move-result v4

    iput v4, v3, Laa/r;->z:I

    iget-wide v11, v0, Laa/o;->e:J

    iget-object v3, v0, Laa/o;->L:LG9/d;
    ...
    iget-boolean v4, v0, Laa/o;->G:Z

    const/4 v15, 0x1

    if-nez v4, :cond_2

    iget-object v4, v1, Laa/r$g;->a:Laa/r;

    invoke-static {v4, v11, v12, v0}, Laa/r;->f(Laa/r;JLaa/o;)V

    iget-object v4, v0, Laa/o;->x0:Lcom/android/camera/module/Camera2Module$d;
    ...
    :cond_0
    iget v4, v0, Laa/o;->A:I

    const/4 v7, 0x4

    if-eq v4, v7, :cond_1

    iput-boolean v15, v0, Laa/o;->z:Z

    :cond_1
    iget-object v4, v1, Laa/r$g;->a:Laa/r;

    iget-object v4, v4, Laa/r;->b:Laa/k;

    iput-object v4, v0, Laa/o;->P:Ljava/lang/Object;
    ...
    :goto_0
    iget v10, v0, Laa/o;->B:I

    iget-boolean v14, v0, Laa/o;->G:Z

    new-instance v6, LG9/b;

    iget v8, v0, Laa/o;->A:I

    iget-object v13, v0, Laa/o;->a0:Ljava/lang/String;
    ...
    invoke-direct/range {v7 .. v15}, LG9/b;-><init>(IIIJLjava/lang/String;ZLaa/k;)V

    iget v4, v0, Laa/o;->k0:I

    iput v4, v6, LG9/b;->x:I

    iget-object v4, v1, Laa/r$g;->a:Laa/r;

    iget-object v4, v4, Laa/r;->B:Laa/r$b;

    iput-object v4, v6, LG9/b;->q:Laa/r$b;

    iget-boolean v4, v0, Laa/o;->J:Z

    iput-boolean v4, v6, LG9/b;->l:Z

    iput-object v3, v6, LG9/b;->o:LG9/d;

    iget-object v3, v0, Laa/o;->i0:LG9/a;

    iput-object v3, v6, LG9/b;->v:LG9/a;

    iget-boolean v3, v0, Laa/o;->O:Z

    iput-boolean v3, v6, LG9/b;->m:Z
    ...
    invoke-static {v3, v15}, LA/P;->f(Ljava/lang/String;Z)Ljava/lang/String;
    ...
    iput-boolean v15, v6, LG9/b;->s:Z

    :cond_5
    sget-object v3, Laa/m$e;->a:Laa/m;

    iget-object v3, v3, Laa/m;->b:Laa/m$a;
    ...
    invoke-direct {v2, v4, v1, v6, v0}, Laa/t;-><init>(ILjava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)V
