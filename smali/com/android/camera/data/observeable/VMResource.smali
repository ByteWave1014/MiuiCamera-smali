...
.method public static synthetic a(Ljava/lang/String;LI3/a;)Lio/reactivex/ObservableSource;
    .locals 0

    invoke-static {p0, p1}, Lcom/android/camera/data/observeable/VMResource;->lambda$startAndGetDownloadDisposable$0(Ljava/lang/String;LI3/a;)Lio/reactivex/ObservableSource;
...
.method private checkStatus(Landroidx/fragment/app/FragmentActivity;)Z
    ...
    invoke-static {p1, p0, v1}, LA/g4;->c(Landroid/content/Context;IZ)V
...
.method private static lambda$startAndGetDownloadDisposable$0(Ljava/lang/String;LI3/a;)Lio/reactivex/ObservableSource;
    .locals 2
    ...
    invoke-direct {v0, v1, p0}, Lc4/s;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    iget-object p0, p1, LI3/a;->b:Lcom/android/camera/resource/BaseResourceItem;

    invoke-virtual {v0, p0}, Lc4/a;->h(Ljava/lang/Object;)Lio/reactivex/Observable;
...
.method private static lambda$startAndGetDownloadDisposable$1(Lcom/android/camera/resource/BaseResourceItem;)Lio/reactivex/ObservableSource;
    ...
    iput-object v1, v0, Lc4/p;->c:Ljava/lang/String;

    iput-object v2, v0, Lc4/p;->d:Ljava/lang/String;
...
.method public startAndGetDownloadDisposable(Lcom/android/camera/resource/BaseResourceItem;Landroidx/fragment/app/FragmentActivity;Lio/reactivex/ObservableEmitter;Z)Lio/reactivex/disposables/Disposable;
    ...
    invoke-virtual {p2, v1, v0}, LUb/h;->c(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    invoke-direct {v0, v1, p2}, Lc4/s;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {v0, p1}, Lc4/a;->h(Ljava/lang/Object;)Lio/reactivex/Observable;
    ...
    invoke-direct {v0, v2}, Lc4/r;-><init>(Ljava/lang/String;)V

    const-string v2, "id"

    invoke-virtual {v0, v2, v1}, Lc4/r;->i(Ljava/lang/String;Ljava/lang/String;)V

    iput-object p1, v0, LI3/b;->g:Lcom/android/camera/resource/BaseResourceItem;

    const-class v1, LI3/a;

    invoke-virtual {v0, v1}, Lc4/a;->g(Ljava/lang/Class;)Lio/reactivex/Observable;
    ...
    invoke-direct {v1, p2, v2}, Lh0/d;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-direct {v1, p3, v2}, LX2/d;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-direct {v0, p0, p4, p2}, Lh0/f;-><init>(Lcom/android/camera/data/observeable/VMResource;ZLjava/lang/String;)V

    new-instance p2, Lh0/g;

    invoke-direct {p2, p0, p1}, Lh0/g;-><init>(Lcom/android/camera/data/observeable/VMResource;Lcom/android/camera/resource/BaseResourceItem;)V
