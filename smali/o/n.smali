...
.method public constructor <init>(Lm/j;Lu/b;Lt/j;)V
    ...
    iput-object v0, p0, Lo/n;->m:Lo/b;

    iput-object p1, p0, Lo/n;->c:Lm/j;
    ...
    iget-boolean v0, p3, Lt/j;->j:Z

    iput-boolean v0, p0, Lo/n;->e:Z

    iget-object v0, p3, Lt/j;->c:Ls/b;
    ...
    iput-object v1, p0, Lo/n;->f:Lp/c;

    iget-object v1, p3, Lt/j;->d:Ls/l;

    invoke-interface {v1}, Ls/l;->a()Lp/a;

    move-result-object v1

    iput-object v1, p0, Lo/n;->g:Lp/a;

    iget-object v2, p3, Lt/j;->e:Ls/b;

    invoke-virtual {v2}, Ls/b;->a()Lp/a;
    ...
    iput-object v3, p0, Lo/n;->h:Lp/c;

    iget-object v3, p3, Lt/j;->g:Ls/b;

    invoke-virtual {v3}, Ls/b;->a()Lp/a;
    ...
    iput-object v4, p0, Lo/n;->j:Lp/c;

    iget-object v4, p3, Lt/j;->i:Ls/b;

    invoke-virtual {v4}, Ls/b;->a()Lp/a;
    ...
    iput-object v5, p0, Lo/n;->l:Lp/c;

    const/4 v5, 0x1

    if-ne p1, v5, :cond_0

    iget-object v6, p3, Lt/j;->f:Ls/b;

    invoke-virtual {v6}, Ls/b;->a()Lp/a;

    move-result-object v6

    check-cast v6, Lp/c;

    iput-object v6, p0, Lo/n;->i:Lp/c;

    iget-object p3, p3, Lt/j;->h:Ls/b;

    invoke-virtual {p3}, Ls/b;->a()Lp/a;

    move-result-object p3

    check-cast p3, Lp/c;

    iput-object p3, p0, Lo/n;->k:Lp/c;
    ...
    iput-object p3, p0, Lo/n;->i:Lp/c;

    iput-object p3, p0, Lo/n;->k:Lp/c;

    :goto_0
    invoke-virtual {p2, v0}, Lu/b;->e(Lp/a;)V

    invoke-virtual {p2, v1}, Lu/b;->e(Lp/a;)V

    invoke-virtual {p2, v2}, Lu/b;->e(Lp/a;)V

    invoke-virtual {p2, v3}, Lu/b;->e(Lp/a;)V

    invoke-virtual {p2, v4}, Lu/b;->e(Lp/a;)V

    if-ne p1, v5, :cond_1

    iget-object p3, p0, Lo/n;->i:Lp/c;

    invoke-virtual {p2, p3}, Lu/b;->e(Lp/a;)V

    iget-object p3, p0, Lo/n;->k:Lp/c;
    ...
    invoke-virtual {v2, p0}, Lp/a;->a(Lp/a$a;)V

    invoke-virtual {v3, p0}, Lp/a;->a(Lp/a$a;)V

    invoke-virtual {v4, p0}, Lp/a;->a(Lp/a$a;)V

    if-ne p1, v5, :cond_2

    iget-object p1, p0, Lo/n;->i:Lp/c;

    invoke-virtual {p1, p0}, Lp/a;->a(Lp/a$a;)V

    iget-object p1, p0, Lo/n;->k:Lp/c;
...
.method public final b(Ljava/util/List;Ljava/util/List;)V
    ...
    iget-object v1, v0, Lo/s;->c:Lt/r$a;

    sget-object v2, Lt/r$a;->a:Lt/r$a;

    if-ne v1, v2, :cond_0

    iget-object v1, p0, Lo/n;->m:Lo/b;
    ...
    invoke-virtual {v0, p0}, Lo/s;->c(Lp/a$a;)V
...
.method public final f()V
    ...
    iput-boolean v0, p0, Lo/n;->n:Z

    iget-object p0, p0, Lo/n;->c:Lm/j;
...
.method public final g(Ljava/lang/Object;Lz/c;)V
    ...
    sget-object v0, Lm/p;->o:Ljava/lang/Float;

    if-ne p1, v0, :cond_0

    iget-object p0, p0, Lo/n;->f:Lp/c;
    ...
    :cond_0
    sget-object v0, Lm/p;->p:Ljava/lang/Float;
    ...
    :cond_2
    sget-object v0, Lm/p;->q:Ljava/lang/Float;

    if-ne p1, v0, :cond_3

    iget-object v0, p0, Lo/n;->i:Lp/c;
    ...
    :cond_3
    sget-object v0, Lm/p;->r:Ljava/lang/Float;

    if-ne p1, v0, :cond_4

    iget-object p0, p0, Lo/n;->j:Lp/c;
    ...
    :cond_4
    sget-object v0, Lm/p;->s:Ljava/lang/Float;

    if-ne p1, v0, :cond_5

    iget-object v0, p0, Lo/n;->k:Lp/c;
    ...
    :cond_5
    sget-object v0, Lm/p;->t:Ljava/lang/Float;

    if-ne p1, v0, :cond_6

    iget-object p0, p0, Lo/n;->l:Lp/c;
...
.method public final getName()Ljava/lang/String;
    ...
    iget-object p0, p0, Lo/n;->b:Ljava/lang/String;
...
.method public final getPath()Landroid/graphics/Path;
    ...
    iget-boolean v1, v0, Lo/n;->n:Z

    iget-object v9, v0, Lo/n;->a:Landroid/graphics/Path;
    ...
    iget-boolean v1, v0, Lo/n;->e:Z

    const/4 v10, 0x1

    if-eqz v1, :cond_1

    iput-boolean v10, v0, Lo/n;->n:Z
    ...
    iget-object v11, v0, Lo/n;->g:Lp/a;

    iget-object v3, v0, Lo/n;->j:Lp/c;

    const/high16 v4, 0x42c80000    # 100.0f

    iget-object v5, v0, Lo/n;->l:Lp/c;
    ...
    iget-object v8, v0, Lo/n;->h:Lp/c;

    iget-object v2, v0, Lo/n;->f:Lp/c;
    ...
    :cond_5
    invoke-virtual/range {v20 .. v20}, Lp/a;->f()Ljava/lang/Object;
    ...
    invoke-static {v8, v6, v0, v6}, LA/y3;->a(FFFF)F
    ...
    iget-object v1, v0, Lo/n;->m:Lo/b;

    invoke-virtual {v1, v9}, Lo/b;->a(Landroid/graphics/Path;)V

    const/4 v1, 0x1

    iput-boolean v1, v0, Lo/n;->n:Z
