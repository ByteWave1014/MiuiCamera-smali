...
.method public constructor <init>(Lt/h;)V
    ...
    iput-object v0, p0, Lo/l;->a:Landroid/graphics/Path;

    new-instance v0, Landroid/graphics/Path;

    invoke-direct {v0}, Landroid/graphics/Path;-><init>()V

    iput-object v0, p0, Lo/l;->b:Landroid/graphics/Path;

    new-instance v0, Landroid/graphics/Path;

    invoke-direct {v0}, Landroid/graphics/Path;-><init>()V

    iput-object v0, p0, Lo/l;->c:Landroid/graphics/Path;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lo/l;->d:Ljava/util/ArrayList;

    invoke-virtual {p1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iput-object p1, p0, Lo/l;->e:Lt/h;
...
.method public final b(Ljava/util/List;Ljava/util/List;)V
    ...
    :goto_0
    iget-object v1, p0, Lo/l;->d:Ljava/util/ArrayList;
...
.method public final c(Landroid/graphics/Path$Op;)V
    ...
    iget-object v0, p0, Lo/l;->b:Landroid/graphics/Path;

    invoke-virtual {v0}, Landroid/graphics/Path;->reset()V

    iget-object v1, p0, Lo/l;->a:Landroid/graphics/Path;

    invoke-virtual {v1}, Landroid/graphics/Path;->reset()V

    iget-object v2, p0, Lo/l;->d:Ljava/util/ArrayList;
    ...
    invoke-virtual {v5}, Lo/d;->e()Ljava/util/List;
    ...
    invoke-interface {v8}, Lo/m;->getPath()Landroid/graphics/Path;
    ...
    invoke-virtual {v2}, Lo/d;->e()Ljava/util/List;
    ...
    :cond_6
    iget-object p0, p0, Lo/l;->c:Landroid/graphics/Path;
...
.method public final getPath()Landroid/graphics/Path;
    ...
    iget-object v0, p0, Lo/l;->c:Landroid/graphics/Path;

    invoke-virtual {v0}, Landroid/graphics/Path;->reset()V

    iget-object v1, p0, Lo/l;->e:Lt/h;
    ...
    invoke-virtual {p0, v1}, Lo/l;->c(Landroid/graphics/Path$Op;)V
