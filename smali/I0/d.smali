...
.method static constructor <clinit>()V
    ...
    sput-object v0, LI0/d;->m:Ljava/lang/String;
...
.method public constructor <init>(Lcom/android/camera/ActivityBase;)V
    ...
    iput-object v0, p0, LI0/d;->c:Ljava/util/HashMap;

    new-instance v0, LJ0/a;

    invoke-direct {v0, p1}, LJ0/a;-><init>(Lcom/android/camera/ActivityBase;)V

    iput-object v0, p0, LI0/d;->l:LJ0/a;
    ...
    invoke-direct {v0, p1, v1}, Lzb/a;-><init>(Landroid/content/ContextWrapper;Lzb/a$b$a;)V

    iput-object v0, p0, LI0/d;->e:Lzb/a;
    ...
    iput-object v0, p0, LI0/d;->f:Landroid/net/ConnectivityManager;

    new-instance v0, LI0/d$b;

    invoke-direct {v0}, Landroid/net/ConnectivityManager$NetworkCallback;-><init>()V

    iput-object v0, p0, LI0/d;->g:LI0/d$b;

    const/4 v0, 0x2

    invoke-static {p1, v0}, LCb/c;->q(Landroid/content/ContextWrapper;I)LCb/c;

    move-result-object p1

    iput-object p1, p0, LI0/d;->d:LCb/c;
...
# virtual methods
.method public final declared-synchronized Q(Ljava/util/HashSet;)I
    .locals 6
    ...
    iget-object v0, p0, LI0/d;->c:Ljava/util/HashMap;
    ...
    iget v4, v3, LI0/c;->h:I

    const/4 v5, 0x1

    if-ne v4, v5, :cond_0

    sget-object v4, LI0/d;->m:Ljava/lang/String;

    invoke-virtual {v3}, LI0/c;->toString()Ljava/lang/String;
...
.method public final declared-synchronized R(LI0/c;Z)V
    .locals 1
    .param p1    # LI0/c;
    ...
    :try_start_0
    iget-boolean v0, p0, LI0/d;->j:Z

    if-eq v0, p2, :cond_0

    iput-boolean p2, p0, LI0/d;->j:Z

    if-nez p2, :cond_0

    if-eqz p1, :cond_0

    iget-object p2, p0, LI0/d;->b:Lcom/xiaomi/microfilm/dualcam/mode/DualVideoModuleBase;

    if-eqz p2, :cond_0

    invoke-interface {p2, p1}, LI0/b;->onConnectivityStateChanged(LI0/c;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final declared-synchronized W()V
    ...
    :try_start_0
    iget-object v0, p0, LI0/d;->d:LCb/c;
...
.method public final declared-synchronized d0(Ljava/lang/String;Landroid/view/Surface;)V
    .locals 11
    ...
    sget-object v1, LL0/W;->e:Landroid/util/Size;
    ...
    sget-object v1, LI0/d;->m:Ljava/lang/String;
    ...
    iput-object v0, p0, LI0/d;->h:Ltv/danmaku/ijk/media/player/IjkMediaPlayer;
    ...
    iget-object v0, p0, LI0/d;->h:Ltv/danmaku/ijk/media/player/IjkMediaPlayer;
    ...
    iget-object p2, p0, LI0/d;->h:Ltv/danmaku/ijk/media/player/IjkMediaPlayer;
    ...
    invoke-static {v2, p2, v0, p1}, LFb/b;->e(ILjava/lang/String;Ljava/lang/String;Ljava/lang/Exception;)V
    :try_end_3
...
.method public final declared-synchronized i0()V
    ...
    invoke-static {v2, v1, v3, v0}, LFb/b;->e(ILjava/lang/String;Ljava/lang/String;Ljava/lang/Exception;)V
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
...
.method public final declared-synchronized l(I)V
    ...
    :try_start_0
    invoke-virtual {p0, p1}, LI0/d;->s(I)LI0/c;
    ...
    iput v2, v1, LI0/c;->i:I

    iget-object v2, p0, LI0/d;->b:Lcom/xiaomi/microfilm/dualcam/mode/DualVideoModuleBase;

    if-eqz v2, :cond_0

    invoke-interface {v2, v1}, LI0/b;->onConnectivityStateChanged(LI0/c;)V
    ...
    :cond_0
    :goto_0
    iget-object v1, p0, LI0/d;->d:LCb/c;
    ...
    invoke-virtual {v0, v1, p1}, Lic/e;->f(II)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final declared-synchronized o(I)V
    ...
    iput v1, v0, LI0/c;->i:I

    iget-object v1, p0, LI0/d;->b:Lcom/xiaomi/microfilm/dualcam/mode/DualVideoModuleBase;

    if-eqz v1, :cond_0

    invoke-interface {v1, v0}, LI0/b;->onConnectivityStateChanged(LI0/c;)V
...
.method public final declared-synchronized onConnectionResult(IILjava/lang/String;I)V
    ...
    invoke-static {p3}, LI0/c;->a(Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_0
    iget-object p2, p0, LI0/d;->c:Ljava/util/HashMap;
    ...
    :cond_1
    :goto_0
    invoke-virtual {p0, p2}, LI0/d;->s(I)LI0/c;
    ...
    sget-object p3, LI0/c;->j:Ljava/lang/String;

    invoke-static {v1, p3, p2}, Landroid/util/Log;->println(ILjava/lang/String;Ljava/lang/String;)I

    :goto_2
    iput-object v4, p1, LI0/c;->e:Ljava/lang/String;

    iput v3, p1, LI0/c;->f:I
...
.method public final declared-synchronized onDisconnection(II)V
    ...
    iput-object p2, p1, LI0/c;->e:Ljava/lang/String;

    const/4 p2, -0x1

    iput p2, p1, LI0/c;->f:I
...
.method public final declared-synchronized onEndpointFound(IILjava/lang/String;[B)V
    ...
    :cond_0
    iget-object p4, p0, LI0/d;->c:Ljava/util/HashMap;
    ...
    invoke-direct {p4, p2, p3}, LI0/c;-><init>(ILjava/lang/String;)V
    ...
    :cond_1
    invoke-static {p3}, LI0/c;->b(Ljava/lang/String;)Ljava/lang/String;

    move-result-object p1

    iput-object p1, p4, LI0/c;->d:Ljava/lang/String;
    ...
    iput-wide p1, p4, LI0/c;->g:J

    const/4 p1, 0x1

    iput p1, p4, LI0/c;->h:I

    iget-object p1, p0, LI0/d;->a:Lcom/xiaomi/microfilm/dualcam/mode/DualVideoModuleBase;

    if-eqz p1, :cond_2

    invoke-interface {p1, p4}, LI0/a;->onAvailabilityStateChanged(LI0/c;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final declared-synchronized onEndpointLost(IILjava/lang/String;)V
    ...
    invoke-direct {v0, p2, p3}, LI0/c;-><init>(ILjava/lang/String;)V
    ...
    invoke-interface {p1, v0}, LI0/a;->onAvailabilityStateChanged(LI0/c;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final declared-synchronized onPayloadReceived(II[B)V
    ...
    sget-object v2, LI0/c;->j:Ljava/lang/String;
...
.method public final registerProtocol()V
    ...
    iget-object v0, p0, LI0/d;->e:Lzb/a;

    invoke-virtual {v0}, Lzb/a;->a()V

    iget-object v0, p0, LI0/d;->f:Landroid/net/ConnectivityManager;
    ...
    iget-object v2, p0, LI0/d;->g:LI0/d$b;
    ...
    invoke-virtual {v0, p0}, LCb/c;->o(LCb/b;)V

    iget-object v0, p0, LI0/d;->d:LCb/c;

    invoke-virtual {v0}, LCb/c;->i()V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final declared-synchronized s(I)LI0/c;
    .locals 3
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
...
.method public final unRegisterProtocol()V
    ...
    invoke-virtual {p0}, LI0/d;->i0()V

    invoke-virtual {p0}, LI0/d;->f0()V
    ...
    iget-object v1, v0, Lzb/a;->c:Lzb/a$a;

    if-eqz v1, :cond_0

    iget-object v2, v0, Lzb/a;->a:Landroid/content/Context;

    invoke-virtual {v2, v1}, Landroid/content/Context;->unregisterReceiver(Landroid/content/BroadcastReceiver;)V

    const/4 v1, 0x0

    iput-object v1, v0, Lzb/a;->c:Lzb/a$a;
    ...
    iget-object v1, p0, LI0/d;->g:LI0/d$b;
