...
# virtual methods
.method public final a(LV0/d;Z)V
    .locals 19
    ...
    iget-object v2, v2, LV0/e;->o:LH/m;

    goto :goto_0

    :cond_0
    iget-object v2, v2, LV0/e;->n:LH/m;
    ...
    :cond_1
    iget-object v3, v0, LV0/d;->g:Landroid/util/Size;

    invoke-virtual {v3}, Landroid/util/Size;->getWidth()I

    move-result v3

    iget-object v4, v0, LV0/d;->g:Landroid/util/Size;
    ...
    iget-object v6, v0, LV0/d;->b:LV0/e;

    const/4 v7, 0x0

    if-eqz v5, :cond_3

    iget-wide v8, v6, LV0/e;->a:J

    invoke-static {v8, v9}, Ljava/lang/Long;->valueOf(J)Ljava/lang/Long;

    move-result-object v5

    iget-object v8, v2, LH/m;->o:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    :cond_2
    iget-object v5, v2, LH/m;->k:Landroid/graphics/Rect;

    :goto_1
    const-string v8, "applyAIWatermark -> "

    invoke-static {v5, v8}, LA/P;->d(Landroid/graphics/Rect;Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_3
    iget-object v8, v0, LV0/d;->n:Landroid/graphics/Rect;
    ...
    :goto_4
    iget-wide v11, v6, LV0/e;->a:J

    invoke-static {v11, v12, v2}, LD5/f;->b(JLH/m;)[I
    ...
    :cond_6
    invoke-static {v3, v4, v8}, LD5/f;->d(IILandroid/graphics/Rect;)[F
    ...
    invoke-static {v6, v8}, LA/P;->c(ILjava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v6, v11}, LVa/a;->j(Ljava/lang/StringBuilder;[I)Ljava/lang/String;
    ...
    invoke-static {v1, v11}, LVa/a;->j(Ljava/lang/StringBuilder;[I)Ljava/lang/String;
    ...
    invoke-static {v11}, LFg/y;->k([I)Landroid/graphics/Rect;
    ...
    invoke-direct {v3, v2}, Lp6/c;-><init>(Landroid/graphics/Bitmap;)V

    iput-object v3, v6, Lcom/android/camera/effect/renders/a;->g:Lp6/c;

    const/4 v2, 0x0

    iput-boolean v2, v3, Lp6/n;->h:Z

    invoke-virtual {v1}, Landroid/graphics/Rect;->centerX()I

    invoke-virtual {v1}, Landroid/graphics/Rect;->centerY()I

    invoke-static {v0, v6, v1}, LV0/f;->c(LV0/d;Lcom/android/camera/effect/renders/p;Landroid/graphics/Rect;)V
