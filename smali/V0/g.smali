...
.method public final a()LWe/c;
    ...
    invoke-direct {v0, v1, v2}, LWe/c;-><init>(Landroid/content/Context;Ljava/lang/String;)V

    iput-object v0, p0, LV0/g;->a:LWe/c;
    ...
    :cond_1
    :goto_2
    iget-object p0, p0, LV0/g;->a:LWe/c;
...
.method public final b(LV0/d;)V
    ...
    iget-object v1, p1, LV0/d;->g:Landroid/util/Size;
    ...
    iget-object v0, p1, LV0/d;->c:Landroid/hardware/HardwareBuffer;
    ...
    invoke-direct {v2, v6, p0, p1}, LA/E1;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V

    invoke-direct {v0, v2}, LEc/a;-><init>(Ljava/lang/Runnable;)V

    invoke-virtual {p0}, LV0/g;->a()LWe/c;

    move-result-object p0

    iget-object p0, p0, LWe/c;->b:LUe/k;
    ...
    :cond_1
    iget-object p0, p0, LUe/k;->b:Landroid/os/Handler;
    ...
    :cond_2
    :goto_0
    iget-object p0, p1, LV0/d;->b:LV0/e;

    iget-boolean p0, p0, LV0/e;->u:Z

    if-eqz p0, :cond_3

    iget-object p0, p1, LV0/d;->c:Landroid/hardware/HardwareBuffer;
    ...
    invoke-static {v4, v5, p1, p0}, LA/X;->f(JLjava/lang/String;Ljava/lang/StringBuilder;)Ljava/lang/String;
