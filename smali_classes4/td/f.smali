...
.field public final a:Ltd/f$a;

.field public final b:Ltd/f$b;
...
.method public constructor <init>(Landroid/content/Context;Z)V
    ...
    iput-object v0, p0, Ltd/f;->a:Ltd/f$a;

    new-instance v0, Ltd/f$b;

    invoke-direct {v0, p0}, Ltd/f$b;-><init>(Ltd/f;)V

    iput-object v0, p0, Ltd/f;->b:Ltd/f$b;

    const-string v0, ""

    iput-object v0, p0, Ltd/f;->r:Ljava/lang/String;

    const/4 v1, -0x1

    iput v1, p0, Ltd/f;->Q:I

    iput-object p1, p0, Ltd/f;->d:Landroid/content/Context;
    ...
    iput-object p1, p0, Ltd/f;->y:Landroid/os/Handler;
    ...
    iput-object p1, p0, Ltd/f;->A:Landroid/os/HandlerThread;

    invoke-virtual {p1}, Ljava/lang/Thread;->start()V

    new-instance p1, Landroid/os/Handler;

    iget-object v1, p0, Ltd/f;->A:Landroid/os/HandlerThread;
    ...
    iput-object p1, p0, Ltd/f;->C:Landroid/os/Handler;

    const/4 p1, 0x0

    iput-boolean p1, p0, Ltd/f;->t:Z

    iput-boolean p1, p0, Ltd/f;->M:Z

    const/4 v1, 0x1

    iput-boolean v1, p0, Ltd/f;->u:Z

    iput-boolean p2, p0, Ltd/f;->c:Z

    iput-object v0, p0, Ltd/f;->r:Ljava/lang/String;

    iput p1, p0, Ltd/f;->p:I

    iput p1, p0, Ltd/f;->q:I
...
.method public static b(Lcom/xiaomi/Video2GifEditer/EffectType;)J
    ...
    sget-object v0, Lgd/q;->d:Ljava/lang/String;
...
.method public final declared-synchronized a(JJ)V
    ...
    :try_start_0
    iget-object v0, p0, Ltd/f;->j:Lcom/xiaomi/Video2GifEditer/MediaEffectGraph;
...
.method public final c()V
    ...
    iget-object v0, p0, Ltd/f;->d:Landroid/content/Context;
    ...
    iput-object v0, p0, Ltd/f;->w:Ljava/lang/String;
    ...
    iput-object v0, p0, Ltd/f;->j:Lcom/xiaomi/Video2GifEditer/MediaEffectGraph;
    ...
    iget-object v1, p0, Ltd/f;->j:Lcom/xiaomi/Video2GifEditer/MediaEffectGraph;

    invoke-direct {v0, v1}, Lcom/xiaomi/Video2GifEditer/EffectMediaPlayer;-><init>(Lcom/xiaomi/Video2GifEditer/MediaEffectGraph;)V

    iput-object v0, p0, Ltd/f;->k:Lcom/xiaomi/Video2GifEditer/EffectMediaPlayer;
...
.method public final e()Z
    ...
    iget-object v3, p0, Ltd/f;->r:Ljava/lang/String;
    ...
    :goto_0
    iget v3, p0, Ltd/f;->p:I

    iget v4, p0, Ltd/f;->q:I
...
.method public final h()V
    ...
    iget-object v0, p0, Ltd/f;->y:Landroid/os/Handler;
...
.method public final i(JLjava/lang/String;)V
    ...
    invoke-static {v0, p3, v1}, LA/Q;->k(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v0

    iget-boolean v1, p0, Ltd/f;->M:Z
    ...
    iput-boolean v0, p0, Ltd/f;->M:Z

    iput-wide p1, p0, Ltd/f;->x:J

    iget-object p1, p0, Ltd/f;->C:Landroid/os/Handler;

    new-instance p2, LA/l1;

    const/16 v0, 0x10

    invoke-direct {p2, v0, p0, p3}, LA/l1;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V
...
.method public final k(Z)V
    ...
    invoke-direct {v1, p0, p1, v2}, Lcom/google/android/exoplayer2/audio/b;-><init>(Ljava/lang/Object;ZI)V
...
.method public final l()V
    ...
    invoke-virtual {v0, v3, v4}, Laa/b;->f(II)I

    move-result v0

    iput v0, p0, Ltd/f;->Q:I

    invoke-static {}, Ljava/lang/System;->currentTimeMillis()J

    move-result-wide v3

    iput-wide v3, p0, Ltd/f;->H:J
    ...
    iget-object v0, p0, Ltd/f;->C:Landroid/os/Handler;

    new-instance v1, Ls2/d;

    const/4 v2, 0x1

    invoke-direct {v1, p0, v2}, Ls2/d;-><init>(Ljava/lang/Object;I)V
    ...
    iget-object p0, p0, Ltd/f;->w:Ljava/lang/String;
...
.method public final onSurfaceTextureAvailable(Landroid/graphics/SurfaceTexture;II)V
    ...
    iget-object p2, p0, Ltd/f;->i:Landroid/view/Surface;
    ...
    iput-object p2, p0, Ltd/f;->i:Landroid/view/Surface;

    iget-object p1, p0, Ltd/f;->k:Lcom/xiaomi/Video2GifEditer/EffectMediaPlayer;
    ...
    :cond_0
    iget-object p1, p0, Ltd/f;->w:Ljava/lang/String;
    ...
    iget-wide p2, p0, Ltd/f;->x:J

    invoke-virtual {p0, p2, p3, p1}, Ltd/f;->i(JLjava/lang/String;)V
...
.method public final onSurfaceTextureUpdated(Landroid/graphics/SurfaceTexture;)V
    ...
    iget-object v0, p0, Ltd/f;->f:Landroid/widget/ImageView;

    const/4 v1, 0x0

    invoke-static {v0, v1, v1}, LA/O2;->r(Landroid/view/View;ZZ)Z
    ...
    invoke-static {v0, p1, v1}, LA/O2;->r(Landroid/view/View;ZZ)Z

    iget-object p0, p0, Ltd/f;->h:Lcom/xiaomi/mimoji/gif/GifEditLayout;
