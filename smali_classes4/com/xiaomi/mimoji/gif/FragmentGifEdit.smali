...
.field public d:Ltd/g;

.field public e:Ltd/f;
...
.method public static Pd(Lcom/xiaomi/mimoji/gif/FragmentGifEdit;Ljava/lang/Boolean;)V
    ...
    iget-object v0, p0, Lcom/xiaomi/mimoji/gif/FragmentGifEdit;->e:Ltd/f;

    invoke-virtual {v0}, Ltd/f;->f()Z
    ...
    iget-object p1, p0, Lcom/xiaomi/mimoji/gif/FragmentGifEdit;->e:Ltd/f;

    invoke-virtual {p1}, Ltd/f;->e()Z
    ...
    invoke-virtual {p0, p1}, Lcom/xiaomi/mimoji/gif/FragmentGifEdit;->re(Lq4/c;)V

    goto :goto_1

    :cond_1
    iget-object p0, p0, Lcom/xiaomi/mimoji/gif/FragmentGifEdit;->e:Ltd/f;

    invoke-virtual {p0}, Ltd/f;->l()V
    ...
    invoke-static {p1, p0, v1}, LA/g4;->d(Landroid/content/Context;Ljava/lang/String;Z)V
...
.method public static fe(Lcom/xiaomi/mimoji/gif/FragmentGifEdit;Ljava/lang/Boolean;)V
    .locals 2
    ...
    invoke-virtual {p0, p1}, Lcom/xiaomi/mimoji/gif/FragmentGifEdit;->Ce(Lq4/c;)V
...
.method public static synthetic me(Lcom/xiaomi/mimoji/gif/FragmentGifEdit;)Ljava/lang/String;
    .locals 0
...
.method public static synthetic vd(Lcom/xiaomi/mimoji/gif/FragmentGifEdit;)V
    .locals 4
...
# virtual methods
.method public final Ce(Lq4/c;)V
    .locals 7
    ...
    iput-object v0, p1, Ll4/b;->b:Ll4/t;
...
.method public final Fc(JLjava/lang/String;)V
    .locals 4
    ...
    invoke-static {v1, p3}, LVa/a;->g(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_0
    iget-object v1, v0, Ltd/f;->i:Landroid/view/Surface;
    ...
    iput-wide v0, p1, Ltd/f;->x:J

    iput-object p2, p1, Ltd/f;->w:Ljava/lang/String;
    ...
    invoke-virtual {v0, p1, p2, p3}, Ltd/f;->i(JLjava/lang/String;)V
...
.method public final Le()V
    ...
    invoke-virtual {p0}, Lcom/xiaomi/mimoji/gif/FragmentGifEdit;->oe()V

    return-void
.end method

.method public final Sg(Lq4/c;)V
    .locals 2
...
.method public final initView(Landroid/view/View;)V
    ...
    iput-object v4, p0, Lcom/xiaomi/mimoji/gif/FragmentGifEdit;->k:Landroid/content/Context;
    ...
    iput-boolean v3, p0, Lcom/xiaomi/mimoji/gif/FragmentGifEdit;->n:Z
    ...
    iput-object v5, v4, Ltd/g;->d:Landroid/content/Context;

    iput-object v4, p0, Lcom/xiaomi/mimoji/gif/FragmentGifEdit;->d:Ltd/g;

    iget-object v5, p0, Lcom/xiaomi/mimoji/gif/FragmentGifEdit;->c:Landroid/view/View;
    ...
    iput-object v6, v4, Ltd/g;->e:Landroid/widget/RelativeLayout;
    ...
    iput-object v6, v4, Ltd/g;->f:Landroid/widget/LinearLayout;
    ...
    iput-object v6, v4, Ltd/g;->g:Landroid/widget/LinearLayout;
    ...
    iput-object v6, v4, Ltd/g;->h:Landroid/widget/LinearLayout;
    ...
    iput-object v6, v4, Ltd/g;->i:Landroid/widget/LinearLayout;
    ...
    iput-object v6, v4, Ltd/g;->k:Landroid/widget/LinearLayout;
    ...
    iput-object v6, v4, Ltd/g;->j:Landroid/widget/LinearLayout;
    ...
    iput-object v5, v4, Ltd/g;->l:Landroid/widget/LinearLayout;

    invoke-virtual {v5, v4}, Landroid/view/View;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    iget-object v5, v4, Ltd/g;->h:Landroid/widget/LinearLayout;

    iget-object v6, v4, Ltd/g;->i:Landroid/widget/LinearLayout;

    iget-object v7, v4, Ltd/g;->k:Landroid/widget/LinearLayout;

    iget-object v8, v4, Ltd/g;->j:Landroid/widget/LinearLayout;

    iget-object v9, v4, Ltd/g;->l:Landroid/widget/LinearLayout;
    ...
    invoke-static {v5, v10}, LM/i;->j(F[Landroid/view/View;)V

    invoke-virtual {v4}, Ltd/g;->a()V
    ...
    invoke-static {v4}, Lnc/d;->a(Landroid/view/View;)Lnc/i;
    ...
    invoke-virtual {v5, v7, v8, v6}, Lio/reactivex/Observable;->throttleFirst(JLjava/util/concurrent/TimeUnit;)Lio/reactivex/Observable;

    move-result-object v5

    new-instance v9, LA/Y0;

    invoke-direct {v9, p0, v2}, LA/Y0;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-direct {v9, v4, v0}, LJ8/c;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-direct {v5, p0, v2}, LJ8/d;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-static {p1}, Lnc/d;->a(Landroid/view/View;)Lnc/i;

    move-result-object v0

    invoke-virtual {v0, v7, v8, v6}, Lio/reactivex/Observable;->throttleFirst(JLjava/util/concurrent/TimeUnit;)Lio/reactivex/Observable;

    move-result-object v0

    new-instance v2, Lhb/a;

    invoke-direct {v2, p0, v1}, Lhb/a;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-direct {v2, p1}, Ltd/a;-><init>(Landroid/widget/ImageView;)V
    ...
    invoke-direct {v0, p0, v2}, LA3/i2;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-interface {p1}, Lld/d;->Kb()Landroid/graphics/Bitmap;
    ...
    invoke-static {p1, v1, v3}, LA/O2;->r(Landroid/view/View;ZZ)Z
    ...
    invoke-static {p1, v3, v3}, LA/O2;->r(Landroid/view/View;ZZ)Z
    ...
    invoke-virtual {p1, v0}, Lgd/s;->a(Ljava/lang/Integer;)Lcom/xiaomi/mimoji/common/bean/MimojiItem;
    ...
    invoke-direct {p1, v0, v1}, Ltd/f;-><init>(Landroid/content/Context;Z)V

    iput-object p1, p0, Lcom/xiaomi/mimoji/gif/FragmentGifEdit;->e:Ltd/f;
    ...
    :cond_7
    iget-object p1, p0, Lcom/xiaomi/mimoji/gif/FragmentGifEdit;->d:Ltd/g;

    iget-object v0, p0, Lcom/xiaomi/mimoji/gif/FragmentGifEdit;->e:Ltd/f;

    iput-object v0, p1, Ltd/g;->m:Ltd/f;

    iget-object p1, p0, Lcom/xiaomi/mimoji/gif/FragmentGifEdit;->g:Landroid/view/TextureView;

    iput-object p1, v0, Ltd/f;->e:Landroid/view/TextureView;
...
.method public final onBackEvent(I)Z
    ...
    invoke-direct {p1, p0}, Ltd/b;-><init>(Lcom/xiaomi/mimoji/gif/FragmentGifEdit;)V
...
.method public final onDestroyView()V
    ...
    iget-object v2, v0, Ltd/f;->A:Landroid/os/HandlerThread;

    const/4 v3, 0x0

    if-eqz v2, :cond_0

    iget-object v2, v0, Ltd/f;->C:Landroid/os/Handler;
    ...
    iput-object v3, v0, Ltd/f;->A:Landroid/os/HandlerThread;

    iput-object v3, v0, Ltd/f;->C:Landroid/os/Handler;

    :cond_0
    iget-object v2, v0, Ltd/f;->w:Ljava/lang/String;

    invoke-static {v2}, Lgd/q;->a(Ljava/lang/String;)Z

    move-result v2

    if-eqz v2, :cond_1

    iget-boolean v2, v0, Ltd/f;->s:Z
    ...
    :cond_1
    iget-object v2, v0, Ltd/f;->k:Lcom/xiaomi/Video2GifEditer/EffectMediaPlayer;
    ...
    iput-object v3, v0, Ltd/f;->k:Lcom/xiaomi/Video2GifEditer/EffectMediaPlayer;

    :cond_2
    iget-object v2, v0, Ltd/f;->e:Landroid/view/TextureView;
    ...
    :try_start_0
    iget-object v2, v0, Ltd/f;->j:Lcom/xiaomi/Video2GifEditer/MediaEffectGraph;

    if-eqz v2, :cond_4

    invoke-virtual {v2}, Lcom/xiaomi/Video2GifEditer/MediaEffectGraph;->DestructMediaEffectGraph()V

    iput-object v3, v0, Ltd/f;->j:Lcom/xiaomi/Video2GifEditer/MediaEffectGraph;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    iget v4, v0, Ltd/f;->Q:I

    invoke-virtual {v2, v4}, Laa/b;->i(I)V

    invoke-virtual {v0, v1}, Ltd/f;->k(Z)V

    iget-wide v4, v0, Ltd/f;->m:J
    ...
    iput-wide v6, v0, Ltd/f;->m:J

    :cond_5
    iget-object v2, v0, Ltd/f;->i:Landroid/view/Surface;

    if-eqz v2, :cond_6

    invoke-virtual {v2}, Landroid/view/Surface;->release()V

    iput-object v3, v0, Ltd/f;->i:Landroid/view/Surface;

    :cond_6
    sget-boolean v0, Ltd/f;->Y:Z

    if-eqz v0, :cond_7

    invoke-static {}, Lcom/xiaomi/MediaRecord/SystemUtil;->UnInit()V

    sput-boolean v1, Ltd/f;->Y:Z
    ...
    iput-object v3, p0, Lcom/xiaomi/mimoji/gif/FragmentGifEdit;->e:Ltd/f;
...
.method public final onPause()V
    ...
    iget-object v1, v0, Ltd/f;->j:Lcom/xiaomi/Video2GifEditer/MediaEffectGraph;

    if-eqz v1, :cond_0

    invoke-virtual {v0}, Ltd/f;->g()Z

    move-result v1

    if-eqz v1, :cond_0

    iget-object v0, v0, Ltd/f;->k:Lcom/xiaomi/Video2GifEditer/EffectMediaPlayer;
...
.method public final provideAnimateElement(ILjava/util/List;I)V
    ...
    invoke-static {p1}, LA/O2;->o(Landroid/view/View;)Z
    ...
    invoke-direct {p1, p2}, Lid/b;-><init>(I)V
