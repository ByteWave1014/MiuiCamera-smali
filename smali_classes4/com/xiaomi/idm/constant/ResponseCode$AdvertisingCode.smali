...
.method static constructor <clinit>()V
    ...
    const-string v2, "Start Advertising SUCCESS"
    ...
    invoke-direct {v1, v3, v4, v5, v2}, Lcom/xiaomi/idm/constant/ResponseCode$AdvertisingCode;-><init>(Ljava/lang/String;IILjava/lang/String;)V
    ...
    const-string v3, "Stop Advertising SUCCESS"
    ...
    invoke-direct {v2, v4, v6, v7, v3}, Lcom/xiaomi/idm/constant/ResponseCode$AdvertisingCode;-><init>(Ljava/lang/String;IILjava/lang/String;)V
    ...
    const-string v8, "Security Manager check success"

    const-string v9, "ADV_ADVERTISING_CHECK_SUCCESS"

    invoke-direct {v3, v9, v4, v6, v8}, Lcom/xiaomi/idm/constant/ResponseCode$AdvertisingCode;-><init>(Ljava/lang/String;IILjava/lang/String;)V
    ...
    const-string v6, "Update Advertising Success"

    const-string v8, "UPDATE_ADVERTISING_SUCCESS"

    const/16 v15, 0x14

    invoke-direct {v4, v8, v5, v15, v6}, Lcom/xiaomi/idm/constant/ResponseCode$AdvertisingCode;-><init>(Ljava/lang/String;IILjava/lang/String;)V

    sput-object v4, Lcom/xiaomi/idm/constant/ResponseCode$AdvertisingCode;->UPDATE_ADVERTISING_SUCCESS:Lcom/xiaomi/idm/constant/ResponseCode$AdvertisingCode;
    ...
    invoke-direct {v5, v9, v7, v6, v8}, Lcom/xiaomi/idm/constant/ResponseCode$AdvertisingCode;-><init>(Ljava/lang/String;IILjava/lang/String;)V
    ...
    invoke-direct {v6, v9, v10, v7, v8}, Lcom/xiaomi/idm/constant/ResponseCode$AdvertisingCode;-><init>(Ljava/lang/String;IILjava/lang/String;)V
    ...
    invoke-direct {v7, v10, v11, v8, v9}, Lcom/xiaomi/idm/constant/ResponseCode$AdvertisingCode;-><init>(Ljava/lang/String;IILjava/lang/String;)V
    ...
    invoke-direct {v8, v11, v12, v9, v10}, Lcom/xiaomi/idm/constant/ResponseCode$AdvertisingCode;-><init>(Ljava/lang/String;IILjava/lang/String;)V

    sput-object v8, Lcom/xiaomi/idm/constant/ResponseCode$AdvertisingCode;->NOT_IN_ADVERTISING:Lcom/xiaomi/idm/constant/ResponseCode$AdvertisingCode;
    ...
    invoke-direct {v12, v15, v0, v13, v14}, Lcom/xiaomi/idm/constant/ResponseCode$AdvertisingCode;-><init>(Ljava/lang/String;IILjava/lang/String;)V
    ...
    invoke-direct {v0, v15, v1, v13, v14}, Lcom/xiaomi/idm/constant/ResponseCode$AdvertisingCode;-><init>(Ljava/lang/String;IILjava/lang/String;)V

    sput-object v0, Lcom/xiaomi/idm/constant/ResponseCode$AdvertisingCode;->ADVERTISING_PERMISSION_DENIED:Lcom/xiaomi/idm/constant/ResponseCode$AdvertisingCode;
    ...
    const-string v14, "repeated advertising request call, please wait for the last call to return"
    ...
    invoke-direct {v0, v15, v2, v1, v14}, Lcom/xiaomi/idm/constant/ResponseCode$AdvertisingCode;-><init>(Ljava/lang/String;IILjava/lang/String;)V

    sput-object v0, Lcom/xiaomi/idm/constant/ResponseCode$AdvertisingCode;->ADV_ERR_REPEATED_REQUEST:Lcom/xiaomi/idm/constant/ResponseCode$AdvertisingCode;
    ...
    const-string v15, "ADV_ERR_PERSISTENT_SERVICE_ALREADY_BOUND"

    move-object/from16 v29, v3

    const/16 v3, 0xe

    invoke-direct {v0, v15, v3, v1, v2}, Lcom/xiaomi/idm/constant/ResponseCode$AdvertisingCode;-><init>(Ljava/lang/String;IILjava/lang/String;)V

    sput-object v0, Lcom/xiaomi/idm/constant/ResponseCode$AdvertisingCode;->ADV_ERR_PERSISTENT_SERVICE_ALREADY_BOUND:Lcom/xiaomi/idm/constant/ResponseCode$AdvertisingCode;
    ...
    const-string v3, "initial clientId of the persistent service does not match the clientId of the caller"

    const-string v1, "ADV_ERR_PERSISTENT_SERVICE_CLIENT_ID"

    move-object/from16 v30, v4

    const/16 v4, 0xf

    invoke-direct {v0, v1, v4, v2, v3}, Lcom/xiaomi/idm/constant/ResponseCode$AdvertisingCode;-><init>(Ljava/lang/String;IILjava/lang/String;)V
    ...
    const-string v3, "ADV_ERR_SERVICE_NOT_AVAILABLE"

    const/16 v4, 0x10

    invoke-direct {v0, v3, v4, v1, v2}, Lcom/xiaomi/idm/constant/ResponseCode$AdvertisingCode;-><init>(Ljava/lang/String;IILjava/lang/String;)V

    sput-object v0, Lcom/xiaomi/idm/constant/ResponseCode$AdvertisingCode;->ADV_ERR_SERVICE_NOT_AVAILABLE:Lcom/xiaomi/idm/constant/ResponseCode$AdvertisingCode;
    ...
    const-string v2, "service Id already registered"
    ...
    const-string v3, "ADV_ERR_SERVICE_INSTANCE_REPEATED"

    const/16 v4, 0x12

    invoke-direct {v0, v3, v4, v1, v2}, Lcom/xiaomi/idm/constant/ResponseCode$AdvertisingCode;-><init>(Ljava/lang/String;IILjava/lang/String;)V

    sput-object v0, Lcom/xiaomi/idm/constant/ResponseCode$AdvertisingCode;->ADV_ERR_SERVICE_INSTANCE_REPEATED:Lcom/xiaomi/idm/constant/ResponseCode$AdvertisingCode;
    ...
    const-string v2, "service Id is empty"

    const-string v3, "ADV_ERR_SERVICE_ID_EMPTY"
    ...
    const-string v2, "service instance not registered"
    ...
    sput-object v0, Lcom/xiaomi/idm/constant/ResponseCode$AdvertisingCode;->ADV_ERR_SERVICE_NOT_REGISTERED:Lcom/xiaomi/idm/constant/ResponseCode$AdvertisingCode;
    ...
    const-string v3, "ADV_ERR_NOT_SUPPORT_OFFLINE_ACCOUNT"
    ...
    const-string v3, "ADV_ERR_NOT_SUPPORT_UPDATE_SERVICE"

    const/16 v4, 0x16

    invoke-direct {v0, v3, v4, v1, v2}, Lcom/xiaomi/idm/constant/ResponseCode$AdvertisingCode;-><init>(Ljava/lang/String;IILjava/lang/String;)V

    sput-object v0, Lcom/xiaomi/idm/constant/ResponseCode$AdvertisingCode;->ADV_ERR_NOT_SUPPORT_UPDATE_SERVICE:Lcom/xiaomi/idm/constant/ResponseCode$AdvertisingCode;
    ...
    const-string v2, "disc type not supported/permission denied"

    const-string v3, "ERROR_CODE_START_DISC_NOT_SUPPORTED"
    ...
    sput-object v0, Lcom/xiaomi/idm/constant/ResponseCode$AdvertisingCode;->ERROR_CODE_COMMTYPE_NOT_SUPPORTED:Lcom/xiaomi/idm/constant/ResponseCode$AdvertisingCode;
    ...
    const-string v2, "Unknown advertising code"

    const-string v3, "ADV_UNKNOWN"
    ...
    filled-new-array/range {v0 .. v25}, [Lcom/xiaomi/idm/constant/ResponseCode$AdvertisingCode;
