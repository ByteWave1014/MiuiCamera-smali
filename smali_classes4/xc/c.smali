...
.method public constructor <init>(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    iput-object p0, p0, Lxc/c;->a:Lxc/c;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lxc/c;->b:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, Lxc/c;->c:Landroid/os/Handler;

    iput-object p0, p0, Lxc/c;->d:Lxc/c;

    iput-object p0, p0, Lxc/c;->e:Lxc/c;

    const/4 v0, 0x0

    iput-object v0, p0, Lxc/c;->j:Lwc/d$a;

    iput-object v0, p0, Lxc/c;->k:Lwc/g;

    const/4 v0, 0x0

    iput-boolean v0, p0, Lxc/c;->l:Z

    iput-boolean v0, p0, Lxc/c;->m:Z

    iput-object p1, p0, Lxc/c;->f:Landroid/content/Context;

    iput-object p2, p0, Lxc/c;->g:Landroid/content/Intent;
    ...
    iput-object p1, p0, Lxc/c;->h:Landroid/os/Handler;

    new-instance p2, Lxc/b;

    invoke-direct {p2, p1}, Lxc/b;-><init>(Landroid/os/Handler;)V

    iput-object p2, p0, Lxc/c;->i:Lxc/b;

    return-void
.end method

.method public static a(Lxc/d;Ljava/lang/Throwable;)V
    .locals 2
    ...
    invoke-virtual {v0, p1}, Lxc/a;->completeExceptionally(Ljava/lang/Throwable;)Z
...
.method public final binderDied()V
    ...
    iput-object v1, p0, Lxc/c;->k:Lwc/g;

    const/4 v1, 0x1

    iput-boolean v1, p0, Lxc/c;->m:Z

    iget-object v1, p0, Lxc/c;->h:Landroid/os/Handler;

    new-instance v2, Ls2/d;

    const/4 v3, 0x2

    invoke-direct {v2, p0, v3}, Ls2/d;-><init>(Ljava/lang/Object;I)V

    invoke-virtual {v1, v2}, Landroid/os/Handler;->post(Ljava/lang/Runnable;)Z

    iget-object p0, p0, Lxc/c;->j:Lwc/d$a;
...
.method public final c(Lwc/g;Z)V
    .locals 0
...
.method public final g(Lwc/c;)Lxc/c$a;
    .locals 3

    new-instance v0, Lxc/c$a;

    invoke-direct {v0, p0}, Lxc/c$a;-><init>(Lxc/c;)V

    iput-object p1, v0, Lxc/c$a;->g:Lwc/c;

    iget-object p1, p0, Lxc/c;->c:Landroid/os/Handler;

    iget-object v1, p0, Lxc/c;->e:Lxc/c;

    invoke-virtual {p1, v1}, Landroid/os/Handler;->removeCallbacks(Ljava/lang/Runnable;)V

    iget-object p1, p0, Lxc/c;->h:Landroid/os/Handler;
    ...
    invoke-virtual {v0, p0}, Lxc/a;->completeExceptionally(Ljava/lang/Throwable;)Z
...
.method public final l()V
    ...
    :cond_0
    :goto_0
    iget-object v0, p0, Lxc/c;->a:Lxc/c;
    ...
    :goto_1
    check-cast v1, Lxc/c$a;

    :try_start_0
    iget-object v2, p0, Lxc/c;->k:Lwc/g;
    ...
    :cond_2
    invoke-interface {v0, v2}, Lxc/d;->a(Lwc/g;)Ljava/lang/Object;

    move-result-object v2

    if-eqz v1, :cond_0

    invoke-virtual {v1, v2}, Lxc/a;->complete(Ljava/lang/Object;)Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    invoke-static {v0, v1}, Lxc/c;->a(Lxc/d;Ljava/lang/Throwable;)V

    goto :goto_0

    :cond_3
    iget-object v0, p0, Lxc/c;->b:Ljava/util/ArrayList;
    ...
    iget-object p0, p0, Lxc/c;->a:Lxc/c;
...
.method public final onBindingDied(Landroid/content/ComponentName;)V
    ...
    invoke-virtual {p0}, Lxc/c;->binderDied()V
...
.method public final onServiceConnected(Landroid/content/ComponentName;Landroid/os/IBinder;)V
    ...
    invoke-virtual {p0, v0, p1}, Lxc/c;->c(Lwc/g;Z)V

    invoke-virtual {p0}, Lxc/c;->l()V
...
.method public final onServiceDisconnected(Landroid/content/ComponentName;)V
    ...
    iput-boolean p1, p0, Lxc/c;->l:Z

    iget-object p1, p0, Lxc/c;->k:Lwc/g;

    if-eqz p1, :cond_0

    const/4 v0, 0x0

    invoke-virtual {p0, p1, v0}, Lxc/c;->c(Lwc/g;Z)V

    const/4 p1, 0x0

    iput-object p1, p0, Lxc/c;->k:Lwc/g;
...
.method public final run()V
    ...
    iget-object v0, p0, Lxc/c;->h:Landroid/os/Handler;
...
.method public final toString()Ljava/lang/String;
    ...
    :cond_1
    iget-object v1, p0, Lxc/c;->k:Lwc/g;
    ...
    iget-object v1, p0, Lxc/c;->a:Lxc/c;
    ...
    :cond_3
    iget-object p0, p0, Lxc/c;->b:Ljava/util/ArrayList;
