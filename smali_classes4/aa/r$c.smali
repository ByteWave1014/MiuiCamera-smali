...
.method public constructor <init>(Laa/r;)V
    ...
    iput-object p1, p0, Laa/r$c;->a:Laa/r;
...
.method public final a(LG9/b;)V
    ...
    iget-wide v9, v1, LG9/b;->d:J

    iget-object v3, v1, LG9/b;->f:Ljava/util/ArrayList;

    iget v2, v1, LG9/b;->a:I
    ...
    iget-object v8, v0, Laa/r$c;->a:Laa/r;

    if-eq v6, v2, :cond_0

    if-ne v5, v2, :cond_5

    iget-boolean v11, v8, Laa/r;->r:Z

    if-eqz v11, :cond_5

    :cond_0
    iget-object v11, v1, LG9/b;->i:LG9/b$a;

    if-eqz v11, :cond_10

    invoke-virtual {v8, v9, v10}, Laa/r;->u(J)Laa/o;

    move-result-object v12

    iget-object v13, v11, LG9/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    invoke-static {v9, v10, v15, v6}, LA/X;->g(JLjava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    iput-wide v13, v12, Laa/o;->e:J

    invoke-virtual {v8, v9, v10}, Laa/r;->y(J)Laa/o;

    invoke-static {v8, v13, v14, v12}, Laa/r;->f(Laa/r;JLaa/o;)V

    :cond_1
    if-ne v5, v2, :cond_4

    iget-boolean v5, v8, Laa/r;->r:Z

    if-eqz v5, :cond_4

    iget-boolean v5, v1, LG9/b;->m:Z

    if-eqz v5, :cond_3

    iget-object v5, v1, LG9/b;->g:Ljava/util/ArrayList;
    ...
    iget-object v5, v2, LG9/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;

    iget-object v2, v2, LG9/b$a;->d:Landroid/media/Image;
    ...
    iput-object v5, v6, Laa/o;->g:Lcom/xiaomi/protocol/ICustomCaptureResult;

    iget-object v5, v6, Laa/o;->r:Laa/p;

    iget-boolean v5, v5, Laa/p;->W:Z
    ...
    iget-boolean v7, v1, LG9/b;->s:Z

    iget-object v8, v6, Laa/o;->L:LG9/d;
    ...
    invoke-direct/range {v2 .. v8}, LG9/h;-><init>(Ljava/util/ArrayList;ZJZLG9/d;)V

    iget v2, v1, LG9/b;->x:I

    iput v2, v0, LG9/h;->f:I

    iget-object v1, v1, LG9/b;->r:Laa/k;

    sget-boolean v2, Lt6/b;->B:Z

    if-nez v2, :cond_7

    iget-object v2, v1, Laa/k;->b:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    invoke-virtual {v1, v0}, Laa/k;->e(LG9/h;)I

    goto/16 :goto_2

    :cond_8
    iget-object v1, v8, Laa/r;->E:Laa/r$e;

    invoke-virtual {v1, v4, v9, v10}, Laa/r$e;->b(IJ)V
    ...
    invoke-virtual {v1, v2, v4, v4}, Laa/r$e;->c(Landroid/media/Image;IZ)V
    ...
    invoke-static {v9, v10, v1}, LA/H2;->b(JLjava/lang/String;)Ljava/lang/String;
    ...
    iget-object v6, v3, LG9/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    sget-object v9, LZ5/N;->a:Ljava/util/List;
    ...
    :cond_c
    sget-object v11, Ln6/J;->J1:Ln6/K;

    const v12, 0xbabe

    invoke-static {v8, v11, v12}, Ln6/L;->j(Landroid/hardware/camera2/CaptureResult;Ln6/K;I)Ljava/lang/Object;
    ...
    invoke-static {v11, v8}, LB3/d;->b(Ljava/lang/String;Ljava/lang/Integer;)Ljava/lang/String;
    ...
    invoke-static {v10, v8}, LA/P;->f(Ljava/lang/String;Z)Ljava/lang/String;
    ...
    iput-object v6, v2, Laa/o;->g:Lcom/xiaomi/protocol/ICustomCaptureResult;

    iget-object v2, v1, LG9/b;->r:Laa/k;
    ...
    invoke-static {v5, v3, v6, v9}, LC9/e;->k(Lcom/xiaomi/camera/imagecodec/ImagePool;Landroid/media/Image;IZ)Landroid/media/Image;
    ...
    sget-object v9, LV0/c$a;->a:LV0/c;

    invoke-virtual {v9}, LV0/c;->a()LV0/g;

    move-result-object v9

    invoke-direct {v6, v5, v4, v8, v9}, LG9/c;-><init>(Landroid/media/Image;IZLV0/g;)V

    invoke-virtual {v2, v6}, Laa/k;->d(LG9/c;)V
    ...
    :cond_d
    invoke-virtual {v0, v3}, Laa/r$c;->b(Landroid/media/Image;)V

    goto :goto_2

    :cond_e
    invoke-virtual {v0, v1, v5}, Laa/r$c;->c(LG9/b;Ljava/lang/String;)V
...
.method public final c(LG9/b;Ljava/lang/String;)V
    .locals 17
    .param p1    # LG9/b;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    invoke-virtual/range {p1 .. p1}, LG9/b;->a()LG9/h;
    ...
    invoke-static {v4, v2, v0}, LA/S;->h(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_0
    iget-object v7, v3, LG9/h;->a:Ljava/util/ArrayList;
    ...
    iget-wide v11, v1, LG9/b;->d:J

    iget v13, v1, LG9/b;->a:I

    iget-object v15, v0, Laa/r$c;->a:Laa/r;
    ...
    iget-boolean v14, v1, LG9/b;->s:Z

    if-nez v14, :cond_5

    iget-boolean v14, v10, LG9/b$a;->a:Z

    if-eqz v14, :cond_4

    iget-object v8, v10, LG9/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    invoke-virtual {v15, v5, v6}, Laa/r;->u(J)Laa/o;
    ...
    invoke-static {v15, v1, v13}, Laa/r;->a(Laa/r;LG9/b;I)Lcom/xiaomi/protocol/ICustomCaptureResult;

    move-result-object v5

    iput-object v5, v8, Laa/o;->g:Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    invoke-virtual/range {p1 .. p1}, LG9/b;->b()Z

    move-result v5

    if-eqz v5, :cond_7

    invoke-virtual {v15, v11, v12}, Laa/r;->u(J)Laa/o;
    ...
    iput-object v6, v5, Laa/o;->g:Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    invoke-static {v15, v2, v0}, Laa/r;->h(Laa/r;LG9/b$a;Laa/r$c;)V
    ...
    :cond_a
    iget-object v0, v1, LG9/b;->r:Laa/k;

    iget-boolean v1, v1, LG9/b;->s:Z

    if-eqz v1, :cond_b

    iget-boolean v1, v3, LG9/h;->b:Z

    if-eqz v1, :cond_b

    iget-object v1, v0, Laa/k;->b:Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-virtual {v1}, Ljava/util/concurrent/atomic/AtomicInteger;->getAndIncrement()I

    :cond_b
    iget-object v1, v15, Laa/r;->b:Laa/k;
    ...
    invoke-static {v4, v2, v1}, LA/S;->h(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    iput v1, v3, LG9/h;->d:I

    :cond_f
    if-eqz v0, :cond_10

    invoke-virtual {v0, v3}, Laa/k;->e(LG9/h;)I
