...
.field public i:Laa/k$a;

.field public j:Laa/r$e;
...
.method public constructor <init>(Laa/r$e;Lcom/xiaomi/engine/BufferFormat;)V
    ...
    iput-object v0, p0, Laa/k;->b:Ljava/util/concurrent/atomic/AtomicInteger;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-direct {v0, v1}, Ljava/util/concurrent/atomic/AtomicInteger;-><init>(I)V

    iput-object v0, p0, Laa/k;->c:Ljava/util/concurrent/atomic/AtomicInteger;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-direct {v0, v1}, Ljava/util/concurrent/atomic/AtomicInteger;-><init>(I)V

    iput-object v0, p0, Laa/k;->d:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iput-object v0, p0, Laa/k;->g:Ljava/lang/Object;
    ...
    iput-object v0, p0, Laa/k;->n:Ljava/lang/Object;

    new-instance v0, Ljava/util/LinkedList;

    invoke-direct {v0}, Ljava/util/LinkedList;-><init>()V

    iput-object v0, p0, Laa/k;->o:Ljava/util/LinkedList;

    new-instance v0, Ljava/lang/Object;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    iput-object v0, p0, Laa/k;->p:Ljava/lang/Object;

    iput v1, p0, Laa/k;->q:I
    ...
    iput-object p1, p0, Laa/k;->j:Laa/r$e;
    ...
    :goto_0
    iput-boolean p1, p0, Laa/k;->m:Z

    sget-object p1, Ljava/util/Locale;->ENGLISH:Ljava/util/Locale;

    invoke-virtual {p0}, Laa/k;->g()Ljava/lang/String;
    ...
    invoke-static {v5, p1, v5, v0, v6}, LA/N;->g(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object p1

    invoke-static {p1, v3, v4, v5}, LA/P2;->f(Ljava/lang/StringBuilder;IILjava/lang/String;)Ljava/lang/String;

    move-result-object p1

    iput-object p1, p0, Laa/k;->l:Ljava/lang/String;
    ...
    iput-object v0, p0, Laa/k;->h:Landroid/os/HandlerThread;

    new-instance p1, Laa/h;

    invoke-direct {p1}, Laa/h;-><init>()V

    iput-object p1, p0, Laa/k;->k:Laa/h;
    ...
    iput-object p0, p1, Laa/h;->a:Landroid/util/Size;
...
.method public abstract e(LG9/h;)I
    .param p1    # LG9/h;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    .end param
...
.method public final h()I
    ...
    iget-object v0, p0, Laa/k;->p:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    iget p0, p0, Laa/k;->q:I
...
.method public v()V
    ...
    iget-object v0, p0, Laa/k;->h:Landroid/os/HandlerThread;
...
.method public final y()V
    ...
    invoke-virtual {p0}, Laa/k;->l()Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-virtual {p0}, Laa/k;->v()V
