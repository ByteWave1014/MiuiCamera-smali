...
.method public final C(LG9/h;)V
    ...
    invoke-static {v0, v1}, LFa/b;->h(Ljava/util/ArrayList;Ljava/lang/StringBuilder;)Ljava/lang/String;
    ...
    iget-boolean v1, v1, LG9/b$a;->i:Z
    ...
    iget-object v5, v4, LG9/b$a;->d:Landroid/media/Image;

    invoke-static {v5}, Laa/k;->m(Landroid/media/Image;)Z
    ...
    :cond_2
    iget-object v6, v4, LG9/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;

    if-nez v1, :cond_3

    iget v7, p1, LG9/h;->d:I

    invoke-virtual {p0, v6, v5, v3, v7}, Laa/C;->K(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;II)V
    ...
    iget-object v8, v4, LG9/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;

    invoke-virtual {v8}, Lcom/xiaomi/protocol/ICustomCaptureResult;->getRequest()Landroid/hardware/camera2/CaptureRequest;

    move-result-object v8

    sget-object v9, Ln6/l;->u:Ln6/K;

    const v10, 0xbabe

    invoke-static {v8, v9, v10}, Ln6/L;->i(Landroid/hardware/camera2/CaptureRequest;Ln6/K;I)Ljava/lang/Object;
    ...
    :goto_2
    iget v8, p1, LG9/h;->d:I

    invoke-virtual {p0, v6, v5, v7, v8}, Laa/C;->K(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;II)V

    :goto_3
    iget-object v4, v4, LG9/b$a;->e:Landroid/media/Image;

    iget-object v5, p0, Laa/k;->j:Laa/r$e;

    invoke-static {v4, v5}, Laa/a;->E(Landroid/media/Image;Laa/r$e;)V
...
.method public final K(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;II)V
    ...
    invoke-static {v0, v1, v2, v4}, LA/O;->f(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-direct {p1, p0}, Laa/A;-><init>(Laa/C;)V
...
.method public final b(Lcom/xiaomi/engine/BufferFormat;)Ljava/util/ArrayList;
    ...
    iget-object v1, p0, Laa/a;->w:Landroid/media/ImageReader;

    new-instance v2, Laa/x;

    invoke-direct {v2, p0, p1}, Laa/x;-><init>(Laa/C;Lcom/xiaomi/engine/BufferFormat;)V
    ...
    invoke-direct {v2, p0}, Laa/y;-><init>(Laa/C;)V
    ...
    invoke-direct {v1, p0}, Laa/z;-><init>(Laa/C;)V
