...
.method public constructor <init>(Laa/r;)V
    ...
    iput-object p1, p0, Laa/r$e;->a:Laa/r;
...
.method public final a(Laa/a;)Z
    ...
    iget-object v2, v0, LG9/b;->r:Laa/k;
...
.method public final b(IJ)V
    ...
    invoke-virtual {p0, p2, p3}, Laa/r;->u(J)Laa/o;
    ...
    invoke-virtual {v1, p2}, LL3/n;->m(Ljava/lang/String;)V

    iget-object p0, p0, Laa/r;->h:Lcom/android/camera/b$a;

    invoke-virtual {p0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iget-object p2, v0, Laa/o;->x:Laa/w;

    if-eqz p2, :cond_2

    invoke-interface {p2, v0, p1}, Laa/w;->a(Laa/o;I)V
    ...
    invoke-interface {p0, v0, p1}, Laa/w;->a(Laa/o;I)V
...
.method public final c(Landroid/media/Image;IZ)V
    ...
    invoke-static {v2, v3, v1}, LA/T;->k(Ljava/lang/StringBuilder;Ljava/lang/String;I)Ljava/lang/String;
    ...
    iget-object v12, v0, Laa/r$e;->a:Laa/r;

    const/4 v2, 0x2

    if-ne v1, v2, :cond_0

    invoke-static/range {p1 .. p1}, LC9/e;->h(Landroid/media/Image;)[B

    move-result-object v0

    if-eqz v0, :cond_1b

    iget-object v1, v12, Laa/r;->F:Laa/r$f;

    invoke-virtual {v1, v0, v8}, Laa/r$f;->onJpegAvailable([BLjava/lang/String;)V

    goto/16 :goto_7

    :cond_0
    invoke-virtual {v12, v6, v7}, Laa/r;->u(J)Laa/o;
    ...
    invoke-static {v6, v7, v0}, LA/H2;->b(JLjava/lang/String;)Ljava/lang/String;
    ...
    iget-object v4, v13, Laa/o;->g:Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    :goto_0
    iget v15, v13, Laa/o;->A:I

    iget-object v14, v12, Laa/r;->F:Laa/r$f;
    ...
    invoke-static {v15}, LC9/c;->c(I)Z

    move-result v5

    if-nez v5, :cond_a

    invoke-static {v15}, LC9/c;->b(I)Z

    move-result v5

    if-nez v5, :cond_a

    iget-boolean v5, v3, Laa/p;->a:Z

    if-nez v5, :cond_a

    iget-boolean v1, v3, Laa/p;->d0:Z
    ...
    iget-object v0, v0, Laa/r$e;->a:Laa/r;
    ...
    :try_start_0
    invoke-virtual {v12, v6, v7, v0}, Laa/r;->z(JLcom/xiaomi/camera/imagecodec/ReprocessData;)V
    :try_end_0
    ...
    invoke-virtual {v14, v0, v8}, Laa/r$f;->onError(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v0, v10, v1, v1}, LC9/e;->k(Lcom/xiaomi/camera/imagecodec/ImagePool;Landroid/media/Image;IZ)Landroid/media/Image;

    move-result-object v0

    iget-object v1, v12, Laa/r;->C:Laa/r$c;

    invoke-virtual {v1, v10}, Laa/r$c;->b(Landroid/media/Image;)V
    ...
    iput-object v0, v3, Ll4/b$a;->e:Landroid/media/Image;

    iput-object v1, v3, Ll4/f$a;->r:Landroid/hardware/camera2/TotalCaptureResult;

    iput-object v13, v3, Ll4/b$a;->b:Laa/o;

    iget-object v0, v12, Laa/r;->s:Laa/s;

    iput-object v0, v3, Ll4/b$a;->p:Laa/s;

    new-instance v0, Ll4/f;

    invoke-direct {v0, v3}, Ll4/b;-><init>(Ll4/b$a;)V

    iget-object v1, v3, Ll4/f$a;->r:Landroid/hardware/camera2/TotalCaptureResult;

    iput-object v1, v0, Ll4/f;->u:Landroid/hardware/camera2/TotalCaptureResult;

    const/4 v1, 0x0

    iput-object v1, v0, Ll4/f;->w:Landroid/media/ImageWriter;

    iget-object v1, v0, Ll4/b;->d:Laa/o;

    iget-object v1, v1, Laa/o;->r:Laa/p;

    iget-object v1, v1, Laa/p;->M:Landroid/util/Size;
    ...
    iput v1, v0, Ll4/b;->j:I

    goto :goto_2

    :cond_7
    iget-object v1, v0, Ll4/b;->g:Landroid/media/Image;

    invoke-virtual {v1}, Landroid/media/Image;->getWidth()I

    move-result v1

    iput v1, v0, Ll4/b;->i:I
    ...
    iget-object v1, v12, Laa/r;->i:Ll4/j;

    iget-object v2, v1, Ll4/j;->m:Landroid/os/HandlerThread;
    ...
    iput-object v2, v1, Ll4/j;->m:Landroid/os/HandlerThread;

    invoke-virtual {v2}, Ljava/lang/Thread;->start()V

    new-instance v2, Landroid/os/Handler;

    iget-object v3, v1, Ll4/j;->m:Landroid/os/HandlerThread;
    ...
    iput-object v2, v1, Ll4/j;->n:Landroid/os/Handler;
    ...
    :cond_8
    iget-object v2, v1, Ll4/j;->n:Landroid/os/Handler;

    iput-object v2, v0, Ll4/b;->m:Landroid/os/Handler;

    const/4 v2, 0x1

    invoke-virtual {v1, v0, v2}, Ll4/j;->d(Ll4/b;Z)V

    invoke-static {v15}, LC9/c;->d(I)Z

    move-result v0

    if-eqz v0, :cond_9

    iget-object v0, v12, Laa/r;->v:Ljava/util/HashMap;
    ...
    iget-boolean v5, v3, Laa/p;->J:Z

    iget-object v0, v3, Laa/p;->l:Landroid/util/Size;
    ...
    iget-object v0, v12, Laa/r;->D:Laa/r$d;
    ...
    iget-object v2, v13, Laa/o;->r:Laa/p;

    iget-boolean v2, v2, Laa/p;->a:Z
    ...
    invoke-virtual/range {v1 .. v7}, Laa/r$e;->e(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;ZLaa/o;J)V
    ...
    iget-object v1, v12, Laa/r;->u:Ljava/util/HashMap;
    ...
    iput-object v1, v12, Laa/r;->u:Ljava/util/HashMap;
    ...
    iget-object v1, v12, Laa/r;->t:Ljava/util/HashMap;
    ...
    iput-object v1, v12, Laa/r;->t:Ljava/util/HashMap;
    ...
    iget v2, v13, Laa/o;->R:I

    iget v3, v13, Laa/o;->S:I

    iget-object v4, v13, Laa/o;->T:Landroid/graphics/Rect;

    iget v5, v13, Laa/o;->U:F

    invoke-static {v1, v2, v3, v4, v5}, Laa/r;->i(Landroid/graphics/Rect;IILandroid/graphics/Rect;F)V
    ...
    iget-object v0, v12, Laa/r;->t:Ljava/util/HashMap;
    ...
    :goto_4
    iget-object v0, v12, Laa/r;->u:Ljava/util/HashMap;
    ...
    invoke-static {v0, v1, v2, v2}, LC9/e;->k(Lcom/xiaomi/camera/imagecodec/ImagePool;Landroid/media/Image;IZ)Landroid/media/Image;

    move-result-object v0

    iget-object v2, v12, Laa/r;->C:Laa/r$c;

    invoke-virtual {v2, v1}, Laa/r$c;->b(Landroid/media/Image;)V

    invoke-virtual {v12, v6, v7, v0}, Laa/r;->r(JLandroid/media/Image;)V
    ...
    invoke-virtual {v12, v6, v7, v1}, Laa/r;->r(JLandroid/media/Image;)V
...
.method public final d(Landroid/media/Image;)V
    ...
    iget-object p0, p0, Laa/r;->C:Laa/r$c;

    invoke-virtual {p0, p1}, Laa/r$c;->b(Landroid/media/Image;)V

    return-void
.end method

.method public final e(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;ZLaa/o;J)V
    .locals 8
    ...
    invoke-static {p2, p1}, LC9/e;->g(Landroid/media/Image;Z)[B
    ...
    invoke-static {v1, v2, p3, p2}, LA/X;->f(JLjava/lang/String;Ljava/lang/StringBuilder;)Ljava/lang/String;
    ...
    invoke-virtual {p4, v0, p1}, Laa/o;->a(I[B)V

    const-string p2, "JPEG"

    invoke-virtual {p4, p2}, Laa/o;->g(Ljava/lang/String;)Z

    move-result p2

    if-nez p2, :cond_2

    sget-boolean p2, Lt6/b;->B:Z
    ...
    iget-object v1, p0, Laa/r;->i:Ll4/j;
    ...
    invoke-virtual/range {v1 .. v6}, Ll4/j;->p(Laa/o;Landroid/hardware/camera2/CaptureResult;Landroid/hardware/camera2/CameraCharacteristics;Ljava/lang/String;Ljava/util/function/IntFunction;)V

    iget-object p1, p4, Laa/o;->K:Landroid/media/Image;

    invoke-static {p0, p1}, Laa/r;->b(Laa/r;Landroid/media/Image;)V

    invoke-static {p0, p4}, Laa/r;->d(Laa/r;Laa/o;)Z

    move-result p1

    if-eqz p1, :cond_3

    iget-object p1, p0, Laa/r;->h:Lcom/android/camera/b$a;

    if-eqz p1, :cond_3

    invoke-virtual {p1, p4}, Lcom/android/camera/b$a;->a(Laa/o;)V

    :cond_3
    const-string p1, "[2] onImageProcessed: parallelTaskHashMap remove "

    invoke-static {p5, p6, p1}, LA/H2;->b(JLjava/lang/String;)Ljava/lang/String;
    ...
    iget p1, p0, Laa/r;->y:I

    add-int/lit8 p1, p1, 0x1

    iput p1, p0, Laa/r;->y:I

    invoke-virtual {p0, p5, p6}, Laa/r;->y(J)Laa/o;

    move-result-object p1

    iget p2, p0, Laa/r;->y:I

    invoke-static {p0, p1, p2}, Laa/r;->e(Laa/r;Laa/o;I)Z

    move-result p1

    if-eqz p1, :cond_4

    invoke-static {p0}, Laa/r;->c(Laa/r;)V

    iput v0, p0, Laa/r;->y:I
