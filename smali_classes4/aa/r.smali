...
# instance fields
.field public final A:Laa/r$a;

.field public final B:Laa/r$b;

.field public final C:Laa/r$c;

.field public final D:Laa/r$d;

.field public final E:Laa/r$e;

.field public final F:Laa/r$f;
...
.method public constructor <init>(Lcom/android/camera/b$a;)V
    ...
    iput v0, p0, Laa/r;->a:I

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Laa/r;->c:Ljava/util/HashMap;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Laa/r;->d:Ljava/util/ArrayList;

    new-instance v0, Landroid/util/SparseArray;

    invoke-direct {v0}, Landroid/util/SparseArray;-><init>()V

    iput-object v0, p0, Laa/r;->e:Landroid/util/SparseArray;

    const/4 v0, 0x0

    iput-object v0, p0, Laa/r;->f:Landroid/os/HandlerThread;

    new-instance v0, Ljava/lang/Object;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    iput-object v0, p0, Laa/r;->j:Ljava/lang/Object;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Laa/r;->k:Ljava/util/HashMap;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Laa/r;->l:Ljava/util/HashMap;

    new-instance v0, Ljava/lang/Object;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    iput-object v0, p0, Laa/r;->m:Ljava/lang/Object;

    new-instance v0, Ljava/lang/Object;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    iput-object v0, p0, Laa/r;->n:Ljava/lang/Object;

    new-instance v0, Laa/r$g;

    invoke-direct {v0, p0}, Laa/r$g;-><init>(Laa/r;)V

    iput-object v0, p0, Laa/r;->o:Laa/r$g;

    const/4 v0, -0x1

    iput v0, p0, Laa/r;->p:I

    iput v0, p0, Laa/r;->q:I

    const/4 v1, 0x1

    iput v1, p0, Laa/r;->x:I

    const/4 v1, 0x0

    iput v1, p0, Laa/r;->y:I

    iput v0, p0, Laa/r;->z:I

    new-instance v0, Laa/r$a;

    invoke-direct {v0, p0}, Laa/r$a;-><init>(Laa/r;)V

    iput-object v0, p0, Laa/r;->A:Laa/r$a;

    new-instance v0, Laa/r$b;

    invoke-direct {v0, p0}, Laa/r$b;-><init>(Laa/r;)V

    iput-object v0, p0, Laa/r;->B:Laa/r$b;

    new-instance v0, Laa/r$c;

    invoke-direct {v0, p0}, Laa/r$c;-><init>(Laa/r;)V

    iput-object v0, p0, Laa/r;->C:Laa/r$c;

    new-instance v0, Laa/r$d;

    invoke-direct {v0, p0}, Laa/r$d;-><init>(Laa/r;)V

    iput-object v0, p0, Laa/r;->D:Laa/r$d;

    new-instance v0, Laa/r$e;

    invoke-direct {v0, p0}, Laa/r$e;-><init>(Laa/r;)V

    iput-object v0, p0, Laa/r;->E:Laa/r$e;

    new-instance v0, Laa/r$f;

    invoke-direct {v0, p0}, Laa/r$f;-><init>(Laa/r;)V

    iput-object v0, p0, Laa/r;->F:Laa/r$f;
    ...
    iget-object v0, p0, Laa/r;->f:Landroid/os/HandlerThread;
    ...
    iput-object v1, p0, Laa/r;->f:Landroid/os/HandlerThread;
    ...
    iput-object v1, p0, Laa/r;->g:Landroid/os/Handler;

    iput-object p1, p0, Laa/r;->h:Lcom/android/camera/b$a;
    ...
    invoke-direct {p1, p0}, Laa/s;-><init>(Ljava/lang/Object;)V

    iput-object p1, p0, Laa/r;->s:Laa/s;

    :cond_1
    return-void
.end method

.method public static a(Laa/r;LG9/b;I)Lcom/xiaomi/protocol/ICustomCaptureResult;
    .locals 5
    ...
    invoke-static {p2, v2}, LB3/d;->b(Ljava/lang/String;Ljava/lang/Integer;)Ljava/lang/String;
    ...
    invoke-direct {v2, v0}, Laa/q;-><init>(Z)V
...
.method public static b(Laa/r;Landroid/media/Image;)V
    .locals 0
...
.method public static c(Laa/r;)V
    .locals 0
...
.method public static d(Laa/r;Laa/o;)Z
    .locals 2
...
.method public static e(Laa/r;Laa/o;I)Z
    .locals 1
...
.method public static f(Laa/r;JLaa/o;)V
    .locals 4

    const-string v0, "putParallelTaskData : data for "

    iget-object v1, p0, Laa/r;->m:Ljava/lang/Object;

    monitor-enter v1

    :try_start_0
    iget-object v2, p0, Laa/r;->k:Ljava/util/HashMap;
    ...
    :cond_0
    :goto_0
    iget-object p0, p0, Laa/r;->k:Ljava/util/HashMap;
...
.method public static g(Laa/r;Laa/o;Landroid/media/Image;Ljava/lang/String;IZ)V
    .locals 21
    ...
    iget-object v3, v7, Laa/r;->C:Laa/r$c;

    invoke-virtual {v3, v1}, Laa/r$c;->b(Landroid/media/Image;)V
    ...
    iget-object v11, v7, Laa/r;->B:Laa/r$b;
    ...
    invoke-virtual {v10}, L渭渡渣湠渣渧湠渪渫游渧渭渫湠渭渡渣渣渡渠湠渍渡渣渣渡渠;->m3()Z
    ...
    invoke-virtual/range {v1 .. v6}, Laa/r;->j(Laa/o;Landroid/media/Image;Ljava/lang/String;IZ)V

    iget v1, v0, Laa/o;->A:I
    ...
    iget v10, v0, Laa/o;->A:I

    iget-object v2, v0, Laa/o;->a0:Ljava/lang/String;

    iget-object v3, v0, Laa/o;->P:Ljava/lang/Object;
    ...
    iget v2, v0, Laa/o;->k0:I

    iput v2, v1, LG9/b;->x:I

    iput-object v8, v1, LG9/b;->q:Laa/r$b;

    sget-object v2, Laa/m$e;->a:Laa/m;

    invoke-virtual {v2, v1}, Laa/m;->g(LG9/b;)V

    invoke-virtual {v7, v0, v4}, Laa/r;->m(Laa/o;Z)V

    iget-object v1, v0, Laa/o;->g:Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    sget-object v5, Ln6/l;->O1:Ln6/K;

    invoke-static {v0, v5, v3}, Ln6/L;->f(Landroid/hardware/camera2/impl/CameraMetadataNative;Ln6/K;Ljava/lang/Integer;)V
    ...
    invoke-static {v5, v3, v8}, Ln6/L;->a(Ljava/lang/Exception;Ljava/lang/Object;I)V
    ...
    iget-object v0, v7, Laa/r;->v:Ljava/util/HashMap;
    ...
    :goto_5
    iget-object v0, v0, Laa/r$i;->a:Lcom/xiaomi/camera/imagecodec/ReprocessData;
    ...
    iget-object v10, v0, Laa/o;->r:Laa/p;

    iget-boolean v10, v10, Laa/p;->J:Z
    ...
    iput-object v11, v4, Laa/p;->l:Landroid/util/Size;

    new-instance v4, LG9/b;

    iget v10, v0, Laa/o;->A:I

    iget-object v15, v0, Laa/o;->a0:Ljava/lang/String;

    iget-object v9, v0, Laa/o;->P:Ljava/lang/Object;
    ...
    iget v9, v0, Laa/o;->k0:I

    iput v9, v4, LG9/b;->x:I

    iput-object v8, v4, LG9/b;->q:Laa/r$b;

    sget-object v8, Laa/m$e;->a:Laa/m;

    invoke-virtual {v8, v4}, Laa/m;->g(LG9/b;)V

    invoke-virtual {v7, v0, v5}, Laa/r;->m(Laa/o;Z)V

    iget-object v4, v0, Laa/o;->g:Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    sget-object v7, Ln6/l;->O1:Ln6/K;

    invoke-static {v0, v7, v3}, Ln6/L;->f(Landroid/hardware/camera2/impl/CameraMetadataNative;Ln6/K;Ljava/lang/Integer;)V
    ...
    invoke-static {v7, v3, v9}, Ln6/L;->a(Ljava/lang/Exception;Ljava/lang/Object;I)V
    ...
    :cond_d
    iget-object v1, v7, Laa/r;->v:Ljava/util/HashMap;
    ...
    check-cast v1, Laa/r$i;

    iget-object v1, v1, Laa/r$i;->a:Lcom/xiaomi/camera/imagecodec/ReprocessData;
    ...
    :goto_9
    iget-object v1, v0, Laa/o;->P:Ljava/lang/Object;
    ...
    invoke-virtual {v4}, LV0/c;->a()LV0/g;

    move-result-object v4

    invoke-direct {v1, v9, v2, v3, v4}, LG9/c;-><init>(Landroid/media/Image;IZLV0/g;)V

    iget-object v0, v0, Laa/o;->P:Ljava/lang/Object;
    ...
    invoke-virtual {v7, v1, v2, v9}, Laa/r;->r(JLandroid/media/Image;)V
...
.method public static h(Laa/r;LG9/b$a;Laa/r$c;)V
    .locals 2
    ...
    invoke-static {p0, v0, p2}, Laa/r;->x(Landroid/media/Image;ZLaa/r$c;)V
    ...
    invoke-static {v0, p1, p2}, Laa/r;->x(Landroid/media/Image;ZLaa/r$c;)V
...
.method public static i(Landroid/graphics/Rect;IILandroid/graphics/Rect;F)V
    ...
    :cond_9
    invoke-static {p3, p4}, Laa/D;->v(Landroid/graphics/Rect;F)Landroid/graphics/Rect;
...
.method public static x(Landroid/media/Image;ZLaa/r$c;)V
    .locals 0
    ...
    invoke-virtual {p2, p0}, Laa/r$c;->b(Landroid/media/Image;)V
...
.method public final A()V
    ...
    iget-object v2, p0, Laa/r;->m:Ljava/lang/Object;

    monitor-enter v2

    :try_start_0
    iget-object v3, p0, Laa/r;->k:Ljava/util/HashMap;
    ...
    iget-object v1, p0, Laa/r;->j:Ljava/lang/Object;

    monitor-enter v1

    :try_start_1
    iget-object v2, p0, Laa/r;->j:Ljava/lang/Object;
    ...
    iget-object v0, p0, Laa/r;->h:Lcom/android/camera/b$a;
    ...
    :cond_3
    :goto_1
    invoke-virtual {p0}, Laa/r;->s()V

    invoke-virtual {p0}, Laa/r;->o()V

    iget-object v0, p0, Laa/r;->t:Ljava/util/HashMap;
    ...
    iput-object v1, p0, Laa/r;->t:Ljava/util/HashMap;

    :cond_4
    iget-object v0, p0, Laa/r;->u:Ljava/util/HashMap;

    if-eqz v0, :cond_5

    invoke-virtual {v0}, Ljava/util/HashMap;->clear()V

    iput-object v1, p0, Laa/r;->u:Ljava/util/HashMap;

    :cond_5
    iget-object v0, p0, Laa/r;->v:Ljava/util/HashMap;

    if-eqz v0, :cond_6

    invoke-virtual {v0}, Ljava/util/HashMap;->clear()V

    iput-object v1, p0, Laa/r;->v:Ljava/util/HashMap;
...
.method public final j(Laa/o;Landroid/media/Image;Ljava/lang/String;IZ)V
    .locals 13
    ...
    iget-object v1, v6, Laa/r;->v:Ljava/util/HashMap;
    ...
    iput-object v1, v6, Laa/r;->v:Ljava/util/HashMap;
    ...
    new-instance v12, Laa/r$i;

    invoke-direct {v12}, Laa/r$i;-><init>()V
    ...
    invoke-virtual/range {v0 .. v5}, Laa/r;->t(Laa/o;Landroid/media/Image;Ljava/lang/String;IZ)Lcom/xiaomi/camera/imagecodec/ReprocessData;

    move-result-object v0

    iput-boolean v11, v12, Laa/r$i;->b:Z
    ...
    iget-object v1, v7, Laa/o;->K:Landroid/media/Image;
    ...
    :cond_2
    iput-object v8, v7, Laa/o;->K:Landroid/media/Image;

    iput-boolean v11, v12, Laa/r$i;->c:Z

    :goto_0
    iput-object v0, v12, Laa/r$i;->a:Lcom/xiaomi/camera/imagecodec/ReprocessData;

    iget-object v0, v6, Laa/r;->v:Ljava/util/HashMap;
    ...
    iget-object v0, v7, Laa/o;->K:Landroid/media/Image;
    ...
    iput-boolean v11, v1, Laa/r$i;->c:Z

    :goto_1
    iget-boolean v0, v1, Laa/r$i;->b:Z

    if-eqz v0, :cond_9

    iget-boolean v0, v1, Laa/r$i;->c:Z

    if-eqz v0, :cond_9

    if-eqz p5, :cond_8

    iget v0, v7, Laa/o;->A:I
...
.method public final k()Z
    ...
    iget-object v0, p0, Laa/r;->j:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    iget v1, p0, Laa/r;->x:I
    ...
    :cond_0
    iget-object v1, p0, Laa/r;->e:Landroid/util/SparseArray;
...
.method public final l()V
    ...
    iget-object v0, p0, Laa/r;->m:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Laa/r;->k:Ljava/util/HashMap;
...
.method public final m(Laa/o;Z)V
    .locals 4
    .annotation build Lcom/android/camera/jacoco/JacocoIgnore;
        ignore = false
    ...
    iget-object v2, p1, Laa/o;->r:Laa/p;

    iget-object v2, v2, Laa/p;->l:Landroid/util/Size;
    ...
    iget-object v0, p1, Laa/o;->P:Ljava/lang/Object;
    ...
    iget-object p0, p0, Laa/r;->A:Laa/r$a;
    ...
    iget-object p0, p1, Laa/o;->P:Ljava/lang/Object;
...
.method public final n(Landroid/util/SparseArray;)Landroid/util/SparseArray;
    ...
    iget-object v4, p0, Laa/r;->d:Ljava/util/ArrayList;
    ...
    iget-object v4, p0, Laa/r;->e:Landroid/util/SparseArray;
    ...
    iput v7, v6, Laa/r$h;->a:I

    iput v4, v6, Laa/r$h;->b:I

    iget-object v4, p0, Laa/r;->g:Landroid/os/Handler;
    ...
    iget-object p0, p0, Laa/r;->e:Landroid/util/SparseArray;
...
.method public final o()V
    ...
    :goto_0
    iget-object v3, p0, Laa/r;->e:Landroid/util/SparseArray;
    ...
    :cond_2
    iget-object v1, p0, Laa/r;->d:Ljava/util/ArrayList;
    ...
    iput-object v1, p0, Laa/r;->s:Laa/s;
...
.method public final r(JLandroid/media/Image;)V
    ...
    iget-object v2, p0, Laa/r;->v:Ljava/util/HashMap;
    ...
    iget-object v5, v2, Laa/r$i;->a:Lcom/xiaomi/camera/imagecodec/ReprocessData;

    invoke-virtual {v5, p3}, Lcom/xiaomi/camera/imagecodec/ReprocessData;->setMainImage(Landroid/media/Image;)Ljava/util/ArrayList;

    iget-object p3, v2, Laa/r$i;->a:Lcom/xiaomi/camera/imagecodec/ReprocessData;

    invoke-virtual {p0, p1, p2, p3}, Laa/r;->z(JLcom/xiaomi/camera/imagecodec/ReprocessData;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    iget-object p0, p0, Laa/r;->v:Ljava/util/HashMap;
    ...
    :try_start_1
    iget-object v2, p0, Laa/r;->F:Laa/r$f;
    ...
    invoke-virtual {v2, p3, v1}, Laa/r$f;->onError(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public final s()V
    ...
    iget-object v3, p0, Laa/r;->j:Ljava/lang/Object;

    monitor-enter v3

    :try_start_0
    iget-object v4, p0, Laa/r;->c:Ljava/util/HashMap;
    ...
    iget-object v0, p0, Laa/r;->c:Ljava/util/HashMap;
    ...
    iget-object v1, p0, Laa/r;->f:Landroid/os/HandlerThread;
    ...
    iput-object v0, p0, Laa/r;->g:Landroid/os/Handler;
    ...
    :goto_3
    iget-object v2, p0, Laa/r;->f:Landroid/os/HandlerThread;
...
.method public final t(Laa/o;Landroid/media/Image;Ljava/lang/String;IZ)Lcom/xiaomi/camera/imagecodec/ReprocessData;
    .locals 15
    ...
    iget-object v8, v1, Laa/o;->g:Lcom/xiaomi/protocol/ICustomCaptureResult;

    iget-boolean v7, v1, Laa/o;->j0:Z
    ...
    iget-boolean v9, v3, Laa/p;->J:Z

    iget-object v4, v3, Laa/p;->M:Landroid/util/Size;
    ...
    iget-object v13, v0, Laa/r;->F:Laa/r$f;
    ...
    iget-boolean v2, v1, Laa/o;->J:Z

    const/4 v4, 0x1

    if-eqz v2, :cond_0

    iget-object v2, v1, Laa/o;->K:Landroid/media/Image;
    ...
    iget-object v0, v1, Laa/o;->W:Ljava/lang/String;
...
.method public final toString()Ljava/lang/String;
    ...
    invoke-static {v0, p0, v1}, LA/S;->i(Ljava/lang/StringBuilder;IC)Ljava/lang/String;
...
.method public final v()Z
    ...
    iget-object v0, p0, Laa/r;->k:Ljava/util/HashMap;
...
.method public final y(J)Laa/o;
    ...
    iget-object p0, p0, Laa/r;->h:Lcom/android/camera/b$a;
    ...
    invoke-static {p0, p2}, LY9/d;->a(II)V
...
.method public final z(JLcom/xiaomi/camera/imagecodec/ReprocessData;)V
    ...
    iget-object v0, p0, Laa/r;->n:Ljava/lang/Object;
