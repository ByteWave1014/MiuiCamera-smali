...
# direct methods
.method public constructor <init>(Laa/r$e;Lcom/xiaomi/engine/BufferFormat;)V
    .locals 2

    invoke-direct {p0, p1, p2}, Laa/k;-><init>(Laa/r$e;Lcom/xiaomi/engine/BufferFormat;)V
    ...
    iput-object p1, p0, Laa/a;->r:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iput-object p1, p0, Laa/a;->B:Landroid/util/LongSparseArray;
    ...
    iget-object v1, p0, Laa/k;->l:Ljava/lang/String;
    ...
    iput-object p1, p0, Laa/a;->s:Landroid/os/HandlerThread;
    ...
    iget-object p0, p0, Laa/k;->l:Ljava/lang/String;
...
.method public static E(Landroid/media/Image;Laa/r$e;)V
    .locals 0
    ...
    invoke-virtual {p1, p0}, Laa/r$e;->d(Landroid/media/Image;)V
...
.method public final A(JZ)V
    ...
    :try_start_0
    iget-object p0, p0, Laa/a;->v:LG9/j;

    if-eqz p0, :cond_0

    iget-object p0, p0, LG9/j;->a:Lcom/xiaomi/engine/TaskSession;
    ...
    :cond_1
    iget-object p0, p0, Laa/a;->u:Lcom/xiaomi/engine/TaskSession;
...
.method public final B(J)V
    ...
    iget-object v2, p0, Laa/a;->r:Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-virtual {v2}, Ljava/util/concurrent/atomic/AtomicInteger;->getAndDecrement()I

    invoke-virtual {p0}, Laa/a;->G()V

    iget-object v2, p0, Laa/k;->n:Ljava/lang/Object;
    ...
    iget-object v1, p0, Laa/a;->B:Landroid/util/LongSparseArray;

    invoke-virtual {v1, p1, p2}, Landroid/util/LongSparseArray;->remove(J)V

    iget-object p1, p0, Laa/k;->o:Ljava/util/LinkedList;
...
.method public abstract C(LG9/h;)V
.end method

.method public final D(LG9/b$a;)V
    .locals 3
    ...
    iget-object v0, p1, LG9/b$a;->d:Landroid/media/Image;

    iget-object v1, p0, Laa/k;->j:Laa/r$e;

    invoke-static {v0, v1}, Laa/a;->E(Landroid/media/Image;Laa/r$e;)V

    iget-object v0, p1, LG9/b$a;->e:Landroid/media/Image;

    iget-object v1, p0, Laa/k;->j:Laa/r$e;

    invoke-static {v0, v1}, Laa/a;->E(Landroid/media/Image;Laa/r$e;)V

    iget-object p1, p1, LG9/b$a;->g:Landroid/media/Image;

    iget-object p0, p0, Laa/k;->j:Laa/r$e;

    invoke-static {p1, p0}, Laa/a;->E(Landroid/media/Image;Laa/r$e;)V

    :cond_0
    return-void
.end method

.method public final F(LG9/i;)V
    .locals 2

    if-eqz p1, :cond_1

    iget-object p1, p1, LG9/i;->c:Ljava/util/ArrayList;
    ...
    iget-object v0, v0, LG9/h;->a:Ljava/util/ArrayList;
    ...
    invoke-virtual {p0, v1}, Laa/a;->D(LG9/b$a;)V
...
.method public final G()V
    ...
    iget-object v0, p0, Laa/k;->g:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Laa/k;->i:Laa/k$a;

    if-eqz v1, :cond_1

    invoke-virtual {p0}, Laa/k;->n()Z
    ...
    iget-object p0, p0, Laa/k;->i:Laa/k$a;

    sget-boolean v1, Lt6/b;->j:Z
...
.method public final H()V
    ...
    iget-object v1, p0, Laa/k;->g:Ljava/lang/Object;

    monitor-enter v1

    :try_start_0
    iget-object v2, p0, Laa/k;->i:Laa/k$a;
    ...
    iget-object v0, p0, Laa/k;->i:Laa/k$a;
    ...
    iget-object p0, p0, Laa/k;->h:Landroid/os/HandlerThread;
...
.method public final I(Lcom/xiaomi/engine/TaskSession;)V
    ...
    iput-object p1, p0, Laa/a;->u:Lcom/xiaomi/engine/TaskSession;

    monitor-exit v1
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_1

    iget-object p1, p0, Laa/k;->h:Landroid/os/HandlerThread;
    ...
    iget-object p1, p0, Laa/k;->n:Ljava/lang/Object;

    monitor-enter p1

    :try_start_1
    iget-object v0, p0, Laa/k;->o:Ljava/util/LinkedList;
...
.method public final J()V
    ...
    iget-object v1, p0, Laa/k;->h:Landroid/os/HandlerThread;
    ...
    :try_start_0
    new-instance v3, Laa/k$a;

    iget-object v4, p0, Laa/k;->h:Landroid/os/HandlerThread;

    invoke-virtual {v4}, Landroid/os/HandlerThread;->getLooper()Landroid/os/Looper;

    move-result-object v4

    invoke-direct {v3, v4, p0}, Laa/k$a;-><init>(Landroid/os/Looper;Laa/a;)V

    iput-object v3, p0, Laa/k;->i:Laa/k$a;
    ...
    invoke-virtual {p0, v1}, Laa/k;->t(I)V

    iget-object v1, p0, Laa/a;->s:Landroid/os/HandlerThread;
    ...
    iput-object v3, p0, Laa/a;->t:Landroid/os/Handler;
    ...
    invoke-static {v1, p0, v3}, LA/S;->h(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public final a(J)V
    ...
    iget-object v1, p0, Laa/k;->n:Ljava/lang/Object;

    monitor-enter v1

    :try_start_0
    iget-object v2, p0, Laa/a;->B:Landroid/util/LongSparseArray;
    ...
    iget-object v5, p0, Laa/a;->B:Landroid/util/LongSparseArray;
    ...
    iget-object v4, p0, Laa/a;->B:Landroid/util/LongSparseArray;
    ...
    iget-wide v7, v5, LG9/i;->a:J

    invoke-static {v7, v8}, Ljava/lang/Long;->valueOf(J)Ljava/lang/Long;

    move-result-object v7

    iget-wide v8, v5, LG9/i;->b:J
    ...
    invoke-virtual {p0, p2, v0}, Laa/a;->z(LG9/i;Ljava/lang/String;)V
...
.method public final c(Lcom/xiaomi/engine/BufferFormat;)Ljava/util/ArrayList;
    ...
    iget-object p1, p0, Laa/a;->z:Landroid/media/ImageReader;

    new-instance v1, LL0/P;

    invoke-direct {v1, p0, v2}, LL0/P;-><init>(Ljava/lang/Object;I)V

    iget-object v2, p0, Laa/a;->t:Landroid/os/Handler;
    ...
    iget-object p0, p0, Laa/a;->z:Landroid/media/ImageReader;
...
.method public final e(LG9/h;)I
    ...
    iget-object v0, p0, Laa/k;->n:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Laa/k;->o:Ljava/util/LinkedList;
    ...
    :try_start_1
    iget-object v0, p0, Laa/a;->u:Lcom/xiaomi/engine/TaskSession;
    ...
    :cond_1
    iget-boolean v0, p1, LG9/h;->e:Z

    if-eqz v0, :cond_2

    iget-boolean p1, p1, LG9/h;->b:Z
...
.method public final f(J)V
    ...
    invoke-virtual {p0, p1, p2, v1}, Laa/a;->A(JZ)V

    const/4 v0, 0x1

    invoke-virtual {p0, p1, p2, v0}, Laa/a;->A(JZ)V
...
.method public final j()LG9/j;
    ...
    iget-object v0, p0, Laa/a;->v:LG9/j;
...
.method public final k()Z
    ...
    iget-object v0, p0, Laa/a;->r:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method public final p()Ljava/util/ArrayList;
    ...
    :try_start_0
    iput-object v1, p0, Laa/a;->u:Lcom/xiaomi/engine/TaskSession;

    iput-object v1, p0, Laa/a;->v:LG9/j;
    ...
    :try_start_1
    iget-object v3, p0, Laa/a;->B:Landroid/util/LongSparseArray;
    ...
    invoke-virtual {p0, v4}, Laa/a;->F(LG9/i;)V

    iget-object v5, p0, Laa/a;->r:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    :cond_0
    iget-object v3, p0, Laa/k;->o:Ljava/util/LinkedList;
    ...
    iget-boolean v5, v4, LG9/h;->b:Z

    if-eqz v5, :cond_1

    iget-wide v5, v4, LG9/h;->c:J
    ...
    :cond_1
    iget-object v5, v4, LG9/h;->a:Ljava/util/ArrayList;
    ...
    check-cast v6, LG9/b$a;

    invoke-virtual {p0, v6}, Laa/a;->D(LG9/b$a;)V
...
.method public final q(J)Z
    ...
    iget-object p2, p0, Laa/a;->B:Landroid/util/LongSparseArray;
    ...
    invoke-virtual {p0, p2, p1}, Laa/a;->z(LG9/i;Ljava/lang/String;)V
...
.method public final r(J)V
    ...
    :cond_0
    iget-object p1, p0, Laa/k;->i:Laa/k$a;
...
.method public final s()V
    ...
    :try_start_0
    iget-object v1, p0, Laa/a;->u:Lcom/xiaomi/engine/TaskSession;
    ...
    iget-object v1, v0, LG9/h;->a:Ljava/util/ArrayList;
    ...
    invoke-virtual {p0, v5}, Laa/a;->D(LG9/b$a;)V
    ...
    :cond_3
    iget-object v1, v0, LG9/b$a;->d:Landroid/media/Image;
    ...
    invoke-static {v6, v1, v7, v3}, LC9/e;->k(Lcom/xiaomi/camera/imagecodec/ImagePool;Landroid/media/Image;IZ)Landroid/media/Image;

    move-result-object v1

    invoke-virtual {p0, v0}, Laa/a;->D(LG9/b$a;)V
    ...
    invoke-direct {v0, v1, v2, v3, v6}, LG9/c;-><init>(Landroid/media/Image;IZLV0/g;)V

    invoke-virtual {p0, v0}, Laa/k;->d(LG9/c;)V

    invoke-virtual {p0, v4, v5}, Laa/a;->B(J)V
    ...
    iget-object v3, p0, Laa/k;->n:Ljava/lang/Object;
    ...
    iput-wide v4, v1, LG9/i;->a:J

    iput-wide v6, v1, LG9/i;->b:J

    new-instance v6, Ljava/util/ArrayList;

    invoke-direct {v6}, Ljava/util/ArrayList;-><init>()V

    iput-object v6, v1, LG9/i;->c:Ljava/util/ArrayList;

    invoke-virtual {v6, v0}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    iget-object v6, p0, Laa/a;->B:Landroid/util/LongSparseArray;
    ...
    iget-object v1, v6, LG9/i;->c:Ljava/util/ArrayList;
    ...
    iget-object v5, v6, LG9/i;->c:Ljava/util/ArrayList;
    ...
    invoke-virtual {p0, v0}, Laa/a;->C(LG9/h;)V
...
.method public final u(LG9/j;)V
    ...
    iput-object p1, p0, Laa/a;->v:LG9/j;
...
.method public final v()V
    ...
    invoke-super {p0}, Laa/k;->v()V

    iget-object v0, p0, Laa/k;->k:Laa/h;

    const/4 v1, 0x0

    if-eqz v0, :cond_0

    iput-object v1, p0, Laa/k;->k:Laa/h;
    ...
    :try_start_0
    iget-object v3, p0, Laa/a;->u:Lcom/xiaomi/engine/TaskSession;
    ...
    iget-object v0, v0, LG9/j;->a:Lcom/xiaomi/engine/TaskSession;
    ...
    iput-object v1, p0, Laa/k;->j:Laa/r$e;

    iget-object v0, p0, Laa/a;->w:Landroid/media/ImageReader;

    if-eqz v0, :cond_4

    invoke-virtual {v0}, Landroid/media/ImageReader;->close()V

    iput-object v1, p0, Laa/a;->w:Landroid/media/ImageReader;

    :cond_4
    iget-object v0, p0, Laa/a;->x:Landroid/media/ImageReader;

    if-eqz v0, :cond_5

    invoke-virtual {v0}, Landroid/media/ImageReader;->close()V

    iput-object v1, p0, Laa/a;->x:Landroid/media/ImageReader;

    :cond_5
    iget-object v0, p0, Laa/a;->y:Landroid/media/ImageReader;

    if-eqz v0, :cond_6

    invoke-virtual {v0}, Landroid/media/ImageReader;->close()V

    iput-object v1, p0, Laa/a;->y:Landroid/media/ImageReader;

    :cond_6
    iget-object v0, p0, Laa/a;->z:Landroid/media/ImageReader;

    if-eqz v0, :cond_7

    invoke-virtual {v0}, Landroid/media/ImageReader;->close()V

    iput-object v1, p0, Laa/a;->z:Landroid/media/ImageReader;

    :cond_7
    iget-object v0, p0, Laa/a;->s:Landroid/os/HandlerThread;
    ...
    :cond_8
    iget-object v0, p0, Laa/a;->t:Landroid/os/Handler;

    if-eqz v0, :cond_9

    invoke-virtual {v0, v1}, Landroid/os/Handler;->removeCallbacksAndMessages(Ljava/lang/Object;)V

    iput-object v1, p0, Laa/a;->t:Landroid/os/Handler;
...
.method public final x()Z
    ...
    :try_start_0
    iget-object v2, p0, Laa/a;->u:Lcom/xiaomi/engine/TaskSession;
    ...
    invoke-virtual {p0, v0}, Laa/k;->t(I)V
...
.method public final z(LG9/i;Ljava/lang/String;)V
    .locals 7
    .param p1    # LG9/i;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    invoke-virtual {p0, p1}, Laa/a;->F(LG9/i;)V

    iget-object v0, p0, Laa/a;->r:Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-virtual {v0}, Ljava/util/concurrent/atomic/AtomicInteger;->getAndDecrement()I

    iget-object v0, p0, Laa/k;->j:Laa/r$e;

    if-eqz v0, :cond_0

    iget-wide v4, p1, LG9/i;->a:J

    iget-object p1, v0, Laa/r$e;->a:Laa/r;

    invoke-virtual {p1, v4, v5}, Laa/r;->u(J)Laa/o;
    ...
    iget-object p0, p0, Laa/r$e;->a:Laa/r;

    invoke-virtual {p0, v4, v5}, Laa/r;->y(J)Laa/o;
    ...
    invoke-static {v0, p1, p2}, Lo0/b;->D(ILjava/lang/String;Ljava/lang/String;)V
