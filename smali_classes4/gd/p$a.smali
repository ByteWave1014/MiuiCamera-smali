...
.field public final synthetic l:Lgd/p;


# direct methods
.method public constructor <init>(Lgd/p;Landroid/content/Context;Lcom/xiaomi/mimoji/common/fragment/bottomlist/FragmentMimojiBottomList;Landroid/widget/RelativeLayout;)V
    .locals 6
    ...
    iput-object p1, p0, Lgd/p$a;->l:Lgd/p;

    const/16 p1, 0x68

    iput p1, p0, Lgd/p$a;->a:I

    const/4 p1, 0x3

    new-array v1, p1, [I

    iput-object v1, p0, Lgd/p$a;->b:[I

    const/4 v2, 0x0

    iput-boolean v2, p0, Lgd/p$a;->k:Z

    iput-object p2, p0, Lgd/p$a;->j:Landroid/content/Context;

    iput-object p4, p0, Lgd/p$a;->c:Landroid/widget/RelativeLayout;

    new-instance p4, Landroid/widget/ImageView;

    invoke-direct {p4, p2}, Landroid/widget/ImageView;-><init>(Landroid/content/Context;)V

    iput-object p4, p0, Lgd/p$a;->g:Landroid/widget/ImageView;
    ...
    iput-object v3, p0, Lgd/p$a;->h:Landroid/widget/ImageView;
    ...
    iput-object v4, p0, Lgd/p$a;->i:Landroid/widget/ImageView;
    ...
    iget-object p3, p0, Lgd/p$a;->g:Landroid/widget/ImageView;

    invoke-static {p3, v2}, Lcom/android/camera/features/mode/capture/w;->g(Landroid/widget/ImageView;Z)V

    invoke-static {p3}, Lcom/android/camera/features/mode/capture/w;->e(Landroid/view/View;)V

    iget-object p3, p0, Lgd/p$a;->h:Landroid/widget/ImageView;

    invoke-static {p3, v2}, Lcom/android/camera/features/mode/capture/w;->g(Landroid/widget/ImageView;Z)V

    invoke-static {p3}, Lcom/android/camera/features/mode/capture/w;->e(Landroid/view/View;)V

    iget-object p3, p0, Lgd/p$a;->i:Landroid/widget/ImageView;
    ...
    iput-object p3, p0, Lgd/p$a;->d:Landroid/widget/RelativeLayout$LayoutParams;

    new-instance p3, Landroid/widget/RelativeLayout$LayoutParams;

    invoke-direct {p3, p1, p2}, Landroid/widget/RelativeLayout$LayoutParams;-><init>(II)V

    iput-object p3, p0, Lgd/p$a;->e:Landroid/widget/RelativeLayout$LayoutParams;

    new-instance p3, Landroid/widget/RelativeLayout$LayoutParams;

    invoke-direct {p3, p1, p2}, Landroid/widget/RelativeLayout$LayoutParams;-><init>(II)V

    iput-object p3, p0, Lgd/p$a;->f:Landroid/widget/RelativeLayout$LayoutParams;
...
.method public static b(Z)V
    ...
    invoke-direct {v1, p0, v2}, LA3/r2;-><init>(II)V
...
.method public final a(III)V
    ...
    iget-boolean v7, v0, Lgd/p$a;->k:Z

    iget-object v8, v0, Lgd/p$a;->i:Landroid/widget/ImageView;

    iget-object v9, v0, Lgd/p$a;->g:Landroid/widget/ImageView;

    iget-object v10, v0, Lgd/p$a;->h:Landroid/widget/ImageView;

    const/4 v11, 0x1

    if-nez v7, :cond_0

    iget-object v7, v0, Lgd/p$a;->c:Landroid/widget/RelativeLayout;
    ...
    iput-boolean v11, v0, Lgd/p$a;->k:Z

    :cond_0
    iget-object v7, v0, Lgd/p$a;->l:Lgd/p;

    iget-boolean v12, v7, Lgd/p;->g:Z

    if-nez v12, :cond_a

    iget-boolean v12, v7, Lgd/p;->f:Z
    ...
    :cond_1
    iget-object v12, v0, Lgd/p$a;->b:[I
    ...
    iget-boolean v11, v7, Lgd/p;->j:Z

    if-eqz v11, :cond_3

    iget-wide v5, v7, Lgd/p;->a:D
    ...
    invoke-direct {v2, v0}, Lgd/m;-><init>(Lgd/p$a;)V
    ...
    invoke-direct {v3, v0}, Lgd/n;-><init>(Lgd/p$a;)V
    ...
    invoke-direct {v1, v0}, Lgd/o;-><init>(Lgd/p$a;)V
    ...
    invoke-static {v0}, Lgd/p$a;->b(Z)V
    ...
    iput v2, v0, Lgd/p$a;->a:I

    iget v2, v7, Lgd/p;->e:I

    sub-int v2, v2, p1

    iget-object v3, v0, Lgd/p$a;->j:Landroid/content/Context;
    ...
    invoke-direct {v4, v0, v1, v2}, Lgd/j;-><init>(Lgd/p$a;II)V
    ...
    invoke-direct {v5, v0, v1, v2}, Lgd/k;-><init>(Lgd/p$a;II)V
    ...
    invoke-direct {v3, v0, v1, v2}, Lgd/l;-><init>(Lgd/p$a;II)V
