...
.field public d:LSc/g;

.field public e:LSc/g;
...
.method public constructor <init>(Lcom/android/camera/ActivityBase;)V
    ...
    iput-object v0, p0, LSc/f;->a:Ljava/lang/String;
...
.method public final F()V
    ...
    iget-object v1, p0, LSc/f;->a:Ljava/lang/String;
    ...
    iput-object v0, p0, LSc/f;->i:Landroid/os/Handler;
...
.method public final I9(Ljava/lang/String;)V
    ...
    iput-object p1, p0, LSc/f;->l:Ljava/lang/String;

    iget-object p0, p0, LSc/f;->e:LSc/g;

    if-eqz p0, :cond_0

    invoke-virtual {p0, p1}, LSc/g;->d(Ljava/lang/String;)V
...
.method public final Md(III)V
    ...
    iget-object p3, p0, LSc/f;->e:LSc/g;

    iget-object v0, p0, LSc/f;->g:Lcom/android/camera/ActivityBase;
    ...
    invoke-virtual {p3, v1}, Lea/b;->v(Ljava/lang/Class;)Ljava/lang/Object;
    ...
    iput-object v0, v1, LSc/g$b;->a:Lcom/android/camera/ActivityBase;

    iput-object p0, v1, LSc/g$b;->e:LSc/f;

    iget-object v2, p0, LSc/f;->i:Landroid/os/Handler;

    iput-object v2, v1, LSc/g$b;->h:Landroid/os/Handler;

    iget-object v2, p0, LSc/f;->n:LSc/f$a;

    iput-object v2, v1, LSc/g$b;->f:LSc/f$a;

    const/high16 v2, 0xe00000

    iput v2, v1, LSc/g$b;->b:I

    const/16 v2, 0x1e

    iput v2, v1, LSc/g$b;->c:I

    sget-object v2, Lbd/a;->c:Ljava/lang/String;

    iput-object v2, v1, LSc/g$b;->d:Ljava/lang/String;
    ...
    iput-object p3, v1, LSc/g$b;->g:Ljava/util/List;

    new-instance p3, LSc/g;

    invoke-direct {p3, v1}, LSc/g;-><init>(LSc/g$b;)V

    iput-object p3, p0, LSc/f;->d:LSc/g;

    iput-object p3, p0, LSc/f;->e:LSc/g;
    ...
    iget-object v4, p3, LSc/g;->a:Ljava/lang/String;

    invoke-static {v4, v1, v3}, Lcom/android/camera/log/Log;->d(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    iget v1, p3, LSc/g;->f:I
    ...
    iput v1, p3, LSc/g;->f:I

    invoke-static {p1, p2}, Ljava/lang/Math;->max(II)I

    move-result p1

    iput p1, p3, LSc/g;->g:I
    ...
    invoke-virtual {p0, p1, p2}, LSc/f;->setMaxDuration(J)V
    ...
    invoke-static {p3, v0, p1, v0, p1}, LA3/h2;->k(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    sget-object p1, Lbd/a;->n:Ljava/lang/String;
    ...
    iput-object p1, p0, LSc/f;->m:Ljava/lang/String;

    goto :goto_2

    :cond_5
    iput-object p2, p0, LSc/f;->m:Ljava/lang/String;

    :goto_2
    iget-object p1, p0, LSc/f;->e:LSc/g;

    if-eqz p1, :cond_6

    iget-object p3, p0, LSc/f;->m:Ljava/lang/String;

    const-string v0, "setFilterPath = "

    invoke-static {v0, p3}, LVa/a;->g(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v0

    new-array v1, v2, [Ljava/lang/Object;

    iget-object v3, p1, LSc/g;->a:Ljava/lang/String;

    invoke-static {v3, v0, v1}, Lcom/android/camera/log/Log;->d(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    iput-object p3, p1, LSc/g;->m:Ljava/lang/String;
    ...
    invoke-virtual {p0, p1}, LSc/f;->setRecordSpeed(I)V
    ...
    :cond_7
    invoke-virtual {p0, p2}, LSc/f;->I9(Ljava/lang/String;)V
...
.method public final R()V
    ...
    iget-object p0, p0, LSc/f;->d:LSc/g;

    if-eqz p0, :cond_1

    iget-object v0, p0, LSc/g;->j:LT0/c;
    ...
    iput-object v1, p0, LSc/g;->j:LT0/c;

    :cond_0
    iget-object v0, p0, LSc/g;->w:LU0/a;

    if-eqz v0, :cond_1

    invoke-virtual {v0}, LU0/a;->b()V

    iput-object v1, p0, LSc/g;->w:LU0/a;
...
.method public final Wa()Landroid/graphics/SurfaceTexture;
    ...
    iget-object v0, p0, LSc/f;->e:LSc/g;
    ...
    iget-object v3, v0, LSc/g;->d:Ljava/util/Stack;
    ...
    iget-object v5, v0, LSc/g;->a:Ljava/lang/String;
    ...
    invoke-virtual {v0, v2}, LSc/g;->e(I)V
    ...
    invoke-virtual {v0, p0}, LSc/g;->e(I)V
...
.method public final Zc()V
    ...
    invoke-static {v4}, Ljc/y;->i(Ljava/lang/String;)Z
    ...
    invoke-static {v1}, Ljc/y;->i(Ljava/lang/String;)Z
    ...
    invoke-static {v1}, Ljc/y;->k([Ljava/lang/String;)V
    ...
    :goto_0
    :try_start_0
    iget-object p0, p0, LSc/f;->h:Landroid/content/Context;
    ...
    invoke-static {p0, v0, v1}, Ljc/M;->i(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V
    :try_end_0
...
.method public final d0(LTc/e$a;)V
    .locals 0

    iput-object p1, p0, LSc/f;->f:LTc/e$a;
...
.method public final e()V
    ...
    invoke-virtual {p0}, LSc/f;->isRecording()Z
    ...
    iget-object v0, v0, LSc/g;->b:LSc/e;
    ...
    :cond_3
    iget-object v0, p0, LSc/g;->k:Ljava/lang/String;

    if-eqz v0, :cond_5

    iget-object v0, p0, LSc/g;->m:Ljava/lang/String;

    if-eqz v0, :cond_5

    iget-object v0, p0, LSc/g;->l:Ljava/lang/String;
    ...
    :cond_4
    iget-object v0, p0, LSc/g;->a:Ljava/lang/String;
    ...
    iget-object v2, p0, LSc/g;->k:Ljava/lang/String;
    ...
    iget-object v2, p0, LSc/g;->m:Ljava/lang/String;
    ...
    iget-object v2, p0, LSc/g;->l:Ljava/lang/String;
    ...
    iget-object v0, p0, LSc/g;->d:Ljava/util/Stack;
    ...
    iget-object v1, p0, LSc/g;->e:Lcom/android/camera/ActivityBase;

    invoke-virtual {v1}, Ljava/lang/Object;->hashCode()I

    move-result v1

    iget-object v2, p0, LSc/g;->d:Ljava/util/Stack;

    invoke-virtual {v0, v2, v1}, Ld0/c;->b(Ljava/util/Stack;I)V

    iget-object v3, p0, LSc/g;->b:LSc/e;

    iget-object v4, p0, LSc/g;->k:Ljava/lang/String;

    iget-object v5, p0, LSc/g;->m:Ljava/lang/String;

    iget-object v6, p0, LSc/g;->l:Ljava/lang/String;

    iget v9, p0, LSc/g;->n:F

    iget-wide v10, p0, LSc/g;->o:J
    ...
    invoke-virtual {p0, v0}, LSc/g;->e(I)V

    iget-object v0, p0, LSc/g;->q:LSc/f$a;

    invoke-virtual {p0, v0}, LSc/g;->f(LSc/f$a;)V
...
.method public final g8()V
    ...
    iput-object v0, p0, LSc/f;->l:Ljava/lang/String;

    iget-object v1, p0, LSc/f;->e:LSc/g;

    if-eqz v1, :cond_1

    invoke-virtual {v1, v0}, LSc/g;->d(Ljava/lang/String;)V
...
.method public final j()V
    ...
    iget-object v0, p0, LSc/g;->s:LSc/h;
    ...
    iget-object p0, p0, LSc/g;->b:LSc/e;
...
.method public final l()V
    ...
    invoke-virtual {p0}, LSc/f;->isRecordingPaused()Z
    ...
    :goto_0
    iget-object v5, p0, LSc/g;->b:LSc/e;

    iget-object v6, p0, LSc/g;->k:Ljava/lang/String;

    iget-object v7, p0, LSc/g;->m:Ljava/lang/String;

    iget-object v8, p0, LSc/g;->l:Ljava/lang/String;
    ...
    invoke-interface {v0}, Ld0/k;->getNextPos()J
...
.method public final o()V
    ...
    invoke-virtual {p0, v1}, LSc/g;->e(I)V
...
.method public final onOrientationChanged(III)V
    ...
    iget p2, p0, LSc/g;->g:I

    invoke-static {p1, p2}, Ljava/lang/Math;->min(II)I

    move-result p1

    iget p2, p0, LSc/g;->f:I

    iget p3, p0, LSc/g;->g:I
    ...
    iget-object p3, p0, LSc/g;->a:Ljava/lang/String;

    invoke-static {p3, p1, p2}, Lcom/android/camera/log/Log;->d(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    invoke-virtual {p0}, LSc/g;->c()V
...
.method public final onSurfaceTextureUpdated(LQ0/b;)V
    ...
    iget-object v2, v0, LSc/f;->g:Lcom/android/camera/ActivityBase;

    iget-object v2, v2, Lcom/android/camera/ActivityBase;->k0:Lo5/f;

    iget-object v9, v0, LSc/f;->d:LSc/g;

    if-eqz v9, :cond_14

    if-eqz v2, :cond_14

    iget-object v0, v2, Lo5/f;->o:Lp6/k;
    ...
    iget-object v6, v9, LSc/g;->A:LQ0/e;
    ...
    iget-object v1, v9, LSc/g;->A:LQ0/e;
    ...
    :goto_0
    iget-object v6, v9, LSc/g;->e:Lcom/android/camera/ActivityBase;

    if-eqz v6, :cond_3

    iget-object v7, v6, Lcom/android/camera/ActivityBase;->k0:Lo5/f;
    ...
    invoke-virtual {v7}, Lo5/f;->h()Lp6/f;
    ...
    :cond_5
    iget-object v8, v9, LSc/g;->c:Lcom/xiaomi/recordmediaprocess/OpenGlRender;
    ...
    iput-object v8, v9, LSc/g;->c:Lcom/xiaomi/recordmediaprocess/OpenGlRender;

    :cond_6
    iget-object v8, v9, LSc/g;->j:LT0/c;

    if-eqz v8, :cond_7

    iget-object v8, v8, LT0/c;->b:Lp6/i;
    ...
    iput-object v8, v9, LSc/g;->j:LT0/c;

    iget-object v5, v9, LSc/g;->c:Lcom/xiaomi/recordmediaprocess/OpenGlRender;
    ...
    :cond_9
    iget v5, v9, LSc/g;->u:I

    if-nez v5, :cond_b

    iget-object v5, v9, LSc/g;->d:Ljava/util/Stack;
    ...
    :goto_3
    invoke-virtual {v9, v5}, LSc/g;->e(I)V
    ...
    :cond_c
    :try_start_0
    iget-object v5, v9, LSc/g;->v:Ljava/util/concurrent/locks/ReentrantLock;

    invoke-virtual {v5}, Ljava/util/concurrent/locks/ReentrantLock;->lock()V

    iget-object v5, v9, LSc/g;->j:LT0/c;
    ...
    iget-object v4, v9, LSc/g;->e:Lcom/android/camera/ActivityBase;
    ...
    iget-object v3, v9, LSc/g;->e:Lcom/android/camera/ActivityBase;

    invoke-static {v3}, Ls0/e;->f(Landroid/app/Activity;)I

    move-result v3

    invoke-static {v3}, Ls0/e;->k(I)I
    ...
    invoke-static {v3, v2, v5}, Ls0/e;->B(ILandroid/graphics/Rect;Landroid/util/Size;)Landroid/graphics/Rect;
    ...
    :cond_10
    :goto_5
    invoke-interface {v0, v1}, Lp6/g;->a(LQ0/b;)V
    ...
    iget v0, v9, LSc/g;->u:I

    if-ne v0, v12, :cond_11

    iget-object v0, v9, LSc/g;->j:LT0/c;

    iget-object v0, v0, LT0/c;->b:Lp6/i;
    ...
    invoke-virtual/range {v3 .. v8}, LSc/g;->a(IIIJ)V

    goto :goto_6

    :cond_11
    iget-object v0, v9, LSc/g;->b:LSc/e;
    ...
    iget v3, v9, LSc/g;->f:I

    iget v4, v9, LSc/g;->g:I
    ...
    invoke-virtual {v9, v0}, LSc/g;->e(I)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    :cond_13
    iget-object v0, v9, LSc/g;->v:Ljava/util/concurrent/locks/ReentrantLock;
    ...
    :goto_7
    iget-object v1, v9, LSc/g;->v:Ljava/util/concurrent/locks/ReentrantLock;
...
.method public final setRecordSpeed(I)V
    ...
    iget-object v1, p0, LSc/g;->a:Ljava/lang/String;

    invoke-static {v1, v0}, Lcom/android/camera/log/LogK;->i(Ljava/lang/String;Ljava/lang/String;)V

    iput p1, p0, LSc/g;->n:F
...
.method public final u()Z
    ...
    iget-object v2, p0, LSc/f;->e:LSc/g;

    iget-wide v2, v2, LSc/g;->t:J
...
.method public final unRegisterProtocol()V
    ...
    iget-object p0, p0, LSc/f;->i:Landroid/os/Handler;
...
.method public final w()V
    ...
    iget-object v1, v0, LSc/g;->d:Ljava/util/Stack;
    ...
    iget-object v4, v0, LSc/g;->e:Lcom/android/camera/ActivityBase;

    invoke-virtual {v4}, Ljava/lang/Object;->hashCode()I

    move-result v4

    iget-object v5, v0, LSc/g;->d:Ljava/util/Stack;

    invoke-virtual {v2, v5, v4}, Ld0/c;->b(Ljava/util/Stack;I)V

    iget-object v2, v0, LSc/g;->d:Ljava/util/Stack;

    invoke-static {v2}, Lcom/xiaomi/microfilm/milive/b;->a(Ljava/util/List;)J

    move-result-wide v4

    iget-object v2, v0, LSc/g;->q:LSc/f$a;

    if-eqz v2, :cond_1

    iget-wide v6, v0, LSc/g;->o:J
    ...
    invoke-virtual {v2, v4, v5, v6}, LSc/f$a;->a(JF)V

    :cond_1
    iget-object v2, v0, LSc/g;->a:Ljava/lang/String;
    ...
    invoke-interface {v1}, Ld0/k;->getPath()Ljava/lang/String;
    ...
    iget-object v0, v0, LSc/g;->a:Ljava/lang/String;
    ...
    iget-object v0, v0, LSc/g;->d:Ljava/util/Stack;
